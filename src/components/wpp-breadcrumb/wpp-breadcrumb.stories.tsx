...
export default {
  ...
  argTypes: {
    ...
    backBtnLabel: {
      control: 'text',
      description:
        'If provided, renders a back button with the specified label instead of the breadcrumb. Clear this field to show normal breadcrumb.',
    },
  },
} as Meta<typeof WppBreadcrumb>

export const Breadcrumbs: StoryObj<Components.WppBreadcrumb> = {
  render: args => {
