...
} as Meta<Components.WppSlider>

export const Single: StoryObj<Components.WppSlider> = (args: Components.WppSlider) => {
...
export const Range: StoryObj<Components.WppSlider> = (args: Components.WppSlider) => {
  const container = document.createElement('div')
