...
import { ActionButtonData, Components } from '../../components'
...
} as Meta<Components.WppFloatingToolbar>

const actionButtonsConfigConst: ActionButtonData[] = [
  {
    icon: 'wpp-icon-add',
...
export const FloatingToolbar: StoryObj<Components.WppFloatingToolbar & { length: number }> = {
  render: args =>
    html`<wpp-floating-toolbar-v3-3-0
