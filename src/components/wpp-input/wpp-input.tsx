...
export class WppInput implements BaseComponent, BaseFormControl<InputValue>, InlineMessage {
  ...
  private _locales: InputLocaleInterface = LOCALES_DEFAULTS
   ...
   */
  @Prop() readonly truncationTooltipConfig: DropdownConfig = {}
   ...
   */
  @Prop() readonly locales: Partial<InputLocaleInterface> = {}
  ...
  @Watch('locales')
  onUpdateLocales(newLocales: Partial<InputLocaleInterface>) {
  ...
  private inputCssClasses = () => ({
    ...
    'tab-focus':
      this.focusType.input === FOCUS_TYPE.TAB &&
      ...
      >
        ...
        <div class={this.inputWithIconsCssClasses()} part="body">
          ...
          <wpp-tooltip
            ...
            anchorTabIndex={-1}
            config={this.truncationTooltipConfig}
          >
            {this.renderInput()}
          </wpp-tooltip>
        ...
        {this.lengthValidationError && (
          <wpp-inline-message
            ...
            part="message"
            onBlur={this.onBlur}
            onKeyUp={(event: KeyboardEvent) => this.onKeyUp(event, 'inlineMessage')}
          />
        )}
