...
| `locales`            | --                   | Defines the component locale types.                                                                                                                                                                                                                                | `{ minLengthErrorMessage?: ((minLength: number) => string) \| undefined; maxLengthErrorMessage?: ((maxLength: number) => string) \| undefined; }`                                                                                                                                                                              | `{}`                                              |
