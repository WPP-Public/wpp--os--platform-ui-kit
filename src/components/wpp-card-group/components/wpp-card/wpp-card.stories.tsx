...
export const Regular: StoryObj<CardStoryArgs> = (args: CardStoryArgs) => html`
  <div
...
export const Clickable: StoryObj<CardStoryArgs> = (args: CardStoryArgs) => html`
  <div
    style="position: fixed; inset: 0; background-color: ${handleBackgroundColor(
      args.interactive,
    )}; display: flex; align-items: center; justify-content: center"
