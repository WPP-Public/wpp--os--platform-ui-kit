...
} as Meta<Components.WppAutocomplete>
...
export const Regular: StoryObj<AutocompleteStoryArgs> = {
  render: args => {
...
export const Extended: StoryObj<AutocompleteStoryArgs> = {
  render: args => {
    const [value, setValue] = useState<Hero[]>([])
...
export const RegularSlotSuggestions: StoryObj<AutocompleteStoryArgs> = {
  render: args => {
    const [value, setValue] = useState<Hero[]>([])
