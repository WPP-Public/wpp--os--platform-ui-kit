...
export class WppTypography {
   ...
   */
  @Prop() readonly color: Color = 'var(--wpp-text-color)'
  ...
  private getTypographyStylesFromTheme = () => {
    ...
    if (this.type === '2xs-strong') typographyStyles[`${PREFIX_FOR_TYPE}-text-transform`] = 'uppercase'
  ...
  render() {
    ...
    return (
      <Host class="wpp-typography" exportparts="typography, inner" style={{ '--typography-color': this.color }}>
