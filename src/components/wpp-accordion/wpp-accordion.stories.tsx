...
export const Accordion: StoryObj<CardStoryArgs> = {
  render: args => html`
    <div style="width: 600px">
      <wpp-accordion-v3-3-0 .size="${args.size}" .withTag="${args.withTag}" .disabled="${args.disabled}">
        <wpp-typography-v3-3-0 slot="header" type=${handleTypographyType(args.size)}>
        ...
        ${args.withTag ? html`<wpp-tag-v3-3-0 slot="tags" label="Neutral" variant="neutral"></wpp-tag-v3-3-0>` : null}
      </wpp-accordion-v3-3-0>
      ...
      >
        ...
        <wpp-typography-v3-3-0 type="s-body">
        ...
        ${args.withActions
          ? html`
              <div style="display: flex; align-items: center" slot="actions">
                <wpp-action-button-v3-3-0 .disabled="${args.disabled}" variant="secondary" style="margin-right: 4px">
                  Actions 2
                  <wpp-icon-premium-v3-3-0 slot="icon-start"></wpp-icon-premium-v3-3-0>
                </wpp-action-button-v3-3-0>
                <wpp-action-button-v3-3-0 .disabled="${args.disabled}" variant="secondary">
                  Actions 1
                  <wpp-icon-edit-v3-3-0 slot="icon-start"></wpp-icon-edit-v3-3-0>
                </wpp-action-button-v3-3-0>
              </div>
            `
          : null}
