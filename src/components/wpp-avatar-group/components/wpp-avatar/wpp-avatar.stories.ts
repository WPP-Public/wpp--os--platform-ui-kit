...
} as Meta<Components.WppAvatar>

export const User: StoryObj<Components.WppAvatar> = {
  render: args => html`
    <wpp-avatar-v3-2-0
      .name="${args.name}"
      .size="${args.size}"
...
export const Logo: StoryObj<Components.WppAvatar> = {
  render: args => html`
    <wpp-avatar-v3-2-0
      variant="square"
      .name="${args.name}"
...
export const Icon: StoryObj<Components.WppAvatar> = {
  render: args => html`
    <wpp-avatar-v3-2-0
      .icon="${args.icon}"
      .size="${args.size}"
