...
@Component({
  tag: 'wpp-icon-speaker-bluetooth',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconSpeakerBluetooth {
  /**
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-speaker-bluetooth"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
