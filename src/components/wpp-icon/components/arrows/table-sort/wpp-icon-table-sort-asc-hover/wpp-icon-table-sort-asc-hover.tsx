...
@Component({
  tag: 'wpp-icon-table-sort-asc-hover',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconTableSortAscHover {
  /**
   ...
   */
  @Prop() readonly upArrowColor: string = 'var(--wpp-grey-color-900)'

  /**
   * Defines the down arrow color.
   */
  @Prop() readonly downArrowColor: string = 'var(--wpp-grey-color-500)'

  render() {
    return (
      <WppIcon
        name="wpp-icon-table-sort-asc-hover"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
