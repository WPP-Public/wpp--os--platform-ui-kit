...
export class WppIconBookmarkFilled {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-bookmark-filled component is deprecated. Please, use wpp-icon-bookmark-selected instead',
