...
export class WppIconArchiveMultiple {
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-archive-multiple"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
