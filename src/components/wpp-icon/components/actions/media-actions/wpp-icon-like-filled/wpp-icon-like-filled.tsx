...
export class WppIconLikeFilled {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-like-filled component is deprecated. Please, use wpp-icon-thumbs-up-filled instead',
