...
export class WppIconLike {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-like component is deprecated. Please, use wpp-icon-thumbs-up instead',
