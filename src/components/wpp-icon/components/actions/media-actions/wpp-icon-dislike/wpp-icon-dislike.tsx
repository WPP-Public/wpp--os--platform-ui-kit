...
@Component({
  tag: 'wpp-icon-dislike',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconDislike {
  /**
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-dislike component is deprecated. Please, use wpp-icon-thumbs-down instead',
