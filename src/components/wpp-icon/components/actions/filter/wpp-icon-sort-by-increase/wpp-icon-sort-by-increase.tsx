...
export class WppIconSortByIncrease {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-sort-by-increase component is deprecated. Please, use wpp-icon-sort-increase instead',
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-sort-by-increase"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
