...
enum ObjectAlignmentDirectionIconPath {
...
export class WppIconObjectAlignment {
   ...
   */
  @Prop() readonly direction: 'top' | 'right' | 'bottom' | 'left' = 'right'

  render() {
    return (
      <WppIcon
        name="wpp-icon-object-alignment"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
      >
        <path d={ObjectAlignmentDirectionIconPath[this.direction]} fill="currentColor" />
      </WppIcon>
    )
  }
}
