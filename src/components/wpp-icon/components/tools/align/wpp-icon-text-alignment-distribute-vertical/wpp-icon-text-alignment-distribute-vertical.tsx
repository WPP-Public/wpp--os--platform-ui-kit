...
@Component({
  tag: 'wpp-icon-text-alignment-distribute-vertical',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconTextAlignmentDistributeVertical {
  /**
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-text-alignment-distribute-vertical"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
