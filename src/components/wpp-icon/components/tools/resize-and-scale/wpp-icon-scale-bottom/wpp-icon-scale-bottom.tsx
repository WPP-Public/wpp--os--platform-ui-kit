...
export class WppIconScaleBottom {
   ...
   */
  @Prop() readonly direction: 'right' | 'left' = 'right'

  render() {
    return (
      <WppIcon name="wpp-icon-scale-bottom" width={this.width} height={this.height} size={this.size} color={this.color}>
        {ScaleBottomDirectionIconPath[this.direction].map(path => (
