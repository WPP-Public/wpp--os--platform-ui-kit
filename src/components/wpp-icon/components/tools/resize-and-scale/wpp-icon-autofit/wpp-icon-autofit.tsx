...
export class WppIconAutofit {
   ...
   */
  @Prop() readonly direction: 'up' | 'down' = 'up'

  render() {
    return (
      <WppIcon name="wpp-icon-autofit" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path d={AutofitDirectionIconPath[this.direction]} fill="currentColor" />
      </WppIcon>
    )
  }
}
