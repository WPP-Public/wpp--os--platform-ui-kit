...
export class WppIconFlip {
  ...
  render() {
    return (
      <WppIcon name="wpp-icon-flip" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path d={FlipDirectionIconPath[this.direction]} fill="currentColor" />
      </WppIcon>
    )
  }
}
