...
@Component({
  tag: 'wpp-icon-statistic-document',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconStatisticDocument {
  /**
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-statistic-document"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
