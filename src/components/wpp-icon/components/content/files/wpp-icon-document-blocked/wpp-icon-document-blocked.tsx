...
export class WppIconDocumentBlocked {
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-document-blocked"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
