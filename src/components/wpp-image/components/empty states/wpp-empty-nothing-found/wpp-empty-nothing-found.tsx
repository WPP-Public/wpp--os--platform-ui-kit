  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <path d="M110 50H126L110 34V50Z" fill="var(--wpp-primary-color-300)" />
        <g filter="url(#filter1_b_18170_248)">
          <path
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur stdDeviation="6.5" result="effect1_foregroundBlur_18170_248" />
          </filter>
          <filter
            id="filter1_b_18170_248"
            x="18.6667"
            y="16.6667"
            width="102.1"
            height="102.1"
          ...
          >
            ...
            <feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_18170_248" />
            <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_18170_248" result="shape" />
          </filter>
        </defs>
      </WppImage>
    )
