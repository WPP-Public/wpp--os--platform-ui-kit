...
| `consistentSearch`     | `consistent-search`      | If `true`, the search input should retain its value when the dropdown is closed. This is useful for cases where the user might want to continue searching                                                                                                                                                                                         | `boolean`                                                                                                                                                                                                                                                                                                                      | `false`                                           |
...
| `getItemKey`           | --                       | Helper function to return the key of the list-item in the list. Should be used when the value of the list item is an object.                                                                                                                                                                                                                      | `(value: ListValue) => string \| number \| undefined`                                                                                                                                                                                                                                                                          | `undefined`                                       |
| `inputType`            | `input-type`             | Defines the type of input NOTE: Used only in `WppCombinedSelect`                                                                                                                                                                                                                                                                                  | `"decimal" \| "email" \| "number" \| "password" \| "search" \| "tel" \| "text" \| "url"`                                                                                                                                                                                                                                       | `'text'`                                          |
...
| `locales`              | --                       | Defines the component locale types.                                                                                                                                                                                                                                                                                                               | `{ emptyText?: string \| undefined; clearAllText?: string \| undefined; selectAllText?: string \| undefined; searchInputPlaceholder?: string \| undefined; allSelectedText?: string \| undefined; selectLabel?: string \| undefined; loadingText?: string \| undefined; }`                                                     | `{}`                                              |
| `maskOptions`          | --                       | Defines the custom mask options. Currently, it can be used with the following types: 'decimal', 'text', 'tel' NOTE: Used only in `WppCombinedSelect`                                                                                                                                                                                              | `undefined \| { decimalPatternOptions?: MaskitoNumberParams \| undefined; maskPlaceholder?: string \| undefined; customPatternOptions?: MaskitoOptions \| undefined; telPatternOptions?: { mask?: MaskitoMask \| undefined; countryCode?: CountryCode \| undefined; countryPhoneCode?: string \| undefined; } \| undefined; }` | `undefined`                                       |
...
| `type`                 | `type`                   | Defines the WppSelect component type. * Valid values: 'single' \| 'multiple' \| 'combined' * Note: The value 'text' is deprecated and will be removed in version 4.0.0. Use WppActionButton with WppMenuContext to achieve the same result.                                                                                                       | `"combined" \| "multiple" \| "single" \| "text"`                                                                                                                                                                                                                                                                               | `'single'`                                        |
