...
} as Meta<Components.WppSelect>

type SelectStoryArgs = Components.WppSelect & { showIconStart: boolean }

export const Single: StoryObj<SelectStoryArgs> = (args: SelectStoryArgs) => {
...
export const Multiple: StoryObj<SelectStoryArgs> = (args: SelectStoryArgs) => {
...
export const Text: StoryObj<Components.WppSelect & { showIconStart: boolean }> = (
