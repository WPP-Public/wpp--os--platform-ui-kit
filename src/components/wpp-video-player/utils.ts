...
export const formatTime = (
  ...
  const formatTwoDigits = (value: number): string => Math.floor(value).toString().padStart(TIME_PADDING, PADDING_CHAR)
...
export const calculateBufferProgress = (videoPlayerRef: HTMLMediaElement): number => {
