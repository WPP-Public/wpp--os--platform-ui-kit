...
export const VerticalDecimalStepper: StoryObj<Props> = (args: Props) => {
...
export const Vertical: StoryObj<Props> = {
  render: () => {
...
export const VerticalStepperWithWidth: StoryObj<Props> = {
  render: () => {
...
export const Horizontal: StoryObj<Props> = (args: Props) => {
