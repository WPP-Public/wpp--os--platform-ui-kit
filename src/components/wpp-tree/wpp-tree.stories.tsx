...
export const Tree: StoryObj<Components.WppTree> = (args: Components.WppTree) => {
...
export const TreeWithCustomSearch: StoryObj<Components.WppTree> = (args: Components.WppTree) => {
  const [treeState, setTreeState] = useState(data)
  const handleTreeChange = ({ detail }: any) => {
    setTreeState(detail.treeState)
  }
