...
import { WppLegacyAvatar } from '../wpp-legacy-avatar';
...
describe('wpp-legacy-avatar', () => {
  it('should initialize with correct default values', () => {
    const a = new WppLegacyAvatar();
    // base object check
    expect(a).toBeTruthy();
  ...
  it('should set border radius based on size when variant is square', async () => {
    ...
    for (const size of Object.keys(expectedBorderRadiusMap)) {
      const page = await newSpecPage({
        components: [WppLegacyAvatar],
        html: `<wpp-legacy-avatar variant="square" size="${size}"></wpp-legacy-avatar>`,
      });
  ...
  it('should set border radius to 120px when variant is circle', async () => {
    ...
    for (const size of sizes) {
      const page = await newSpecPage({
        components: [WppLegacyAvatar],
        html: `<wpp-legacy-avatar variant="circle" size="${size}"></wpp-legacy-avatar>`,
      });
      await page.waitForChanges();
      const el = page.root;
  ...
  it('should show abbreviation when image fails to load', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar src="img.png" name="Akash"></wpp-legacy-avatar>`,
    });
    await page.waitForChanges();
  ...
  it('should show +N hidden avatars', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar amount-of-hidden-avatars="5"></wpp-legacy-avatar>`,
    });
    await page.waitForChanges();
  ...
  for (const [size, expected] of Object.entries(EXPECTED_SIZES)) {
    it(`returns ${expected} for size="${size}"`, async () => {
      const page = await newSpecPage({
        components: [WppLegacyAvatar],
        html: `<wpp-legacy-avatar icon="${RAW_ICON}" size="${size}"></wpp-legacy-avatar>`,
      });
      await page.waitForChanges();
  ...
  it('should emit wppClick when handleClick is called', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar name="Akash"></wpp-legacy-avatar>`,
    });
  ...
  it('renders component', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar color='var(--wpp-dataviz-color-cat-neutral-4)'></wpp-legacy-avatar>`,
    });
  ...
  it('renders component with abbreviation message when image source was not provided', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar color='var(--wpp-dataviz-color-cat-neutral-4)' with-tooltip name='Test Avatar'></wpp-legacy-avatar>`,
    });
    expect(page.root).toMatchSnapshot();
  });
  it('renders component with number of hidden avatars when number was provided', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar color='var(--wpp-dataviz-color-cat-neutral-4)' amount-of-hidden-avatars='4'></wpp-legacy-avatar>`,
    });
    expect(page.root).toMatchSnapshot();
  });
  it('renders component with image when source was provided', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar color='var(--wpp-dataviz-color-cat-neutral-4)' with-tooltip name='Test Avatar' size='m' src='https://mui.com/static/images/avatar/1.jpg'></wpp-legacy-avatar>`,
    });
    expect(page.root).toMatchSnapshot();
  });
  it('renders component with abbreviation when flag with-tooltip is disabled', async () => {
    const page = await newSpecPage({
      components: [WppLegacyAvatar],
      html: `<wpp-legacy-avatar color='var(--wpp-dataviz-color-cat-neutral-4)' name='Test Avatar'></wpp-legacy-avatar>`,
    });
    expect(page.root).toMatchSnapshot();
  });
});
