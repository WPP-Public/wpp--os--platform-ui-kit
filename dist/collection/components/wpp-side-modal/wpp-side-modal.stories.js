...
export const SideModal = (args) => {
  ...
  return html `
    <div style="height: 1200px">
      <wpp-button-v3-5-0 @click=${handleOpenModal}>Open Side Modal</wpp-button-v3-5-0>

      <wpp-side-modal-v3-5-0
        @wppSideModalClose=${() => {
    ...
    console.log('Back button clicked');
      ...
      >
        ...
        <div
          slot="actions"
          style="
            display: ${args.withActions ? 'flex' : 'none'};
        ...
        >
          ...
          <wpp-button-v3-5-0 variant="primary" .width=${'86px'} @click=${handleActionModal}> Action </wpp-button-v3-5-0>
        </div>
      </wpp-side-modal-v3-5-0>
    </div>
  `;
...
export const SideModalWithActionsConfig = (args) => {
  ...
  return html `
    <div style="height: 1200px">
      <wpp-button-v3-5-0 @click=${handleOpenModal}>Open Side Modal with Actions Config</wpp-button-v3-5-0>
      <wpp-side-modal-v3-5-0
        @wppSideModalClose=${() => {
    console.log('Called wppSideModalClose');
    handleCloseModal();
...
export const SideModalWithHeaderActionsConfig = (args) => {
  ...
  return html `
    <div style="height: 1200px">
      <wpp-button-v3-5-0 @click=${handleOpenModal}>Open Side Modal Header with Actions Config</wpp-button-v3-5-0>
      <wpp-side-modal-v3-5-0
        @wppSideModalClose=${() => {
    console.log('Called wppSideModalClose');
    handleCloseModal();
