 ...
 */
export class WppLegacyStickyBar {
  constructor() {
  ...
  static get is() { return "wpp-legacy-sticky-bar"; }
  static get registryIs() { return "wpp-legacy-sticky-bar-v4-2-0"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["wpp-legacy-sticky-bar.scss"]
    };
  }
  static get styleUrls() {
    return {
      "$": ["wpp-legacy-sticky-bar.css"]
    };
  }
  static get properties() {
    return {
      "variant": {
        ...
        "mutable": false,
        "complexType": {
          "original": "LegacyStickyBarVariants",
          "resolved": "\"blank\" | \"one-line\" | \"two-lines\" | \"two-lines-with-tabs\"",
          "references": {
            "LegacyStickyBarVariants": {
              "location": "import",
              "path": "./types",
              "id": "src/components/wpp-legacy-sticky-bar/types.ts::LegacyStickyBarVariants"
            }
          }
        },
        "required": false,
