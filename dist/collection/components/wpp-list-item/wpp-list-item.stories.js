...
const lineOptionMap = {
  ...
  'with-action-btn': _disabled => html `
    <wpp-action-button-v3-4-0 variant="secondary" slot="right" .ariaProps=${{ label: 'Add' }}>
      <wpp-icon-plus-v3-4-0 slot="icon-start"></wpp-icon-plus-v3-4-0>
    </wpp-action-button-v3-4-0>
  `,
  'with-chevron': () => html `<wpp-icon-chevron-v3-4-0 slot="right"></wpp-icon-chevron-v3-4-0>`,
  'with-tag': disabled => html `
    <wpp-tag-v3-4-0 ?disabled="${disabled}" label="Text" variant="positive" slot="right"></wpp-tag-v3-4-0>
  `,
  'with-toggle': () => html `<wpp-toggle-v3-4-0 slot="right" .ariaProps=${{ label: 'no label' }} .name="toggle"></wpp-toggle-v3-4-0>`,
  'with-text': () => html `<wpp-typography-v3-4-0 slot="right" type="s-body">Text</wpp-typography-v3-4-0>`,
  // Icon left variants
  'with-icon': () => html `<wpp-icon-document-v3-4-0 slot="left"></wpp-icon-document-v3-4-0>`,
  'with-icon-and-action-btn': disabled => html `
    <wpp-icon-document-v3-4-0 slot="left"></wpp-icon-document-v3-4-0>
  ...
  'with-logo-and-tag': (disabled, size = 'xs') => html `
    ...
    <wpp-tag-v3-4-0 ?disabled="${disabled}" label="Text" variant="neutral" slot="right"></wpp-tag-v3-4-0>
  `,
  ...
  'with-logo-and-text': (disabled, size = 'xs') => html `
    ${lineOptionMap['with-logo'](disabled, size)}
    <wpp-typography-v3-4-0 slot="right" type="s-body" style="color:var(--wpp-grey-color-800)">
      Text
...
export const DynamicWidth = {
  render: args => html `
    <div>
      <wpp-typography-v3-4-0 type="xl-heading">Current width: ${args.width}</wpp-typography-v3-4-0>
      <wpp-list-item-v3-4-0
