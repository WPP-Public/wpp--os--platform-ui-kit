...
const lineOptionMap = {
  ...
  'with-action-btn': _disabled => html `
    <wpp-action-button-v2-22-0 variant="secondary" slot="right">
      <wpp-icon-plus-v2-22-0 slot="icon-start"></wpp-icon-plus-v2-22-0>
    </wpp-action-button-v2-22-0>
  `,
  'with-chevron': () => html `<wpp-icon-chevron-v2-22-0 slot="right"></wpp-icon-chevron-v2-22-0>`,
  'with-tag': disabled => html `
    <wpp-tag-v2-22-0 ?disabled="${disabled}" label="Text" variant="positive" slot="right"></wpp-tag-v2-22-0>
  `,
  'with-toggle': () => html `<wpp-toggle-v2-22-0 slot="right"></wpp-toggle-v2-22-0>`,
  'with-text': () => html `<wpp-typography-v2-22-0 slot="right" type="s-body">Text</wpp-typography-v2-22-0>`,
  // Icon left variants
  'with-icon': () => html `<wpp-icon-document-v2-22-0 slot="left"></wpp-icon-document-v2-22-0>`,
  'with-icon-and-action-btn': disabled => html `
    <wpp-icon-document-v2-22-0 slot="left"></wpp-icon-document-v2-22-0>
  ...
  'with-logo-and-tag': (disabled, size = 'xs') => html `
    ...
    <wpp-tag-v2-22-0 ?disabled="${disabled}" label="Text" variant="neutral" slot="right"></wpp-tag-v2-22-0>
  `,
  ...
  'with-logo-and-text': (disabled, size = 'xs') => html `
    ${lineOptionMap['with-logo'](disabled, size)}
    <wpp-typography-v2-22-0 slot="right" type="s-body" style="color:var(--wpp-grey-color-800)">
      Text
...
export const DynamicWidth = (args) => html `
  <Fragment>
    <wpp-typography-v2-22-0 type="xl-heading">Current width: ${args.width}</wpp-typography-v2-22-0>
    <wpp-list-item-v2-22-0
