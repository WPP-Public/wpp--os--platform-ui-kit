      ...
      >
        ...
        >
          <div slot="header" style="display: flex; flex-direction: column;">
            ...
            ></div>
            <wpp-typography-v3-3-1 type="m-strong" style="margin-top: 8px;">App Name</wpp-typography-v3-3-1>
          </div>
          <wpp-nav-sidebar-item-v3-3-1 .label=${'Dashboard'} path=${'/dashboard'} target=${args.target}>
            <wpp-icon-globe-v3-3-1 slot="icon-start"></wpp-icon-globe-v3-3-1>
          </wpp-nav-sidebar-item-v3-3-1>
          <wpp-nav-sidebar-item-v3-3-1 .label=${'Projects'} path=${'/projects'} .extended=${true}>
            <wpp-icon-favorites-v3-3-1 slot="icon-start"></wpp-icon-favorites-v3-3-1>
            <wpp-nav-sidebar-item-v3-3-1
              .label=${'Projects 01'}
              path=${'/project1'}
              target=${args.target}
          ...
          <wpp-nav-sidebar-item-v3-3-1
            ...
            path=${'/scheduled'}
          >
            <wpp-icon-calendar-v3-3-1 slot="icon-start"></wpp-icon-calendar-v3-3-1>
            <wpp-nav-sidebar-item-v3-3-1 .label=${'Scheduled 01'} path=${'/scheduled1'}></wpp-nav-sidebar-item-v3-3-1>
            <wpp-nav-sidebar-item-v3-3-1 .label=${'Scheduled 02'} path=${'/scheduled2'}></wpp-nav-sidebar-item-v3-3-1>
          </wpp-nav-sidebar-item-v3-3-1>
          <wpp-nav-sidebar-item-v3-3-1 .label=${'Shared reports'} path=${'/shared-reports'} .divide=${true}>
          </wpp-nav-sidebar-item-v3-3-1>
          <wpp-nav-sidebar-item-v3-3-1 .label=${'Attachments'} path=${'/attachments'}>
            <wpp-icon-mail-v3-3-1 slot="icon-start"></wpp-icon-mail-v3-3-1>
          </wpp-nav-sidebar-item-v3-3-1>
          <wpp-nav-sidebar-item-v3-3-1 .label=${'Archive'} path=${'/archive'} .divide=${true}>
            <wpp-icon-subscribe-v3-3-1 slot="icon-start"></wpp-icon-subscribe-v3-3-1>
          </wpp-nav-sidebar-item-v3-3-1>
          <wpp-nav-sidebar-item-v3-3-1 .label=${'Applications'} path=${'/applications'}>
            <wpp-icon-upload-v3-3-1 slot="icon-start"></wpp-icon-upload-v3-3-1>
          </wpp-nav-sidebar-item-v3-3-1>
        </wpp-nav-sidebar-v3-3-1>
        ...
        <wpp-typography-v3-3-1>Valid paths for activePath:</wpp-typography-v3-3-1>
        <li><wpp-typography-v3-3-1>/dashboard</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/projects</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/project1</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/project2</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/project3</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/project4</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/scheduled</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/scheduled1</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/scheduled2</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/shared-reports</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/attachments</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/archive</wpp-typography-v3-3-1></li>
        <li><wpp-typography-v3-3-1>/applications</wpp-typography-v3-3-1></li>
        <br />
      </div>
    </div>
  `,
