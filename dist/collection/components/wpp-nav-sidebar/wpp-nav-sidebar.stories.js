      ...
      >
        ...
        >
          <div slot="header" style="display: flex; flex-direction: column;">
            ...
            ></div>
            <wpp-typography-v4-2-0 type="m-strong" style="margin-top: 8px;">App Name</wpp-typography-v4-2-0>
          </div>
          <wpp-nav-sidebar-item-v4-2-0 .label=${'Dashboard'} path=${'/dashboard'} target=${args.target}>
            <wpp-icon-globe-v4-2-0 slot="icon-start"></wpp-icon-globe-v4-2-0>
          </wpp-nav-sidebar-item-v4-2-0>
          <wpp-nav-sidebar-item-v4-2-0 .label=${'Projects'} path=${'/projects'} .extended=${true}>
            <wpp-icon-favourites-v4-2-0 slot="icon-start"></wpp-icon-favourites-v4-2-0>
            <wpp-nav-sidebar-item-v4-2-0
              .label=${'Projects 01'}
              path=${'/project1'}
              target=${args.target}
          ...
          <wpp-nav-sidebar-item-v4-2-0
            ...
            path=${'/scheduled'}
          >
            <wpp-icon-calendar-v4-2-0 slot="icon-start"></wpp-icon-calendar-v4-2-0>
            <wpp-nav-sidebar-item-v4-2-0 .label=${'Scheduled 01'} path=${'/scheduled1'}></wpp-nav-sidebar-item-v4-2-0>
            <wpp-nav-sidebar-item-v4-2-0 .label=${'Scheduled 02'} path=${'/scheduled2'}></wpp-nav-sidebar-item-v4-2-0>
          </wpp-nav-sidebar-item-v4-2-0>
          <wpp-nav-sidebar-item-v4-2-0 .label=${'Shared reports'} path=${'/shared-reports'} .divide=${true}>
          </wpp-nav-sidebar-item-v4-2-0>
          <wpp-nav-sidebar-item-v4-2-0 .label=${'Attachments'} path=${'/attachments'}>
            <wpp-icon-mail-v4-2-0 slot="icon-start"></wpp-icon-mail-v4-2-0>
          </wpp-nav-sidebar-item-v4-2-0>
          <wpp-nav-sidebar-item-v4-2-0 .label=${'Archive'} path=${'/archive'} .divide=${true}>
            <wpp-icon-subscribe-v4-2-0 slot="icon-start"></wpp-icon-subscribe-v4-2-0>
          </wpp-nav-sidebar-item-v4-2-0>
          <wpp-nav-sidebar-item-v4-2-0 .label=${'Applications'} path=${'/applications'}>
            <wpp-icon-upload-v4-2-0 slot="icon-start"></wpp-icon-upload-v4-2-0>
          </wpp-nav-sidebar-item-v4-2-0>
        </wpp-nav-sidebar-v4-2-0>
        ...
        <wpp-typography-v4-2-0>Valid paths for activePath:</wpp-typography-v4-2-0>
        <li><wpp-typography-v4-2-0>/dashboard</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/projects</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/project1</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/project2</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/project3</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/project4</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/scheduled</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/scheduled1</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/scheduled2</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/shared-reports</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/attachments</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/archive</wpp-typography-v4-2-0></li>
        <li><wpp-typography-v4-2-0>/applications</wpp-typography-v4-2-0></li>
        <br />
      </div>
    </div>
  `,
