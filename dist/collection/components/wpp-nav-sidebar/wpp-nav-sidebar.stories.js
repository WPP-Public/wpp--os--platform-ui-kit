    ...
    >
      ...
      >
        <div slot="header" style="display: flex; flex-direction: column;">
          ...
          ></div>
          <wpp-typography-v2-22-0 type="m-strong" style="margin-top: 8px;">App Name</wpp-typography-v2-22-0>
        </div>
        <wpp-nav-sidebar-item-v2-22-0 .label=${'Dashboard'} path=${'/dashboard'} target=${args.target}>
          <wpp-icon-globe-v2-22-0 slot="icon-start"></wpp-icon-globe-v2-22-0>
        </wpp-nav-sidebar-item-v2-22-0>
        <wpp-nav-sidebar-item-v2-22-0 .label=${'Projects'} path=${'/projects'} .extended=${true}>
          <wpp-icon-favorites-v2-22-0 slot="icon-start"></wpp-icon-favorites-v2-22-0>
          <wpp-nav-sidebar-item-v2-22-0
            .label=${'Projects 01'}
            path=${'/project1'}
            target=${args.target}
        ...
        <wpp-nav-sidebar-item-v2-22-0
          ...
          path=${'/scheduled'}
        >
          <wpp-icon-calendar-v2-22-0 slot="icon-start"></wpp-icon-calendar-v2-22-0>
          <wpp-nav-sidebar-item-v2-22-0 .label=${'Scheduled 01'} path=${'/scheduled1'}></wpp-nav-sidebar-item-v2-22-0>
          <wpp-nav-sidebar-item-v2-22-0 .label=${'Scheduled 02'} path=${'/scheduled2'}></wpp-nav-sidebar-item-v2-22-0>
        </wpp-nav-sidebar-item-v2-22-0>
        <wpp-nav-sidebar-item-v2-22-0 .label=${'Shared reports'} path=${'/shared-reports'} .divide=${true}>
        </wpp-nav-sidebar-item-v2-22-0>
        <wpp-nav-sidebar-item-v2-22-0 .label=${'Attachments'} path=${'/attachments'}>
          <wpp-icon-mail-v2-22-0 slot="icon-start"></wpp-icon-mail-v2-22-0>
        </wpp-nav-sidebar-item-v2-22-0>
        <wpp-nav-sidebar-item-v2-22-0 .label=${'Archive'} path=${'/archive'} .divide=${true}>
          <wpp-icon-subscribe-v2-22-0 slot="icon-start"></wpp-icon-subscribe-v2-22-0>
        </wpp-nav-sidebar-item-v2-22-0>
        <wpp-nav-sidebar-item-v2-22-0 .label=${'Applications'} path=${'/applications'}>
          <wpp-icon-upload-v2-22-0 slot="icon-start"></wpp-icon-upload-v2-22-0>
        </wpp-nav-sidebar-item-v2-22-0>
      </wpp-nav-sidebar-v2-22-0>
      ...
      <wpp-typography-v2-22-0>Valid paths for activePath:</wpp-typography-v2-22-0>
      <li><wpp-typography-v2-22-0>/dashboard</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/projects</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/project1</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/project2</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/project3</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/project4</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/scheduled</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/scheduled1</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/scheduled2</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/shared-reports</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/attachments</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/archive</wpp-typography-v2-22-0></li>
      <li><wpp-typography-v2-22-0>/applications</wpp-typography-v2-22-0></li>
      <br />
    </div>
  </div>
`;
