...
export const Tag = (args) => html `
  ...
  <div class="wrapper">
    ...
    <wpp-tag-v4-3-0 .label="${args.label}" .variant=${args.variant}></wpp-tag-v4-3-0>
    <wpp-tag-v4-3-0 .label="${args.label}" .variant=${args.variant}>
      ${args.showIconStart ? html ` <wpp-icon-premium-v4-3-0 slot="icon-start"></wpp-icon-premium-v4-3-0> ` : null}
    </wpp-tag-v4-3-0>
    ...
    ></wpp-tag-v4-3-0>
    <wpp-tag-v4-3-0 style="max-width: ${args.maxWidth}" .label="${args.truncatedLabel}" .variant=${args.variant}>
