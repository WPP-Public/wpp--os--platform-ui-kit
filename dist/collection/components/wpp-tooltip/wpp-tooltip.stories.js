...
export const TitleAndText = (args) => html `
  <wpp-tooltip-v4-0-0
    ...
    .error="${args.error}"
  >
    <wpp-button-v4-0-0 variant="${args.error ? 'destructive' : 'primary'}">
...
export const Value = (args) => html ` <wpp-tooltip-v4-0-0
    .text="${args.text}"
    .value="${args.value}"
    .theme="${args.theme}"
    .config="${args.config}"
    ...
    .wordBreak="${args.wordBreak}"
  >
    <wpp-button-v4-0-0 variant="primary">Button</wpp-button-v4-0-0>
  </wpp-tooltip-v4-0-0>`;
Value.args = {
  text: 'Label',
  value: '$100,000',
...
export const CustomContent = (args) => html `
  <wpp-tooltip-v4-0-0
    ...
    .wordBreak="${args.wordBreak}"
  >
    <wpp-button-v4-0-0 data-testid="allow-html-tooltip-button">Tooltip with Custom Content</wpp-button-v4-0-0>
