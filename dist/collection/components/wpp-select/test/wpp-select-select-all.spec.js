...
describe('wpp-select: showSelectAllOption', () => {
  const renderMultipleSelect = async (props = {}) => {
    const page = await newSpecPage({
      ...
      template: () => (h("wpp-select-v4-3-0", { type: "multiple", withFolder: true, showSelectAllOption: true, list: props.list ?? MOCK_MULTIPLE_LIST, value: props.value ?? [], placeholder: "Choose option", ...props })),
    });
  ...
  describe('rendering', () => {
    ...
    it('should render select-all-option by default for multiple select', async () => {
      const page = await newSpecPage({
        components: [WppSelect],
        template: () => h("wpp-select-v4-3-0", { type: "multiple", list: MOCK_MULTIPLE_LIST, value: [], placeholder: "Choose option" }),
      });
      await new Promise(resolve => setTimeout(resolve, 0));
      await page.waitForChanges();
      const instance = page.rootInstance;
    ...
    it('should not render select-all-option when showSelectAllOption is explicitly false', async () => {
      const page = await newSpecPage({
        components: [WppSelect],
        template: () => (h("wpp-select-v4-3-0", { type: "multiple", withFolder: true, showSelectAllOption: false, list: MOCK_MULTIPLE_LIST, value: [], placeholder: "Choose option" })),
      });
      await new Promise(resolve => setTimeout(resolve, 0));
      await page.waitForChanges();
      const instance = page.rootInstance;
    ...
    it('should render original Select All/Clear buttons when showSelectAllOption is false', async () => {
      const page = await newSpecPage({
        components: [WppSelect],
        template: () => (h("wpp-select-v4-3-0", { type: "multiple", withFolder: true, showSelectAllOption: false, list: MOCK_MULTIPLE_LIST, value: ['a', 'b'], placeholder: "Choose option" })),
      });
      await new Promise(resolve => setTimeout(resolve, 0));
      await page.waitForChanges();
      const instance = page.rootInstance;
  ...
  describe('locale customization', () => {
    it('should use custom locale texts for Select All, Clear, and Apply', async () => {
      const page = await newSpecPage({
        components: [WppSelect],
        template: () => (h("wpp-select-v4-3-0", { type: "multiple", withFolder: true, showSelectAllOption: true, list: MOCK_MULTIPLE_LIST, value: [], placeholder: "Choose option", locales: {
  ...
  describe('pinnedItems', () => {
    ...
    it('should capture checked items as pinnedItems without withFolder', async () => {
      const page = await newSpecPage({
        components: [WppSelect],
        template: () => h("wpp-select-v4-3-0", { type: "multiple", list: MOCK_MULTIPLE_LIST, value: ['a', 'c'] }),
      });
      await new Promise(resolve => setTimeout(resolve, 0));
      await page.waitForChanges();
      const instance = page.rootInstance;
