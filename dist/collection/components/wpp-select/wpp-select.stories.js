...
export const Text = (args) => {
  ...
  return html `
    ...
    <div style="width: 300px;">
      <wpp-menu-context-v4-3-0 .dropdownConfig=${dropdownConfig}>
        ...
        >
          ...
          <wpp-icon-chevron-v4-3-0 id="text-select-chevron" slot="icon-end" direction="down"></wpp-icon-chevron-v4-3-0>
        </wpp-action-button-v4-3-0>
        <div>
  ...
  const renderAnchor = () => {
    switch (args.anchorComponent) {
      case 'WppActionButton':
        return html ` <wpp-action-button-v4-3-0 slot="anchor-button"> ${args.anchorLabel} </wpp-action-button-v4-3-0> `;
      case 'WppActionButtonWithIcon':
        return html `
          <wpp-action-button-v4-3-0 slot="anchor-button">
      ...
      case 'WppButton':
      default:
        return html ` <wpp-button-v4-3-0 slot="anchor-button"> ${args.anchorLabel} </wpp-button-v4-3-0> `;
    }
  };
  return html `
    <wpp-select-v4-3-0
