...
export const Accordion = (args) => html `<div style="width: 600px">
  <wpp-accordion-v2-22-0 .size="${args.size}" .withTag="${args.withTag}" text="Commitments & Responsibilities">
    ...
    ${args.withTag && html `<wpp-tag-v2-22-0 slot="tags" label="Neutral" variant="neutral"></wpp-tag-v2-22-0>`}
  </wpp-accordion-v2-22-0>
  <wpp-accordion-v2-22-0
  ...
  >
    <wpp-typography-v2-22-0
      ...
      style="${handleDisabledText(args.disabled)}"
      >${args.header}</wpp-typography-v2-22-0
    >
    <wpp-typography-v2-22-0 type="s-body" style="${handleDisabledText(args.disabled)}">
  ...
  ? html `
          <div style="display: flex; align-items: center" slot="actions">
            <wpp-action-button-v2-22-0 .disabled="${args.disabled}" variant="secondary" style="margin-right: 4px">
              Actions 2
              <wpp-icon-premium-v2-22-0 slot="icon-start"></wpp-icon-premium-v2-22-0>
            </wpp-action-button-v2-22-0>
            <wpp-action-button-v2-22-0 .disabled="${args.disabled}" variant="secondary">
              Actions 1
              <wpp-icon-edit-v2-22-0 slot="icon-start"></wpp-icon-edit-v2-22-0>
            </wpp-action-button-v2-22-0>
          </div>
        `
  : null}
    ${args.withTag &&
  html `<wpp-tag-v2-22-0
      slot="tags"
      label="Neutral"
      variant="neutral"
      .disabled="${args.disabled}"
