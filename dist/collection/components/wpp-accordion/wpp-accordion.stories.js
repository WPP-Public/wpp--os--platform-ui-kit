...
export const Accordion = {
  render: args => html `
    <div style="width: 600px">
      <wpp-accordion-v4-1-0 .size="${args.size}" .withTag="${args.withTag}" .disabled="${args.disabled}">
        <wpp-typography-v4-1-0 slot="header" type=${handleTypographyType(args.size)}>
        ...
        ${args.withTag ? html `<wpp-tag-v4-1-0 slot="tags" label="Neutral" variant="neutral"></wpp-tag-v4-1-0>` : null}
      </wpp-accordion-v4-1-0>
    ...
    ? html `
              <div style="display: flex; align-items: center" slot="actions">
                <wpp-action-button-v4-1-0 .disabled="${args.disabled}" variant="secondary" style="margin-right: 4px">
                  Actions 2
                  <wpp-icon-premium-v4-1-0 slot="icon-start"></wpp-icon-premium-v4-1-0>
                </wpp-action-button-v4-1-0>
                <wpp-action-button-v4-1-0 .disabled="${args.disabled}" variant="secondary">
                  Actions 1
                  <wpp-icon-edit-v4-1-0 slot="icon-start"></wpp-icon-edit-v4-1-0>
                </wpp-action-button-v4-1-0>
              </div>
            `
    : null}
    ...
    : null}
      ...
      <wpp-accordion-v4-1-0 .size="${args.size}" .expanded="${args.expanded}" .disabled="${args.disabled}">
        <wpp-typography-v4-1-0 slot="header" type=${handleTypographyType(args.size)}>
