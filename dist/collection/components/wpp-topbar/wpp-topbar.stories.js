...
export const NoLogo = (args) => {
  ...
  >
    <div slot="app" style="display: flex; margin-right: 32px">
      <wpp-typography-v3-5-0 style="white-space: nowrap" type="m-strong" tag="h3"> APP Name</wpp-typography-v3-5-0>
    </div>
  </wpp-topbar-v3-5-0>`;
};
NoLogo.args = {
...
export const WithLogo = (args) => {
  ...
  >
    <div slot="app" style="display: flex; align-items: center; margin-right: 32px">
      ...
      />
      <wpp-typography-v3-5-0 class="application-name" style="white-space: nowrap" type="m-strong" tag="h3">
        APP Name
