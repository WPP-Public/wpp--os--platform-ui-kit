...
export const NoLogo = (args) => {
  ...
  >
    <div slot="app" style="display: flex; margin-right: 32px">
      <wpp-typography-v4-2-0 style="white-space: nowrap" type="m-strong" tag="h3"> APP Name</wpp-typography-v4-2-0>
    </div>
  </wpp-topbar-v4-2-0>`;
};
NoLogo.args = {
...
export const WithLogo = (args) => {
  ...
  >
    <div slot="app" style="display: flex; align-items: center; margin-right: 32px">
      ...
      />
      <wpp-typography-v4-2-0 class="application-name" style="white-space: nowrap" type="m-strong" tag="h3">
        APP Name
