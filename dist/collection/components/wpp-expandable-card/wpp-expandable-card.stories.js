...
export const Expandable = {
  ...
  <wpp-expandable-card-v4-2-0 .size="${args.size}" .variant="${args.variant}">
    ...
    <wpp-typography-v4-2-0
      ...
      slot="header"
    >Governance & Ethics</wpp-typography-v4-2-0>
    <div slot="actions">
      <wpp-action-button-v4-2-0 variant="secondary">
        Action
        <wpp-icon-plus-v4-2-0 slot="icon-start"></wpp-icon-plus>
      </wpp-action-button-v4-2-0>
    </div>
  </wpp-expandable-card-v4-2-0>

  <wpp-expandable-card-v4-2-0 .size="${args.size}" .variant="${args.variant}" is-expanded>
    <wpp-typography-v4-2-0
      style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis"
      type=${handleTypographyType(args.size)}
      slot="header"
      >Card with interactive content</wpp-typography-v4-2-0
    >
