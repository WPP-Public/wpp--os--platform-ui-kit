...
export const Expandable = {
  render: args => html `
  <wpp-expandable-card-v4-0-0 .size="${args.size}" .variant="${args.variant}">
    ...
    <wpp-typography-v4-0-0
      ...
      slot="header"
    >Governance & Ethics</wpp-typography-v4-0-0>
    <div slot="actions">
      <wpp-action-button-v4-0-0 variant="secondary">
        Action
        <wpp-icon-plus-v4-0-0 slot="icon-start"></wpp-icon-plus>
      </wpp-action-button-v4-0-0>
    </div>
  </wpp-expandable-card-v4-0-0>
`,
  args: {
    size: 'm',
    variant: 'primary',
