...
export const TreeWithCustomSearch = (args) => {
  ...
  return html `
    <div>
      <wpp-typography-v3-6-0 .type=${'l-strong'}>
  ...
  return html `
    <div>
      ...
      <div style="display: flex; gap: 8px; margin: 12px 0;">
        <wpp-button-v3-6-0 @click=${handleExpandAll}>Expand All</wpp-button-v3-6-0>
        <wpp-button-v3-6-0 variant="secondary" @click=${handleCollapseAll}>Collapse All</wpp-button-v3-6-0>
      </div>
      <wpp-tree-v3-6-0 id="tree-open-on-load" .data=${treeState} @wppChange="${handleTreeChange}"></wpp-tree-v3-6-0>
    </div>
  `;
};
