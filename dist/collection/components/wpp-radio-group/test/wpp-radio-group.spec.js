...
describe('wpp-radio-group', () => {
  ...
  it('renders component with items and attributes', async () => {
    const page = await newSpecPage({
      ...
      template: () => (h("wpp-radio-group-v4-3-0", null, h("wpp-radio-v4-3-0", { name: "contact", value: "email", labelConfig: { text: 'Email' } }), h("wpp-radio-v4-3-0", { name: "contact", value: "mail", labelConfig: { text: 'Mail' } }), h("wpp-radio-v4-3-0", { name: "contact", value: "phone", labelConfig: { text: 'Phone' } }))),
    });
