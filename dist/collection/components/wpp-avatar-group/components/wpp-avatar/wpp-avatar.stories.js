...
export const Icon = (args) => html `
  <wpp-avatar-v2-22-0 .icon="${args.icon}" .size="${args.size}" .interactable="${args.interactable}" />
`;
Icon.args = {
