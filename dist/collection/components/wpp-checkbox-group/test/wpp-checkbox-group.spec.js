...
describe('wpp-checkbox-group', () => {
  ...
  it('should render checkbox-group with 4 items', async () => {
    const page = await newSpecPage({
      ...
      template: () => (h("wpp-checkbox-group-v4-0-0", null, h("wpp-checkbox-v4-0-0", { required: true, name: "email", value: "email", labelConfig: { text: 'Email' } }), h("wpp-checkbox-v4-0-0", { required: true, name: "mail", value: "mail", labelConfig: { text: 'Mail' } }), h("wpp-checkbox-v4-0-0", { required: true, name: "phone", value: "phone", labelConfig: { text: 'Phone' } }), h("wpp-checkbox-v4-0-0", { required: true, name: "fax", value: "fax", labelConfig: { text: 'Fax' } }))),
    });
