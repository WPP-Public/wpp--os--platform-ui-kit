...
export const SingleSelectGroup = (args) => {
  ...
  return html `
    ...
    >
      <wpp-card-v3-6-0 name="item-a" value="item-a">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-6-0 type=${handleTypographyType(args.size)} slot="header">Item A</wpp-typography-v3-6-0>
      </wpp-card-v3-6-0>
      <wpp-card-v3-6-0 name="item-b" value="item-b">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-6-0 type=${handleTypographyType(args.size)} slot="header">Item B</wpp-typography-v3-6-0>
      </wpp-card-v3-6-0>
      <wpp-card-v3-6-0 value="item-c" .disabled="${args.disabled}">
        <div style="width: 238px; height: 200px"></div>
        <div slot="header" style="display: flex; align-items: center">
          <wpp-icon-user-v3-6-0 style="margin-right: 8px"></wpp-icon-user-v3-6-0>
  ...
  render: args => {
    ...
    return html `
      <wpp-card-group-v3-6-0
        ...
        style="width: 1000px; justify-content: space-between"
      >
        <wpp-card-v3-6-0 header="Item A" value="item-a">
          <div style="width: 238px; height: 200px"></div>
          <wpp-typography-v3-6-0 type=${handleTypographyType(args.size)} slot="header">Item A</wpp-typography-v3-6-0>
        </wpp-card-v3-6-0>
        <wpp-card-v3-6-0 header="Item B" value="item-b">
          <div style="width: 238px; height: 200px"></div>
          <wpp-typography-v3-6-0 type=${handleTypographyType(args.size)} slot="header">Item B</wpp-typography-v3-6-0>
        </wpp-card-v3-6-0>
        <wpp-card-v3-6-0 value="item-c" .disabled="${args.disabled}">
          <div style="width: 238px; height: 200px"></div>
          <wpp-typography-v3-6-0 type=${handleTypographyType(args.size)} slot="header"
            >${args.header}
          </wpp-typography-v3-6-0>
        </wpp-card-v3-6-0>
      </wpp-card-group-v3-6-0>
