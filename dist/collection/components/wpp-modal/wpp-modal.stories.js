...
export const Regular = (args) => {
  ...
  return html ` <wpp-button-v3-4-0 @click=${handleOpenModal}>Open Modal</wpp-button-v3-4-0>
    <wpp-modal-v3-4-0
      @wppModalClose=${() => {
    ...
    ? html `<div slot="header" style=${styleMap(styles.header)}>
            ...
            >
              <wpp-icon-cross-v3-4-0 slot="icon-start"></wpp-icon-cross-v3-4-0>
            </wpp-action-button-v3-4-0>
          </div>`
    : html `<div slot="header">Title</div>`}
      ...
      <div slot="actions" style="display:flex; justify-content: flex-end;">
        <wpp-button-v3-4-0 variant="secondary" size="s" style="margin-right: 12px" @click=${handleCloseModal}>
          Cancel
        </wpp-button-v3-4-0>
        <wpp-button-v3-4-0 variant="primary" size="s" @click=${handleActionModal}>Action</wpp-button-v3-4-0>
      </div>
    </wpp-modal-v3-4-0>`;
};
Regular.args = {
...
export const Destructive = (args) => {
  const { handleOpenModal, handleCloseModal, handleActionModal } = getModalHandlers();
  return html ` <wpp-button-v3-4-0 @click=${handleOpenModal}>Open Destructive Modal</wpp-button-v3-4-0>
    <wpp-modal-v3-4-0
      @wppModalClose=${() => {
    console.log('Called: wppModalClose');
    handleCloseModal();
    ...
    : html `<div slot="header">This is a destructive message</div>`}
      ...
      <div slot="actions" style="display:flex; justify-content: flex-end;">
        ...
        <wpp-button-v3-4-0 variant="destructive" size="s" @click=${handleActionModal}>Action</wpp-button-v3-4-0>
      </div>
    </wpp-modal-v3-4-0>`;
};
Destructive.args = {
