...
export const Overlay = (args) => html `
  <div>
    <wpp-typography-v3-6-0 type="xl-heading">The WppOverlay will render inside the "Body"</wpp-typography-v3-6-0>
    <div
    ...
    >
      ...
      >
        ...
        >
          <wpp-typography-v3-6-0 type="s-body">Header</wpp-typography-v3-6-0>
        </div>
        <div style="height: 100%; padding-left: 20px; box-sizing: border-box; position: relative; padding-top: 20px;">
          <wpp-typography-v3-6-0 type="s-body">Body</wpp-typography-v3-6-0>
          <wpp-overlay-v3-6-0 .isVisible="${args.isVisible}" @wppClick="${() => console.log('Overlay clicked')}" />
        </div>
      </div>
    </div>
  </div>
