...
describe('wpp-slider', () => {
  it('should render slider component', async () => {
    ...
    const page = await newSpecPage({
      ...
      template: () => h("wpp-slider-v3-3-0", { value: value }),
    });
  ...
  it('should render slider with marks', async () => {
    ...
    const page = await newSpecPage({
      components: [WppSlider],
      template: () => h("wpp-slider-v3-3-0", { value: 2, marks: marks, max: 3 }),
    });
    expect(page.root).toMatchSnapshot();
  });
  it('should render range slider with value 4-75', async () => {
    ...
    const page = await newSpecPage({
      components: [WppSlider],
      template: () => h("wpp-slider-v3-3-0", { type: "range", value: value }),
    });
    expect(page.root).toMatchSnapshot();
  });
  it('should render range slider with displayed value', async () => {
    ...
    const page = await newSpecPage({
      components: [WppSlider],
      template: () => h("wpp-slider-v3-3-0", { type: "range", max: 5, step: 2, value: value, "with-value": true }),
    });
    expect(page.root).toMatchSnapshot();
  });
  it('should render range slider with label, icon and tooltip description', async () => {
    ...
    const page = await newSpecPage({
      ...
      template: () => h("wpp-slider-v3-3-0", { type: "range", max: 5, step: 2, value: value, labelConfig: labelConfig }),
    });
    expect(page.root).toMatchSnapshot();
  });
});
