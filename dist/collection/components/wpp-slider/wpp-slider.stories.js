...
export const RangeWithInputsAndMask = (args) => html `<wpp-slider-v3-6-0
    type="range"
    .name=${args.name}
    .value=${args.value}
...
export const MiddleRange = (args) => html `<wpp-slider-v3-6-0
    type="middle-range"
    .name=${args.name}
    .value=${args.value}
    .marks=${args.marks}
...
export const MiddleRangeContinuous = (args) => html `<wpp-slider-v3-6-0
    type="middle-range"
    .name=${args.name}
    .value=${args.value}
    .inputWidth=${args.inputWidth}
