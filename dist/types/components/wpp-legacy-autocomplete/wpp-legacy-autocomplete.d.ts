...
import { AutocompleteExtendedOption, AutocompleteLabelConfig, LegacyAutocompleteLocales, GetOptionIdHandler, GetOptionLabelHandler, LegacyAutocompleteChangeEventDetail } from './types';
import { ListItemChangeEventDetail } from '../wpp-list-item/types';
import { AutocompleteOption, AutocompleteTypes, LoadMoreHandler } from '../wpp-autocomplete/types';
/**
 ...
 */
export declare class WppLegacyAutocomplete implements BaseComponent, InlineMessage {
  private inputEl?;
  private triggerEl?;
  private dropdownEl?;
  ...
  private _locales;
  host: HTMLWppLegacyAutocompleteElement;
  isFocused: boolean;
  searchValue: string;
   ...
   */
  readonly locales: Partial<LegacyAutocompleteLocales>;
  /**
   ...
   */
  wppChange: EventEmitter<LegacyAutocompleteChangeEventDetail>;
  /**
  ...
  onUpdateLocales(newLocales: Partial<LegacyAutocompleteLocales>): void;
  /**
