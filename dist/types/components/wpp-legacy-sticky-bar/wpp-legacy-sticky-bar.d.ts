...
import { LegacyStickyBarVariants } from './types';
import { StickyBarButtonItem, StickyBarTabItem, VisibilityClasses } from '../wpp-sticky-bar/types';
/**
...
export declare class WppLegacyStickyBar {
  ...
  host: HTMLWppLegacyStickyBarElement;
  /**
   * The variant of the sticky-bar. The default value is 'one-line'
   */
  readonly variant: LegacyStickyBarVariants;
  /**
