...
const WppRadio = class {
  ...
  render() {
    if (this.decorative) {
      return (index.h(index.Host, { class: this.hostCssClasses(), "aria-hidden": "true", role: "presentation", tabindex: "-1", exportparts: "label, content, inner", name: this.name }, index.h("wpp-label-v4-1-0", { class: this.labelCssClasses(), part: "label" }, index.h("div", { class: "circle", part: "circle" }))));
    }
    return (index.h(index.Host, { class: this.hostCssClasses(), onKeyUp: this.onKeyUp, onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, exportparts: "label, content, inner", name: this.name }, index.h("wpp-label-v4-1-0", { class: this.labelCssClasses(), typography: "s-body", htmlFor: this.name, disabled: this.disabled, optional: !this.required, config: this.labelConfig, onClick: this.onClick, tooltipConfig: {
        ...{
          onCreate: (instance) => {
