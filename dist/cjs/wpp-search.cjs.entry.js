  ...
  constructor(hostRef) {
    ...
    this.renderInputPlaceholder = () => {
      if ((this.isFocused && !this.searchValue) || this.isDropdownShown || !this.value.length)
        return null;
      return (index.h("wpp-typography-v3-3-1", { type: "s-body", class: "input-placeholder", ref: placeholderEl => (this.placeholderEl = placeholderEl) }, this.getOptionLabel(this.value[0])));
    };
    ...
    this.renderDropdownContent = () => {
      ...
      if (this.value.length && !this.isFocused)
        return null;
      if (this.loading) {
        return (index.h("div", { class: "loading" }, index.h("wpp-spinner-v3-3-1", { slot: "left" }), index.h("wpp-typography-v3-3-1", { type: "s-body", slot: "label" }, this._locales.loading)));
      }
