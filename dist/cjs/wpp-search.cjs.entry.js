  ...
  constructor(hostRef) {
    ...
    this.renderInputPlaceholder = () => {
      if ((this.isFocused && !this.searchValue) || this.isDropdownShown || !this.value.length)
        return null;
      return (index.h("wpp-typography-v4-3-0", { type: "s-body", class: "input-placeholder", ref: placeholderEl => (this.placeholderEl = placeholderEl) }, this.getOptionLabel(this.value[0])));
    };
    ...
    this.renderDropdownContent = () => {
      ...
      if (this.value.length && !this.isFocused)
        return null;
      if (this.loading) {
        return (index.h("div", { class: "loading" }, index.h("wpp-spinner-v4-3-0", { slot: "left" }), index.h("wpp-typography-v4-3-0", { type: "s-body", slot: "label" }, this._locales.loading)));
      }
      ...
      return (index.h(index.Fragment, null, !!this._locales.dropdownHeader && (index.h("wpp-list-item-v4-3-0", { class: "dropdown-header", part: "dropdown-header" }, index.h("wpp-typography-v4-3-0", { type: "s-strong", slot: "label" }, this._locales.dropdownHeader))), index.h("slot", null), index.h("div", null, this.isInfiniteLoading && (index.h("div", { class: "infinite-loader" }, index.h("wpp-spinner-v4-3-0", null))))));
    };
    this.isFocused = false;
    this.searchValue = '';
