...
const WppToast = class {
  constructor(hostRef) {
    ...
    this.getIconType = (iconType) => {
      if (iconType === 'warning')
        return index.h("wpp-icon-warning-v2-22-0", { width: 16, height: 16, class: "icon" });
      if (iconType === 'error')
        return index.h("wpp-icon-error-v2-22-0", { width: 16, height: 16, class: "icon" });
      if (iconType === 'information')
        return index.h("wpp-icon-info-message-v2-22-0", { width: 16, height: 16, class: "icon" });
      if (iconType === 'success')
        return index.h("wpp-icon-success-v2-22-0", { width: 16, height: 16, class: "icon" });
      return null;
    };
  ...
  render() {
    const style = {
      ...
      '--mt-show-animation-duration': consts.ANIMATION_DURATION / 1000 + 's',
      '--mt-hide-animation-duration': consts.ANIMATION_DURATION / 1500 + 's',
      '--mt-max-message-lines': this.maxMessageLines + '',
    };
    return (index.h(index.Host, { class: this.hostCssClasses(), style: style, exportparts: "body, message, body, info-wrapper, header, message, actions, action-button, icon-start, icon-wrapper", onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, this.variant === 'chat' ? (index.h("div", { class: this.chatToastWrapper() }, index.h("wpp-typography-v2-22-0", { class: "chat-toast-message", type: "2xs-strong" }, this.message))) : (index.h(index.Fragment, null, this.message && !this.header && (index.h("div", { class: "body", part: "body" }, index.h("div", { class: this.iconWrapperCssClasses(), style: this.icon?.styles, part: "icon-wrapper" }, this.isIconProvided() ? this.renderIcon() : this.getIconType(this.type)), index.h("wpp-typography-v2-22-0", { type: "s-body", class: "message", part: "message" }, this.message))), this.header && (index.h("div", { class: "body", part: "body" }, index.h("div", { class: this.iconWrapperCssClasses(), style: this.icon?.styles, part: "icon-wrapper" }, this.isIconProvided() ? this.renderIcon() : this.getIconType(this.type)), index.h("div", { class: "info", part: "info-wrapper" }, index.h("wpp-typography-v2-22-0", { type: "s-strong", class: "header", part: "header" }, this.header), index.h("wpp-typography-v2-22-0", { type: "s-body", class: "message", part: "message" }, this.message)))), !!this.primaryBtn && (index.h("div", { class: "actions", part: "actions" }, this.primaryBtn && (index.h("wpp-action-button-v2-22-0", { onClick: () => this.primaryBtn?.onClick(this.index || ''), disabled: this.primaryBtn.disabled, loading: this.primaryBtn.loading, variant: this.primaryBtn.variant, part: "action-button" }, this.primaryBtn.label)), index.h("wpp-action-button-v2-22-0", { variant: "inverted", part: "action-button", onClick: this.handleCloseClick }, index.h("wpp-icon-cross-v2-22-0", { slot: "icon-start", part: "icon-start" })))), !this.primaryBtn && (index.h("div", { class: "actions", part: "actions" }, index.h("wpp-action-button-v2-22-0", { variant: "inverted", part: "action-button", onClick: this.handleCloseClick }, index.h("wpp-icon-cross-v2-22-0", { slot: "icon-start", part: "icon-start" }))))))));
  }
