...
const WppPagination = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "body, per-page-label, pre-page-select, per-page-item, divider, range, page-select" }, index.h("div", { class: "control-pagination-wrapper", part: "body" }, index.h("wpp-typography-v2-22-0", { type: "s-body", part: "per-page-label" }, this.locales.itemsPerPage, ":"), index.h("wpp-select-v2-22-0", { type: "text", onWppChange: this.handleItemsPerPageNumberChange, value: this.selectedItemPerPage, dropdownConfig: { ...this.dropdownConfig, appendTo: 'parent' }, part: "pre-page-select" }, this.itemsPerPage.map(item => (index.h("wpp-list-item-v2-22-0", { value: item, part: "per-page-item" }, index.h("span", { slot: "label" }, item))))), index.h("wpp-divider-v2-22-0", { part: "divider" }), index.h("wpp-typography-v2-22-0", { type: "s-body", part: "range" }, this.getPageRange())), countPagesToDisplay && (index.h("wpp-pagination-select-v2-22-0", { count: countPagesToDisplay, pageSelectThreshold: this.pageSelectThreshold, onWppChange: this.handleSelectedPageChange, activePageNumber: this.activePageNumber, part: "page-select" }))));
  }
