  ...
  const renderListOptions = () => {
    ...
    return (index.h(index.Fragment, null,
      this.internalList.map((item, ndx) => {
        ...
        return (index.h("wpp-list-item-v4-0-0", { ref: el => (this.listItemsRefs[ndx] = el), onWppChangeListItem: this.handleClickListItem, key: convertValueToKey(item.value), ...rest, id: item.id !== undefined ? `${_const.LIB_COMPONENTS_PREFIX}list-item-${item.id}` : undefined, role: "option" },
