...
const WppChatAlert = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "alert", part: "alert", role: "alert" }, this.renderIcon(), index.h("wpp-typography-v4-2-0", { class: "message", type: "s-body", part: "message" }, this.message), this.description && (index.h("wpp-typography-v4-2-0", { class: "description", type: "xs-body", part: "description" }, this.description)), this.closable && (index.h("wpp-icon-cross-v4-2-0", { class: "close", part: "close", role: "button", tabindex: 0, "aria-label": this._locales.closeLabel, onClick: this.handleClose, onKeyDown: this.handleCloseKeyDown })))));
  }
