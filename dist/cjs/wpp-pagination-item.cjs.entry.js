...
const WppPaginationItem = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), onClick: this.handleClick, onBlur: this.onBlur, onMouseDown: this.onMouseDown, onKeyUp: this.onKeyUp, tabIndex: 0, exportparts: "number" }, index.h("wpp-typography-v2-22-0", { type: "s-body", part: "number" }, this.number)));
  }
  static get registryIs() { return "wpp-pagination-item-v2-22-0"; }
};
WppPaginationItem.style = wppPaginationItemCss;

exports.wpp_pagination_item = WppPaginationItem;
