...
const WppPaginationItem = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), onClick: this.handleClick, onBlur: this.onBlur, onMouseDown: this.onMouseDown, onKeyUp: this.onKeyUp, tabIndex: 0, exportparts: "number" }, index.h("wpp-typography-v3-3-1", { type: "s-body", part: "number" }, this.number)));
  }
