 ...
 */
const normalizeMonthRangeDates = (dates, config = { enabled: true }) => {
...
const WppDatepicker = class {
  constructor(hostRef) {
    ...
    this.isDefaultDateFormat = () => {
      ...
      if (this.isDefaultDateFormatSeparator(separator)) {
        ...
        return isEqual.isEqual_1(baseFormat, separatedDate);
      }
      return false;
    };
    ...
    this.onHideGetLastAppliedValue = () => {
      ...
      if (selectedDates.length === 2) {
        ...
        if (!isEqual.isEqual_1(formattedDates, this.lastAppliedDate)) {
          this.lastAppliedDate = formattedDates;
          this.lastValidDate = formattedDates;
          const inputValue = formattedDates.join(DATES_SEPARATOR);
          this.updateInput(inputValue, inputValue.length);
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "label, datepicker-container, icon-calendar, datepicker-input, icon-cross, message, trigger-wrapper" }, this.labelConfig?.text && !this.hasTriggerSlot && (index.h("wpp-label-v3-6-0", { class: "label", htmlFor: this.name, optional: !this.required, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "label" })), index.h("div", { class: this.containerClasses(), id: "container", part: "datepicker-container" }, this.hasTriggerSlot
      ...
      : [
        index.h("input", { id: "datepicker", type: "text", class: this.inputCssClasses(), onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onMouseDown: this.onMouseDown, onKeyUp: this.onKeyUp, onKeyDown: this.onKeyDown, disabled: this.disabled, placeholder: this.placeholder ||
            (this.range
        ...
        index.h("wpp-icon-calendar-v3-6-0", { onClick: this.handleClickCalendarIcon, class: this.iconCalendarCssClasses(), part: "icon-calendar", color: "inherit" }),
      ], index.h("div", { onBlur: this.handleBlurPortal, onFocus: () => clearTimeout(this.hideTimer), ...(this.hasPresets() ? { tabIndex: 0 } : {}), ref: ref => (this.portalRef = ref), class: this.portalClasses() }, this.hasPresets() && (index.h("div", { class: "wpp-presets-container" }, index.h("div", { class: "wpp-presets-list" }, this.presets.map((preset) => (index.h("wpp-list-item-v3-6-0", { onMouseEnter: () => this.handlePreviewPreset(preset.value), onMouseLeave: this.handleMouseLeavePreset, onWppChangeListItem: () => this.handleClickPreset(preset), class: "wpp-presets-item" }, index.h("wpp-typography-v3-6-0", { type: "s-body", slot: "label" }, preset.label))))), index.h("div", { class: "wpp-presets-footer" })))), (!!this.lastValidDate || this.inputRef?.value) && !this.hasTriggerSlot && (index.h("wpp-icon-cross-v3-6-0", { class: this.iconCrossCssClasses(), "aria-label": "Erase date", onClick: this.handleClickIconCross, onMouseDown: (e) => e.preventDefault(), part: "icon-cross" })), (this.message || this.internalMessage) && (index.h("wpp-inline-message-v3-6-0", { id: "datepicker-message", class: "inline-message", message: this.message || this.internalMessage, type: this.message ? this.messageType : this.internalMessageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig, part: "message" })))));
  }
