...
var airDatepicker = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var en = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const defaultLocale = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(en);
...
function baseIsDate(value) {
  return isEqual.isObjectLike_1(value) && isEqual._baseGetTag(value) == dateTag;
}

var _baseIsDate = baseIsDate;

/* Node.js helper references. */
var nodeIsDate = isEqual._nodeUtil && isEqual._nodeUtil.isDate;
 ...
 * // => false
 */
var isDate = nodeIsDate ? isEqual._baseUnary(nodeIsDate) : _baseIsDate;
...
const DATE_FORMAT_SEPARATOR_PATTERN = /[- /.]/;
...
function isValidDate(date) {
  if (Array.isArray(date)) {
    return date.every(currentDate => isDate_1(currentDate) && currentDate.toString() !== 'Invalid Date');
  }
  return isDate_1(date) && date.toString() !== 'Invalid Date';
}
const getSplittedDateParts = (date) => date.match(DATE_FORMAT_REG_EXP)?.map(item => item.toLowerCase()) || [];
function getCurrentFormatDate(dateFormat, separator = '/') {
  return (date) => {
    if (!date)
...
const getFormattedDateString = (date = '', dateFormat, separator = '/') => {
...
const getNextCursorPosition = (value, startPos, isAdded, separator = '/') => {
...
const WppDatepicker = class {
  constructor(hostRef) {
    ...
    this.wppDateClear = index.createEvent(this, "wppDateClear", 1);
    ...
    this.setInitialDate = () => {
      if (this.value === '' || isEqual.isEqual_1(this.value, [])) {
    ...
    this.createDateInstance = () => {
      ...
      const IconChevron = utils.transformToVersionedTag('wpp-icon-chevron');
    ...
    this.createTippyInstance = () => {
      ...
      this.tippyInstance = menuListConfig.menuListConfig({
        ...
        onHidden: (instance) => {
          ...
          if (this.focusType === common.FOCUS_TYPE.NONE && this.inputRef) {
            this.inputRef?.blur();
          }
    ...
    this.onKeyUp = (event) => {
      ...
      if (!isEqual.isEqual_1(inputDates, this.datePickerInstance.selectedDates)) {
        // @ts-ignore Due to outdated air-datepicker.d.ts
    ...
    this.handlePreviewPreset = (dateRange) => {
      ...
      if (isValidDate([formattedStartDate, formattedEndDate]) &&
        (!isEqual.isEqual_1(currentSelectedStartDate, formattedStartDate) || !isEqual.isEqual_1(currentSelectedEndDate, formattedEndDate))) {
  ...
  updateValue() {
    ...
    if (this.range) {
      ...
      if (isValidDate(formattedDate) && !isEqual.isEqual_1(formattedDate, currentDatePickerValue)) {
        this.setInitialDate();
      }
    }
  }
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "label, datepicker-container, icon-calendar, datepicker-input, icon-cross, message" }, this.labelConfig?.text && (index.h("wpp-label-v2-22-0", { class: "label", htmlFor: this.name, optional: !this.required, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "label" })), index.h("div", { class: this.containerClasses(), id: "container", part: "datepicker-container" }, index.h("wpp-icon-calendar-v2-22-0", { onClick: this.handleClickCalendarIcon, class: this.iconCalendarCssClasses(), part: "icon-calendar" }), index.h("input", { id: "datepicker", type: "text", class: this.inputCssClasses(), onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onMouseDown: this.onMouseDown, onKeyUp: this.onKeyUp, onKeyDown: this.onKeyDown, disabled: this.disabled, readOnly: !this.range && !this.isDefaultDateFormat(), placeholder: this.placeholder ||
        (this.range
          ? `${this.locale.dateFormat}${DATES_SEPARATOR}${this.locale.dateFormat}`
          : `${this.locale.dateFormat}`), ref: inputRef => (this.inputRef = inputRef), autocomplete: "off", part: "datepicker-input", title: "" }), index.h("div", { onBlur: this.handleBlurPortal, onFocus: () => clearTimeout(this.hideTimer), ...(this.hasPresets() ? { tabIndex: 0 } : {}), ref: ref => (this.portalRef = ref), class: this.portalClasses() }, this.hasPresets() && (index.h("div", { class: "wpp-presets-container" }, index.h("div", { class: "wpp-presets-list" }, this.presets.map((preset) => (index.h("wpp-list-item-v2-22-0", { onMouseEnter: () => this.handlePreviewPreset(preset.value), onMouseLeave: this.handleMouseLeavePreset, onWppChangeListItem: () => this.handleClickPreset(preset), class: "wpp-presets-item" }, index.h("wpp-typography-v2-22-0", { type: "s-body", slot: "label" }, preset.label))))), index.h("div", { class: "wpp-presets-footer" })))), !!this.lastValidDate && (index.h("wpp-icon-cross-v2-22-0", { class: this.iconCrossCssClasses(), "aria-label": "Erase date", onClick: this.handleClickIconCross, part: "icon-cross" })), this.message && (index.h("wpp-inline-message-v2-22-0", { class: "inline-message", message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig, part: "message" })))));
  }
...
WppDatepicker.style = wppDatepickerCss;

exports.wpp_datepicker = WppDatepicker;
