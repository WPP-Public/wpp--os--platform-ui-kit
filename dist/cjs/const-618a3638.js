...
const returnIconFromExtension = (fileExtension, thumbnailUrl) => {
  ...
  switch (fileExtension) {
    // Text
    case '.txt':
      return index.h("wpp-icon-document-v3-3-1", null);
    // Compressed
    case '.zip':
    case '.rar':
    case '.7z':
      return index.h("wpp-icon-file-zip-v3-3-1", null);
    // Image
    case '.png':
    case '.jpg':
    case '.jpeg':
    case '.svg':
    case '.gif':
      return index.h("wpp-icon-image-v3-3-1", null);
    // Video
    case '.mp4':
    case '.mov':
    case '.avi':
    ...
    case '.flv':
    case '.webm':
      return index.h("wpp-icon-video-clip-v3-3-1", null);
    // Audio
    case '.mp3':
    case '.wav':
    case '.ogg':
    ...
    case '.m4a':
    case '.aac':
      return index.h("wpp-icon-music-v3-3-1", null);
    // Data
    case '.csv':
    case '.json':
    case '.xml':
    ...
    case '.sqlite':
    case '.dat':
      return index.h("wpp-icon-database-v3-3-1", null);
    // Presentation
    case '.pptx':
    case '.key':
    case '.odp':
    ...
    case '.sldx':
    case '.ppt':
      return index.h("wpp-icon-pitch-v3-3-1", null);
    // Spreadsheet
    case '.xlsx':
    case '.xls':
    case '.ods':
    case '.numbers':
    case '.tsv':
      return index.h("wpp-icon-spreadsheet-v3-3-1", null);
    default:
      return index.h("wpp-icon-file-v3-3-1", null);
  }
};
