...
const WppArtefact = class {
  ...
  render() {
    return (index.h(index.Host, { class: "wpp-artefact" }, index.h("div", { class: this.getArtefactWrapperClasses() }, index.h("div", { class: "artefact-header" }, this.titleIcon && index.h("div", { class: "artefact-icon-container" }, index.h(utils.transformToVersionedTag(this.titleIcon))), index.h("wpp-tooltip-v4-2-0", { text: this.artefactTitle, class: "title-tooltip", config: {
        placement: 'top',
        onShow: () => {
          if (!this.titleRef)
            return false;
      ...
      } }, index.h("p", { ref: el => (this.titleRef = el), class: "artefact-title" }, this.artefactTitle))), index.h("wpp-divider-v4-2-0", null), index.h("div", { class: "artefact-body" }, index.h("slot", { name: "body" })), this.hasScrollbar && index.h("wpp-divider-v4-2-0", null), index.h("div", { class: "artefact-actions" }, this.defaultActions.map((action) => (index.h("wpp-tooltip-v4-2-0", { text: action.label, key: action.label, config: { placement: 'bottom' } }, index.h("wpp-action-button-v4-2-0", { variant: "secondary", onClick: () => this.handleActionClick(action), ariaProps: { label: action.label } }, index.h(utils.transformToVersionedTag(action.icon), { slot: 'icon-start' }))))), this.dropdownActions.length > 0 && (index.h("wpp-menu-context-v4-2-0", { appendToListWrapper: true }, index.h("wpp-action-button-v4-2-0", { slot: "trigger-element", variant: "secondary", ariaProps: { label: this.ariaProps.label } }, index.h("wpp-icon-more-v4-2-0", { slot: "icon-start" })), index.h("div", null, this.dropdownActions.map((action) => (index.h("wpp-list-item-v4-2-0", { key: action.label, onWppChangeListItem: () => this.handleActionClick(action) }, index.h(utils.transformToVersionedTag(action.icon), { slot: 'left' }), index.h("span", { slot: "label" }, action.label)))))))), index.h("slot", { name: "handles" }))));
  }
