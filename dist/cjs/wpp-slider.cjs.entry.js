...
const WppSlider = class {
  constructor(hostRef) {
    ...
    this.renderControl = () => {
      const label = this.labelConfig?.text && (index.h("wpp-label-v4-2-0", { htmlFor: this.name, optional: !this.required, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "label" }));
      if (this.withValue && !this.withInput) {
        return (index.h("div", { class: this.controlCssClasses(), part: "control-wrapper" }, label || index.h("div", null), this.handleType({
          single: value => (index.h("wpp-typography-v4-2-0", { type: "s-midi", part: "value" }, value)),
          range: value => (index.h("div", { class: "range-value-wrapper", part: "value-wrapper" }, index.h("wpp-typography-v4-2-0", { type: "s-midi", part: "value" }, value[0]), index.h("wpp-divider-v4-2-0", { part: "value-divider", class: { divider: true, disabled: this.disabled } }), index.h("wpp-typography-v4-2-0", { type: "s-midi", part: "value" }, value[1]))),
          'middle-range': value => (index.h("div", { class: "range-value-wrapper", part: "value-wrapper" }, index.h("wpp-typography-v4-2-0", { type: "s-midi", part: "value" }, this.isMiddlePointHigher() ? value : this.middleValue), index.h("wpp-divider-v4-2-0", { part: "value-divider", class: { divider: true, disabled: this.disabled } }), index.h("wpp-typography-v4-2-0", { type: "s-midi", part: "value" }, this.isMiddlePointHigher() ? this.middleValue : value))),
        })));
      }
      return label;
    };
    this.renderSingleInput = () => (index.h("wpp-input-v4-2-0", { ref: inputRef => (this.inputRef = inputRef), type: "text", size: this.size, disabled: this.disabled, part: "input-number", onBlur: this.handleBlur, style: { width: this.inputWidth ? this.inputWidth : DEFAULT_INPUT_WIDTH }, class: { [`size-${this.size}`]: true }, maskOptions: {
    ...
    this.renderEditableInput = () => (index.h("div", { class: this.editableInputCssClasses(), part: "editable-input-wrapper" }, this.handleType({
      ...
      range: () => (index.h("div", { class: "range-input-wrapper", part: "input-wrapper" }, index.h("wpp-input-v4-2-0", { ref: inputRef => (this.inputRef = inputRef), type: "text", size: this.size, disabled: this.disabled, part: "input-min", onBlur: this.handleBlur, style: { width: this.inputWidth ? this.inputWidth : DEFAULT_INPUT_WIDTH }, class: { 'min-input': true, [`size-${this.size}`]: true }, maskOptions: {
          decimalPatternOptions: this.maskOptions && this.maskOptions[0]
            ...
            : getDefaultMaskOptions(this.step),
        } }), index.h("wpp-divider-v4-2-0", { class: { 'wpp-disabled': this.disabled }, part: "divider" }), index.h("wpp-input-v4-2-0", { ref: inputRef => (this.inputMaxRef = inputRef), type: "text", size: this.size, disabled: this.disabled, part: "input-max", onBlur: this.handleBlur, style: { width: this.inputWidth ? this.inputWidth : DEFAULT_INPUT_WIDTH }, class: { 'max-input': true, [`size-${this.size}`]: true }, maskOptions: {
  ...
  static get registryIs() { return "wpp-slider-v4-2-0"; }
