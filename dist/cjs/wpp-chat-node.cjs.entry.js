...
const WppChatNode = class {
  constructor(hostRef) {
    ...
    this.wppReRun = index.createEvent(this, "wppReRun", 7);
    this.wppAttach = index.createEvent(this, "wppAttach", 7);
    this.wppMic = index.createEvent(this, "wppMic", 7);
  ...
  renderInput() {
    return (index.h("input", { class: "chat-input", type: "text",
  ...
  renderChatBar(isLoadingActive) {
    ...
    return (index.h("div", { class: barClasses }, index.h("div", { class: "left-actions" }, this.renderActionMenu(), this.renderInput()), index.h("div", { class: "right-actions" }, index.h("div", { class: "right-actions-controls" }, this.renderModelSelector(), this.renderMicrophoneBtn()), this.renderSendButton(isLoadingActive))));
  }
  renderAvatar(config) {
    if (config === false)
      return null;
  ...
  renderMessageAttachments(message) {
    ...
    index.h("div", { class: "chat-attachments", role: "list", tabIndex: 0, "aria-label": this._locales.attachmentsRegionLabel }, attachments.map((attachment, index$1) => {
