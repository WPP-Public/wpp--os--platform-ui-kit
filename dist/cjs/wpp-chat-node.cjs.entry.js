...
const WppChatNode = class {
  ...
  renderActionMenu() {
    ...
    if (!hasActions && !hasModels) {
      return (index.h("wpp-tooltip-v4-2-0", { text: this._locales.attachAction, config: { placement: 'bottom' } }, index.h("wpp-action-button-v4-2-0", { variant: "secondary", ariaProps: { label: this._locales.attachAction }, onClick: this.handleAttach }, index.h("wpp-icon-plus-v4-2-0", { slot: "icon-start" }))));
    }
    return (index.h("wpp-menu-context-v4-2-0", { appendToListWrapper: true, class: "chat-actions-menu-context", style: { width: 'fit-content' } }, index.h("wpp-action-button-v4-2-0", { slot: "trigger-element", variant: "secondary", ariaProps: { label: this._locales.actionsMenu } }, index.h("wpp-icon-plus-v4-2-0", { slot: "icon-start" })), index.h("div", { class: "chat-actions-menu" }, this.actions.map(action => (index.h("wpp-list-item-v4-2-0", { key: `${action.icon}-${action.label}`, onWppChangeListItem: () => this.handleActionClick(action) }, this.renderIcon(action.icon, 'left'), index.h("span", { slot: "label" }, action.label)))), hasActions && hasModels && index.h("wpp-divider-v4-2-0", { class: "chat-actions-menu-divider" }), hasModels && (index.h("wpp-menu-context-v4-2-0", { appendToListWrapper: true }, index.h("wpp-list-item-v4-2-0", { slot: "trigger-element", isExtended: true }, this.renderIcon(selectedModel?.icon || 'wpp-icon-ai', 'left'), index.h("span", { slot: "label" }, selectedModel?.label)), index.h("div", { class: "chat-models-menu" }, this.models.map(model => (index.h("wpp-list-item-v4-2-0", { key: model.id, checked: model.id === selectedModel?.id, onWppChangeListItem: () => this.handleModelSelect(model) }, this.renderIcon(model.icon || 'wpp-icon-ai', 'left'), index.h("span", { slot: "label" }, model.label))))))))));
  }
  ...
  renderMessageActions(message) {
    ...
    if (!hasRenderableContent || actions.length === 0)
      return null;
    return (index.h("div", { class: "chat-message-actions" }, actions.map(action => (index.h("wpp-tooltip-v4-2-0", { key: action.id, text: action.label, config: { placement: 'bottom' } }, index.h("wpp-action-button-v4-2-0", { variant: "secondary", ariaProps: { label: action.label }, onClick: () => this.handleMessageActionClick(message, action) }, this.renderIcon(action.icon, 'icon-start')))))));
  }
  renderMessages() {
    ...
    return this.messages.map(msg => {
      ...
      return (index.h("div", { class: {
        ...
        }, key: msg.id }, this.renderAvatar(avatarConfig), index.h("div", { class: `chat-message-content chat-message-content-${msg.role}` }, hasContent && (index.h("div", { class: `chat-bubble chat-bubble-${msg.role}` }, index.h("wpp-typography-v4-2-0", { type: "s-body" }, msg.content))), this.renderMessageAttachments(msg), this.renderMessageActions(msg))));
    });
  }
  render() {
    ...
    if (isSizeS) {
      return (index.h(index.Host, { class: { 'wpp-chat-node': true, 'wpp-size-s': true }, onFocusin: this.handleNodeInteraction, onPointerDown: this.handleNodeInteraction }, index.h("div", { class: containerClasses }, index.h("div", { class: wrapperClasses }, this.renderChatBar(false, isSelectedActive))), index.h("slot", { name: "handles" })));
    }
    return (index.h(index.Host, { class: { 'wpp-chat-node': true, 'wpp-size-m': true }, onFocusin: this.handleNodeInteraction, onPointerDown: this.handleNodeInteraction }, index.h("div", { class: containerClasses }, index.h("div", { class: wrapperClasses }, index.h("div", { class: "node-header" }, index.h("span", { class: "title-icon" }, index.h("wpp-icon-service-v4-2-0", { color: "var(--wpp-grey-color-700)" })), index.h("wpp-tooltip-v4-2-0", { text: this.nodeTitle, class: "title-tooltip", config: {
        placement: 'top',
        onShow: () => {
          if (!this.titleRef || this.titleRef.clientWidth >= this.titleRef.scrollWidth)
            return false;
        },
      } }, index.h("p", { ref: el => (this.titleRef = el), class: "node-title" }, this.nodeTitle))), index.h("wpp-divider-v4-2-0", null), index.h("div", { class: "node-body", ref: el => (this.bodyRef = el) }, this.renderMessages(), index.h("slot", null)), index.h("wpp-divider-v4-2-0", null), this.renderChatBar(isLoadingActive, isSelectedActive))), index.h("slot", { name: "handles" })));
  }
