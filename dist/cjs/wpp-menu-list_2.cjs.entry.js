...
const WppMenuList = class {
      ...
      this.tippyInstance = menuListConfig.menuListConfig({
        ...
        onHide(instance) {
          ...
          Array.from(contentSlots?.assignedNodes() || []).forEach(el => {
            const element = el;
            if (element.tagName === utils.transformToVersionedTag('wpp-list-item').toUpperCase()) {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "trigger, inner" }, index.h("slot", { name: "trigger-element", part: "trigger", class: "trigger-element" }), index.h("div", { class: this.innerWrapperCssClasses() }, index.h("slot", { part: "inner" }))));
  }
...
WppMenuList.style = wppMenuListCss;
...
function isEmpty(value) {
  ...
  if (isEqual.isArrayLike_1(value) &&
      (isEqual.isArray_1(value) || typeof value == 'string' || typeof value.splice == 'function' ||
        isEqual.isBuffer_1(value) || isEqual.isTypedArray_1(value) || isEqual.isArguments_1(value))) {
    return !value.length;
  }
  var tag = isEqual._getTag(value);
  if (tag == mapTag || tag == setTag) {
    return !value.size;
  }
  if (isEqual._isPrototype(value)) {
    return !isEqual._baseKeys(value).length;
  }
...
function renderSingleSelect(isBaseComponent = true, customSize) {
  ...
  const inputWrapperCssClasses = () => {
    let classes = {
      ...
      'tab-focus': this.focusType.input === common.FOCUS_TYPE.TAB && this.focusType.listItem !== common.FOCUS_TYPE.TAB,
    };
  ...
  return (index.h(RootTag, { class: hostCssClasses(), "aria-disabled": this.disabled, onBlur: this.onBlur, onFocus: this.onFocus, onMouseDown: this.onMouseDown, onKeyUp: (event) => this.onKeyUp(event, 'input'), exportparts: "label, wrapper, body, single-select-input, placeholder-wrap, placeholder, input, icon-chevron, message, options-list, search-wrapper, search-divider, input-search, list-wrapper, list-slot, empty-text" },
    this.labelConfig?.text && isBaseComponent && (index.h("wpp-label-v2-22-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: this.handleLabelClick, part: "label" })),
    index.h("wpp-menu-list-v2-22-0", { shouldCloseOnOutsideClick: this.handleShouldCloseOnOutsideClick, dropdownConfig: {
        ...this.dropdownConfig,
      ...
      index.h("div", { class: wrapperCssClasses(), slot: "trigger-element", tabIndex: -1, part: "body", ref: ref => (this.triggerEl = ref) },
        index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.iconStartCssClasses(), name: "icon-start", onSlotchange: this.updateSlotData }),
        index.h("div", { ref: el => (this.inputRef = el), class: inputWrapperCssClasses(), role: "button", part: "single-select-input" },
          index.h("div", { class: textWrapCssClasses(), part: "placeholder-wrap" },
            index.h("p", { class: inputTextCssClasses(), part: "placeholder" }, getSelectPlaceholder())),
          index.h("input", { class: "input", type: "text", name: this.name, value: this.value, required: this.required, "aria-hidden": "true", disabled: this.disabled, placeholder: this.placeholder, "aria-label": this.ariaProps.label, tabIndex: -1, onFocus: this.onFocus, part: "input", title: "" }),
          index.h("wpp-icon-chevron-v2-22-0", { direction: "down", part: "icon-chevron", color: "" })),
        !!this.message && isBaseComponent && (index.h("wpp-inline-message-v2-22-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, part: "message" }))),
      index.h("div", { ref: ref => (this.menuRef = ref), class: menuCssClasses(), onKeyUp: (event) => this.onKeyUp(event, 'listItem'), onScroll: this.handleOptionsScroll },
        this.shouldShowSearch() && (index.h("div", { class: "search-wrapper", part: "search-wrapper" },
          index.h("wpp-input-v2-22-0", { name: this.name && `${this.name}-search-input`, ref: ref => (this.inputSearchRef = ref), type: "search", value: this.searchText, size: customSize, placeholder: this.locales.searchInputPlaceholder, onWppChange: handleSelectOptionSearch, part: "input-search" }),
          index.h("wpp-divider-v2-22-0", { part: "search-divider" }))),
        this.shouldShowSearch() ? (index.h("div", { ref: ref => (this.listWrapperRef = ref), class: getListWrapperClasses(), part: "list-wrapper" },
          index.h("slot", { onSlotchange: this.handleSlotChange, part: "list-slot" }))) : (index.h("slot", { onSlotchange: this.handleSlotChange, part: "list-slot" })),
        this.isEmpty && !this.loading && !this.isInfiniteLoading && (index.h("p", { class: "empty-select-text", part: "empty-text" }, this.locales.emptyText)),
        (this.isInfiniteLoading || this.loading) && (index.h("div", { class: "infinite-loader" },
          index.h("wpp-spinner-v2-22-0", null)))))));
}
...
function renderCombinedSelect() {
  ...
  return (index.h(index.Host, { "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur, class: { focused: this.isFocused }, exportparts: "label, content, inner" },
    this.labelConfig?.text && (index.h("wpp-label-v2-22-0", { class: this.labelCssClasses(), htmlFor: this.name, optional: !this.required, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: this.handleLabelClick, part: "label" })),
    index.h("div", { class: combinedInputWrapperCssClasses(), tabIndex: 0, part: "input-wrapper" },
      renderSingleSelect.call(this, false, this.size),
      index.h("wpp-input-v2-22-0", { onWppChange: this.handleInputChange, value: this.inputValue, disabled: this.disabled, messageType: this.messageType, placeholder: this.placeholder, size: this.size, tabIndex: -1, part: "input" })),
    this.message && (index.h("wpp-inline-message-v2-22-0", { message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig, part: "message" }))));
}
...
function renderMultipleSelect(isBaseComponent = true) {
  ...
  const getSelectPlaceholder = () => {
    ...
    if (this.isAllSelected && this.showSelectAllText) {
      return index.h("span", { class: "selected-item-text" }, this.locales.allSelectedText);
    }
    return (index.h(index.Fragment, null,
      this.selectedItemsTextList.map((selectedText, index$1) => (index.h("p", { key: selectedText, class: "selected-item" },
        index.h("span", { class: "selected-item-text-wrapper" },
          index.h("span", { class: "selected-item-text" }, selectedText)),
        (this.selectedItemsTextList.length - 1 !== index$1 || !!this.textToDisplay) && (index.h("span", { class: "select-item-divider" }, ","))))),
      !!this.textToDisplay && index.h("span", null,
        "+",
        this.textToDisplay)));
  };
  const getListWrapperClasses = () => ({
  ...
  const RootTag = isBaseComponent ? index.Host : index.Fragment;
  return (index.h(RootTag, { class: hostCssClasses(), "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur, exportparts: "label, wrapper, body, multiple-select-input, placeholder-wrap, placeholder, input, total-text, icon-chevron, message, options-list, search-wrapper, search-divider, input-search, list-wrapper, list-slot, empty-text, folder, folder-divider, folder-buttons, clear-all-button, select-all-button" },
    this.labelConfig?.text && isBaseComponent && (index.h("wpp-label-v2-22-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: this.handleLabelClick, part: "label" })),
    index.h("wpp-menu-list-v2-22-0", { shouldCloseOnOutsideClick: this.handleShouldCloseOnOutsideClick, dropdownConfig: {
        ...this.dropdownConfig,
        onHide: this.handleMenuListHide,
      ...
      index.h("div", { ref: ref => (this.triggerEl = ref), class: wrapperCssClasses(), slot: "trigger-element", tabIndex: -1, part: "body" },
        index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.iconStartCssClasses(), name: "icon-start", onSlotchange: this.updateSlotData }),
        index.h("div", { ref: el => (this.inputRef = el), class: inputWrapperCssClasses(), tabIndex: -1, role: "button", part: "multiple-select-input" },
          index.h("div", { class: textWrapCssClasses(), part: "placeholder-wrap" },
            index.h("p", { class: inputTextCssClasses(), part: "placeholder" }, getSelectPlaceholder()),
            this.isInputFilled && (index.h("span", { class: "selected-total-text", part: "total-text" },
              this.activeItems.length,
              " ",
              this.locales.selectLabel))),
          index.h("input", { class: "input", type: "text", name: this.name, value: this.textToDisplay, required: this.required, "aria-hidden": "true", disabled: this.disabled, placeholder: this.placeholder, tabIndex: -1, "aria-label": this.ariaProps.label, part: "input", title: "" }),
          index.h("wpp-icon-chevron-v2-22-0", { direction: "down", part: "icon-chevron", color: "" })),
        !!this.message && isBaseComponent && (index.h("wpp-inline-message-v2-22-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, part: "message" }))),
      index.h("div", { ref: ref => (this.menuRef = ref), class: menuCssClasses(), tabindex: -1, role: "menu", part: "options-list", onScroll: this.handleOptionsScroll },
        this.shouldShowSearch() && (index.h("div", { class: "search-wrapper", part: "search-wrapper" },
          index.h("wpp-input-v2-22-0", { ref: ref => (this.inputSearchRef = ref), type: "search", value: this.searchText, size: "m", placeholder: this.locales.searchInputPlaceholder, onWppChange: handleSelectOptionSearch, part: "input-search", name: this.name && `${this.name}-search-input` }),
          index.h("wpp-divider-v2-22-0", { part: "search-divider" }))),
        this.shouldShowSearch() ? (index.h("div", { ref: ref => (this.listWrapperRef = ref), class: getListWrapperClasses(), part: "list-wrapper" },
          index.h("slot", { onSlotchange: this.handleSlotChange, onMouseDown: this.onMouseDown, onKeyUp: (event) => this.onKeyUp(event, 'listItem'), part: "list-slot" }))) : (index.h("slot", { onSlotchange: this.handleSlotChange, onMouseDown: this.onMouseDown, onKeyUp: (event) => this.onKeyUp(event, 'listItem'), part: "list-slot" })),
        this.isEmpty && !this.loading && !this.isInfiniteLoading && (index.h("p", { class: "empty-select-text", part: "empty-text" }, this.locales.emptyText)),
        (this.isInfiniteLoading || this.loading) && (index.h("div", { class: "infinite-loader" },
          index.h("wpp-spinner-v2-22-0", null))),
        this.withFolder && !this.isEmpty && (index.h("div", { class: "multiple-select-folder", part: "folder" },
          this.withScroll && index.h("wpp-divider-v2-22-0", { part: "folder-divider" }),
          index.h("div", { class: "multiple-select-folder-buttons", part: "folder-buttons" },
            index.h("wpp-action-button-v2-22-0", { variant: "secondary", disabled: !this.canSelectAll(), onClick: this.handleSelectAll, part: "select-all-button" }, this.locales.selectAllText),
            index.h("wpp-action-button-v2-22-0", { variant: "secondary", disabled: !this.anyClearable(), class: clearButtonCssClasses(), onClick: this.handleClearAll, part: "clear-all-button" }, this.locales.clearAllText))))))));
}
...
function renderTextSelect() {
  ...
  const renderTriggerText = () => (index.h(index.Fragment, null,
    index.h("wpp-typography-v2-22-0", { type: "s-body", part: "text" }, this.textToDisplay || this.placeholder),
    index.h("wpp-icon-chevron-v2-22-0", { direction: "down", part: "icon-chevron" })));
  const dropdownMaxWidthTextSelect = () => {
    ...
    return {
      '--custom-dropdown-max-width': `${utils.selectDropdownWidth(this.dropdownWidth, this.triggerEl, this.host)}px`,
    };
  };
  return (index.h(index.Host, { class: hostCssClasses(), "aria-disabled": this.disabled, disabled: this.disabled, onFocus: this.onFocus, onBlur: this.onBlur, onMouseDown: this.onMouseDown, onKeyUp: (event) => this.onKeyUp(event, 'input'), exportparts: "wrapper, body, text-select-wrapper, text, icon-chevron, options-list" },
    index.h("wpp-menu-list-v2-22-0", { shouldCloseOnOutsideClick: this.handleShouldCloseOnOutsideClick, part: "wrapper", exportparts: "trigger, inner, body", dropdownConfig: {
        ...this.dropdownConfig,
        ...
        onHide: (instance) => {
          this.focusType = this.getUpdatedFocusInfo('listItem', common.FOCUS_TYPE.NONE);
          if (this.dropdownConfig?.onHide) {
            return this.dropdownConfig.onHide(instance);
          }
        },
      } },
      index.h("div", { class: triggerElementCssClasses(), slot: "trigger-element", tabIndex: -1, part: "body" },
        index.h("div", { class: textSelectWrapperCssClasses(), tabIndex: 0, role: "button", ref: inputRef => (this.inputRef = inputRef), "aria-label": this.ariaProps.label, part: "text-select-wrapper" }, this.truncate && this.shouldTruncate ? (index.h("wpp-tooltip-v2-22-0", { text: this.textToDisplay || this.placeholder, config: { placement: 'right' }, class: "tooltip" }, renderTriggerText())) : (renderTriggerText()))),
      index.h("ul", { class: "wpp-list", role: "menu", part: "options-list", onMouseDown: this.onMouseDown, style: { ...dropdownMaxWidthTextSelect() }, onKeyUp: (event) => this.onKeyUp(event, 'listItem') },
        index.h("slot", null)))));
}
...
const getInitFocusInfo = () => ({
  input: common.FOCUS_TYPE.NONE,
  listItem: common.FOCUS_TYPE.NONE,
});
  ...
  constructor(hostRef) {
    ...
    this.getEnabledItems = () => {
      this.host.childNodes.forEach(el => {
        const item = el;
        if (item.tagName === utils.transformToVersionedTag(SELECT_OPTION_TAG_NAME).toUpperCase() && !item.disabled) {
    ...
    this.disableNonSelectedItems = () => {
      this.enabledElements.forEach(el => {
        if (el.tagName === utils.transformToVersionedTag(SELECT_OPTION_TAG_NAME).toUpperCase() && !el.checked) {
          el.disabled = true;
        }
      });
    };
    ...
    this.isOptionsValueEqual = (leftValue, rightValue) => {
      if (this.withCustomValue) {
        ...
        return isEqual.isEqual_1(leftValueArray.map(this.getOptionId), rightValueArray.map(this.getOptionId));
      }
      return isEqual.isEqual_1(leftValue, rightValue);
    };
    ...
    this.handleSearch = (initSearchText) => {
      ...
      this.host.childNodes.forEach(el => {
        const element = el;
        if (element.tagName === utils.transformToVersionedTag(SELECT_OPTION_TAG_NAME).toUpperCase()) {
    ...
    this.findParentModal = () => {
      ...
      while (current) {
        ...
        if (current.tagName &&
          [
            utils.transformToVersionedTag('wpp-modal').toUpperCase(),
            utils.transformToVersionedTag('wpp-side-modal').toUpperCase(),
            utils.transformToVersionedTag('wpp-full-screen-modal').toUpperCase(),
    ...
    this.handleShouldCloseOnOutsideClick = (event) => event.target !== this.host && !utils.isEventTargetContained(this.host, event);
    ...
    this.onMouseDown = () => {
      this.focusType = this.getUpdatedFocusInfo('listItem', common.FOCUS_TYPE.MOUSE);
      this.focusType = this.getUpdatedFocusInfo('input', common.FOCUS_TYPE.MOUSE);
    };
    ...
    this.onBlur = (event) => {
      ...
      this.handleBlurCall(event);
      this.focusType = this.getUpdatedFocusInfo('input', common.FOCUS_TYPE.NONE);
      this.focusType = this.getUpdatedFocusInfo('listItem', common.FOCUS_TYPE.NONE);
    ...
    this.onKeyUp = (event, type) => {
      if (event.key === 'Tab') {
        ...
        if (this.focusType.listItem === common.FOCUS_TYPE.TAB) {
          this.focusType = this.getUpdatedFocusInfo('input', common.FOCUS_TYPE.NONE);
        }
      }
    };
    ...
    this.handleSlotChange = () => {
      ...
      if (this.type === 'multiple') {
        ...
        this.host.childNodes.forEach(el => {
          const element = el;
          element.checked = isEqual.isEqual_1(this.value, element.value);
        });
      }
    };
    this.getDropdownWidth = (instance) => {
    ...
    if (!this.enableStaticOptions && this.host) {
      const observer = new MutationObserver(mutationsList => {
        const addedValues = mutationsList
          ...
          .filter(el => el.tagName === utils.transformToVersionedTag(SELECT_OPTION_TAG_NAME).toUpperCase())
          .map(el => el.value);
...
exports.wpp_menu_list = WppMenuList;
