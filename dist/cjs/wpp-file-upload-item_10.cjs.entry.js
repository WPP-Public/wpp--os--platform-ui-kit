...
const WppFileUploadItem = class {
  constructor(hostRef) {
    ...
    this.setCurrentIcon = () => {
      if (this.isFileLoading())
        return index.h("wpp-spinner-v2-22-0", null);
      const { name } = this.file;
      if (this.isFileWithError())
        return null;
      const fileExtension = utils.getExtension(name);
      return constants.returnIconFromExtension(fileExtension, this.thumbnailUrl);
    };
    ...
    this.setCurrentError = () => {
      if (this.isFileWithError()) {
        ...
        return (index.h("div", { class: "error-wrapper" }, index.h("wpp-inline-message-v2-22-0", { class: "inline-message-error", message: currentError, type: "error", showTooltipFrom: 140, tooltipConfig: { popperOptions: { strategy: 'fixed' } } }), this.file.deletable !== false && (index.h("wpp-icon-cross-v2-22-0", { class: "cross-icon", part: "cross-icon", onClick: this.handleCloseClick }))));
      }
      return null;
    };
    this.getEventData = () => ({
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "file-item, wrapper, content, file-name, tooltip, loading, percentage, cross-icon", onClick: this.handleClick }, index.h("li", { class: this.itemCssClasses(), part: "file-item" }, this.setCurrentError(), index.h("div", { class: "content-wrapper", part: "wrapper" }, index.h("div", { class: this.blockCssClasses(), part: "content" }, this.setCurrentIcon(), index.h("p", { class: this.fileNameCssClasses(), part: "file-name" }, this.file.name.length > this.maxLabelLength ? (index.h("wpp-tooltip-v2-22-0", { text: this.file.name, config: { popperOptions: { strategy: 'fixed' } }, part: "tooltip" }, utils$1.truncate(this.file.name, this.maxLabelLength, true))) : (this.file.name)), this.isFileWithError() ? null : (index.h("p", { class: "loading", part: "loading" }, this.isFileLoading()
      ? `${this.loaded}/${this.total} ${this.measurementUnit}`
      : `${this.total} ${this.measurementUnit}`))), index.h("div", { class: "controls-wrapper", part: "controls" }, this.isFileLoading() && (index.h("p", { class: "percentage", part: "percentage" }, this.percentage, "%")), this.file.deletable !== false && !this.isFileWithError() && (index.h("wpp-icon-cross-v2-22-0", { class: "cross-icon", part: "cross-icon", onClick: this.handleCloseClick })))))));
  }
...
const WppIconFile = class {
  ...
  static get registryIs() { return "wpp-icon-file-v2-22-0"; }
};
...
const WppIconFileZip = class {
  ...
  static get registryIs() { return "wpp-icon-file-zip-v2-22-0"; }
};
...
const WppIconMusic = class {
  ...
  static get registryIs() { return "wpp-icon-music-v2-22-0"; }
};
...
const WppIconPitch = class {
  ...
  static get registryIs() { return "wpp-icon-pitch-v2-22-0"; }
};
...
const WppIconSpreadsheet = class {
  ...
  static get registryIs() { return "wpp-icon-spreadsheet-v2-22-0"; }
};
WppIconSpreadsheet.style = wppIconCss;

exports.wpp_icon_image = wppIconVideoClip.WppIconImage;
exports.wpp_icon_video_clip = wppIconVideoClip.WppIconVideoClip;
