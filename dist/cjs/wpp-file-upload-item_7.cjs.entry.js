...
const utils = require('./utils-42e3ffa9.js');
...
const WppFileUploadItem = class {
  constructor(hostRef) {
    ...
    this.setCurrentIcon = () => {
      if (this.isFileLoading())
        return index.h("wpp-spinner-v4-3-0", null);
    ...
    this.setCurrentError = () => {
      if (this.isFileWithError()) {
        ...
        return (index.h("div", { class: "error-wrapper" }, index.h("wpp-inline-message-v4-3-0", { class: "inline-message-error", message: currentError, type: "error", showTooltipFrom: 140, tooltipConfig: { popperOptions: { strategy: 'fixed' } } }), this.file.deletable !== false && (index.h("wpp-icon-cross-v4-3-0", { class: this.crossIconClasses(), part: "cross-icon", role: "button", tabindex: this.parentDisabled || this.file.disabled ? -1 : 0, "aria-disabled": this.parentDisabled || this.file.disabled ? 'true' : undefined, "aria-label": `Remove file ${this.file.name}`, onClick: this.handleCloseClick, onKeyDown: this.handleDeleteKeyDown, onKeyUp: this.handleDeleteKeyUp, onBlur: this.handleDeleteBlur }))));
      }
      return null;
    };
    this.getEventData = () => ({
    ...
    this.renderThumbnail = () => {
      if (this.isFileLoading())
        return index.h("wpp-spinner-v4-3-0", null);
      if (this.isFileWithError())
        return index.h("wpp-icon-error-v4-3-0", { class: "thumbnail-error-icon", "aria-hidden": "true" });
    ...
    this.renderDeleteIcon = () => this.file.deletable !== false && (index.h("wpp-icon-cross-v4-3-0", { class: this.crossIconClasses(), part: "cross-icon", role: "button", tabindex: this.parentDisabled || this.file.disabled ? -1 : 0, "aria-disabled": this.parentDisabled || this.file.disabled ? 'true' : undefined, "aria-label": `Remove file ${this.file.name}`, onClick: this.handleCloseClick, onKeyDown: this.handleDeleteKeyDown, onKeyUp: this.handleDeleteKeyUp, onBlur: this.handleDeleteBlur }));
  ...
  renderChatVariant() {
    ...
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "file-item, thumbnail, content, file-name, subtitle, cross-icon", onClick: this.handleClick, role: "listitem" }, index.h("div", { class: this.itemCssClasses(), part: "file-item" }, index.h("div", { class: { thumbnail: true, error: this.isFileWithError(), loading: this.isFileLoading() }, part: "thumbnail" }, this.renderThumbnail()), index.h("div", { class: "details", part: "content" }, index.h("wpp-tooltip-v4-3-0", { ref: ref => (this.tooltipRef = ref), text: this.file.name, config: {
        popperOptions: { strategy: 'fixed' },
        onShow: () => {
          if (!this.isTruncated)
            return false;
        },
      }, part: "tooltip" }, index.h("wpp-typography-v4-3-0", { ref: ref => (this.fileNameRef = ref), class: this.fileNameCssClasses(), type: "xs-midi", part: "file-name", title: this.file.name }, this.file?.name)), index.h("wpp-tooltip-v4-3-0", { text: subtitle, config: {
        popperOptions: { strategy: 'fixed' },
        onShow: () => {
      ...
      } }, index.h("wpp-typography-v4-3-0", { ref: ref => (this.subtitleRef = ref), type: "xs-body", class: { subtitle: true, 'subtitle-error': this.isFileWithError() }, part: "subtitle" }, subtitle))), this.renderDeleteIcon()), index.h("wpp-typography-v4-3-0", { ref: ref => (this.measureRef = ref), type: "xs-midi", class: "measure", "aria-hidden": "true", role: "presentation" }), index.h("wpp-typography-v4-3-0", { ref: ref => (this.subtitleMeasureRef = ref), type: "xs-body", class: "measure", "aria-hidden": "true", role: "presentation" })));
  }
  render() {
    if (this.variant === 'chat')
      return this.renderChatVariant();
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "file-item, wrapper, content, file-name, tooltip, loading, percentage, cross-icon", onClick: this.handleClick, role: "listitem" }, index.h("div", { class: this.itemCssClasses(), part: "file-item" }, this.setCurrentError(), index.h("div", { class: "content-wrapper", part: "wrapper" }, index.h("div", { class: this.blockCssClasses(), part: "content" }, index.h("div", { class: "icon-wrapper" }, this.setCurrentIcon()), index.h("wpp-tooltip-v4-3-0", { ref: ref => (this.tooltipRef = ref), text: this.file.name, config: {
        popperOptions: { strategy: 'fixed' },
        onShow: () => {
          if (!this.isTruncated)
            return false;
        },
      }, part: "tooltip" }, index.h("wpp-typography-v4-3-0", { ref: ref => (this.fileNameRef = ref), class: this.fileNameCssClasses(), type: "s-body", part: "file-name", title: this.file.name }, this.file?.name)), !this.isFileWithError() ? (index.h("span", { ref: ref => (this.loadingRef = ref), class: "loading", part: "loading" }, this.total, " ", this.measurementUnit)) : (index.h("span", { class: "error-message", part: "error-message" }, this.total, " ", this.measurementUnit))), index.h("div", { class: "controls-wrapper", part: "controls" }, this.isFileLoading() && (index.h("span", { class: "percentage", part: "percentage" }, this.percentage, "%")), this.file.deletable !== false && !this.isFileWithError() && (index.h("wpp-icon-cross-v4-3-0", { class: this.crossIconClasses(), part: "cross-icon", role: "button", tabindex: this.parentDisabled || this.file.disabled ? -1 : 0, "aria-disabled": this.parentDisabled || this.file.disabled ? 'true' : undefined, "aria-label": `Remove file ${this.file.name}`, onClick: this.handleCloseClick, onKeyDown: this.handleDeleteKeyDown, onBlur: this.handleDeleteBlur, onKeyUp: this.handleDeleteKeyUp }))))), index.h("wpp-typography-v4-3-0", { ref: ref => (this.measureRef = ref), type: "s-body", class: "measure", "aria-hidden": "true", role: "presentation" })));
  }
...
const WppIconDatabase = class {
  ...
  static get registryIs() { return "wpp-icon-database-v4-3-0"; }
};
...
const WppIconDocument = class {
  ...
  static get registryIs() { return "wpp-icon-document-v4-3-0"; }
};
...
const WppIconFileZip = class {
  ...
  static get registryIs() { return "wpp-icon-file-zip-v4-3-0"; }
};
...
const WppIconMusic = class {
  ...
  static get registryIs() { return "wpp-icon-music-v4-3-0"; }
};
...
const WppIconPitch = class {
  ...
  static get registryIs() { return "wpp-icon-pitch-v4-3-0"; }
};
...
const WppIconSpreadsheet = class {
  ...
  static get registryIs() { return "wpp-icon-spreadsheet-v4-3-0"; }
};
