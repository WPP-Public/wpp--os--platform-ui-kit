...
const defaultDropdownConfig = {
  ...
  maxWidth: '378px',
  offset: [0, 4],
  zIndex: consts.Z_INDEX.COLOR_PICKER,
  popperOptions: {
    modifiers: [
      {
        name: 'flip',
...
exports.DEFAULT_VALUE_HEX = DEFAULT_VALUE_HEX;
exports.DEFAULT_VALUE_RGBA = DEFAULT_VALUE_RGBA;
exports.MAXIMUM_NUMBER_OF_SAVED_COLORS = MAXIMUM_NUMBER_OF_SAVED_COLORS;
exports.OPACITY_INPUT_CONFIG = OPACITY_INPUT_CONFIG;
exports.RGB_INPUTS = RGB_INPUTS;
exports.RGB_INPUT_CONFIG = RGB_INPUT_CONFIG;
exports.contrastWithWhite = contrastWithWhite;
exports.defaultDropdownConfig = defaultDropdownConfig;
exports.getColorsForSections = getColorsForSections;
exports.getColorsFromThemeOnPage = getColorsFromThemeOnPage;
exports.hexToHsv = hexToHsv;
exports.hexToRGBA = hexToRGBA;
exports.hexToRgb = hexToRgb;
exports.hsvToHex = hsvToHex;
exports.isValid6DigitHex = isValid6DigitHex;
