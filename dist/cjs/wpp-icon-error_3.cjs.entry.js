...
const WppTypography = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "wpp-typography", exportparts: "typography, inner" }, index.h(TypographyTag, { class: this.typographyCssClasses(), part: "typography", exportparts: "typography" }, index.h("slot", { part: "inner" }))));
  }
