...
const WppBanner = class {
  constructor(hostRef) {
    ...
    this.getMessageTypesIcons = () => {
      if (this.type === 'warning')
        return index.h("wpp-icon-warning-v3-3-0", { class: "left-icon", part: "left-icon" });
      if (this.type === 'information')
        return index.h("wpp-icon-info-message-v3-3-0", { class: "left-icon", part: "left-icon" });
      return null;
    };
  ...
  render() {
    ...
    return (index.h(index.Host, { style: style, class: this.hostCssClasses(), role: this.role, "aria-label": this.ariaProps.label || 'banner', exportparts: "left-icon, wrapper, body, content-wrapper, message, actions-wrapper, close-button, close-icon, actions, actions-wrapper" }, index.h("div", { class: this.hiddenBannerWrapperCssClasses(), part: "wrapper" }, index.h("div", { class: this.bannerWrapperCssClasses(), part: "body" }, index.h("div", { class: "content-wrapper", part: "content-wrapper" }, this.getMessageTypesIcons(), !this.isOverflowing ? (messageWrapper) : (index.h("wpp-tooltip-v3-3-0", { text: this.messageText, class: this.tooltipCSSClasses() }, messageWrapper))), index.h("div", { class: "actions-wrapper", part: "actions-wrapper" }, index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.actionsCssClasses(), name: "actions", onSlotchange: this.updateSlotData, role: "presentation" }), this.closable && (index.h("wpp-action-button-v3-3-0", { variant: this.type === 'information' ? 'inverted' : 'secondary', onClick: this.handleCloseIconClick, class: "close-button", part: "close-button", ariaProps: { label: 'close banner' }, role: "presentation" }, index.h("wpp-icon-cross-v3-3-0", { slot: "icon-start", part: "close-icon", "aria-hidden": "true" }))))))));
  }
