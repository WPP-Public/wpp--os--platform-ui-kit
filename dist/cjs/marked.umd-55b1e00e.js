...
const wppIconAttach = require('./wpp-icon-attach-18caec1f.js');
const wppIconBlockquote = require('./wpp-icon-blockquote-3b1f65a9.js');
const wppIconBold = require('./wpp-icon-bold-8a1c9991.js');
const wppIconCodeView = require('./wpp-icon-code-view-77a8384b.js');
const wppIconFloatCenter = require('./wpp-icon-float-center-d9ccf8df.js');
const wppIconFloatLeft = require('./wpp-icon-float-left-91e1b2de.js');
const wppIconFloatRight = require('./wpp-icon-float-right-8784d915.js');
const wppIconH1 = require('./wpp-icon-h1-5bffca36.js');
const wppIconH2 = require('./wpp-icon-h2-2597c2b7.js');
const wppIconVideoClip = require('./wpp-icon-video-clip-906d3736.js');
const wppIconIndentDecrease = require('./wpp-icon-indent-decrease-4ebb56d9.js');
const wppIconIndentIncrease = require('./wpp-icon-indent-increase-b5082dc1.js');
const wppIconItalic = require('./wpp-icon-italic-7ee24a77.js');
const wppIconLink = require('./wpp-icon-link-69465e77.js');
const wppIconOrderedList = require('./wpp-icon-ordered-list-53ec5736.js');
const wppIconRedo = require('./wpp-icon-redo-a3384b93.js');
const wppIconStrikeThrough = require('./wpp-icon-strike-through-53689c77.js');
const wppIconTextAlignmentCenter = require('./wpp-icon-text-alignment-center-b00d0f4b.js');
const wppIconTextAlignmentJustify = require('./wpp-icon-text-alignment-justify-a30c1bf9.js');
const wppIconTextAlignmentLeft = require('./wpp-icon-text-alignment-left-316ef4ef.js');
const wppIconTextAlignmentRight = require('./wpp-icon-text-alignment-right-6c87f495.js');
const wppIconUnderline = require('./wpp-icon-underline-a26a36fc.js');
const wppIconUndo = require('./wpp-icon-undo-47d7786e.js');
const wppIconUnorderedList = require('./wpp-icon-unordered-list-771565fd.js');
const wppProgressIndicator = require('./wpp-progress-indicator-56fa2d43.js');
const _commonjsHelpers = require('./_commonjsHelpers-bcc1208a.js');
const wppIconChevron = require('./wpp-icon-chevron-38c9cfb8.js');
const wppIconGallery = require('./wpp-icon-gallery-4955ec97.js');
const lodash = require('./lodash-04cddce7.js');
const wppActionButton$1 = require('./wpp-action-button-5ccf570c.js');
const wppInput$1 = require('./wpp-input-5512f89c.js');
...
function extendBlotNames(blotNames) {
  blotNames.forEach(blotName => {
    types.Quill$1.register(blotName, extendBlot(types.Quill$1.import(blotName)), true);
  });
}
...
class BlotSpec {
  ...
  setSelection() {
    const blot = types.Quill$1.find(this.getTargetElement());
    if (blot) {
...
const icons = {
  align: {
    '': icon(wppIconTextAlignmentLeft.WppIconTextAlignmentLeft.is),
    center: icon(wppIconTextAlignmentCenter.WppIconTextAlignmentCenter.is),
    right: icon(wppIconTextAlignmentRight.WppIconTextAlignmentRight.is),
    justify: icon(wppIconTextAlignmentJustify.WppIconTextAlignmentJustify.is),
  },
  background: 'Bg',
  blockquote: icon(wppIconBlockquote.WppIconBlockquote.is),
  bold: icon(wppIconBold.WppIconBold.is),
  clean: 'Cl',
  code: 'Co',
  'code-block': icon(wppIconCodeView.WppIconCodeView.is),
  color: 'Cc',
  direction: {
    '': 'ltr',
    rtl: 'rtl',
  ...
  float: {
    center: icon(wppIconFloatCenter.WppIconFloatCenter.is),
    full: 'F',
    left: icon(wppIconFloatLeft.WppIconFloatLeft.is),
    right: icon(wppIconFloatRight.WppIconFloatRight.is),
  },
  formula: 'F',
  header: {
    1: icon(wppIconH1.WppIconH1.is),
    2: icon(wppIconH2.WppIconH2.is),
  },
  italic: icon(wppIconItalic.WppIconItalic.is),
  image: icon(wppIconVideoClip.WppIconImage.is),
  indent: {
    '+1': icon(wppIconIndentIncrease.WppIconIndentIncrease.is),
    '-1': icon(wppIconIndentDecrease.WppIconIndentDecrease.is),
  },
  link: icon(wppIconLink.WppIconLink.is),
  list: {
    ordered: icon(wppIconOrderedList.WppIconOrderedList.is),
  ...
  strike: icon(wppIconStrikeThrough.WppIconStrikeThrough.is),
  underline: icon(wppIconUnderline.WppIconUnderline.is),
  video: icon(wppIconVideoClip.WppIconVideoClip.is),
  undo: icon(wppIconUndo.WppIconUndo.is),
  redo: icon(wppIconRedo.WppIconRedo.is),
...
const QuillToolbar = types.Quill$1.import('modules/toolbar');
...
class Uploading {
  ...
  selectLocalFiles() {
    this.quill.editor.scroll.domNode.dispatchEvent(
      new CustomEvent(types.UPLOAD_REQUEST_EVENT, {
        bubbles: true,
        detail: {
...
const BlockEmbed = types.Quill$1.import('blots/block/embed');
...
const DRAG_THUMBNAIL_MAX_SIZE = 100;
...
const embedBlotInnerHtmlRegexp = /\uFEFF.*?\uFEFF/g;
const exportHtml = (html) => html.replace(embedBlotInnerHtmlRegexp, '');
function createDragThumbnail(node) {
...
const BaseBlot$1 = types.Quill$1.import('blots/embed');
...
types.Quill$1.register('formats/attachment', AttachmentBlot);
types.Quill$1.register('formats/attachmentUploading', AttachmentUploadingBlot);
...
const BaseBlot = types.Quill$1.import('blots/embed');
...
types.Quill$1.register('formats/video', VideoBlot, true);
types.Quill$1.register('formats/videoUploading', VideoUploadingBlot);
...
types.Quill$1.register('formats/image', ImageBlot, true);
types.Quill$1.register('formats/imageUploading', ImageUploadingBlot);
...
var implementation = _commonjsHelpers.createCommonjsModule(function (module) {
...
class ImageLibraryPicker extends Picker {
  static handler(value) {
    ...
    this.quill.deleteText(index, length, types.sources.user);
    this.quill.insertEmbed(index, 'image', blotValue, types.sources.user);
    this.quill.setSelection(index, 1, types.sources.silent);

    Object.keys(lodash.lodash.omit(blotValue, ['src'])).forEach(key => {
      this.quill.format(key, blotValue[key]);
    });

    this.quill.setSelection(index + 1, 0, types.sources.user);
  }
...
const LinkBlot = types.Quill$1.import('formats/link');
...
const SizeAttributor = types.Quill.import('attributors/class/size');
SizeAttributor.whitelist = ['2xs', 'xs', 'm', 'l', 'xl', '2xl', '3xl', '4xl', '5xl'];
types.Quill.register(SizeAttributor, true);
types.Quill.register({ 'themes/wpp': WppTheme });
// media upload modules
types.Quill.register('modules/imageUpload', Image);
types.Quill.register('modules/videoUpload', Video);
types.Quill.register('modules/attachmentUpload', Attachment);
// image and video positioning modules (width, height, float, align)
ImageFormats.extendBlotNames = ['formats/image', 'formats/video'];
types.Quill.register('modules/imageFormats', ImageFormats);
types.Quill.register('modules/imageActions', ImageActions);
const keyboardModule = types.Quill.import('modules/keyboard');
...
types.Quill.register('modules/toolbar', WppQuillToolbar, true);
types.Quill.register('modules/imageLibrary', () => { });
types.Quill.DEFAULTS.formats = [...defaultFormats, ...quillImageFormats, ...quillUploadFormats];
types.Quill.DEFAULTS.modules = {
  history: {
    delay: 1000,
    maxStack: 100,
    userOnly: true,
...
const turndownService = new turndown_browser_es.TurndownService({ headingStyle: 'atx' });
...
exports.createDragThumbnail = createDragThumbnail;
exports.deepmerge_1 = deepmerge_1;
exports.embedBlotInnerHtmlRegexp = embedBlotInnerHtmlRegexp;
exports.exportHtml = exportHtml;
exports.marked_umd = marked_umd;
exports.quillMarkdownOptions = quillMarkdownOptions;
