...
const WppTimePicker = class {
  ...
  render() {
    return (index.h(index.Host, { class: "wpp-time-picker", "aria-disabled": this.disabled, style: { width: !this.width ? DEFAULT_WIDTH_VALUE : this.width } }, this.labelConfig?.text && (index.h("wpp-label-v4-3-0", { typography: "s-strong", class: "label", htmlFor: this.name, optional: !this.required, config: this.labelConfig, disabled: this.disabled, tooltipConfig: this.labelTooltipConfig })), index.h("div", { ref: el => (this.anchorRef = el), id: "anchor", class: this.getAnchorCssClasses() }, index.h("div", { class: "anchor-time" }, index.h("wpp-icon-clock-v4-3-0", { class: "clock-icon" }), index.h("input", { ref: el => (this.inputRef = el), onFocus: this.onFocus, onBlur: this.onBlur, onKeyUp: this.onKeyUp, onKeyPress: this.onKeyPress, onPaste: this.onPaste, disabled: this.disabled, onInput: this.onUpdateInput, id: "time-picker", type: "text", placeholder: this.placeholder, value: this.value })), index.h("div", { class: "cross-icon-container" }, this.showDisplayCross && (index.h("wpp-icon-cross-v4-3-0", { class: "cross-icon", "aria-label": "Erase time", onClick: this.handleClickCrossIcon })))), index.h("div", { ref: el => (this.portalRef = el), class: "wpp-time-picker-portal" }, index.h("div", { ref: refEl => (this.hoursSectionRef = refEl), class: "hours section" }, HOURS.map((hour, hourIndex) => (index.h("wpp-list-item-v4-3-0", { id: `hour-${hour}`, key: hour, checked: this.checkedTimeValues.hoursIndex === hourIndex, onWppChangeListItem: () => this.handleClickListItem(hour, 'hour') }, index.h("span", { slot: "label" }, hour))))), index.h("wpp-divider-v4-3-0", { vertical: true }), index.h("div", { ref: refEl => (this.minutesSectionRef = refEl), class: "minutes section" }, this.generatedMinutes.map((minutes, minutesIndex) => (index.h("wpp-list-item-v4-3-0", { id: `minutes-${minutes}`, key: minutes, checked: this.checkedTimeValues.minutesIndex === minutesIndex, onWppChangeListItem: () => this.handleClickListItem(minutes, 'minutes') }, index.h("span", { slot: "label" }, minutes)))))), this.message && (index.h("wpp-inline-message-v4-3-0", { class: !this.messageType ? 'helper-text' : '', message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig }))));
  }
