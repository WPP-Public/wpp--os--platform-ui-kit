...
const WppFullScreenModal = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: this.hostCssClasses(), "aria-modal": "true", exportparts: "wrapper, overlay,full-screen-modal, header, body, actions, header-wrapper, body-wrapper, actions-wrapper", onTransitionStart: this.handleTransitionStart, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { class: "full-screen-modal-overlay", part: "wrapper" }, index.h("div", { class: "overlay-color", ...(this.withTransparentOverlay ? { style: { opacity: '0' } } : {}), onClick: this.onOverlayClick, part: "overlay" }), index.h(Tag, { role: "dialog", class: this.fullScreenModalCssClasses(), part: "content", ...this.formConfig }, index.h("div", { class: this.headerContainerCssClasses() }, index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.headerCssClasses(), name: "header", onSlotchange: this.updateSlotData }), index.h("wpp-action-button-v2-22-0", { variant: "secondary", onClick: this.handleCloseModal, class: "close-button" }, index.h("wpp-icon-cross-v2-22-0", { slot: "icon-start" }))), index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.bodyCssClasses(), name: "body", onSlotchange: this.updateSlotData }), index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.actionsCssClasses(), name: "actions", onSlotchange: this.updateSlotData })))));
  }
