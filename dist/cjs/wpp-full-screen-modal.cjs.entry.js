  ...
  constructor(hostRef) {
    ...
    this.onOverlayClick = () => {
      if (this.disableOutsideClick)
        return;
      this.wppFullScreenModalClose.emit({ reason: types.FullScreenModalCloseReason.outsideClick });
      this.closeReason = types.FullScreenModalCloseReason.outsideClick;
    };
    this.updateSlotData = () => {
    ...
    this.renderActionBtn = (btnConfig, variant) => {
      ...
      return (index.h("wpp-button-v4-3-0", { variant: variant, ...rest }, label));
    };
    ...
    this.handleCloseModal = () => {
      this.wppFullScreenModalClose.emit({ reason: types.FullScreenModalCloseReason.escapePress });
      this.closeReason = types.FullScreenModalCloseReason.escapePress;
    };
...
exports.wpp_full_screen_modal = WppFullScreenModal;
