...
const WppFullScreenModal = class {
  constructor(hostRef) {
    ...
    this.renderActionBtn = (btnConfig, variant) => {
      ...
      return (index.h("wpp-button-v4-2-0", { variant: variant, ...rest }, label));
    };
