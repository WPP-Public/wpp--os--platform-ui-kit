...
const WppTab = class {
  ...
  static get registryIs() { return "wpp-tab-v4-3-0"; }
  get host() { return index.getElement(this); }
};
WppTab.style = wppTabCss;

const TAB_MARGIN_RIGHT = 20;
const LOCALES_DEFAULTS = { tablistLabel: 'Tabs' };
...
const WppTabs = class {
  ...
  valueChanged(newValue) {
    ...
    const activeElement = Array.from(this.host.querySelectorAll(utils.transformToVersionedTag('wpp-tab'))).find(tab => tab.value === newValue);
  ...
  static get registryIs() { return "wpp-tabs-v4-3-0"; }
  get host() { return index.getElement(this); }
...
exports.wpp_tab = WppTab;
exports.wpp_tabs = WppTabs;
