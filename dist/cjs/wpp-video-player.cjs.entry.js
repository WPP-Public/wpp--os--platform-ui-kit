...
function renderVideoCurrentTimeComponent(time) {
  ...
  return (index.h(index.Fragment, null,
    index.h("wpp-typography-v4-3-0", { class: "video-time", type: "xs-body" },
...
function renderVolumeBarComponent() {
  return (index.h("div", { ref: ref => (this.volumeContainerRef = ref), class: "volume-container", onMouseEnter: this.handleSliderShow, onMouseLeave: () => this.handleSliderHide(300) },
    index.h("wpp-action-button-v4-3-0", { ref: ref => (this.volumeButtonRef = ref), class: "volume-button", variant: "inverted", onClick: this.toggleMute, onFocus: this.handleSliderShow, onFocusout: () => this.handleSliderHide(300), ariaProps: { label: this._locales.volumeButtonAriaLabel } }, this.volume === 0 ? (index.h("wpp-icon-speaker-mute-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })) : (index.h("wpp-icon-speaker-v4-3-0", { slot: "icon-start", "aria-hidden": "true" }))),
...
const WppVideoPlayer = class {
  constructor(hostRef) {
     ...
     * - autoplay=true
     */
    this.renderMainPlayButton = () => (index.h("wpp-action-button-v4-3-0", { ref: ref => (this.initPlayButtonRef = ref), class: this.playButtonCssClasses(), onClick: this.togglePlay, variant: "inverted", ariaProps: {
      ...
      } }, this.videoPlayerState !== 'playing' ? (index.h("wpp-icon-play-filled-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })) : (index.h("wpp-icon-pause-filled-v4-3-0", { slot: "icon-start", "aria-hidden": "true" }))));
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "video-player, controls", onMouseMove: this.handleMouseMove, onMouseLeave: this.handleMouseLeave, ...this.videoPlayerHostSize, role: "region", "aria-label": this._locales.hostAriaLabel }, this.renderVideoTag(), this.renderMainPlayButton(), !this.controlPanelConfigDefault.autoplay && (index.h("div", { ref: ref => (this.controlsRef = ref), ...(this.thumbnail ? { style: { backgroundImage: `url(${this.thumbnail})` } } : {}), class: this.controlsCssClasses(), part: "controls", tabindex: "-1", ...(this.videoPlayerState !== 'idle'
        ...
        : {}) }, this.videoPlayerState !== 'idle' && (index.h(index.Fragment, null, this.caption && this.renderCaptions(), index.h("div", { class: "controls-bar", ref: ref => (this.controlsBarRef = ref) }, index.h("wpp-action-button-v4-3-0", { ref: ref => (this.playPauseButtonRef = ref), class: "play-pause-button", variant: "inverted", onClick: this.togglePlay, ariaProps: {
        label: this.videoPlayerState === 'playing'
          ? this._locales.playPauseButtonArealLabels.pause
          : this._locales.playPauseButtonArealLabels.play,
        pressed: this.videoPlayerState === 'playing',
      } }, this.videoPlayerState === 'playing' ? (index.h("wpp-icon-pause-filled-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })) : (index.h("wpp-icon-play-filled-v4-3-0", { slot: "icon-start", "aria-hidden": "true" }))), this.renderVideoTime(this.splitCurrentVideoTime), this.renderSeekBar(), this.renderVideoTime(this.splitOverallVideoTime), this.caption && (index.h("wpp-action-button-v4-3-0", { ref: ref => (this.captionButtonRef = ref), onClick: this.toggleCaptions, variant: "inverted", ariaProps: {
        label: this._locales.captionButtonAriaLabel,
      } }, this.isCaptionEnabled ? (index.h("wpp-icon-caption-on-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })) : (index.h("wpp-icon-caption-off-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })))), this.controlPanelConfigDefault.showVolumeButton && this.renderVolumeBar(), this.controlPanelConfigDefault.showFullscreenButton && (index.h("wpp-action-button-v4-3-0", { ref: ref => (this.fullScreenButtonRef = ref), onClick: this.toggleFullscreen, variant: "inverted", ariaProps: {
        label: this._locales.fullscreenButtonAriaLabel,
      } }, this.isFullscreen ? (index.h("wpp-icon-fullscreen-minimise-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })) : (index.h("wpp-icon-fullscreen-v4-3-0", { slot: "icon-start", "aria-hidden": "true" })))), this.renderAccessibilityInstructions())))))));
  }
