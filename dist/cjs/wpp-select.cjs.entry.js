...
function renderSingleSelect(isBaseComponent = true, customSize, isRenderMessageInTooltip) {
  ...
  const getInlineMessage = () => (index.h(index.Fragment, null, this.message && isBaseComponent && (index.h("wpp-inline-message-v4-2-0", { class: !this.messageType ? 'default-message' : '', showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType || 'information', tooltipConfig: this.tooltipConfig }))));
  const renderAnchor = () => (index.h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick() }, this.anchorButton ? (index.h("slot", { name: "anchor-button", onSlotchange: this.updateSlotData })) : (index.h(index.Fragment, null,
    ...
    index.h("div", { class: "overflow-container", ref: refEl => (this.overflowContainerRef = refEl) }, this.textOverflows ? (index.h("wpp-tooltip-v4-2-0", { text: getSelectPlaceholder() },
    ...
    index.h("wpp-icon-chevron-v4-2-0", { class: this.isOpen || this.isDropdownOpen ? 'isOpen' : '', direction: 'down' })))));
  ...
  return (index.h(RootTag, { onKeyUp: this.onKeyUp, onKeyDown: this.onKeyDown, class: "wpp-single-select", "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && isBaseComponent && (index.h("wpp-label-v4-2-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    index.h("div", { class: "anchor-container" }, isRenderMessageInTooltip ? (index.h("wpp-tooltip-v4-2-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
    ...
    index.h("div", { class: "wpp-select-portal", onKeyDown: this.onKeyDownPortal, ref: el => (this.portalRef = el) },
      this.shouldShowSearch && (index.h(index.Fragment, null,
        index.h("wpp-input-v4-2-0", { type: "search", class: "select-portal-search-input", value: this.searchText, onWppChange: this.handleSearch, name: this.name && `${this.name}-search-input`, placeholder: this._locales.searchInputPlaceholder }),
        index.h("wpp-divider-v4-2-0", { color: "var(--wpp-grey-color-300)" }))),
...
function renderMultipleSelect() {
  ...
  const getInlineMessage = () => (index.h(index.Fragment, null, this.message && (index.h("wpp-inline-message-v4-2-0", { class: !this.messageType ? 'default-message' : '', showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType || 'information', tooltipConfig: this.tooltipConfig }))));
  const renderAnchor = () => (index.h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick() }, this.anchorButton ? (index.h("slot", { name: "anchor-button", onSlotchange: this.updateSlotData })) : (index.h(index.Fragment, null,
    index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.iconStartCssClasses(), name: "icon-start", onSlotchange: this.updateSlotData }),
    ...
    index.h("wpp-icon-chevron-v4-2-0", { class: this.isOpen ? 'isOpen' : '', direction: 'down' })))));
  return (index.h(index.Host, { class: "wpp-multiple-select", onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && (index.h("wpp-label-v4-2-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    index.h("div", { class: "anchor-container" }, this.isRenderMessageInTooltip ? (index.h("wpp-tooltip-v4-2-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
        ...
        index.h("div", { class: "list-scrollable", ref: refEl => (this.listRef = refEl) },
          shouldRenderTopSelectAll && (index.h("div", { class: "select-all-section" },
            !this.maximumSelectedItems && (index.h(index.Fragment, null,
              index.h("wpp-list-item-v4-2-0", { multiple: true, checked: this.isSelectAllChecked, indeterminate: this.isSelectAllIndeterminate, disabled: this.isSelectAllDisabled, onWppChangeListItem: e => {
                  e.stopPropagation();
                ...
                index.h("p", { slot: "label" },
                  ...
                  this.selectAllCount,
                  ")")),
              index.h("wpp-divider-v4-2-0", { class: "select-all-divider", color: "var(--wpp-grey-color-300)" }))),
            this.renderPinnedItems(),
            hasPinnedItems && (index.h("wpp-divider-v4-2-0", { class: "pinned-items-divider", color: "var(--wpp-grey-color-300)" })))),
          this.renderList())),
      this.withFolder && this.isOpen && (index.h("div", { class: "multiple-select-folder" },
        this.withScroll && index.h("wpp-divider-v4-2-0", null),
        this.showSelectAllOption ? (index.h("div", { class: `multiple-select-folder-buttons select-all-mode${this.withScroll ? ' with-divider' : ''}` },
          this.canClearVisible && (index.h("wpp-action-button-v4-2-0", { variant: "secondary", disabled: this.loading, onClick: this.handleClearAll }, this._locales.clearText)),
          index.h("wpp-action-button-v4-2-0", { class: "apply-button", variant: "primary", disabled: this.loading, onClick: this.handleApply }, this._locales.applyText))) : (index.h("div", { class: `multiple-select-folder-buttons${this.withScroll ? ' with-divider' : ''}` },
          index.h("wpp-action-button-v4-2-0", { variant: "secondary", disabled: !this.canSelectAll || this.loading, onClick: this.handleSelectAll }, this._locales.selectAllText),
          this.canClearAll && (index.h("wpp-action-button-v4-2-0", { variant: "secondary", disabled: this.loading, onClick: this.handleClearAll }, this._locales.clearAllText)))))))));
}
...
function renderTextSelect() {
  const renderAnchor = () => (index.h(index.Fragment, null,
    index.h("wpp-typography-v4-2-0", { id: "select-text", type: "s-body" }, this.renderedText || this.placeholder),
    index.h("wpp-icon-chevron-v4-2-0", { class: this.isOpen ? 'isOpen' : '', direction: 'down' })));
  const getAnchorCSSClasses = () => ({
    anchor: true,
    disabled: this.disabled,
  ...
  const getInlineMessage = () => (index.h(index.Fragment, null, this.message && (index.h("wpp-inline-message-v4-2-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, tooltipConfig: this.tooltipConfig }))));
  return (index.h(index.Host, { class: "wpp-text-select", onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    index.h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick(), role: this.ariaProps.role || 'button', "aria-label": this.ariaProps.label ||
      ...
      } }, this.truncate && this.shouldTruncate ? (index.h("wpp-tooltip-v4-2-0", { text: this.renderedText || this.placeholder, config: { placement: 'right' }, class: "tooltip" }, renderAnchor())) : (renderAnchor())),
    getInlineMessage(),
    index.h("div", { class: "wpp-select-portal", ref: el => (this.portalRef = el) },
...
function renderCombinedSelect() {
  ...
  const getInlineMessage = () => (index.h(index.Fragment, null, this.message && (index.h("wpp-inline-message-v4-2-0", { message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig }))));
...
const WppSelect = class {
  constructor(hostRef) {
    ...
    this.renderList = () => {
      ...
      if (this.loading) {
        return (index.h("div", { class: "loading-container" }, index.h("wpp-spinner-v4-2-0", null), index.h("wpp-typography-v4-2-0", { type: "s-body" }, this._locales.loadingText)));
      }
      if (this.internalList?.length === 0) {
        return (index.h("wpp-typography-v4-2-0", { class: "nothing-found", type: "s-body" }, this._locales.emptyText));
      }
      ...
      return (index.h(index.Fragment, null, this.internalList?.map((item) => {
        ...
        return (index.h("wpp-list-item-v4-2-0", { onWppChangeListItem: this.handleClickListItem, key: this.convertValueToKey(item.value), ref: item.checked && this.type === 'single'
