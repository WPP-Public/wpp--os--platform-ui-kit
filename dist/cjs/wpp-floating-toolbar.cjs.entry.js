...
const WppFloatingToolbar = class {
  constructor(hostRef) {
    ...
    this.renderActionButton = (data) => (index.h("wpp-action-button-v3-3-1", { key: `${data.icon}`, ...data }, index.h(utils.transformToVersionedTag(data.icon), { slot: 'icon-start', part: 'icon' })));
