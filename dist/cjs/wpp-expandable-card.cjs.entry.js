...
const WppExpandableCard = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), onFocus: this.onFocus, onBlur: this.onBlur, "aria-expanded": this.expanded, exportparts: "expandable-card-body, accordion, section, title, icon, counter, divider, title-wrapper" }, index.h("div", { class: "body-container", part: "expandable-card-body" }, index.h("wpp-accordion-v2-22-0", { size: this.size, text: this.header, expanded: this.expanded, expandedByDefault: this.expandedByDefault, withDivider: false, onWppChange: this.onChange, part: "accordion" }, index.h("slot", null), index.h("slot", { name: "header", slot: "header", class: "header" }), index.h("slot", { name: "actions", slot: "actions", class: "actions" })))));
  }
