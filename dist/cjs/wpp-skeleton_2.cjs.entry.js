...
const WppSkeleton = class {
  ...
  static get registryIs() { return "wpp-skeleton-v4-2-0"; }
};
...
const WppTreeItem = class {
  constructor(hostRef) {
    ...
    this.renderEndContent = () => {
      ...
      switch (contentType) {
        case 'text':
          return (index.h("wpp-typography-v4-2-0", { type: "s-body", tag: "span", ...props, class: this.endContentCssClasses(className), part: "tree-item-end-text" }, props?.text));
        case 'tag': {
          const { icon } = props;
          return (index.h("wpp-tag-v4-2-0", { ...props, class: this.endContentCssClasses(className), disabled: this.item.disabled, part: "tree-item-end-tag" }, icon &&
        ...
        case 'avatar':
          return (index.h("wpp-avatar-v4-2-0", { ...props, class: this.endContentCssClasses(className), size: "xs", part: "tree-item-end-avatar",
            // Remove from tab order - tree uses arrow keys per ARIA APG
            index: -1 }));
        case 'avatarGroup':
          return (index.h("wpp-avatar-group-v4-2-0", { ...props, class: this.endContentCssClasses(className), part: "tree-item-end-avatar-group",
