...
const WppIconTableSortDescPressed = class {
  ...
  render() {
    return (index.h(WppIcon.WppIcon, { name: "wpp-icon-table-sort-desc-pressed", width: this.width, height: this.height, size: this.size, color: this.color }, index.h("path", { d: "M10 4L13.4641 8.5H6.5359L10 4Z", fill: "#8B919A" }), index.h("path", { d: "M10 16L13.4641 11.5H6.5359L10 16Z", fill: "#343A3F" })));
  }
