    ...
    this.validateFileType = (file) => {
      ...
      if (!this.acceptConfig || Object.keys(this.acceptConfig).length === 0) {
        if (!file.type) {
          ...
          const typeFromExtension = utils.EXTENSION_TO_TYPE[extension] || '';
