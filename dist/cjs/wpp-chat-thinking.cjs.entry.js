...
const WppChatThinking = class {
  ...
  render() {
    return (index.h(index.Host, { role: "status", "aria-live": "polite" }, index.h("div", { class: "thinking", part: "thinking" }, index.h("wpp-spinner-v4-2-0", { class: "spinner", part: "spinner", size: "s", "aria-hidden": "true" }), index.h("wpp-typography-v4-2-0", { class: "label", type: "s-body", part: "label" }, this.label))));
  }
