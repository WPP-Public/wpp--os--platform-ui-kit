...
const wppActionButton = require('./wpp-action-button-5ccf570c.js');
...
const WppInlineMessage = class {
  constructor(hostRef) {
    ...
    this.getMessageTypesIcons = () => {
      if (this.type === 'warning')
        return index.h("wpp-icon-warning-v2-22-0", { class: "left-icon", part: "message-icon" });
      if (this.type === 'error')
        return index.h("wpp-icon-error-v2-22-0", { class: "left-icon", part: "message-icon" });
      if (this.type === 'information')
        return index.h("wpp-icon-info-message-v2-22-0", { class: "left-icon", part: "message-icon" });
      if (this.type === 'success')
        return index.h("wpp-icon-success-v2-22-0", { class: "left-icon", part: "message-icon" });
      return null;
    };
    ...
    this.renderContent = () => {
      ...
      return this.size === 'l' ? (index.h("div", { class: "container", part: "container" }, index.h("div", { class: "container-content" }, this.getMessageTypesIcons(), index.h("div", { class: "content-wrapper" }, index.h("div", { class: this.titleCssClasses(), part: "title" }, this.titleText), index.h("div", { class: "container-body" }, this.isTruncated ? (index.h("wpp-tooltip-v2-22-0", { class: "tooltip", text: this.message, config: { placement: 'bottom', ...this.tooltipConfig }, part: "tooltip" }, index.h("span", { class: "message", part: "message" }, message))) : (index.h("span", { class: "message", part: "message" }, message))))), index.h("div", { class: "container-actions" }, this.actionBtnText.length > 0 && (index.h("wpp-action-button-v2-22-0", { part: "action-btn", class: "action-btn", variant: "secondary", onClick: this.handleClickActionBtn }, this.actionBtnText)), !this.hideCloseBtn && (index.h("wpp-action-button-v2-22-0", { class: "close-btn", variant: "secondary", onClick: this.handleClickClose }, index.h("wpp-icon-cross-v2-22-0", { color: "var(--ab-secondary-text-color)", size: "m" })))))) : this.isTruncated ? (index.h("wpp-tooltip-v2-22-0", { text: this.message, config: { placement: 'bottom', ...this.tooltipConfig }, part: "tooltip" }, index.h("div", { class: this.messageBlockCssClasses(), part: "message-block" }, this.getMessageTypesIcons(), index.h("span", { class: "message", part: "message" }, message)))) : (index.h("div", { class: this.messageBlockCssClasses(), part: "message-block" }, this.getMessageTypesIcons(), index.h("span", { class: "message", part: "message" }, message)));
    };
    this.getExportParts = () => {
  ...
  render() {
    return (index.h(index.Host, { exportparts: this.getExportParts(), class: this.hostCssClasses() }, index.h("div", { class: this.inlineMessageWrapperCssClasses(), part: "wrapper" }, this.renderContent())));
  }
...
const WppInternalLabel = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "info-wrapper, text, optional-text, tooltip, icon, icon-wrapper" }, !!this.labelText && (index.h("div", { class: this.infoWrapperCssClasses(), part: "info-wrapper" }, index.h("wpp-typography-v2-22-0", { type: this.typography, class: "text", part: "text" }, this.labelText), this.optional && (index.h("wpp-typography-v2-22-0", { type: "s-body", class: "optional", part: "optional-text" }, "(", this.locales.optional, ")")))), !!this.description && this.hasIconSlot ? (index.h("wpp-tooltip-v2-22-0", { class: "tooltip", text: this.description, config: this.tooltipConfig, part: "tooltip" }, index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.iconCssClasses(), name: "icon", onSlotchange: this.updateSlotData }))) : (index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.iconCssClasses(), name: "icon", onSlotchange: this.updateSlotData }))));
  }
...
const WppTooltip$1 = class {
  constructor(hostRef) {
    ...
    this.getIconBasedOnProps = () => {
      if (this.error) {
        return index.h("wpp-icon-error-v2-22-0", { class: "left-icon", part: "icon-error" });
      }
      if (this.warning) {
        return index.h("wpp-icon-warning-v2-22-0", { color: "var(--wpp-warning-color-400)", class: "left-icon" });
      }
      return null;
    };
    this.getTextLines = () => {
...
const WppLabel = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "wrapper, content, icon" }, index.h("label", { class: "internal-label-wrapper", htmlFor: this.htmlFor, part: "wrapper" }, index.h("wpp-internal-label-v2-22-0", { labelText: this.config?.text, description: this.config?.description, optional: this.optional, typography: this.typography, disabled: this.disabled, locales: this.config?.locales, tooltipConfig: this.tooltipConfig, part: "content" }, this.config?.icon && index.h(utils.transformToVersionedTag(this.config?.icon), { slot: 'icon', part: 'icon' })))));
  }
...
const WppSpinner = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses() }, index.h("svg", { class: this.spinnerCssClasses(), role: "alert", "aria-busy": "true" }, index.h("circle", { cx: SPINNER_SIZES[this.size], cy: SPINNER_SIZES[this.size], r: SPINNER_RADIUS[this.size], fill: "transparent", stroke: this.color, "stroke-linecap": "round" }))));
  }
...
const WppTooltip = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses() }, index.h("div", { part: "anchor", class: "anchor", ref: anchorEl => (this.anchorEl = anchorEl) }, index.h("slot", { part: "inner" })), index.h("div", { class: this.contentWrapperCssClasses() }, !this.config.allowHTML ? (index.h("wpp-internal-tooltip-v2-22-0", { cssStyle: this.style, ref: contentEl => (this.contentEl = contentEl), header: this.header, text: this.text, value: this.value, error: this.error, wordBreak: this.wordBreak, warning: this.warning, theme: this.theme, externalClass: this.externalClass })) : (index.h("div", { ref: customContentEl => (this.customContentEl = customContentEl), class: `tooltip-custom-content ${this.theme}` })))));
  }
