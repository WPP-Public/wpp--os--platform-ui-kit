...
const WppAccordion = class {
  ...
  render() {
    ...
    const titleContent = (index.h(index.Fragment, null, this.hasHeaderSlot ? (index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.headerCssClasses(), name: "header", role: "presentation", onSlotchange: this.updateSlotData })) : (index.h("wpp-typography-v3-6-0", { type: this.typographyType(), part: "title", role: "presentation", class: "title-text" }, this.text))));
    return (index.h(index.Host, { class: this.hostCssClasses(internal), exportparts: "section, title, icon, counter, divider, title-wrapper, content, button", style: style, onBlur: this.onBlur, onKeyUp: this.onKeyUp, onKeyDown: this.onKeyDown }, index.h("div", { class: this.cssSectionClasses(), part: "section" }, index.h("button", { ref: ref => (this.titleTagsWrapperButtonRef = ref), class: this.cssTagWrapperClasses(), "aria-expanded": this.expanded.toString(), "aria-controls": this.ariaProps?.controls ?? 'expandable-panel', id: this.ariaProps?.labelledby ?? 'expandable-button', onFocus: this.onFocus, onClick: this.onClick, disabled: this.disabled, part: "button" }, index.h("div", { class: "title-wrapper", part: "title-wrapper", role: "none" }, index.h("wpp-icon-chevron-v3-6-0", { role: "presentation", part: "icon" }), this.isTitleOverflowing ? (index.h("wpp-tooltip-v3-6-0", { config: { triggerTarget: this.titleTagsWrapperButtonRef }, text: tooltipText }, titleContent)) : (titleContent), this.counter > 0 && (index.h("wpp-typography-v3-6-0", { type: this.counterType(), class: "counter", part: "counter" }, `(${this.counter})`))), this.withTag && (index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.tagGroupCssClasses(), name: "tags", onSlotchange: this.updateSlotData }))), index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.actionsCssClasses(), name: "actions", onSlotchange: this.updateSlotData })), index.h("div", { class: this.contentCssClasses(), part: "content", role: "region", id: this.ariaProps?.controls ?? 'expandable-panel', "aria-labelledby": this.ariaProps?.labelledby ?? 'expandable-button', ...(!this.expanded ? { inert: true, 'aria-hidden': true } : {}) }, index.h("slot", { class: "slot-content" })), this.withDivider && index.h("wpp-divider-v3-6-0", { part: "divider" })));
  }
