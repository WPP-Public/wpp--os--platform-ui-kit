...
const WppTree = class {
  constructor(hostRef) {
    ...
    this.renderSkeletonLoading = () => [...Array(this.skeletonNumberItems)].map(_ => (index.h("div", { class: "skeleton-item" }, index.h("wpp-skeleton-v3-3-1", { variant: "rectangle", width: "100%", animation: true }))));
