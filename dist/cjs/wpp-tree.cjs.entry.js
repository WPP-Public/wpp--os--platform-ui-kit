...
const WppTree = class {
  ...
  renderSkeletonRows(count = 1, paddingLeft) {
    ...
    return Array.from({ length: count }, (_, idx) => (index.h("div", { class: "skeleton-item", key: `skeleton-${idx}`, ...(paddingLeft && { style: { paddingLeft } }) }, index.h("wpp-skeleton-v3-6-0", { variant: "rectangle", width: "100%", height: height, animation: true }))));
  }
