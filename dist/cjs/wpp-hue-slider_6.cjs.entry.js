...
const WppIconSwatch = class {
  ...
  static get registryIs() { return "wpp-icon-swatch-v4-1-0"; }
};
...
const OpacitySlider = class {
  ...
  render() {
    return (index.h(index.Host, { class: "wpp-opacity-slider" }, index.h("div", { class: "slider-container" }, index.h("wpp-icon-transparent-v4-1-0", { class: "checkerboard" }), index.h("canvas", null), index.h("div", { class: "marker", style: {
        left: `${this.markerPosition}px`,
      } }))));
  }
