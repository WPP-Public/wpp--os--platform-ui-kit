...
const OpacitySlider = class {
  ...
  render() {
    return (index.h(index.Host, { class: "wpp-opacity-slider" }, index.h("div", { class: "slider-container" }, index.h("wpp-icon-transparent-v4-0-0", { class: "checkerboard" }), index.h("canvas", null), index.h("div", { class: "marker", style: {
        left: `${this.markerPosition}px`,
      } }))));
  }
