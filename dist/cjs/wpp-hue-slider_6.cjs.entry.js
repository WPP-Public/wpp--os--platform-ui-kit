...
const OpacitySlider = class {
  ...
  render() {
    return (index.h(index.Host, { class: "wpp-opacity-slider" }, index.h("div", { class: "slider-container" }, index.h("wpp-icon-transparent-v4-3-0", { class: "checkerboard" }), index.h("canvas", null), index.h("div", { class: "marker", style: {
        left: `${this.markerPosition}px`,
      } }))));
  }
...
const LOCALES_DEFAULTS = { tablistLabel: 'Segmented Control' };
...
const WppSegmentedControl = class {
  ...
  get _locales() {
    return utils$1.mergeLocales(LOCALES_DEFAULTS, this.locales);
  }
  getItems() {
    return Array.from(this.host.querySelectorAll(utils$1.transformToVersionedTag('wpp-segmented-control-item')));
  }
  render() {
    ...
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "wrapper, inner, label", onFocus: this.onFocus, onBlur: this.onBlur }, this.labelConfig?.text && (index.h("wpp-label-v4-3-0", { class: "label", tag: "span", optional: !this.required, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, labelId: labelId, part: "label" })), index.h("div", { class: this.cssClasses(), role: "tablist", "aria-orientation": "horizontal", "aria-label": tablistLabel, "aria-labelledby": tablistLabelledBy, part: "wrapper" }, index.h("slot", { onSlotchange: this.handleSlotChange, part: "inner" }))));
  }
...
const WppSegmentedControlItem = class {
  constructor(hostRef) {
    ...
    this.wppFocus = index.createEvent(this, "wppFocus", 1);
    this.wppBlur = index.createEvent(this, "wppBlur", 1);
    this.wppDisabledChangeSegmentedControlItem = index.createEvent(this, "wppDisabledChangeSegmentedControlItem", 1);
    ...
    this.onFocus = (event) => {
      this.focusType = this.isMouseClicked ? common.FOCUS_TYPE.MOUSE : common.FOCUS_TYPE.TAB;
      this.isMouseClicked = false;
      this.wppFocus.emit(event);
    };
    this.onBlur = (event) => {
