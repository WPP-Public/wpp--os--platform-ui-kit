...
const HueSlider = class {
  ...
  static get registryIs() { return "wpp-hue-slider-v3-3-1"; }
...
const WppIconSwatch = class {
  ...
  static get registryIs() { return "wpp-icon-swatch-v3-3-1"; }
};
...
const OpacitySlider = class {
  ...
  render() {
    return (index.h(index.Host, { class: "wpp-opacity-slider" }, index.h("div", { class: "slider-container" }, index.h("wpp-icon-transparent-v3-3-1", { class: "checkerboard" }), index.h("canvas", null), index.h("div", { class: "marker", style: {
        left: `${this.markerPosition}px`,
      } }))));
  }
...
const SaturationPicker = class {
  ...
  static get registryIs() { return "wpp-saturation-picker-v3-3-1"; }
  get host() { return index.getElement(this); }
  static get watchers() { return {
