...
const WppBackToTopButton = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "button, icon", onMouseDown: this.onMouseDown, onKeyDown: this.onKeyDown, onKeyUp: this.onKeyUp }, index.h("button", { ref: el => (this.buttonRef = el), onBlur: this.onBlur, class: this.buttonCssClasses(), type: "button", part: "button", "data-testid": "wppBackToTopButton", "aria-pressed": this.isPressed ? 'true' : 'false', ...this.validAriaProps }, index.h("wpp-icon-arrow-v4-1-0", { direction: "up", class: "icon", part: "icon" }))));
  }
