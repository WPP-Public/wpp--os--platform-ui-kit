...
const WppColorPicker = class {
  ...
  render() {
    return (index.h(index.Host, { "aria-disabled": this.disabled, class: this.hostCssClasses(), onFocus: this.onFocus, onBlur: this.onBlur, tabindex: this.disabled ? -1 : 0 }, index.h("div", { onClick: this.handleAnchorClick, class: "anchor", ref: anchorEl => (this.anchorEl = anchorEl) }, index.h("div", { class: "color-container" }, index.h("div", { class: "color-preview" }, index.h("div", { style: { backgroundColor: this.displayValue, opacity: this.type === 'hex' ? this.hexOpacity : '1' }, class: "color-preview-box" }), index.h("wpp-icon-swatch-v4-2-0", { size: "s" })), index.h("wpp-typography-v4-2-0", { type: "s-body", color: this.disabled ? 'var(--wpp-text-color-disabled)' : undefined }, this.displayValue)), this.type === 'hex' && (index.h("wpp-typography-v4-2-0", { class: "hex-opacity", type: "s-body", color: this.disabled ? 'var(--wpp-text-color-disabled)' : undefined }, this.hexOpacity))), index.h("div", { class: this.dropdownCssClasses(), ref: elRef => (this.contentEl = elRef) }, this.mode === 'theme and custom' && (index.h("wpp-segmented-control-v4-2-0", { width: "346px", hugContentOff: true, size: "s", value: this.activeSegment, onWppChange: this.handleSegmentChange }, index.h("wpp-segmented-control-item-v4-2-0", { variant: "text", value: "theme" }, "Theme"), index.h("wpp-segmented-control-item-v4-2-0", { variant: "text", value: "custom" }, "Custom"))), (this.mode === 'custom' || (this.mode === 'theme and custom' && this.activeSegment === 'custom')) && (index.h("div", { class: "wpp-custom-picker" }, index.h("wpp-saturation-picker-v4-2-0", { hue: this.hue, saturation: this.saturation, value: this.saturationValue }), index.h("div", { class: "wpp-bottom-pickers" }, index.h("div", { class: "wpp-sliders" }, index.h("wpp-hue-slider-v4-2-0", { hue: this.hue }), index.h("wpp-opacity-slider-v4-2-0", { hexColor: this.hexColor, opacity: parseInt(this.internalOpacity) / 100 })), index.h("div", { class: "wpp-color-preview" }, index.h("div", { class: "wpp-color", style: { backgroundColor: this.hexColor, opacity: this.internalOpacity } }), index.h("wpp-icon-swatch-v4-2-0", null))), index.h("div", { class: "wpp-controls" }, this.isDropdownVisible && (index.h("wpp-select-v4-2-0", { size: "s", required: true, type: "single", value: this.internalType, onWppChange: this.handleChangeTypeOfPicker, dropdownConfig: {
        placement: 'bottom',
        onShow: (instance) => {
      ...
      ] })), this.internalType === 'hex' ? (index.h("wpp-input-v4-2-0", { class: "hex-input", size: "s", name: "hexValue", value: this.hexColor.replace('#', ''), onBlur: this.handleInputHexChange })) : (index.h(index.Fragment, null, utils.RGB_INPUTS.map((inputName) => (index.h("wpp-input-v4-2-0", { key: inputName, class: `${inputName}-input`, size: "s", name: inputName, type: "text", value: String(this.rgbInputValues[inputName]), maskOptions: utils.RGB_INPUT_CONFIG, onBlur: this.handleInputRGBChange }))))), index.h("wpp-input-v4-2-0", { class: "opacity-input", size: "s", name: "opacity", type: "text", maskOptions: utils.OPACITY_INPUT_CONFIG, value: this.internalOpacity, onBlur: this.handleInputOpacityChange })), index.h("div", { class: "wpp-saved-colors" }, index.h("wpp-typography-v4-2-0", { class: "title", type: "s-strong" }, "Saved colors"), index.h("div", { class: "wpp-colors" }, this.savedColors.map((savedColor) => (index.h("wpp-popover-v4-2-0", { config: {
        trigger: '',
        onShow: instance => {
      ...
      } }, index.h("div", { onContextMenu: event => this.handleRightClick(event), slot: "trigger-element", class: "saved-color", key: savedColor, onClick: () => this.handleClickSavedColor(savedColor) }, index.h("div", { class: "saved-color-preview", style: { backgroundColor: savedColor } }), this.hasColorOpacity(savedColor) && index.h("wpp-icon-swatch-v4-2-0", { size: "s" })), index.h("div", { class: "popover-content" }, index.h("wpp-list-item-v4-2-0", { onWppChangeListItem: () => this.handleRemoveSavedColor(savedColor) }, index.h("span", { slot: "label" }, "Remove color")))))), this.savedColors.length < utils.MAXIMUM_NUMBER_OF_SAVED_COLORS && (index.h("wpp-icon-plus-v4-2-0", { onClick: this.handleSaveColor })))))), (this.mode === 'theme' || (this.mode === 'theme and custom' && this.activeSegment === 'theme')) &&
      this.themeColorValues.map((colorSection) => (index.h("div", { key: colorSection.title, class: "wpp-color-section" }, index.h("wpp-typography-v4-2-0", { class: "wpp-color-section-title", type: "s-strong" }, colorSection.title), colorSection.colors.map((colorSubsection) => (index.h("div", { class: "wpp-color-subsection" }, colorSubsection.map((color) => (index.h("div", { key: color.hexValue, class: this.colorBoxCssClasses(color), onClick: () => this.handleClickThemeColor(color, colorSection.title) }, index.h("div", { class: "wpp-color-box-preview", style: { backgroundColor: color.hexValue, opacity: color.opacity } }), color.opacity !== '100%' && index.h("wpp-icon-swatch-v4-2-0", { size: "s" }), this.selectedCategory === colorSection.title &&
        this.hexColor === color.hexValue &&
        this.internalOpacity === color.opacity && (index.h("wpp-icon-tick-v4-2-0", { color: utils.contrastWithWhite(this.hexColor) < 3
