  ...
  constructor(hostRef) {
    ...
    this.item = () => {
      ...
      return (index.h(index.Fragment, null, index.h(WrappedSlot.WrappedSlot, { name: "icon-start", wrapperClass: "icon-wrapper", class: "slot-icon-start-fallback", onSlotchange: this.updateSlotData }), index.h("p", { class: this.labelCssClasses(), part: "label" }, isNeedTruncate
        ...
        : this.label), index.h(WrappedSlot.WrappedSlot, { name: "icon-end", wrapperClass: this.iconEndCssClasses(), class: "slot-icon-end-fallback" }, this.extended && index.h("wpp-icon-chevron-v3-6-0", { class: "extended-icon", size: "m", part: "icon-chevron" }))));
    };
    ...
    this.renderItemWithTooltip = () => (index.h("wpp-tooltip-v3-6-0", { text: this.label, config: tooltipConfig, part: "tooltip" }, this.extended ? this.extendedItem() : this.linkItem()));
    this.renderItem = () => {
      const currentMaxLengthLabel = this.extended ? this.maxTitleLengthWithSubItems : this.maxTitleLengthWithoutSubItems;
