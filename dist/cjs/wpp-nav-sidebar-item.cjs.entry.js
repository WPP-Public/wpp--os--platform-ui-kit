  ...
  constructor(hostRef) {
    ...
    this.item = () => {
      ...
      return (index.h(index.Fragment, null, index.h(WrappedSlot.WrappedSlot, { name: "icon-start", wrapperClass: "icon-wrapper", class: "slot-icon-start-fallback", onSlotchange: this.updateSlotData }), index.h("p", { class: this.labelCssClasses(), part: "label" }, isNeedTruncate
        ...
        : this.label), index.h(WrappedSlot.WrappedSlot, { name: "icon-end", wrapperClass: this.iconEndCssClasses(), class: "slot-icon-end-fallback" }, this.extended && index.h("wpp-icon-chevron-v4-3-0", { class: "extended-icon", size: "m", part: "icon-chevron", "aria-hidden": "true" }))));
    };
    ...
    this.extendedItem = () => (index.h("div", { class: this.navigationWrapperCssClasses(), role: "button", tabIndex: 0, "aria-expanded": this.expanded ? 'true' : 'false', onClick: this.handleClickExpandedItem, onKeyDown: this.handleExpandedItemKeyDown, part: "extended-item" }, this.item()));
    ...
    this.linkItem = () => (index.h("a", { class: this.navigationWrapperCssClasses(), href: this.path, onClick: this.handleClickLinkItem, target: this.target, "aria-current": this.active ? 'page' : undefined, part: "link-item" }, this.item()));
    ...
    this.renderSubItemsWrapper = () => (index.h("div", { class: this.subItemWrapperCssClasses(), part: "ws-wrapper", ...(!this.expanded ? { inert: true, 'aria-hidden': 'true' } : {}) }, index.h("slot", { part: "ws-inner" })));
    this.renderItemWithTooltip = () => (index.h("wpp-tooltip-v4-3-0", { text: this.label, config: tooltipConfig, part: "tooltip" }, this.extended ? this.extendedItem() : this.linkItem()));
    this.renderItem = () => {
      const currentMaxLengthLabel = this.extended ? this.maxTitleLengthWithSubItems : this.maxTitleLengthWithoutSubItems;
