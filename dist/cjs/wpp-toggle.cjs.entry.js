...
const WppToggle = class {
  ...
  render() {
    return (index.h(index.Host, { "aria-checked": this.checked, "aria-disabled": this.disabled, "aria-hidden": this.disabled ? 'true' : null, "aria-required": this.required, onClick: this.onClick, onFocus: this.onFocus, onBlur: this.onBlur, onMouseDown: this.onMouseDown, onKeyUp: this.onKeyUp, class: this.hostCssClasses(), role: "switch", tabIndex: this.disabled ? -1 : 0, exportparts: "label, input" }, index.h("wpp-label-v2-22-0", { class: this.labelCssClasses(), typography: "s-body", optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "label" }, index.h("input", { type: "checkbox", name: this.name, id: this.name, value: this.value, disabled: this.disabled, checked: this.checked, required: this.required, role: "switch", autoFocus: this.autoFocus, ref: inputRef => (this.inputRef = inputRef), "aria-label": this.ariaProps.label, class: "toggle-input", tabIndex: -1, part: "input", title: "" }))));
  }
