...
const TiptapImageUpload = index.Node3.create({
  ...
  addProseMirrorPlugins() {
    ...
    const emitUploadRequest = (type, files) => {
      ...
      if (hostElement) {
        const event = new CustomEvent(index.TIPTAP_UPLOAD_REQUEST_EVENT, {
          detail,
          bubbles: true,
          composed: false,
        });
...
const WppRichtext = class {
  constructor(hostRef) {
    ...
    this.formControlCssClasses = () => ({
      ...
      active: this.active,
      [KEYBOARD_FOCUS_CLASS]: this.active && this.focusType === common.FOCUS_TYPE.TAB,
  ...
  componentDidLoad() {
    ...
    this.host.addEventListener(index.TIPTAP_UPLOAD_REQUEST_EVENT, ((e) => {
      e.stopPropagation();
      e.preventDefault();
  ...
  renderToolbarIcon(actionName) {
    ...
    switch (actionName) {
      case 'bold':
        return index$1.h("wpp-icon-bold-v4-2-0", { ...iconProps });
      case 'italic':
        return index$1.h("wpp-icon-italic-v4-2-0", { ...iconProps });
      case 'underline':
        return index$1.h("wpp-icon-underline-v4-2-0", { ...iconProps });
      case 'strike':
        return index$1.h("wpp-icon-strike-through-v4-2-0", { ...iconProps });
      case 'codeBlock':
        return index$1.h("wpp-icon-code-view-v4-2-0", { ...iconProps });
      case 'blockquote':
        return index$1.h("wpp-icon-blockquote-v4-2-0", { ...iconProps });
      case 'orderedList':
        return index$1.h("wpp-icon-ordered-list-v4-2-0", { ...iconProps });
      case 'bulletList':
        return index$1.h("wpp-icon-unordered-list-v4-2-0", { ...iconProps });
      case 'outdent':
        return index$1.h("wpp-icon-indent-decrease-v4-2-0", { ...iconProps });
      case 'indent':
        return index$1.h("wpp-icon-indent-increase-v4-2-0", { ...iconProps });
      case 'heading1':
        return index$1.h("wpp-icon-h1-v4-2-0", { ...iconProps });
      case 'heading2':
        return index$1.h("wpp-icon-h2-v4-2-0", { ...iconProps });
      case 'alignLeft':
        return index$1.h("wpp-icon-text-alignment-left-v4-2-0", { ...iconProps });
      case 'alignCenter':
        return index$1.h("wpp-icon-text-alignment-center-v4-2-0", { ...iconProps });
      case 'alignRight':
        return index$1.h("wpp-icon-text-alignment-right-v4-2-0", { ...iconProps });
      case 'alignJustify':
        return index$1.h("wpp-icon-text-alignment-justify-v4-2-0", { ...iconProps });
      case 'link':
        return index$1.h("wpp-icon-link-v4-2-0", { ...iconProps });
      case 'image':
        return index$1.h("wpp-icon-image-v4-2-0", { ...iconProps });
      case 'video':
        return index$1.h("wpp-icon-video-clip-v4-2-0", { ...iconProps });
      case 'attachment':
        return index$1.h("wpp-icon-attach-v4-2-0", { ...iconProps });
      case 'undo':
        return index$1.h("wpp-icon-undo-v4-2-0", { ...iconProps });
      case 'redo':
        return index$1.h("wpp-icon-redo-v4-2-0", { ...iconProps });
      default:
        return null;
    }
  }
  ...
  renderFontSizePicker() {
    ...
    return (index$1.h("wpp-menu-context-v4-2-0", { class: "ql-size-menu", dropdownConfig: this.fontSizeDropdownConfig, "data-testid": "font-size-picker" }, index$1.h("wpp-action-button-v4-2-0", { slot: "trigger-element", variant: "secondary", class: "ql-size-trigger", disabled: this.disabled }, currentLabel, index$1.h("wpp-icon-chevron-v4-2-0", { slot: "icon-end", direction: this.isFontSizePickerOpen ? 'up' : 'down', size: "s" })), index$1.h("div", null, sizes.map(s => (index$1.h("wpp-list-item-v4-2-0", { checked: this.activeFontSize === s.value, onWppChangeListItem: () => this.onFontSizeChange(s.value) }, index$1.h("span", { slot: "label" }, s.label)))))));
  }
  render() {
    return (index$1.h(index$1.Host, { class: this.hostCssClasses(), "aria-disabled": this.disabled, "aria-required": this.required, "data-testid": "wpp-rich-text" }, index$1.h("wpp-richtext-icon-loader-v4-2-0", null), index$1.h("wpp-richtext-common-styles-v4-2-0", null), this.labelConfig?.text && (index$1.h("wpp-label-v4-2-0", { class: "label", htmlFor: this.name, optional: !this.required, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "label" })), index$1.h("div", { class: this.formControlCssClasses(), "data-testid": "rich-text-form" }, index$1.h("slot", { name: "editor-toolbar" }, this.parsedToolbarItems.length > 0 && (index$1.h("div", { class: "ql-toolbar ql-wpp", role: "toolbar", "aria-label": "Text formatting" }, this.parsedToolbarItems.map(group => {
      if (group.length === 0)
        return null;
      ...
      ? [
        index$1.h("wpp-input-v4-2-0", { key: "link-input", size: "s", type: "text", placeholder: "https://", value: this.linkPromptValue, onWppChange: this.onLinkPromptInput, onKeyDown: this.onLinkPromptKeyDown, "data-testid": "richtext-link-prompt-input" }),
        index$1.h("wpp-action-button-v4-2-0", { key: "link-save", class: "ql-action ql-save", variant: "primary", onClick: this.onLinkPromptSave, "data-testid": "richtext-link-prompt-save" }, "Save"),
      ]
      : [
