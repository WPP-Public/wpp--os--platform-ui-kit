...
const WppIconAdd = class {
  ...
  render() {
    return (index.h(WppIcon.WppIcon, { name: "wpp-icon-cross", width: this.width, height: this.height, size: this.size, color: this.color }, index.h("path", { d: "M11 4C11 3.44772 10.5523 3 10 3C9.44772 3 9 3.44772 9 4V9H4C3.44772 9 3 9.44772 3 10C3 10.5523 3.44772 11 4 11H9V16C9 16.5523 9.44772 17 10 17C10.5523 17 11 16.5523 11 16V11H16C16.5523 11 17 10.5523 17 10C17 9.44772 16.5523 9 16 9H11V4Z", fill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-add-v4-1-0"; }
};
WppIconAdd.style = wppIconCss;

exports.wpp_icon_add = WppIconAdd;
