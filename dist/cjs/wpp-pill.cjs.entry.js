...
const WppPill = class {
  constructor(hostRef) {
    ...
    this.renderLabel = () => {
      ...
      return shouldShowTooltip ? (index.h("wpp-tooltip-v4-0-0", { text: originalLabel, disabled: this.disabled }, labelNode)) : (labelNode);
    };
    this.setLabelRef = (el) => {
      if (el === this.labelRef)
        return;
