...
const returnIconFromExtension = (fileExtension, thumbnailUrl) => {
  ...
  switch (fileExtension) {
    // Text
    case '.txt':
      return index.h("wpp-icon-document-v4-0-0", null);
    // Compressed
    case '.zip':
    case '.rar':
    case '.7z':
      return index.h("wpp-icon-file-zip-v4-0-0", null);
    // Image
    case '.png':
    case '.jpg':
    case '.jpeg':
    case '.svg':
    case '.gif':
      return index.h("wpp-icon-image-v4-0-0", null);
    // Video
    case '.mp4':
    case '.mov':
    case '.avi':
    ...
    case '.flv':
    case '.webm':
      return index.h("wpp-icon-video-clip-v4-0-0", null);
    // Audio
    case '.mp3':
    case '.wav':
    case '.ogg':
    ...
    case '.m4a':
    case '.aac':
      return index.h("wpp-icon-music-v4-0-0", null);
    // Data
    case '.csv':
    case '.json':
    case '.xml':
    ...
    case '.sqlite':
    case '.dat':
      return index.h("wpp-icon-database-v4-0-0", null);
    // Presentation
    case '.pptx':
    case '.key':
    case '.odp':
    ...
    case '.sldx':
    case '.ppt':
      return index.h("wpp-icon-pitch-v4-0-0", null);
    // Spreadsheet
    case '.xlsx':
    case '.xls':
    case '.ods':
    case '.numbers':
    case '.tsv':
      return index.h("wpp-icon-spreadsheet-v4-0-0", null);
    default:
      return index.h("wpp-icon-file-v4-0-0", null);
  }
};
