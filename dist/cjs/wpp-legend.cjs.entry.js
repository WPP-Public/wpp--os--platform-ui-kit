...
const WppLegend = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses() }, index.h("svg", { class: this.dotCssClasses() }, index.h("circle", { cx: 6, cy: 6, r: 5, fill: this.color })), this.label && (index.h("wpp-typography-v3-3-0", { color: this.disabled ? 'var(--wpp-grey-color-500)' : 'var(--wpp-grey-color-1000)', type: "xs-body" }, this.label))));
  }
