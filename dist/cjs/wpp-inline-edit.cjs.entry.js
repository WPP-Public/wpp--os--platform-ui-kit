...
const WppInlineEdit = class {
  constructor(hostRef) {
    ...
    this.renderViewContent = () => {
      ...
      return shouldShowTooltip ? (index.h("wpp-tooltip-v4-2-0", { class: "view-tooltip", text: this.value }, this.renderViewText())) : (this.renderViewText());
    };
    this.renderTriggerElement = () => (index.h("div", { tabIndex: 0, role: "button", class: "trigger", "aria-label": this.value || this.placeholder }, this.mode === types.InlineEditModeEnum.EDIT ? (index.h("div", { class: "wrapper", part: "wrapper" }, index.h("div", { class: "form-element", onKeyDown: this.onKeyDownFormEl }, index.h("slot", { name: "form-element" })))) : (index.h("div", { class: "content", onClick: () => this.emitModeChange(types.InlineEditModeEnum.EDIT), part: "content" }, index.h("div", { class: "content-bg", part: "content-bg" }), this.renderViewContent(), index.h("wpp-icon-edit-v4-2-0", { "aria-hidden": "true" })))));
  ...
  render() {
    ...
    return (index.h(index.Host, { class: this.inlineEditCssClasses(), exportparts: "label, wrapper, input, textarea, buttons, view-text, content, content-bg" }, index.h("wpp-popover-v4-2-0", { ref: ref => (this.popoverRef = ref), externalClass: "inline-edit-popover", exportparts: "content", class: this.inlineEditPopoverCssClasses(), style: { width: inlineWidth ? this.inputWidth : '' }, config: {
      ...
      } }, index.h("div", { slot: "trigger-element", ref: elRef => (this.triggerContainerRef = elRef), class: "trigger-element" }, this.errorMessage && this.mode === types.InlineEditModeEnum.EDIT ? (index.h("wpp-tooltip-v4-2-0", { class: 'wpp-anchor-toolip', error: true, text: this.errorMessage, config: {
        showOnCreate: true,
        onCreate: instance => {
      ...
      } }, this.renderTriggerElement())) : (this.renderTriggerElement())), index.h("div", { class: "wpp-buttons-container", part: "buttons" }, index.h("wpp-action-button-v4-2-0", { disabled: this.isPendingRequest || this.value === this.lastValueWithError, variant: "inverted", onClick: this.handleAccept }, index.h("wpp-icon-done-v4-2-0", { slot: "icon-start" })), index.h("wpp-action-button-v4-2-0", { disabled: this.isPendingRequest, variant: "inverted", onClick: e => this.handleClose(e, 'cancel') }, index.h("wpp-icon-cross-v4-2-0", { slot: "icon-start" }))))));
  }
