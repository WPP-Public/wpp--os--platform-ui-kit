...
const WppModal = class {
  constructor(hostRef) {
    ...
    this.renderActionBtn = (btnConfig, variant) => {
      ...
      return (index.h("wpp-button-v4-2-0", { size: "s", variant: variant, ...rest }, label));
    };
