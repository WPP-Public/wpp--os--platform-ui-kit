...
const WppTooltip$1 = class {
  constructor(hostRef) {
    ...
    this.getIconBasedOnProps = () => {
      if (this.error) {
        return index.h("wpp-icon-error-v4-3-0", { class: "left-icon", part: "icon-error" });
      }
      if (this.warning) {
        return index.h("wpp-icon-warning-v4-3-0", { color: "var(--wpp-warning-color-400)", class: "left-icon" });
      }
      return null;
    };
    this.getTextLines = () => {
