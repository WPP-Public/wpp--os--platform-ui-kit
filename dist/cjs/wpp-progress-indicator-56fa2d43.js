...
const WppProgressIndicator = class {
  ...
  render() {
    ...
    const renderLine = () => (index.h("div", { class: this.lineCssClasses(isShowCircleInfinityLoading, isShowLinearInfinityLoading, shouldShowPercentage), role: "progressbar", "aria-valuenow": this.value, "aria-valuemin": "0", "aria-valuemax": "100", part: "line" }));
    ...
    return (index.h(index.Host, { class: this.hostCssClasses(isLinearDontHaveWidth), role: "progressbar", "aria-valuenow": this.value, "aria-valuemin": "0", "aria-valuemax": "100", exportparts: "label, content, inner" }, index.h("div", { class: this.progressBarCssClasses(isLinearDontHaveProgress, shouldShowPercentage), part: "body" }, isCircle ? renderCircle() : renderLine()), !!this.label && (index.h("p", { class: "progress-text", part: "label" }, this.label))));
  }
