...
const WppIconCaptionOff = class {
  ...
  static get registryIs() { return "wpp-icon-caption-off-v3-6-0"; }
};
...
const WppIconCaptionOn = class {
  ...
  static get registryIs() { return "wpp-icon-caption-on-v3-6-0"; }
};
...
const WppIconFullscreen = class {
  ...
  static get registryIs() { return "wpp-icon-fullscreen-v3-6-0"; }
};
...
const WppIconFullscreenMinimise = class {
  ...
  static get registryIs() { return "wpp-icon-fullscreen-minimise-v3-6-0"; }
};
...
const WppIconPauseFilled = class {
  ...
  static get registryIs() { return "wpp-icon-pause-filled-v3-6-0"; }
};
...
const WppIconSpeaker = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-v3-6-0"; }
};
...
const WppIconSpeakerMute = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-mute-v3-6-0"; }
};
