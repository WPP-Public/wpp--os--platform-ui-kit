...
const WppIconCaptionOn = class {
  ...
  static get registryIs() { return "wpp-icon-caption-on-v3-4-0"; }
};
...
const WppIconFullscreen = class {
  ...
  static get registryIs() { return "wpp-icon-fullscreen-v3-4-0"; }
};
...
const WppIconPauseFilled = class {
  ...
  static get registryIs() { return "wpp-icon-pause-filled-v3-4-0"; }
};
...
const WppIconPlayFilled = class {
  ...
  static get registryIs() { return "wpp-icon-play-filled-v3-4-0"; }
};
...
const WppIconSpeaker = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-v3-4-0"; }
};
...
const WppIconSpeakerMute = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-mute-v3-4-0"; }
};
