...
const WppIconFullscreen = class {
  ...
  render() {
    return (index.h(WppIcon.WppIcon, { name: "wpp-icon-fullscreen", width: this.width, height: this.height, size: this.size, color: this.color }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M4.79167 2.375C3.45704 2.375 2.375 3.45704 2.375 4.79167V7.29167C2.375 7.70588 2.71079 8.04167 3.125 8.04167C3.53921 8.04167 3.875 7.70588 3.875 7.29167V4.79167C3.875 4.28546 4.28546 3.875 4.79167 3.875H7.29167C7.70588 3.875 8.04167 3.53921 8.04167 3.125C8.04167 2.71079 7.70588 2.375 7.29167 2.375H4.79167ZM17.625 12.7084C17.625 12.2942 17.2893 11.9584 16.875 11.9584C16.4608 11.9584 16.125 12.2942 16.125 12.7084V15.2084C16.125 15.7146 15.7146 16.125 15.2084 16.125H12.7084C12.2942 16.125 11.9584 16.4608 11.9584 16.875C11.9584 17.2893 12.2942 17.625 12.7084 17.625H15.2084C16.543 17.625 17.625 16.543 17.625 15.2084V12.7084ZM11.9584 3.125C11.9584 2.71079 12.2942 2.375 12.7084 2.375H15.2084C16.543 2.375 17.625 3.45704 17.625 4.79167V7.29167C17.625 7.70588 17.2893 8.04167 16.875 8.04167C16.4608 8.04167 16.125 7.70588 16.125 7.29167V4.79167C16.125 4.28546 15.7146 3.875 15.2084 3.875H12.7084C12.2942 3.875 11.9584 3.53921 11.9584 3.125ZM3.875 12.7084C3.875 12.2942 3.53921 11.9584 3.125 11.9584C2.71079 11.9584 2.375 12.2942 2.375 12.7084V15.2084C2.375 16.543 3.45704 17.625 4.79167 17.625H7.29167C7.70588 17.625 8.04167 17.2893 8.04167 16.875C8.04167 16.4608 7.70588 16.125 7.29167 16.125H4.79167C4.28546 16.125 3.875 15.7146 3.875 15.2084V12.7084Z", fill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-fullscreen-v3-3-0"; }
};
WppIconFullscreen.style = wppIconCss$5;

const wppIconCss$4 = ":host{display:-ms-inline-flexbox;display:inline-flex;color:var(--wpp-prop-icon-color)}";

const WppIconFullscreenMinimise = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.size = 'm';
    this.width = undefined;
...
const WppIconPauseFilled = class {
  ...
  render() {
    return (index.h(WppIcon.WppIcon, { name: "wpp-icon-pause-filled", width: this.width, height: this.height, size: this.size, color: this.color }, index.h("path", { d: "M4.375 2.5C3.33945 2.5 2.5 3.33948 2.5 4.375V15.625C2.5 16.6605 3.33945 17.5 4.375 17.5H6.25C7.28555 17.5 8.125 16.6605 8.125 15.625V4.375C8.125 3.33948 7.28555 2.5 6.25 2.5H4.375ZM13.75 2.5C12.7145 2.5 11.875 3.33948 11.875 4.375V15.625C11.875 16.6605 12.7145 17.5 13.75 17.5H15.625C16.6605 17.5 17.5 16.6605 17.5 15.625V4.375C17.5 3.33948 16.6605 2.5 15.625 2.5H13.75Z", fill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-pause-filled-v3-3-0"; }
};
WppIconPauseFilled.style = wppIconCss$3;

const wppIconCss$2 = ":host{display:-ms-inline-flexbox;display:inline-flex;color:var(--wpp-prop-icon-color)}";

const WppIconPlayFilled = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.size = 'm';
    this.width = undefined;
  ...
  render() {
    return (index.h(WppIcon.WppIcon, { name: "wpp-icon-play-filled", width: this.width, height: this.height, size: this.size, color: this.color }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M6.23868 2.26663L17.5989 8.69445C18.614 9.2688 18.614 10.7311 17.5989 11.3055L6.23868 17.7333C5.23874 18.2991 4 17.5767 4 16.4278V3.57214C4 2.42323 5.23874 1.70085 6.23868 2.26663Z", fill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-play-filled-v3-3-0"; }
};
WppIconPlayFilled.style = wppIconCss$2;
...
const WppIconSpeaker = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-v3-3-0"; }
};
WppIconSpeaker.style = wppIconCss$1;

const wppIconCss = ":host{display:-ms-inline-flexbox;display:inline-flex;color:var(--wpp-prop-icon-color)}";

const WppIconSpeakerMute = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.size = 'm';
    this.width = undefined;
  ...
  render() {
    return (index.h(WppIcon.WppIcon, { name: "wpp-icon-speaker-mute", width: this.width, height: this.height, size: this.size, color: this.color }, index.h("path", { d: "M10.7356 3.05442C11.3804 2.48108 12.4 2.93886 12.4 3.80176V16.1982C12.4 17.0612 11.3804 17.5189 10.7355 16.9455L7.14234 13.7506C7.0325 13.6529 6.89063 13.599 6.74365 13.599H3.8C2.80589 13.599 2 12.7931 2 11.799V8.20063C2 7.20651 2.80589 6.40063 3.8 6.40063H6.74369C6.89066 6.40063 7.03252 6.34668 7.14235 6.24903L10.7356 3.05442ZM11.2 4.24719L7.93968 7.14584C7.61017 7.4388 7.1846 7.60063 6.74369 7.60063H3.8C3.46863 7.60063 3.2 7.86926 3.2 8.20063V11.799C3.2 12.1303 3.46863 12.399 3.8 12.399H6.74365C7.1846 12.399 7.6102 12.5608 7.93972 12.8538L11.2 15.7528V4.24719ZM13.3757 7.77751C13.6101 7.54319 13.99 7.54319 14.2243 7.77751L15.6 9.15324L16.9757 7.77751C17.2101 7.54319 17.5899 7.54319 17.8243 7.77751C18.0586 8.01182 18.0586 8.39172 17.8243 8.62604L16.4485 10.0018L17.8243 11.3775C18.0586 11.6118 18.0586 11.9917 17.8243 12.226C17.5899 12.4603 17.2101 12.4603 16.9757 12.226L15.6 10.8503L14.2243 12.226C13.9899 12.4603 13.6101 12.4603 13.3757 12.226C13.1414 11.9917 13.1414 11.6118 13.3757 11.3775L14.7515 10.0018L13.3757 8.62604C13.1414 8.39172 13.1414 8.01182 13.3757 7.77751Z", fill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-speaker-mute-v3-3-0"; }
};
WppIconSpeakerMute.style = wppIconCss;

exports.wpp_icon_caption_off = WppIconCaptionOff;
exports.wpp_icon_caption_on = WppIconCaptionOn;
exports.wpp_icon_fullscreen = WppIconFullscreen;
exports.wpp_icon_fullscreen_minimise = WppIconFullscreenMinimise;
exports.wpp_icon_pause_filled = WppIconPauseFilled;
exports.wpp_icon_play_filled = WppIconPlayFilled;
exports.wpp_icon_speaker = WppIconSpeaker;
exports.wpp_icon_speaker_mute = WppIconSpeakerMute;
