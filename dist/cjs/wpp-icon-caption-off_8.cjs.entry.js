...
const WppIconCaptionOff = class {
  ...
  static get registryIs() { return "wpp-icon-caption-off-v3-3-1"; }
};
...
const WppIconCaptionOn = class {
  ...
  static get registryIs() { return "wpp-icon-caption-on-v3-3-1"; }
};
...
const WppIconFullscreen = class {
  ...
  static get registryIs() { return "wpp-icon-fullscreen-v3-3-1"; }
};
...
const WppIconFullscreenMinimise = class {
  ...
  static get registryIs() { return "wpp-icon-fullscreen-minimise-v3-3-1"; }
};
...
const WppIconPlayFilled = class {
  ...
  static get registryIs() { return "wpp-icon-play-filled-v3-3-1"; }
};
...
const WppIconSpeaker = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-v3-3-1"; }
};
...
const WppIconSpeakerMute = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-mute-v3-3-1"; }
};
