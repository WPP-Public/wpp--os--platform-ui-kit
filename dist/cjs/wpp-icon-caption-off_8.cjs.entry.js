...
const WppIconCaptionOff = class {
  ...
  static get registryIs() { return "wpp-icon-caption-off-v4-1-0"; }
};
...
const WppIconFullscreenMinimise = class {
  ...
  static get registryIs() { return "wpp-icon-fullscreen-minimise-v4-1-0"; }
};
...
const WppIconPauseFilled = class {
  ...
  static get registryIs() { return "wpp-icon-pause-filled-v4-1-0"; }
};
...
const WppIconPlayFilled = class {
  ...
  static get registryIs() { return "wpp-icon-play-filled-v4-1-0"; }
};
...
const WppIconSpeaker = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-v4-1-0"; }
};
...
const WppIconSpeakerMute = class {
  ...
  static get registryIs() { return "wpp-icon-speaker-mute-v4-1-0"; }
};
