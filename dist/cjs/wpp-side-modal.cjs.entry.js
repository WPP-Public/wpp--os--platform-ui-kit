...
const WppSideModal = class {
  constructor(hostRef) {
    ...
    this.wppSideModalOpen = index.createEvent(this, "wppSideModalOpen", 1);
    ...
    this.renderLeftButton = () => {
      ...
      return (index.h("div", { class: "left-button-container" }, index.h("wpp-action-button-v3-4-0", { ...rest }, index.h(utils.transformToVersionedTag(icon), { slot: 'icon-start' }), label)));
    };
    this.renderRightButtons = () => {
      ...
      return (index.h("div", { class: "right-button-container" }, this.rightButtonsConfig.map((rightButtonConfigItem) => {
        ...
        return (index.h("wpp-button-v3-4-0", { size: "m", ...rest }, label));
      })));
    };
    ...
    this.renderHeaderActionButtons = () => (index.h("div", { class: "header-action-buttons-container" }, this.headerActionsConfig?.map(button => {
      ...
      return (index.h("wpp-action-button-v3-4-0", { variant: "secondary", ...rest }, index.h(utils.transformToVersionedTag(icon), { slot: 'icon-start' })));
    })));
    this.renderBody = () => {
      const Tag = this.formConfig ? 'form' : 'div';
      return (index.h(Tag, { part: "content", role: "dialog", class: this.sideModalCssClasses(), ...this.formConfig, "data-testid": "wpp-side-modal-content" }, index.h("div", { class: this.headerContainerCssClasses(), part: "header-container" }, this.withBackButton ? (index.h("div", { class: "header-with-back-button", part: "header-with-back-button" }, index.h("wpp-action-button-v3-4-0", { variant: "secondary", onClick: this.handleBackButtonClick, class: "back-button", part: "back-button" }, index.h("wpp-icon-chevron-v3-4-0", { direction: "left", slot: "icon-start", part: "icon-chevron" })), index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.headerCssClasses(), name: "header", onSlotchange: this.updateSlotData }))) : (index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.headerCssClasses(), name: "header", onSlotchange: this.updateSlotData })), this.headerActionsConfig?.length > 0 && this.renderHeaderActionButtons(), index.h("wpp-action-button-v3-4-0", { variant: "secondary", onClick: this.handleCloseModal, class: "close-button", part: "button" }, index.h("wpp-icon-cross-v3-4-0", { slot: "icon-start", part: "icon-cross" }))), index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.bodyCssClasses(), name: "body", onSlotchange: this.updateSlotData }), this.hasActionsSlot ? (index.h(WrappedSlot.WrappedSlot, { wrapperClass: this.actionsCssClasses(), name: "actions", onSlotchange: this.updateSlotData })) : (this.actionsConfig &&
        this.actionsConfig.length > 0 && (index.h("div", { class: this.actionsCssClasses(), part: "actions" }, this.renderLeftButton(), this.renderRightButtons())))));
    };
