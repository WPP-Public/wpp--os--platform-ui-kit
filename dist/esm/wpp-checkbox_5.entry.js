...
export { W as wpp_icon_chevron } from './wpp-icon-chevron-d5e8c4f1.js';
import { W as WppIcon } from './WppIcon-f4802cc9.js';
import { h as highlightWords } from './highlight-words-e56d0d41.js';
import { W as WrappedSlot } from './WrappedSlot-2ee5325a.js';
import { u as uuidv4, k as transformToVersionedTag, g as getSlotEmptyStates, d as debounce } from './utils-b49ad9c8.js';
...
const WppCheckbox = class {
  ...
  render() {
    if (this.decorative)
      return (h(Host, { class: this.hostCssClasses(), "aria-hidden": "true", role: "presentation", tabindex: "-1", exportparts: "body, input, square, icon-tick, icon-dash, message", name: this.name }, h("wpp-label-v3-3-1", { class: this.labelCssClasses(), typography: "s-body", optional: !this.required, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "body" }, h("div", { class: "square", part: "square" }), h("wpp-icon-tick-v3-3-1", { part: "icon-tick" }), h("wpp-icon-dash-v3-3-1", { part: "icon-dash" })), !!this.message && (h("wpp-inline-message-v3-3-1", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, part: "message" }))));
    return (h(Host, { class: this.hostCssClasses(), onKeyUp: this.onKeyUp, onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, exportparts: "body, input, square, icon-tick, icon-dash, message", name: this.name }, h("wpp-label-v3-3-1", { class: this.labelCssClasses(), typography: "s-body", optional: !this.required, htmlFor: this.name, disabled: this.disabled, onClick: this.onClick, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "body" }, h("input", { class: this.inputCssClasses(), type: "checkbox", id: this.name, name: this.name, disabled: this.disabled, checked: this.checked || this.indeterminate, required: this.required, onFocus: this.onFocus, onBlur: this.onBlur, autoFocus: this.autoFocus, ref: inputRef => (this.inputRef = inputRef), "aria-label": this.ariaProps.label, "aria-hidden": this.disabled ? 'true' : null, "aria-required": this.required.toString(), tabindex: this.disabled ? '-1' : this.index, part: "input" }), h("div", { class: "square", part: "square" }), h("wpp-icon-tick-v3-3-1", { part: "icon-tick" }), h("wpp-icon-dash-v3-3-1", { part: "icon-dash" })), !!this.message && (h("wpp-inline-message-v3-3-1", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, part: "message" }))));
  }
  static get registryIs() { return "wpp-checkbox-v3-3-1"; }
...
const WppIconDash = class {
  ...
  static get registryIs() { return "wpp-icon-dash-v3-3-1"; }
};
...
const WppListItem = class {
  constructor(hostRef) {
    ...
    this.renderRightSlot = () => (h(WrappedSlot, { wrapperClass: this.rightSlotCssClasses(), name: "right", onSlotchange: this.updateSlotData, onClick: this.handleRightWrapperClick }, this.isExtended && h("wpp-icon-chevron-v3-3-1", { class: "fallback-icon", size: "s", part: "icon-extended" }), !this.isExtended && this.active && h("wpp-icon-tick-v3-3-1", { class: "fallback-icon", part: "icon-active" })));
