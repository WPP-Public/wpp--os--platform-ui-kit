...
export { W as wpp_icon_chevron } from './wpp-icon-chevron-d46d5422.js';
import { W as WppIcon } from './WppIcon-f4802cc9.js';
import { h as highlightWords } from './highlight-words-e56d0d41.js';
import { W as WrappedSlot } from './WrappedSlot-2ee5325a.js';
import { u as uuidv4, k as transformToVersionedTag, g as getSlotEmptyStates, d as debounce } from './utils-fb733700.js';
...
const WppListItem = class {
  constructor(hostRef) {
    ...
    this.renderRightSlot = () => (h(WrappedSlot, { wrapperClass: this.rightSlotCssClasses(), name: "right", onSlotchange: this.updateSlotData, onClick: this.handleRightWrapperClick }, this.isExtended && h("wpp-icon-chevron-v3-4-0", { class: "fallback-icon", size: "s", part: "icon-extended" }), !this.isExtended && this.active && h("wpp-icon-tick-v3-4-0", { class: "fallback-icon", part: "icon-active" })));
