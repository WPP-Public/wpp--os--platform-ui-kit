...
const WppIconBold = class {
  ...
  static get registryIs() { return "wpp-icon-bold-v3-6-0"; }
};
...
const WppIconCodeView = class {
  ...
  static get registryIs() { return "wpp-icon-code-view-v3-6-0"; }
};
...
const WppIconFloatLeft = class {
  ...
  static get registryIs() { return "wpp-icon-float-left-v3-6-0"; }
};
...
const WppIconFloatRight = class {
  ...
  static get registryIs() { return "wpp-icon-float-right-v3-6-0"; }
};
...
const WppIconH1 = class {
  ...
  static get registryIs() { return "wpp-icon-h1-v3-6-0"; }
};
...
const WppIconH2 = class {
  ...
  static get registryIs() { return "wpp-icon-h2-v3-6-0"; }
};
...
const WppIconIndentDecrease = class {
  ...
  static get registryIs() { return "wpp-icon-indent-decrease-v3-6-0"; }
};
...
const WppIconIndentIncrease = class {
  ...
  static get registryIs() { return "wpp-icon-indent-increase-v3-6-0"; }
};
...
const WppIconItalic = class {
  ...
  static get registryIs() { return "wpp-icon-italic-v3-6-0"; }
};
...
const WppIconLink = class {
  ...
  static get registryIs() { return "wpp-icon-link-v3-6-0"; }
};
...
const WppIconOrderedList = class {
  ...
  static get registryIs() { return "wpp-icon-ordered-list-v3-6-0"; }
};
...
const WppIconRedo = class {
  ...
  static get registryIs() { return "wpp-icon-redo-v3-6-0"; }
};
...
const WppIconStrikeThrough = class {
  ...
  static get registryIs() { return "wpp-icon-strike-through-v3-6-0"; }
};
...
const WppIconTextAlignmentLeft = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-left-v3-6-0"; }
};
...
const WppIconTextAlignmentRight = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-right-v3-6-0"; }
};
...
const WppIconUndo = class {
  ...
  static get registryIs() { return "wpp-icon-undo-v3-6-0"; }
};
...
const WppIconUnorderedList = class {
  ...
  static get registryIs() { return "wpp-icon-unordered-list-v3-6-0"; }
};
