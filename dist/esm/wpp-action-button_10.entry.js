export { W as wpp_action_button } from './wpp-action-button-f11ae9a2.js';
import { r as registerInstance, h, H as Host, g as getElement, F as Fragment } from './index-9177bb6d.js';
import { W as WppIcon } from './WppIcon-f4802cc9.js';
import { g as getSlotEmptyStates, w as getHighestContainerInDOM, z as isWppElement } from './utils-3463d13f.js';
...
import { t as themeSubscriptionController, a as themeObserver } from './subscribe-to-theme-2f801cf6.js';
...
const WppIconCross = class {
  ...
  static get registryIs() { return "wpp-icon-cross-v4-1-0"; }
};
WppIconCross.style = wppIconCss$3;
...
const WppIconError = class {
  ...
  static get registryIs() { return "wpp-icon-error-v4-1-0"; }
};
WppIconError.style = wppIconCss$2;
...
const WppIconInfoMessage = class {
  ...
  static get registryIs() { return "wpp-icon-info-message-v4-1-0"; }
};
...
const WppIconWarning = class {
  ...
  static get registryIs() { return "wpp-icon-warning-v4-1-0"; }
};
...
const WppInternalLabel = class {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), onKeyUp: this.onKeyUp, onBlur: this.onBlur, exportparts: "info-wrapper, text, optional-text, tooltip, icon, icon-wrapper" }, !!this.labelText && (h("div", { class: this.infoWrapperCssClasses(), part: "info-wrapper", role: this.role }, h("wpp-typography-v4-1-0", { type: this.typography, class: "text", part: "text" }, this.labelText), this.optional && (h("wpp-typography-v4-1-0", { type: "s-body", class: "optional", part: "optional-text" }, "(", this._locales.optional, ")")))), !!this.description && this.hasIconSlot ? (h("wpp-tooltip-v4-1-0", { class: "tooltip", text: this.description, config: this.tooltipConfig, part: "tooltip" }, h(WrappedSlot, { wrapperClass: this.iconCssClasses(), name: "icon", onSlotchange: this.updateSlotData, role: this.tooltipConfig.tabIndex === -1 ? 'none' : 'button', tabIndex: this.tooltipConfig.tabIndex ?? 0, "aria-label": this.tooltipConfig.tabIndex !== -1 ? 'Show info' : undefined }))) : (h(WrappedSlot, { wrapperClass: this.iconCssClasses(), name: "icon", onSlotchange: this.updateSlotData, role: "button", tabIndex: 0, "aria-label": "Show info" }))));
  }
  static get registryIs() { return "wpp-internal-label-v4-1-0"; }
...
const WppTooltip$1 = class {
  constructor(hostRef) {
    ...
    this.getIconBasedOnProps = () => {
      if (this.error) {
        return h("wpp-icon-error-v4-1-0", { class: "left-icon", part: "icon-error" });
      }
      if (this.warning) {
        return h("wpp-icon-warning-v4-1-0", { color: "var(--wpp-warning-color-400)", class: "left-icon" });
      }
      return null;
    };
    this.getTextLines = () => {
  ...
  static get registryIs() { return "wpp-internal-tooltip-v4-1-0"; }
  get host() { return getElement(this); }
};
...
export { WppIconCross as wpp_icon_cross, WppIconError as wpp_icon_error, WppIconInfoMessage as wpp_icon_info_message, WppIconWarning as wpp_icon_warning, WppInternalLabel as wpp_internal_label, WppTooltip$1 as wpp_internal_tooltip, WppSpinner as wpp_spinner, WppTooltip as wpp_tooltip, WppTypography as wpp_typography };
