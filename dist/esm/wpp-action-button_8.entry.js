...
import { g as getSlotEmptyStates, l as closestElement, z as getAriaProps, w as getHighestContainerInDOM, A as isWppElement } from './utils-fc9002c9.js';
...
const WppTooltip$1 = class {
  constructor(hostRef) {
    ...
    this.getIconBasedOnProps = () => {
      if (this.error) {
        return h("wpp-icon-error-v4-2-0", { class: "left-icon", part: "icon-error" });
      }
      if (this.warning) {
        return h("wpp-icon-warning-v4-2-0", { color: "var(--wpp-warning-color-400)", class: "left-icon" });
      }
      return null;
    };
    this.getTextLines = () => {
