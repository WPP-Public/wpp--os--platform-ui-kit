...
const wppIconCss$n = ":host{display:-ms-inline-flexbox;display:inline-flex;color:var(--wpp-prop-icon-color)}";

const WppIconAttach = class {
  constructor(hostRef) {
  ...
  static get registryIs() { return "wpp-icon-attach-v4-2-0"; }
};
WppIconAttach.style = wppIconCss$n;

const wppIconCss$m = ":host{display:-ms-inline-flexbox;display:inline-flex;color:var(--wpp-prop-icon-color)}";
...
const WppIconBlockquote = class {
  ...
  static get registryIs() { return "wpp-icon-blockquote-v4-2-0"; }
};
WppIconBlockquote.style = wppIconCss$m;
...
const WppIconBold = class {
  ...
  static get registryIs() { return "wpp-icon-bold-v4-2-0"; }
};
WppIconBold.style = wppIconCss$l;
...
const WppIconCodeView = class {
  ...
  static get registryIs() { return "wpp-icon-code-view-v4-2-0"; }
};
WppIconCodeView.style = wppIconCss$k;
...
const WppIconFloatCenter = class {
  ...
  static get registryIs() { return "wpp-icon-float-center-v4-2-0"; }
};
WppIconFloatCenter.style = wppIconCss$j;
...
const WppIconFloatLeft = class {
  ...
  static get registryIs() { return "wpp-icon-float-left-v4-2-0"; }
};
WppIconFloatLeft.style = wppIconCss$i;
...
const WppIconFloatRight = class {
  ...
  static get registryIs() { return "wpp-icon-float-right-v4-2-0"; }
};
WppIconFloatRight.style = wppIconCss$h;
...
const WppIconH1 = class {
  ...
  static get registryIs() { return "wpp-icon-h1-v4-2-0"; }
};
WppIconH1.style = wppIconCss$g;
...
const WppIconIndentDecrease = class {
  ...
  static get registryIs() { return "wpp-icon-indent-decrease-v4-2-0"; }
};
WppIconIndentDecrease.style = wppIconCss$e;
...
const WppIconIndentIncrease = class {
  ...
  static get registryIs() { return "wpp-icon-indent-increase-v4-2-0"; }
};
WppIconIndentIncrease.style = wppIconCss$d;

const wppIconCss$c = ":host{display:-ms-inline-flexbox;display:inline-flex;color:var(--wpp-prop-icon-color)}";

const WppIconInfo = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.size = 'm';
    this.width = undefined;
  ...
  render() {
    return (h(WppIcon, { name: "wpp-icon-info", width: this.width, height: this.height, size: this.size, color: this.color }, h("path", { d: "M10.4919 8.9101C10.4495 8.67686 10.2454 8.49998 9.99992 8.49998C9.72378 8.49998 9.49992 8.72384 9.49992 8.99998V13.5021L9.50797 13.592C9.55031 13.8253 9.75446 14.0021 9.99992 14.0021C10.2761 14.0021 10.4999 13.7783 10.4999 13.5021V8.99998L10.4919 8.9101ZM10.7986 6.74998C10.7986 6.33577 10.4628 5.99998 10.0486 5.99998C9.63442 5.99998 9.29863 6.33577 9.29863 6.74998C9.29863 7.16419 9.63442 7.49998 10.0486 7.49998C10.4628 7.49998 10.7986 7.16419 10.7986 6.74998ZM17.9998 9.99999C17.9998 5.58171 14.4181 1.99999 9.9998 1.99999C5.58153 1
ill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-info-v4-2-0"; }
};
WppIconInfo.style = wppIconCss$c;
...
const WppIconItalic = class {
  ...
  static get registryIs() { return "wpp-icon-italic-v4-2-0"; }
};
...
const WppIconLink = class {
  ...
  static get registryIs() { return "wpp-icon-link-v4-2-0"; }
};
...
const WppIconRedo = class {
  ...
  static get registryIs() { return "wpp-icon-redo-v4-2-0"; }
};
...
const WppIconTextAlignmentCenter = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-center-v4-2-0"; }
};
...
const WppIconTextAlignmentJustify = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-justify-v4-2-0"; }
};
...
const WppIconTextAlignmentLeft = class {
  ...
  render() {
    return (h(WppIcon, { name: "wpp-icon-text-alignment-left", width: this.width, height: this.height, size: this.size, color: this.color }, h("path", { d: "M2 4.25C2 3.83579 2.33579 3.5 2.75 3.5H13.25C13.6642 3.5 14 3.83579 14 4.25C14 4.66421 13.6642 5 13.25 5H2.75C2.33579 5 2 4.66421 2 4.25ZM2 9.25C2 8.83579 2.33579 8.5 2.75 8.5H17.25C17.6642 8.5 18 8.83579 18 9.25C18 9.66421 17.6642 10 17.25 10H2.75C2.33579 10 2 9.66421 2 9.25ZM2.75 13.5C2.33579 13.5 2 13.8358 2 14.25C2 14.6642 2.33579 15 2.75 15H11.25C11.6642 15 12 14.6642 12 14.25C12 13.8358 11.6642 13.5 11.25 13.5H2.75Z", fill: "currentColor" })));
  }
  static get registryIs() { return "wpp-icon-text-alignment-left-v4-2-0"; }
};
...
const WppIconTextAlignmentRight = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-right-v4-2-0"; }
};
...
const WppIconUnderline = class {
  ...
  static get registryIs() { return "wpp-icon-underline-v4-2-0"; }
};
...
const WppIconUndo = class {
  ...
  static get registryIs() { return "wpp-icon-undo-v4-2-0"; }
};
...
const WppIconUnorderedList = class {
  ...
  static get registryIs() { return "wpp-icon-unordered-list-v4-2-0"; }
};
WppIconUnorderedList.style = wppIconCss;

export { WppIconAttach as wpp_icon_attach, WppIconBlockquote as wpp_icon_blockquote, WppIconBold as wpp_icon_bold, WppIconCodeView as wpp_icon_code_view, WppIconFloatCenter as wpp_icon_float_center, WppIconFloatLeft as wpp_icon_float_left, WppIconFloatRight as wpp_icon_float_right, WppIconH1 as wpp_icon_h1, WppIconH2 as wpp_icon_h2, WppIconIndentDecrease as wpp_icon_indent_decrease, WppIconIndentIncrease as wpp_icon_indent_increase, WppIconInfo as wpp_icon_info, WppIconItalic as wpp_icon_italic, WppIconLink as wpp_icon_link, WppIconOrderedList as wpp_icon_ordered_list, WppIconRedo as wpp_icon_redo, WppIconStrikeThrough as wpp_icon_strike_through, WppIconTextAlignmentCenter as wpp_icon_text_alignment_center, WppIconTextAlignmentJustify as wpp_icon_text_alignment_justify, WppIconTextAlignmentLeft as wpp_icon_text_alignment_left, WppIconTextAlignmentRight as wpp_icon_text_alignment_right, WppIconUnderline as wpp_icon_underline, WppIconUndo as wpp_icon_undo, WppIconUnorderedList as wpp_icon_unordered_list };
