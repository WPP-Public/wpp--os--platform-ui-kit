...
const WppIconAttach = class {
  ...
  static get registryIs() { return "wpp-icon-attach-v3-3-0"; }
};
WppIconAttach.style = wppIconCss$m;
...
const WppIconBlockquote = class {
  ...
  static get registryIs() { return "wpp-icon-blockquote-v3-3-0"; }
};
...
const WppIconBold = class {
  ...
  static get registryIs() { return "wpp-icon-bold-v3-3-0"; }
};
...
const WppIconFloatCenter = class {
  ...
  static get registryIs() { return "wpp-icon-float-center-v3-3-0"; }
};
...
const WppIconFloatLeft = class {
  ...
  static get registryIs() { return "wpp-icon-float-left-v3-3-0"; }
};
...
const WppIconFloatRight = class {
  ...
  static get registryIs() { return "wpp-icon-float-right-v3-3-0"; }
};
...
const WppIconH1 = class {
  ...
  static get registryIs() { return "wpp-icon-h1-v3-3-0"; }
};
...
const WppIconH2 = class {
  ...
  static get registryIs() { return "wpp-icon-h2-v3-3-0"; }
};
...
const WppIconIndentDecrease = class {
  ...
  static get registryIs() { return "wpp-icon-indent-decrease-v3-3-0"; }
};
...
const WppIconIndentIncrease = class {
  ...
  static get registryIs() { return "wpp-icon-indent-increase-v3-3-0"; }
};
...
const WppIconItalic = class {
  ...
  static get registryIs() { return "wpp-icon-italic-v3-3-0"; }
};
...
const WppIconLink = class {
  ...
  static get registryIs() { return "wpp-icon-link-v3-3-0"; }
};
...
const WppIconOrderedList = class {
  ...
  static get registryIs() { return "wpp-icon-ordered-list-v3-3-0"; }
};
...
const WppIconRedo = class {
  ...
  static get registryIs() { return "wpp-icon-redo-v3-3-0"; }
};
...
const WppIconStrikeThrough = class {
  ...
  static get registryIs() { return "wpp-icon-strike-through-v3-3-0"; }
};
...
const WppIconTextAlignmentCenter = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-center-v3-3-0"; }
};
...
const WppIconTextAlignmentJustify = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-justify-v3-3-0"; }
};
...
const WppIconTextAlignmentLeft = class {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-left-v3-3-0"; }
};
...
const WppIconUnderline = class {
  ...
  static get registryIs() { return "wpp-icon-underline-v3-3-0"; }
};
...
const WppIconUndo = class {
  ...
  static get registryIs() { return "wpp-icon-undo-v3-3-0"; }
};
...
const WppIconUnorderedList = class {
  ...
  static get registryIs() { return "wpp-icon-unordered-list-v3-3-0"; }
};
WppIconUnorderedList.style = wppIconCss;

export { WppIconTextAlignmentCenter as W, WppIconTextAlignmentRight as a, WppIconTextAlignmentJustify as b, WppIconBlockquote as c, WppIconBold as d, WppIconCodeView as e, WppIconFloatCenter as f, WppIconFloatLeft as g, WppIconFloatRight as h, WppIconH1 as i, WppIconH2 as j, WppIconItalic as k, WppIconIndentIncrease as l, WppIconIndentDecrease as m, WppIconLink as n, WppIconOrderedList as o, WppIconUnorderedList as p, WppIconStrikeThrough as q, WppIconUnderline as r, WppIconUndo as s, WppIconRedo as t, WppIconAttach as u, WppIconTextAlignmentLeft as v };
