import { N as Node3, m as mergeAttributes, w as wrappingInputRule, M as Mark, c as markInputRule, e as markPasteRule, T as TextSelection, S as Selection$1, t as textblockTypeInputRule, a as Plugin, P as PluginKey, g as canInsertNode, i as isNodeSelection, h as NodeSelection, n as nodeInputRule, j as combineTransactionSteps, k as getChangedRanges, l as findChildrenInRange, o as getMarksBetween, p as getAttributes, r as renderNestedMarkdownContent, b as Extension, q as getRenderedAttributes, v as parseIndentedBlocks, x as getNodeType, y as getNodeAtPosition, z as isNodeActive, A as isAtStartOfNode, B as isAtEndOfNode, C as dropPoint, D as Slice, F as keydownHandler, G as Fragment, H as DecorationSet, I as Decoration, J as Mapping, K as callOrReturn, L as getExtensionField, O as isNodeEmpty, R as SelectionRange, V as Transform, W as findParentNodeClosestToPos, X as textInputRule, Y as commands_exports, Z as sortExtensions, _ as flattenExtensions, $ as decodeHtmlEntities, a0 as generateJSON, a1 as encodeHtmlEntities, a2 as ResizableNodeView, a3 as InputRule, a4 as Quill$1, U as UPLOAD_REQUEST_EVENT, s as sources, Q as Quill$2 } from './index-7537e942.js';
...
import { W as WppIconAttach } from './wpp-icon-attach-4c24e8c3.js';
import { W as WppIconTextAlignmentCenter, a as WppIconTextAlignmentRight, b as WppIconTextAlignmentJustify, c as WppIconBlockquote, d as WppIconBold, e as WppIconCodeView, f as WppIconFloatCenter, g as WppIconFloatLeft, h as WppIconFloatRight, i as WppIconH1, j as WppIconH2, k as WppIconItalic, l as WppIconIndentIncrease, m as WppIconIndentDecrease, n as WppIconLink, o as WppIconOrderedList, p as WppIconUnorderedList, q as WppIconStrikeThrough, r as WppIconUnderline, s as WppIconUndo, t as WppIconRedo, u as WppIconTextAlignmentLeft } from './wpp-icon-unordered-list-441a2fd9.js';
import { W as WppIconImage, a as WppIconVideoClip } from './wpp-icon-video-clip-06707f50.js';
import { O as ONE_PIXEL_TRANSPARENT_GIF } from './const-ee6c5d3f.js';
import './marked.umd-be419d39.js';
import { W as WppProgressIndicator } from './wpp-progress-indicator-0650cc55.js';
import { W as WppIconChevron } from './wpp-icon-chevron-33a44db3.js';
import { W as WppIconGallery } from './wpp-icon-gallery-3ae4e377.js';
import { l as lodash } from './lodash-cc2b04b5.js';
import { W as WppActionButton } from './wpp-action-button-f11ae9a2.js';
import { W as WppInput } from './wpp-input-430d9d27.js';
import { T as TurndownService } from './turndown.browser.es-11865203.js';
 ...
 */
const TiptapMarkdownFix = Extension.create({
  name: 'markdownFix',
...
const TiptapMarkdownShortcuts = Extension.create({
...
const TiptapMarkdownPaste = Extension.create({
...
function extendBlotNames(blotNames) {
  blotNames.forEach(blotName => {
    Quill$1.register(blotName, extendBlot(Quill$1.import(blotName)), true);
  });
}
...
class BlotSpec {
  ...
  setSelection() {
    const blot = Quill$1.find(this.getTargetElement());
    if (blot) {
...
const QuillToolbar = Quill$1.import('modules/toolbar');
...
const BlockEmbed = Quill$1.import('blots/block/embed');
...
const BaseBlot$1 = Quill$1.import('blots/embed');
...
Quill$1.register('formats/attachment', AttachmentBlot);
Quill$1.register('formats/attachmentUploading', AttachmentUploadingBlot);
...
const BaseBlot = Quill$1.import('blots/embed');
...
Quill$1.register('formats/video', VideoBlot, true);
Quill$1.register('formats/videoUploading', VideoUploadingBlot);
...
Quill$1.register('formats/image', ImageBlot, true);
Quill$1.register('formats/imageUploading', ImageUploadingBlot);
...
var parchment = createCommonjsModule(function (module, exports) {
...
const Parchment = /*@__PURE__*/getDefaultExportFromCjs(parchment);
...
class ImageLibraryPicker extends Picker {
  static handler(value) {
    ...
    Object.keys(lodash.omit(blotValue, ['src'])).forEach(key => {
...
const LinkBlot = Quill$1.import('formats/link');
...
const SizeAttributor = Quill$2.import('attributors/class/size');
SizeAttributor.whitelist = ['2xs', 'xs', 'm', 'l', 'xl', '2xl', '3xl', '4xl', '5xl'];
Quill$2.register(SizeAttributor, true);
Quill$2.register({ 'themes/wpp': WppTheme });
// media upload modules
Quill$2.register('modules/imageUpload', Image);
Quill$2.register('modules/videoUpload', Video);
Quill$2.register('modules/attachmentUpload', Attachment);
// image and video positioning modules (width, height, float, align)
ImageFormats.extendBlotNames = ['formats/image', 'formats/video'];
Quill$2.register('modules/imageFormats', ImageFormats);
Quill$2.register('modules/imageActions', ImageActions);
const keyboardModule = Quill$2.import('modules/keyboard');
...
Quill$2.register('modules/toolbar', WppQuillToolbar, true);
Quill$2.register('modules/imageLibrary', () => { });
Quill$2.DEFAULTS.formats = [...defaultFormats, ...quillImageFormats, ...quillUploadFormats];
Quill$2.DEFAULTS.modules = {
  history: {
    delay: 1000,
    maxStack: 100,
    userOnly: true,
...
export { KEYBOARD_FOCUS_CLASS as K, LOCALES_DEFAULTS as L, TiptapMarkdownShortcuts as T, normalizeListHtml as a, buildTiptapExtensions as b, KEYBOARD_FOCUS_EVENT as c, TIPTAP_DEFAULT_TOOLBAR_ALIASES as d, extractPlainText as e, normalizeEmptyParagraphs as n };
