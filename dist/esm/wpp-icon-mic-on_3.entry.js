import { r as registerInstance, h, c as createEvent, F as Fragment, H as Host, g as getElement } from './index-9177bb6d.js';
...
const WppIconMicOn = class {
  ...
  static get registryIs() { return "wpp-icon-mic-on-v3-6-0"; }
};
...
const WppToast = class {
  constructor(hostRef) {
    ...
    this.getIconType = (iconType) => {
      if (iconType === 'warning')
        return h("wpp-icon-warning-v3-6-0", { width: 16, height: 16, class: "icon" });
      if (iconType === 'error')
        return h("wpp-icon-error-v3-6-0", { width: 16, height: 16, class: "icon" });
      if (iconType === 'information')
        return h("wpp-icon-info-message-v3-6-0", { color: "var(--wpp-grey-color-700)", width: 16, height: 16, class: "icon" });
      if (iconType === 'success')
        return h("wpp-icon-success-v3-6-0", { width: 16, height: 16, class: "icon" });
      return null;
    };
  ...
  render() {
    ...
    return (h(Host, { class: this.hostCssClasses(), style: style, exportparts: "body, message, body, info-wrapper, header, message, actions, action-button, icon-start, icon-wrapper", onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, role: "alert" }, this.variant === 'chat' ? (h("div", { class: this.chatToastWrapper() }, h("wpp-typography-v3-6-0", { class: "chat-toast-message", type: "2xs-strong" }, this.message))) : (h(Fragment, null, this.message && !this.header && (h("div", { class: "body", part: "body" }, h("div", { class: this.iconWrapperCssClasses(), style: this.icon?.styles, part: "icon-wrapper" }, this.isIconProvided() ? this.renderIcon() : this.getIconType(this.type)), h("wpp-typography-v3-6-0", { type: "s-body", class: "message", part: "message" }, this.message))), this.header && (h("div", { class: "body", part: "body" }, h("div", { class: this.iconWrapperCssClasses(), style: this.icon?.styles, part: "icon-wrapper" }, this.isIconProvided() ? this.renderIcon() : this.getIconType(this.type)), h("div", { class: "info", part: "info-wrapper" }, h("wpp-typography-v3-6-0", { type: "s-strong", class: "header", part: "header" }, this.header), h("wpp-typography-v3-6-0", { type: "s-body", class: "message", part: "message" }, this.message)))), !!this.primaryBtn && (h("div", { class: "actions", part: "actions" }, this.primaryBtn && (h("wpp-action-button-v3-6-0", { onClick: () => this.primaryBtn?.onClick(this.index || ''), disabled: this.primaryBtn.disabled, loading: this.primaryBtn.loading, variant: this.primaryBtn.variant, ariaProps: this.ariaProps, part: "action-button" }, this.primaryBtn.label)), h("wpp-action-button-v3-6-0", { ariaProps: { label: 'Remove message' }, variant: "inverted", part: "action-button", onClick: this.handleCloseClick }, h("wpp-icon-cross-v3-6-0", { slot: "icon-start", part: "icon-start" })))), !this.primaryBtn && (h("div", { class: "actions", part: "actions" }, h("wpp-action-button-v3-6-0", { ariaProps: { label: 'Remove message' }, variant: "inverted", part: "action-button", onClick: this.handleCloseClick }, h("wpp-icon-cross-v3-6-0", { slot: "icon-start", part: "icon-start" }))))))));
  }
  static get registryIs() { return "wpp-toast-v3-6-0"; }
...
export { WppIconMicOn as wpp_icon_mic_on, WppIconSend as wpp_icon_send, WppToast as wpp_toast };
