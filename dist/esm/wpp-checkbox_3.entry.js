import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, f as forceUpdate, F as Fragment } from './index-93f63aaa.js';
...
import { u as uuidv4, k as transformToVersionedTag, g as getSlotEmptyStates, d as debounce, w as getHighestContainerInDOM } from './utils-452958a4.js';
import { c as isEqual_1 } from './isEqual-cbad439f.js';
import { T as TAB_FOCUS_CLASS, a as MENU_ROLE, M as MENU_ITEM, P as PRESENTATION_ROLE$1, B as BUTTON_ROLE, C as CONTEXT_ITEM_TAG, b as MENU_CONTEXT_TAG, c as TOPBAR_NAVIGATION_ITEM_TAG, d as MENU_CONTEXT_KEYBOARD_ACTIVATION_EVENT, W as WPP_LIST_CLASSNAME, e as MENU_BAR_ROLE, G as GROUP_ROLE } from './constants-28e0b02e.js';
...
const WppCheckbox = class {
  ...
  render() {
    if (this.decorative)
      return (h(Host, { class: this.hostCssClasses(), "aria-hidden": "true", role: "presentation", tabindex: "-1", exportparts: "body, input, square, icon-tick, icon-dash, message", name: this.name, ...(this.isDarkTheme !== undefined ? { 'data-wpp-theme': this.isDarkTheme ? 'dark' : 'light' } : {}) }, h("wpp-label-v4-3-0", { class: this.labelCssClasses(), typography: "s-body", optional: !this.required, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "body" }, h("div", { class: "square", part: "square" }), h("wpp-icon-tick-v4-3-0", { part: "icon-tick" }), h("wpp-icon-dash-v4-3-0", { part: "icon-dash" })), !!this.message && (h("wpp-inline-message-v4-3-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, part: "message" }))));
    return (h(Host, { class: this.hostCssClasses(), onKeyUp: this.onKeyUp, onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, exportparts: "body, input, square, icon-tick, icon-dash, message", name: this.name, ...(this.isDarkTheme !== undefined ? { 'data-wpp-theme': this.isDarkTheme ? 'dark' : 'light' } : {}) }, h("wpp-label-v4-3-0", { class: this.labelCssClasses(), typography: "s-body", optional: !this.required, htmlFor: this.name, disabled: this.disabled, onClick: this.onClick, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "body" }, h("input", { class: this.inputCssClasses(), type: "checkbox", id: this.name, name: this.name, disabled: this.disabled, checked: this.checked || this.indeterminate, required: this.required, onFocus: this.onFocus, onBlur: this.onBlur, autoFocus: this.autoFocus, ref: inputRef => (this.inputRef = inputRef), "aria-label": this.ariaProps.label, "aria-hidden": this.disabled ? 'true' : null, "aria-required": this.required.toString(), tabindex: this.disabled ? '-1' : this.index, part: "input" }), h("div", { class: "square", part: "square" }), h("wpp-icon-tick-v4-3-0", { part: "icon-tick" }), h("wpp-icon-dash-v4-3-0", { part: "icon-dash" })), !!this.message && (h("wpp-inline-message-v4-3-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, part: "message" }))));
  }
  ...
  constructor(hostRef) {
    ...
    this.updateTriggerAccessibility = (isExpanded) => {
      ...
      const shouldSetButtonRole = !this.triggerElement.matches('button, a[href], input, select, textarea, summary') &&
        (!currentRole || currentRole === PRESENTATION_ROLE$1);
      this.applyAriaPropsAsAttributes(this.triggerElement, triggerAriaProps);
    ...
    this.updateMenuGroupAccessibility = (group) => {
      ...
      const role = hasDividerOnly ? PRESENTATION_ROLE$1 : GROUP_ROLE;
...
export { WppCheckbox as wpp_checkbox, WppListItem as wpp_list_item, WppMenuContext as wpp_menu_context };
