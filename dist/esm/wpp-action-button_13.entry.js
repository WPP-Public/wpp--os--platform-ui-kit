export { W as wpp_action_button } from './wpp-action-button-e277a221.js';
...
import { d as debounce, g as getSlotEmptyStates, k as transformToVersionedTag, w as getHighestContainerInDOM, z as isWppElement } from './utils-f415b66e.js';
  ...
  constructor(hostRef) {
    ...
    this.getMessageTypesIcons = () => {
      if (this.type === 'warning')
        return h("wpp-icon-warning-v3-6-0", { class: "left-icon", part: "message-icon", role: "presentation" });
      if (this.type === 'error')
        return h("wpp-icon-error-v3-6-0", { class: "left-icon", part: "message-icon", role: "presentation" });
      if (this.type === 'information')
        return (h("wpp-icon-info-message-v3-6-0", { color: "var(--wpp-grey-color-700)", class: "left-icon", part: "message-icon", role: "presentation" }));
      if (this.type === 'success')
        return h("wpp-icon-success-v3-6-0", { class: "left-icon", part: "message-icon", role: "presentation" });
      return null;
    };
    ...
    this.renderContent = () => {
      ...
      return this.size === 'l' ? (h("div", { class: "container", part: "container" }, h("div", { class: this.getContainerContentCssClasses() }, this.getMessageTypesIcons(), h("div", { class: "content-wrapper" }, h("wpp-typography-v3-6-0", { class: this.titleCssClasses(), tag: "h4", type: "m-strong", part: "title" }, this.titleText), h("div", { class: "container-body" }, this.isTruncated ? (h("wpp-tooltip-v3-6-0", { class: "tooltip", text: this.message, config: { placement: 'bottom', triggerTarget: this.messageRef, ...this.tooltipConfig }, part: "tooltip" }, h("span", { ref: ref => (this.messageRef = ref), class: this.messageCssClasses(), tabIndex: 0, part: "message", onBlur: this.onBlur }, message))) : (h("span", { class: "message", part: "message" }, message))))), this.actionBtnText || !this.hideCloseBtn ? (h("div", { class: "container-actions" }, this.actionBtnText?.length > 0 && (h("wpp-action-button-v3-6-0", { part: "action-btn", class: "action-btn", variant: "secondary", onClick: this.handleClickActionBtn }, this.actionBtnText)), !this.hideCloseBtn && (h("wpp-action-button-v3-6-0", { class: "close-btn", ariaProps: { label: this._locales.close }, variant: "secondary", onClick: this.handleClickClose }, h("wpp-icon-cross-v3-6-0", { color: "var(--ab-secondary-text-color)", size: "m" }))))) : null)) : this.isTruncated ? (h("wpp-tooltip-v3-6-0", { text: this.message, config: { placement: 'bottom', ...this.tooltipConfig }, part: "tooltip" }, h("div", { class: this.messageBlockCssClasses(), part: "message-block", ref: ref => (this.messageRef = ref), onBlur: this.onBlur, tabIndex: 0 }, this.getMessageTypesIcons(), h("span", { class: "message", part: "message" }, message)))) : (h("div", { class: this.messageBlockCssClasses(), part: "message-block" }, this.getMessageTypesIcons(), h("span", { class: "message", part: "message" }, message)));
    };
    this.getExportParts = () => {
...
export { WppIconCross as wpp_icon_cross, WppIconError as wpp_icon_error, WppIconInfoMessage as wpp_icon_info_message, WppIconSuccess as wpp_icon_success, WppIconWarning as wpp_icon_warning, WppInlineMessage as wpp_inline_message, WppInternalLabel as wpp_internal_label, WppTooltip$1 as wpp_internal_tooltip, WppLabel as wpp_label, WppSpinner as wpp_spinner, WppTooltip as wpp_tooltip, WppTypography as wpp_typography };
