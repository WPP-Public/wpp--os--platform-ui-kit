...
type KebabObjectKeys<T> = {
  [key in keyof T as Kebab<key & string>]: T[key] extends Record<string, any> ? KebabObjectKeys<T[key]> : T[key]
}
...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      'swiper-container': KebabObjectKeys<SwiperOptions> & {
        ref?: RefObject<SwiperRef>
        children?: ReactNode
        class?: string
      }
      'swiper-slide': KebabObjectKeys<SwiperSlideProps>
    }
  }
}
