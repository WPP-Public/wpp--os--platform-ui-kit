...
@Component({
  selector: 'app-vertical-stepper-with-width-example',
  templateUrl: './vertical-stepper-with-widthVC.html',
  styleUrls: ['./vertical-stepper-with-widthVC.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class VerticalStepperWWidthVC {
  public LAST_PAGE = 12
  public FIRST_PAGE = 1
