...
const isToShowBanner = ref(false);
  ...
  <div class="page">
    ...
    <div class="container">
      <div class="nav-sidebar">
        <WppNavSidebar class="sidebar" initialPath="/dashboard">
          <div slot="header">
            <div class="icon">
              <WppIconBookmarkSelected />
            </div>
      ...
      <div class="container-body">
        <WppBanner type="warning" :show="isToShowBanner" class="banner">
          USPS has updated their rates. Make sure you know how these changes
          affect your store.
        </WppBanner>
          ...
          <div class="section">
            <div class="section-info">
              ...
              <div class="actions-row">
                ...
                <WppTypography type="s-midi" class="helper">
                  Help
                </WppTypography>
                <WppButton variant="secondary" @click="handleShowBanner" data-testid="show-banner">
                  Show Banner
                </WppButton>
                <WppButton
                  variant="primary"
