...
import { WppAvatar, WppCard, WppButton } from '@platform-ui-kit/components-library-vue'
...
<template>
  ...
  <div class="modal-actions" slot="actions">
    <WppButton variant="destructive" @click="handleCloseSideModal"> Close </WppButton>
  </div>
</template>
