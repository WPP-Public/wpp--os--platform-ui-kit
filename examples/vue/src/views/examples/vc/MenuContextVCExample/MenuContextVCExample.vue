...
<template>
  <div class="container" data-testid="menu-context-container">
    <div class="context">
      <h3>The list is the Same Width as a Button</h3>
      <WppMenuContext :dropdownConfig="{ triggerElementWidth: true }" appendToListWrapper>
        <WppButton :disabled="false" slot="trigger-element" data-testid="same-width-button"> Click to open </WppButton>
        <div>
          <WppListItem>
    ...
    <div class="context">
      ...
      <WppMenuContext listWidth="100px" appendToListWrapper>
        <WppButton slot="trigger-element" data-testid="fixed-width-button"> Click to open </WppButton>
        <div>
          <WppListItem>
            <WppIconPlus slot="left" />
    ...
    <div class="context">
      ...
      <WppMenuContext listWidth="150px">
        <WppButton slot="trigger-element" data-testid="group-menu-button"> Click to open </WppButton>
        <div>
