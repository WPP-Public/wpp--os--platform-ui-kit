...
const WppIconZoomIn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconZoomIn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-zoom-in-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-zoom-in-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconZoomIn$1);
      }
      break;
  } });
}

const WppIconZoomIn = WppIconZoomIn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconZoomIn, defineCustomElement };
