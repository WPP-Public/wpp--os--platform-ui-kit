...
const WppIconZoomIn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconZoomIn extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-zoom-in-v4-1-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-zoom-in", "wpp-icon-zoom-in-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-zoom-in-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-zoom-in-v4-1-0":
