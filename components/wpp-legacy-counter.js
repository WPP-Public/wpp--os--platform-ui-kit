...
function defineCustomElement$1() {
  ...
  const components = ["wpp-legacy-counter-v4-2-0", "wpp-action-button-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-plus-v4-2-0", "wpp-icon-remove-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-legacy-counter-v4-2-0":
