...
import { d as defineCustomElement$g } from './wpp-action-button2.js';
...
import { d as defineCustomElement$c } from './wpp-icon-plus2.js';
import { d as defineCustomElement$b } from './wpp-icon-remove2.js';
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-legacy-counter-v4-3-0", "wpp-action-button-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-plus-v4-3-0", "wpp-icon-remove-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-inline-message-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-label-v4-3-0", "wpp-spinner-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-legacy-counter-v4-3-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppLegacyCounter$1);
      }
      break;
...
const WppLegacyCounter = WppLegacyCounter$1;
const defineCustomElement = defineCustomElement$1;

export { WppLegacyCounter, defineCustomElement };
