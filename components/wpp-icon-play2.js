...
const WppIconPlay = /*@__PURE__*/ proxyCustomElement(class WppIconPlay extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-play-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-play", "wpp-icon-play-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-play-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-play-v4-2-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconPlay);
      }
      break;
  } });
}

export { WppIconPlay as W, defineCustomElement as d };
