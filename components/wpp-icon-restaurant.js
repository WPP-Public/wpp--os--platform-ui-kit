...
const WppIconRestaurant$1 = /*@__PURE__*/ proxyCustomElement(class WppIconRestaurant extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-restaurant", "wpp-icon-restaurant-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-restaurant-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-restaurant-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconRestaurant$1);
      }
      break;
  } });
}

const WppIconRestaurant = WppIconRestaurant$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconRestaurant, defineCustomElement };
