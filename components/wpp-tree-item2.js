 ...
 */
const findParentOfItem = (tree, targetId, parent = null) => {
 ...
 */
const getSiblings = (tree, targetId) => {
  for (const item of tree) {
    if (item.id === targetId)
      return tree;
    if (item.children) {
...
const WppTreeItem = /*@__PURE__*/ proxyCustomElement(class WppTreeItem extends HTMLElement {
  constructor() {
    ...
    this.shouldCheckTruncation = true;
    ...
    this.componentDidRender = () => {
      if (this.shouldCheckTruncation) {
        this.checkTitleTruncation();
        this.shouldCheckTruncation = false;
      }
    };
    this.checkTitleTruncation = () => {
    ...
    this.updateSlotData = () => {
      ...
      if (this.hasIconStartSlot !== !emptyStates.start ||
    ...
    this.renderEndContent = () => {
      ...
      switch (contentType) {
        case 'text':
          return (h("wpp-typography-v4-3-0", { type: "s-body", tag: "span", ...props, class: this.endContentCssClasses(className), part: "tree-item-end-text" }, props?.text));
        case 'tag': {
          const { icon } = props;
          return (h("wpp-tag-v4-3-0", { ...props, class: this.endContentCssClasses(className), disabled: this.item.disabled, part: "tree-item-end-tag" }, icon &&
        ...
        case 'avatar':
          return (h("wpp-avatar-v4-3-0", { ...props, class: this.endContentCssClasses(className), size: "xs", part: "tree-item-end-avatar",
            // Remove from tab order - tree uses arrow keys per ARIA APG
            index: -1 }));
        case 'avatarGroup':
          return (h("wpp-avatar-group-v4-3-0", { ...props, class: this.endContentCssClasses(className), part: "tree-item-end-avatar-group",
  ...
  static get registryIs() { return "wpp-tree-item-v4-3-0"; }
...
}, [1, "wpp-tree-item", "wpp-tree-item-v4-3-0", {
    "text": [513],
    "multiple": [516],
    "search": [1],
    "item": [16],
    "level": [514],
    "setSize": [514, "set-size"],
    "posInSet": [514, "pos-in-set"],
    "isFocused": [516, "is-focused"],
    "highlightOptions": [16],
...
function defineCustomElement() {
  ...
  const components = ["wpp-tree-item-v4-3-0", "wpp-action-button-v4-3-0", "wpp-avatar-v4-3-0", "wpp-avatar-group-v4-3-0", "wpp-checkbox-v4-3-0", "wpp-icon-chevron-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-dash-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-tick-v4-3-0", "wpp-icon-triangle-fill-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-inline-message-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-label-v4-3-0", "wpp-list-item-v4-3-0", "wpp-menu-context-v4-3-0", "wpp-spinner-v4-3-0", "wpp-tag-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
...
export { DEFAULT_OVERSCAN as D, LOCALES_DEFAULTS as L, TREE_ITEM_HEIGHT as T, WppTreeItem as W, TREE_PADDING_TOP as a, updateTreeById as b, convertToOriginalItems as c, findTreeItemById as d, extractExtraProps as e, findSelectedItems as f, getAllVisibleItems as g, getSiblings as h, isHaveFoundChildren as i, findParentOfItem as j, defineCustomElement as k, DEFAULT_TREE_HEIGHT as l, markChildrenAs as m, recalculateIndeterminateTreeState as r, updateTreeByIds as u };
