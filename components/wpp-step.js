...
const WppStep$1 = /*@__PURE__*/ proxyCustomElement(class WppStep extends HTMLElement {
  constructor() {
    ...
    this.renderStep = () => {
      if (!this.isSubStep() && this.completed) {
        return h("wpp-icon-tick-v4-1-0", { color: "var(--wpp-grey-color-000)" });
      }
      if (this.isSubStep()) {
        return null;
      }
    ...
    this.renderStepTypeData = () => {
      let icon;
      if (this.error)
        icon = h("wpp-icon-error-v4-1-0", null);
      if (this.warning)
        icon = h("wpp-icon-warning-v4-1-0", null);
      if (!icon)
        return null;
      if (this.iconDescription) {
        return (h("wpp-tooltip-v4-1-0", { config: { placement: 'bottom' }, text: this.iconDescription }, icon));
      }
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), exportparts: "wrapper, step, step-bg, step-index, step-label, optional, icon, last-step, last-step-text, label, label-wrapper, ws-wrapper, ws-inner", onClick: this.handleStepClick }, h("div", { class: this.stepWrapperCssClasses(), part: "wrapper" }, this.orientation === 'vertical' && (h("div", { class: this.stepBgCssClasses(), part: "step-bg" }, h("div", { class: this.stepTextWrapperCssClasses(), part: "step-label" }, !this.labelTooltipText ? (h(WrappedSlot, { onSlotchange: this.handleSlotChange, name: "label" })) : (h("wpp-tooltip-v4-1-0", { class: "label-tooltip", config: { placement: 'right' }, text: this.labelTooltipText }, h(WrappedSlot, { onSlotchange: this.handleSlotChange, wrapperClass: 'label-wrapper', name: "label" }))), this.tooltipText ? (h("div", { class: "step-description" }, h("wpp-tooltip-v4-1-0", { class: "description-tooltip", config: { placement: 'right' }, text: this.tooltipText }, h(WrappedSlot, { onSlotchange: this.handleSlotChange, name: "description" })))) : (h("div", { class: "step-description" }, h("slot", { onSlotchange: this.handleSlotChange, name: "description" })))), this.renderStepTypeData())), h("div", { class: this.stepCssClasses(), part: "step" }, h("span", { class: this.stepIndexCssClasses(), part: "step-index" }, this.renderStep()), this.orientation === 'horizontal' && (h("div", { class: this.stepTextWrapperCssClasses(), part: "step-label" }, h(WrappedSlot, { name: "label" }), this.renderStepTypeData()))), !this.lastStep && (h("div", { class: this.stepConnectorCssClasses(), part: "last-step" }, h("span", { class: this.connectorLineCssClasses(), part: "last-step-text" })))), h(WrappedSlot, { wrapperClass: "steps-list-container" })));
  }
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-step-v4-1-0", "wpp-icon-error-v4-1-0", "wpp-icon-tick-v4-1-0", "wpp-icon-warning-v4-1-0", "wpp-internal-tooltip-v4-1-0", "wpp-tooltip-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-step-v4-1-0":
