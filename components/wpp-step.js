...
function defineCustomElement$1() {
  ...
  const components = ["wpp-step-v3-3-0", "wpp-icon-error-v3-3-0", "wpp-icon-tick-v3-3-0", "wpp-icon-warning-v3-3-0", "wpp-internal-tooltip-v3-3-0", "wpp-tooltip-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-step-v3-3-0":
