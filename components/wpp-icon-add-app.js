...
const WppIconAddApp$1 = /*@__PURE__*/ proxyCustomElement(class WppIconAddApp extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-add-app", "wpp-icon-add-app-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-add-app-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-add-app-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconAddApp$1);
      }
      break;
  } });
}

const WppIconAddApp = WppIconAddApp$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconAddApp, defineCustomElement };
