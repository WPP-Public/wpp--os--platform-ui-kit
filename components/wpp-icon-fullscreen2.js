...
const WppIconFullscreen = /*@__PURE__*/ proxyCustomElement(class WppIconFullscreen extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-fullscreen", "wpp-icon-fullscreen-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-fullscreen-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-fullscreen-v3-3-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconFullscreen);
      }
      break;
  } });
}

export { WppIconFullscreen as W, defineCustomElement as d };
