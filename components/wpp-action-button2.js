...
const WppActionButton = /*@__PURE__*/ proxyCustomElement(class WppActionButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-action-button", "wpp-action-button-v4-3-0", {
    "disabled": [516],
    "loading": [516],
    "variant": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-action-button-v4-3-0", "wpp-spinner-v4-3-0"];
...
export { WppActionButton as W, defineCustomElement as d };
