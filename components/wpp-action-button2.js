...
}, [1, "wpp-action-button", "wpp-action-button-v3-6-0", {
    "disabled": [516],
    "loading": [516],
    "variant": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-action-button-v3-6-0", "wpp-spinner-v3-6-0"];
