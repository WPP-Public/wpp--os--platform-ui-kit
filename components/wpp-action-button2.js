...
import { g as getSlotEmptyStates, k as closestElement } from './utils.js';
...
}, [1, "wpp-action-button", "wpp-action-button-v2-22-0", {
    "disabled": [516],
    "loading": [516],
    "variant": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-action-button-v2-22-0", "wpp-spinner-v2-22-0"];
