...
const WppIconDataTreemap$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDataTreemap extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-data-treemap", "wpp-icon-data-treemap-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-data-treemap-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-data-treemap-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDataTreemap$1);
      }
      break;
  } });
}

const WppIconDataTreemap = WppIconDataTreemap$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDataTreemap, defineCustomElement };
