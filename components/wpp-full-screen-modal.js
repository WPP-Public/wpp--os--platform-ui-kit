...
}, [1, "wpp-full-screen-modal", "wpp-full-screen-modal-v4-2-0", {
    "open": [1540],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-full-screen-modal-v4-2-0", "wpp-action-button-v4-2-0", "wpp-button-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-overlay-v4-2-0", "wpp-spinner-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-full-screen-modal-v4-2-0":
