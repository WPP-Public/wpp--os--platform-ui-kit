...
const WppIconShieldSuccess$1 = /*@__PURE__*/ proxyCustomElement(class WppIconShieldSuccess extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-shield-success", "wpp-icon-shield-success-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-shield-success-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-shield-success-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconShieldSuccess$1);
      }
      break;
  } });
}

const WppIconShieldSuccess = WppIconShieldSuccess$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconShieldSuccess, defineCustomElement };
