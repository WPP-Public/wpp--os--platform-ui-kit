...
const WppIconCalendar3Days$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCalendar3Days extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-calendar-3-days-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-calendar-3-days", "wpp-icon-calendar-3-days-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-calendar-3-days-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-calendar-3-days-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCalendar3Days$1);
      }
      break;
  } });
}

const WppIconCalendar3Days = WppIconCalendar3Days$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCalendar3Days, defineCustomElement };
