...
const WppIconMail$1 = /*@__PURE__*/ proxyCustomElement(class WppIconMail extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-mail", "wpp-icon-mail-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-mail-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-mail-v2-22-0":
...
const WppIconMail = WppIconMail$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconMail, defineCustomElement };
