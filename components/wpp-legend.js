...
const WppLegend$1 = /*@__PURE__*/ proxyCustomElement(class WppLegend extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses() }, h("svg", { class: this.dotCssClasses() }, h("circle", { cx: 6, cy: 6, r: 5, fill: this.color })), this.label && (h("wpp-typography-v4-2-0", { color: this.disabled ? 'var(--wpp-text-color-disabled)' : 'var(--wpp-grey-color-1000)', type: "xs-body" }, this.label))));
  }
  static get registryIs() { return "wpp-legend-v4-2-0"; }
  static get style() { return wppLegendCss; }
}, [1, "wpp-legend", "wpp-legend-v4-2-0", {
    "label": [1],
    "disabled": [4],
    "color": [1]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-legend-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-legend-v4-2-0":
