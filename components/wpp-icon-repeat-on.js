...
const WppIconRepeatOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconRepeatOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-repeat-on-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-repeat-on-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconRepeatOn$1);
      }
      break;
  } });
}

const WppIconRepeatOn = WppIconRepeatOn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconRepeatOn, defineCustomElement };
