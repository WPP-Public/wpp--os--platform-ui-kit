...
}, [1, "wpp-icon-table-sort-desc-pressed", "wpp-icon-table-sort-desc-pressed-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-table-sort-desc-pressed-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-table-sort-desc-pressed-v3-3-1":
