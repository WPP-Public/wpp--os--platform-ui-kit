...
import { d as defineCustomElement$8 } from './wpp-legacy-topbar-item2.js';
import { d as defineCustomElement$7 } from './wpp-list-item2.js';
import { d as defineCustomElement$6 } from './wpp-menu-context2.js';
import { d as defineCustomElement$5 } from './wpp-navigation-item2.js';
...
const wppLegacyTopbarCss = ":host{--topbar-padding:var(--wpp-topbar-padding, 12px 0);--topbar-with-app-padding:var(--wpp-topbar-with-app-padding, 8px 0);--topbar-item-margin:var(--wpp-topbar-item-margin, 8px);--topbar-max-width:var(--wpp-topbar-max-width, 1812px);--topbar-offset-top:var(--wpp-topbar-offset-top, 64px);display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-pack:justify;justify-content:space-between;position:-webkit-sticky;position:sticky;top:var(--topbar-offset-top);background-color:var(--wpp-grey-color-000)}:host .wrapper{max-width:var(--topbar-max-width);width:95%;margin:0 auto;padding:0 2.5%}:host .wrapper .container{margin-left:0}:host .header{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;padding:var(--topbar-padding)}:host .header .navigation{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;width:100%;opacity:1}:host .header .navigation.hidden{height:32px;overflow-y:hidden;opacity:0}:host .header .navigation .wpp-topbar-item{white-space:nowrap}:host .header .navigation .wpp-topbar-item:not(:last-child){margin-right:var(--topbar-item-margin)}:host .header.without-application .application{display:none}:host .header.with-app{padding:var(--topbar-with-app-padding)}.app.slot-hidden,right.slot-hidden{display:none}";

const WppLegacyTopbar$1 = /*@__PURE__*/ proxyCustomElement(class WppLegacyTopbar extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (h(Host, { class: this.hostCssClasses(), style: { zIndex: this.zIndex.toString() }, exportparts: "wrapper, body, navigation, topbar-item, divider, app, right, app-wrapper, right-wrapper" }, h("div", { class: this.wrapperCssClasses(), part: "wrapper" }, h("wpp-grid-v4-2-0", { container: true }, h("wpp-grid-v4-2-0", { item: true, all: 24 }, h("div", { class: this.headerCssClasses(), part: "body" }, h(WrappedSlot, { wrapperClass: { 'slot-hidden': !this.hasAppSlot }, name: "app", onSlotchange: this.updateSlotData }), h("nav", { class: this.navigationCssClasses(), key: this.itemsToShow, part: "navigation" }, this.navigation.slice(0, this.itemsToShow).map(navigation => (h("wpp-legacy-topbar-item-v4-2-0", { navigation: navigation, firstLevel: true, active: navigation.active, onWppActiveTopbarItemChange: this.topbarItemClick, activeItems: this.activeItems, nativeLink: this.nativeLink, part: "topbar-item" }))), this.truncated && (h("wpp-legacy-topbar-item-v4-2-0", { key: this.value, navigation: hiddenNavigation, firstLevel: true, menu: true, active: isMenuActive, onWppActiveTopbarItemChange: this.topbarItemClick, activeItems: this.activeItems, nativeLink: this.nativeLink, part: "topbar-item" }))), h(WrappedSlot, { wrapperClass: { 'slot-hidden': !this.hasRightSlot }, name: "right", onSlotchange: this.updateSlotData }))))), h("wpp-divider-v4-2-0", { part: "divider" })));
  }
  static get registryIs() { return "wpp-legacy-topbar-v4-2-0"; }
  get host() { return this; }
  static get watchers() { return {
    "navigation": ["navigationChanged"],
    "value": ["valueChanged"]
  }; }
  static get style() { return wppLegacyTopbarCss; }
}, [1, "wpp-legacy-topbar", "wpp-legacy-topbar-v4-2-0", {
    "navigation": [16],
    "value": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-legacy-topbar-v4-2-0", "wpp-action-button-v4-2-0", "wpp-checkbox-v4-2-0", "wpp-divider-v4-2-0", "wpp-grid-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-dash-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-more-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-tick-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-legacy-topbar-item-v4-2-0", "wpp-list-item-v4-2-0", "wpp-menu-context-v4-2-0", "wpp-navigation-item-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-legacy-topbar-v4-2-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppLegacyTopbar$1);
      }
      break;
    ...
    case "wpp-label-v4-2-0":
      ...
      break;
    case "wpp-legacy-topbar-item-v4-2-0":
      if (!customElements.get(tagName)) {
    ...
    case "wpp-menu-context-v4-2-0":
      ...
      break;
    case "wpp-navigation-item-v4-2-0":
      if (!customElements.get(tagName)) {
...
const WppLegacyTopbar = WppLegacyTopbar$1;
const defineCustomElement = defineCustomElement$1;

export { WppLegacyTopbar, defineCustomElement };
