...
const WppIconFolderOpen$1 = /*@__PURE__*/ proxyCustomElement(class WppIconFolderOpen extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-folder-open-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-folder-open-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconFolderOpen$1);
      }
      break;
  } });
}

const WppIconFolderOpen = WppIconFolderOpen$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconFolderOpen, defineCustomElement };
