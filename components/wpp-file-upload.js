...
const WppFileUpload$1 = /*@__PURE__*/ proxyCustomElement(class WppFileUpload extends HTMLElement {
  ...
  static get registryIs() { return "wpp-file-upload-v3-6-0"; }
...
}, [1, "wpp-file-upload", "wpp-file-upload-v3-6-0", {
    "name": [1],
    "value": [1040],
    "disabled": [516],
    "multiple": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-file-upload-v3-6-0", "wpp-action-button-v3-6-0", "wpp-avatar-v3-6-0", "wpp-file-upload-item-v3-6-0", "wpp-icon-cross-v3-6-0", "wpp-icon-database-v3-6-0", "wpp-icon-document-v3-6-0", "wpp-icon-error-v3-6-0", "wpp-icon-file-v3-6-0", "wpp-icon-file-zip-v3-6-0", "wpp-icon-image-v3-6-0", "wpp-icon-info-message-v3-6-0", "wpp-icon-music-v3-6-0", "wpp-icon-pitch-v3-6-0", "wpp-icon-spreadsheet-v3-6-0", "wpp-icon-success-v3-6-0", "wpp-icon-video-clip-v3-6-0", "wpp-icon-warning-v3-6-0", "wpp-inline-message-v3-6-0", "wpp-internal-label-v3-6-0", "wpp-internal-tooltip-v3-6-0", "wpp-label-v3-6-0", "wpp-spinner-v3-6-0", "wpp-tooltip-v3-6-0", "wpp-typography-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-file-upload-v3-6-0":
