...
const WppIconCaptionOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCaptionOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-caption-on", "wpp-icon-caption-on-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-caption-on-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-caption-on-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCaptionOn$1);
      }
      break;
  } });
}

const WppIconCaptionOn = WppIconCaptionOn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCaptionOn, defineCustomElement };
