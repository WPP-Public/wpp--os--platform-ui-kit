...
}, [1, "wpp-icon-segmented-control", "wpp-icon-segmented-control-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-segmented-control-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-segmented-control-v3-5-0":
