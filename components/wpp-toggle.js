...
function defineCustomElement$1() {
  ...
  const components = ["wpp-toggle-v3-6-0", "wpp-icon-error-v3-6-0", "wpp-icon-warning-v3-6-0", "wpp-internal-label-v3-6-0", "wpp-internal-tooltip-v3-6-0", "wpp-label-v3-6-0", "wpp-tooltip-v3-6-0", "wpp-typography-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-toggle-v3-6-0":
