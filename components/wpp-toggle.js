...
}, [1, "wpp-toggle", "wpp-toggle-v3-3-1", {
    "name": [1],
    "value": [1032],
    "checked": [1540],
    "required": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-toggle-v3-3-1", "wpp-icon-error-v3-3-1", "wpp-icon-warning-v3-3-1", "wpp-internal-label-v3-3-1", "wpp-internal-tooltip-v3-3-1", "wpp-label-v3-3-1", "wpp-tooltip-v3-3-1", "wpp-typography-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-toggle-v3-3-1":
