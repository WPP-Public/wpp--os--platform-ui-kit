...
}, [1, "wpp-toggle", "wpp-toggle-v2-22-0", {
    "name": [1],
    "value": [1032],
    "checked": [1540],
    "required": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-toggle-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-label-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-label-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-toggle-v2-22-0":
