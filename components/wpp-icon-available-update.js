...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-available-update-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-available-update-v2-22-0":
...
const WppIconAvailableUpdate = WppIconAvailable;
const defineCustomElement = defineCustomElement$1;

export { WppIconAvailableUpdate, defineCustomElement };
