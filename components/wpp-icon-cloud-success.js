...
const WppIconCloudSuccess$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCloudSuccess extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-cloud-success", "wpp-icon-cloud-success-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-cloud-success-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-cloud-success-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCloudSuccess$1);
      }
      break;
  } });
}

const WppIconCloudSuccess = WppIconCloudSuccess$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCloudSuccess, defineCustomElement };
