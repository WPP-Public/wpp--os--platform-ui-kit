...
const WppIconThumbsUpFilled$1 = /*@__PURE__*/ proxyCustomElement(class WppIconThumbsUpFilled extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-thumbs-up-filled-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-thumbs-up-filled-v4-1-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconThumbsUpFilled$1);
      }
      break;
  } });
}

const WppIconThumbsUpFilled = WppIconThumbsUpFilled$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconThumbsUpFilled, defineCustomElement };
