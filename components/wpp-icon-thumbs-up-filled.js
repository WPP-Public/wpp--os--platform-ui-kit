...
const WppIconThumbsUpFilled$1 = /*@__PURE__*/ proxyCustomElement(class WppIconThumbsUpFilled extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-thumbs-up-filled-v4-0-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-thumbs-up-filled", "wpp-icon-thumbs-up-filled-v4-0-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-thumbs-up-filled-v4-0-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-thumbs-up-filled-v4-0-0":
