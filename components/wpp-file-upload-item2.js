...
const returnIconFromExtension = (fileExtension, thumbnailUrl) => {
  ...
  switch (fileExtension) {
    // Text
    case '.txt':
      return h("wpp-icon-document-v3-6-0", null);
    // Compressed
    case '.zip':
    case '.rar':
    case '.7z':
      return h("wpp-icon-file-zip-v3-6-0", null);
    // Image
    case '.png':
    case '.jpg':
    case '.jpeg':
    case '.svg':
    case '.gif':
      return h("wpp-icon-image-v3-6-0", null);
    // Video
    case '.mp4':
    case '.mov':
    case '.avi':
    ...
    case '.flv':
    case '.webm':
      return h("wpp-icon-video-clip-v3-6-0", null);
    // Audio
    case '.mp3':
    case '.wav':
    case '.ogg':
    ...
    case '.m4a':
    case '.aac':
      return h("wpp-icon-music-v3-6-0", null);
    // Data
    case '.csv':
    case '.json':
    case '.xml':
    ...
    case '.sqlite':
    case '.dat':
      return h("wpp-icon-database-v3-6-0", null);
    // Presentation
    case '.pptx':
    case '.key':
    case '.odp':
    ...
    case '.sldx':
    case '.ppt':
      return h("wpp-icon-pitch-v3-6-0", null);
    // Spreadsheet
    case '.xlsx':
    case '.xls':
    case '.ods':
    case '.numbers':
    case '.tsv':
      return h("wpp-icon-spreadsheet-v3-6-0", null);
    default:
      return h("wpp-icon-file-v3-6-0", null);
  }
};
...
}, [1, "wpp-file-upload-item", "wpp-file-upload-item-v3-6-0", {
