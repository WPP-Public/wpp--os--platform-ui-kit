...
const WppIconPhone$1 = /*@__PURE__*/ proxyCustomElement(class WppIconPhone extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-phone", "wpp-icon-phone-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-phone-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-phone-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconPhone$1);
      }
      break;
  } });
}

const WppIconPhone = WppIconPhone$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconPhone, defineCustomElement };
