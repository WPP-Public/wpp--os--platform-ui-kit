...
}, [1, "wpp-chat-reference", "wpp-chat-reference-v4-2-0", {
    "type": [513],
    "name": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-chat-reference-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-database-v4-2-0", "wpp-icon-document-v4-2-0", "wpp-icon-file-v4-2-0", "wpp-icon-file-zip-v4-2-0", "wpp-icon-image-v4-2-0", "wpp-icon-music-v4-2-0", "wpp-icon-pitch-v4-2-0", "wpp-icon-spreadsheet-v4-2-0", "wpp-icon-video-clip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-chat-reference-v4-2-0":
