...
const WppIconLikeFilled$1 = /*@__PURE__*/ proxyCustomElement(class WppIconLikeFilled extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-like-filled-v3-4-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-like-filled", "wpp-icon-like-filled-v3-4-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-like-filled-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-like-filled-v3-4-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconLikeFilled$1);
      }
      break;
  } });
}

const WppIconLikeFilled = WppIconLikeFilled$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconLikeFilled, defineCustomElement };
