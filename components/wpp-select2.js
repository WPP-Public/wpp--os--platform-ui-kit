...
import { w as getHighestContainerInDOM, k as transformToVersionedTag, g as getSlotEmptyStates, B as version, y as mergeLocales, b as isEventTargetContained } from './utils.js';
...
function renderSingleSelect(isBaseComponent = true, customSize, isRenderMessageInTooltip) {
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && isBaseComponent && (h("wpp-inline-message-v4-3-0", { class: !this.messageType ? 'default-message' : '', showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType || 'information', tooltipConfig: this.tooltipConfig }))));
  const renderAnchor = () => (h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick() }, this.anchorButton ? (h("slot", { name: "anchor-button", onSlotchange: this.updateSlotData })) : (h(Fragment, null,
    ...
    h("div", { class: "overflow-container", ref: refEl => (this.overflowContainerRef = refEl) }, this.textOverflows ? (h("wpp-tooltip-v4-3-0", { text: getSelectPlaceholder() },
      h("p", null, getSelectPlaceholder()))) : (h("p", null, getSelectPlaceholder()))),
    h("input", { class: "input", ref: refEl => (this.inputRef = refEl), type: "text", id: this.name, name: this.name, onChange: () => this.checkIfTextOverflows(), disabled: this.disabled, value: getSelectPlaceholder(), tabIndex: -1, readonly: true, "aria-label": this.ariaProps.label, title: "", style: { width: this.overflowContainerRef ? `${this.overflowContainerRef.clientWidth}px` : 'auto' }, required: this.required }),
    h("wpp-icon-chevron-v4-3-0", { class: this.isOpen || this.isDropdownOpen ? 'isOpen' : '', direction: 'down' })))));
  ...
  return (h(RootTag, { onKeyUp: this.onKeyUp, onKeyDown: this.onKeyDown, class: "wpp-single-select", "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && isBaseComponent && (h("wpp-label-v4-3-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    h("div", { class: "anchor-container" }, isRenderMessageInTooltip ? (h("wpp-tooltip-v4-3-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
    ...
    h("div", { class: "wpp-select-portal", onKeyDown: this.onKeyDownPortal, ref: el => (this.portalRef = el) },
      this.shouldShowSearch && (h(Fragment, null,
        h("wpp-input-v4-3-0", { type: "search", class: "select-portal-search-input", value: this.searchText, onWppChange: this.handleSearch, name: this.name && `${this.name}-search-input`, placeholder: this._locales.searchInputPlaceholder }),
        h("wpp-divider-v4-3-0", { color: "var(--wpp-grey-color-300)" }))),
      h("div", { class: "list", ref: el => (this.listRef = el) }, this.renderList()))));
}
...
function renderMultipleSelect() {
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && (h("wpp-inline-message-v4-3-0", { class: !this.messageType ? 'default-message' : '', showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType || 'information', tooltipConfig: this.tooltipConfig }))));
  const renderAnchor = () => (h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick() }, this.anchorButton ? (h("slot", { name: "anchor-button", onSlotchange: this.updateSlotData })) : (h(Fragment, null,
    h(WrappedSlot, { wrapperClass: this.iconStartCssClasses(), name: "icon-start", onSlotchange: this.updateSlotData }),
    ...
    h("wpp-icon-chevron-v4-3-0", { class: this.isOpen ? 'isOpen' : '', direction: 'down' })))));
  return (h(Host, { class: "wpp-multiple-select", onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && (h("wpp-label-v4-3-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    h("div", { class: "anchor-container" }, this.isRenderMessageInTooltip ? (h("wpp-tooltip-v4-3-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
    h("div", null, !this.isRenderMessageInTooltip && getInlineMessage()),
    h("div", { class: "wpp-select-portal", ref: el => (this.portalRef = el) },
      this.shouldShowSearch && (h(Fragment, null,
        h("wpp-input-v4-3-0", { type: "search", class: "select-portal-search-input", value: this.searchText, onWppChange: this.handleSearch, name: this.name && `${this.name}-search-input`, placeholder: this._locales.searchInputPlaceholder }),
        h("wpp-divider-v4-3-0", { color: "var(--wpp-grey-color-300)" }))),
      h("div", { class: "list list-with-scrollable" },
        h("div", { class: "list-scrollable", ref: refEl => (this.listRef = refEl) },
          shouldRenderTopSelectAll && (h("div", { class: "select-all-section" },
            !this.maximumSelectedItems && (h(Fragment, null,
              h("wpp-list-item-v4-3-0", { multiple: true, checked: this.isSelectAllChecked, indeterminate: this.isSelectAllIndeterminate, disabled: this.isSelectAllDisabled, onWppChangeListItem: e => {
                  e.stopPropagation();
                ...
                h("p", { slot: "label" },
                  ...
                  this.selectAllCount,
                  ")")),
              h("wpp-divider-v4-3-0", { class: "select-all-divider", color: "var(--wpp-grey-color-300)" }))),
            this.renderPinnedItems(),
            hasPinnedItems && (h("wpp-divider-v4-3-0", { class: "pinned-items-divider", color: "var(--wpp-grey-color-300)" })))),
          this.renderList())),
      this.withFolder && this.isOpen && (h("div", { class: "multiple-select-folder" },
        this.withScroll && h("wpp-divider-v4-3-0", null),
        this.showSelectAllOption ? (h("div", { class: `multiple-select-folder-buttons select-all-mode${this.withScroll ? ' with-divider' : ''}` },
          this.canClearVisible && (h("wpp-action-button-v4-3-0", { variant: "secondary", disabled: this.loading, onClick: this.handleClearAll }, this._locales.clearText)),
          h("wpp-action-button-v4-3-0", { class: "apply-button", variant: "primary", disabled: this.loading, onClick: this.handleApply }, this._locales.applyText))) : (h("div", { class: `multiple-select-folder-buttons${this.withScroll ? ' with-divider' : ''}` },
          h("wpp-action-button-v4-3-0", { variant: "secondary", disabled: !this.canSelectAll || this.loading, onClick: this.handleSelectAll }, this._locales.selectAllText),
          this.canClearAll && (h("wpp-action-button-v4-3-0", { variant: "secondary", disabled: this.loading, onClick: this.handleClearAll }, this._locales.clearAllText)))))))));
}
...
function renderTextSelect() {
  const renderAnchor = () => (h(Fragment, null,
    h("wpp-typography-v4-3-0", { id: "select-text", type: "s-body" }, this.renderedText || this.placeholder),
    h("wpp-icon-chevron-v4-3-0", { class: this.isOpen ? 'isOpen' : '', direction: 'down' })));
  const getAnchorCSSClasses = () => ({
    anchor: true,
    disabled: this.disabled,
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && (h("wpp-inline-message-v4-3-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, tooltipConfig: this.tooltipConfig }))));
  return (h(Host, { class: "wpp-text-select", onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick(), role: this.ariaProps.role || 'button', "aria-label": this.ariaProps.label ||
      ...
      } }, this.truncate && this.shouldTruncate ? (h("wpp-tooltip-v4-3-0", { text: this.renderedText || this.placeholder, config: { placement: 'right' }, class: "tooltip" }, renderAnchor())) : (renderAnchor())),
    getInlineMessage(),
    h("div", { class: "wpp-select-portal", ref: el => (this.portalRef = el) },
...
function renderCombinedSelect() {
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && (h("wpp-inline-message-v4-3-0", { message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig }))));
  ...
  return (h(Host, { class: getHostCssClasses(), onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && (h("wpp-label-v4-3-0", { class: this.labelCssClasses(), htmlFor: this.name, optional: !this.required, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    h("div", { class: "combined-anchor-container" }, this.isRenderMessageInTooltip ? (h("wpp-tooltip-v4-3-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
    h("div", null, !this.isRenderMessageInTooltip && getInlineMessage())));
}
...
const WppSelect = /*@__PURE__*/ proxyCustomElement(class WppSelect extends HTMLElement {
  constructor() {
    ...
    this.wppApply = createEvent(this, "wppApply", 1);
    ...
    this.onUpdateListMultiple = () => {
      ...
      this.internalList = [
        ...this.list.map((listItem) => {
          const hidden = !listItem.label.toLowerCase().includes(searchTextLowerCase);
          const checked = this.value?.some((valueItem) => lodash.isEqual(listItem.value, valueItem)) ?? false;
    ...
    this.checkListAgainstValueMultiple = () => {
      ...
      let disabledItems = 0;
      this.internalList?.forEach((listItem) => {
        const checked = this.value?.some((item) => lodash.isEqual(listItem.value, item)) ?? false;
        if (listItem.disabled) {
          disabledItems++;
        }
        else if (checked) {
    ...
    this.renderList = () => {
      ...
      return (h(Fragment, null, this.internalList?.map((item) => {
        ...
        const isPinned = this.filteredPinnedItems.some(p => lodash.isEqual(p.value, item.value));
        if (hidden || isPinned) {
          if (hidden)
            hiddeItemsCount++;
    ...
    this.renderPinnedItems = () => {
      ...
      return (h(Fragment, null, items.map((item) => {
        ...
        const current = this.internalList?.find(listItem => lodash.isEqual(listItem.value, item.value));
        if (!current)
          return null;
    ...
    this.onClickListItemMultiple = (listItemValue) => {
      const valueIndex = this.value?.findIndex((item) => lodash.isEqual(item, listItemValue)) ?? -1;
      if (valueIndex >= 0) {
        this.emittedValue = this.value ? [...this.value.filter((item) => !lodash.isEqual(item, listItemValue))] : [];
      }
      else {
  ...
  static get style() { return wppSelectCss; }
}, [1, "wpp-select", "wpp-select-v4-3-0", {
    ...
    "showSelectAllOption": [4, "show-select-all-option"],
    "inputValue": [1025, "input-value"],
    "maskOptions": [16],
    "inputType": [1, "input-type"],
    "tooltipConfig": [1040],
    "messageInTooltip": [4, "message-in-tooltip"],
    "scrollSelectedItemIntoView": [516, "scroll-selected-item-into-view"],
    "isOpen": [32],
    "searchText": [32],
    "internalList": [32],
    "renderedText": [32],
...
function defineCustomElement() {
  ...
  const components = ["wpp-select-v4-3-0", "wpp-action-button-v4-3-0", "wpp-checkbox-v4-3-0", "wpp-divider-v4-3-0", "wpp-icon-chevron-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-dash-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-search-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-tick-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-inline-message-v4-3-0", "wpp-input-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-label-v4-3-0", "wpp-list-item-v4-3-0", "wpp-spinner-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-select-v4-3-0":
