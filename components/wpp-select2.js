...
function renderSingleSelect(isBaseComponent = true, customSize, isRenderMessageInTooltip) {
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && isBaseComponent && (h("wpp-inline-message-v4-2-0", { class: !this.messageType ? 'default-message' : '', showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType || 'information', tooltipConfig: this.tooltipConfig }))));
  const renderAnchor = () => (h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick() }, this.anchorButton ? (h("slot", { name: "anchor-button", onSlotchange: this.updateSlotData })) : (h(Fragment, null,
    ...
    h("div", { class: "overflow-container", ref: refEl => (this.overflowContainerRef = refEl) }, this.textOverflows ? (h("wpp-tooltip-v4-2-0", { text: getSelectPlaceholder() },
    ...
    h("wpp-icon-chevron-v4-2-0", { class: this.isOpen || this.isDropdownOpen ? 'isOpen' : '', direction: 'down' })))));
  ...
  return (h(RootTag, { onKeyUp: this.onKeyUp, onKeyDown: this.onKeyDown, class: "wpp-single-select", "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && isBaseComponent && (h("wpp-label-v4-2-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    h("div", { class: "anchor-container" }, isRenderMessageInTooltip ? (h("wpp-tooltip-v4-2-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
    ...
    h("div", { class: "wpp-select-portal", onKeyDown: this.onKeyDownPortal, ref: el => (this.portalRef = el) },
      this.shouldShowSearch && (h(Fragment, null,
        h("wpp-input-v4-2-0", { type: "search", class: "select-portal-search-input", value: this.searchText, onWppChange: this.handleSearch, name: this.name && `${this.name}-search-input`, placeholder: this._locales.searchInputPlaceholder }),
        h("wpp-divider-v4-2-0", { color: "var(--wpp-grey-color-300)" }))),
...
function renderMultipleSelect() {
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && (h("wpp-inline-message-v4-2-0", { class: !this.messageType ? 'default-message' : '', showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType || 'information', tooltipConfig: this.tooltipConfig }))));
  const renderAnchor = () => (h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick() }, this.anchorButton ? (h("slot", { name: "anchor-button", onSlotchange: this.updateSlotData })) : (h(Fragment, null,
    h(WrappedSlot, { wrapperClass: this.iconStartCssClasses(), name: "icon-start", onSlotchange: this.updateSlotData }),
    ...
    h("wpp-icon-chevron-v4-2-0", { class: this.isOpen ? 'isOpen' : '', direction: 'down' })))));
  return (h(Host, { class: "wpp-multiple-select", onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && (h("wpp-label-v4-2-0", { class: this.labelCssClasses(), optional: !this.required, htmlFor: this.name, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    h("div", { class: "anchor-container" }, this.isRenderMessageInTooltip ? (h("wpp-tooltip-v4-2-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
        ...
        h("div", { class: "list-scrollable", ref: refEl => (this.listRef = refEl) },
          shouldRenderTopSelectAll && (h("div", { class: "select-all-section" },
            !this.maximumSelectedItems && (h(Fragment, null,
              h("wpp-list-item-v4-2-0", { multiple: true, checked: this.isSelectAllChecked, indeterminate: this.isSelectAllIndeterminate, disabled: this.isSelectAllDisabled, onWppChangeListItem: e => {
                  e.stopPropagation();
                ...
                h("p", { slot: "label" },
                  ...
                  this.selectAllCount,
                  ")")),
              h("wpp-divider-v4-2-0", { class: "select-all-divider", color: "var(--wpp-grey-color-300)" }))),
            this.renderPinnedItems(),
            hasPinnedItems && (h("wpp-divider-v4-2-0", { class: "pinned-items-divider", color: "var(--wpp-grey-color-300)" })))),
          this.renderList())),
      this.withFolder && this.isOpen && (h("div", { class: "multiple-select-folder" },
        this.withScroll && h("wpp-divider-v4-2-0", null),
        this.showSelectAllOption ? (h("div", { class: `multiple-select-folder-buttons select-all-mode${this.withScroll ? ' with-divider' : ''}` },
          this.canClearVisible && (h("wpp-action-button-v4-2-0", { variant: "secondary", disabled: this.loading, onClick: this.handleClearAll }, this._locales.clearText)),
          h("wpp-action-button-v4-2-0", { class: "apply-button", variant: "primary", disabled: this.loading, onClick: this.handleApply }, this._locales.applyText))) : (h("div", { class: `multiple-select-folder-buttons${this.withScroll ? ' with-divider' : ''}` },
          h("wpp-action-button-v4-2-0", { variant: "secondary", disabled: !this.canSelectAll || this.loading, onClick: this.handleSelectAll }, this._locales.selectAllText),
          this.canClearAll && (h("wpp-action-button-v4-2-0", { variant: "secondary", disabled: this.loading, onClick: this.handleClearAll }, this._locales.clearAllText)))))))));
}
...
function renderTextSelect() {
  const renderAnchor = () => (h(Fragment, null,
    h("wpp-typography-v4-2-0", { id: "select-text", type: "s-body" }, this.renderedText || this.placeholder),
    h("wpp-icon-chevron-v4-2-0", { class: this.isOpen ? 'isOpen' : '', direction: 'down' })));
  const getAnchorCSSClasses = () => ({
    anchor: true,
    disabled: this.disabled,
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && (h("wpp-inline-message-v4-2-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, tooltipConfig: this.tooltipConfig }))));
  return (h(Host, { class: "wpp-text-select", onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    h("div", { class: getAnchorCSSClasses(), ref: el => (this.anchorRef = el), tabIndex: this.disabled ? -1 : 0, onClick: () => this.handleClick(), role: this.ariaProps.role || 'button', "aria-label": this.ariaProps.label ||
      ...
      } }, this.truncate && this.shouldTruncate ? (h("wpp-tooltip-v4-2-0", { text: this.renderedText || this.placeholder, config: { placement: 'right' }, class: "tooltip" }, renderAnchor())) : (renderAnchor())),
    getInlineMessage(),
    h("div", { class: "wpp-select-portal", ref: el => (this.portalRef = el) },
...
function renderCombinedSelect() {
  ...
  const getInlineMessage = () => (h(Fragment, null, this.message && (h("wpp-inline-message-v4-2-0", { message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig }))));
  ...
  return (h(Host, { class: getHostCssClasses(), onKeyUp: this.onKeyUp, "aria-disabled": this.disabled, onFocus: this.onFocus, onBlur: this.onBlur },
    this.labelConfig?.text && (h("wpp-label-v4-2-0", { class: this.labelCssClasses(), htmlFor: this.name, optional: !this.required, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, onClick: () => this.handleClick() })),
    h("div", { class: "combined-anchor-container" }, this.isRenderMessageInTooltip ? (h("wpp-tooltip-v4-2-0", { text: this.message, error: this.messageType === 'error', warning: this.messageType === 'warning', config: this.tooltipConfig }, renderAnchor())) : (renderAnchor())),
    h("div", null, !this.isRenderMessageInTooltip && getInlineMessage())));
}
...
}, [1, "wpp-select", "wpp-select-v4-2-0", {
...
function defineCustomElement() {
  ...
  const components = ["wpp-select-v4-2-0", "wpp-action-button-v4-2-0", "wpp-checkbox-v4-2-0", "wpp-divider-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-dash-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-search-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-tick-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-input-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-list-item-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-select-v4-2-0":
