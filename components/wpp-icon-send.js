...
const WppIconSend$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSend extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-send-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-send", "wpp-icon-send-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-send-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-send-v4-2-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSend$1);
      }
      break;
  } });
}

const WppIconSend = WppIconSend$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSend, defineCustomElement };
