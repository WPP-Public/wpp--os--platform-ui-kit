...
const WppIconFlagOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconFlagOn extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-flag-on-v4-1-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-flag-on", "wpp-icon-flag-on-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-flag-on-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-flag-on-v4-1-0":
