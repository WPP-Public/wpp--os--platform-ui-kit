...
}, [1, "wpp-counter", "wpp-counter-v3-3-0", {
    "name": [1],
    "value": [1026],
    "min": [2],
    "max": [2],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-counter-v3-3-0", "wpp-action-button-v3-3-0", "wpp-icon-cross-v3-3-0", "wpp-icon-error-v3-3-0", "wpp-icon-info-message-v3-3-0", "wpp-icon-plus-v3-3-0", "wpp-icon-remove-v3-3-0", "wpp-icon-success-v3-3-0", "wpp-icon-warning-v3-3-0", "wpp-inline-message-v3-3-0", "wpp-internal-label-v3-3-0", "wpp-internal-tooltip-v3-3-0", "wpp-label-v3-3-0", "wpp-spinner-v3-3-0", "wpp-tooltip-v3-3-0", "wpp-typography-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-counter-v3-3-0":
