...
const WppCounter$1 = /*@__PURE__*/ proxyCustomElement(class WppCounter extends HTMLElement {
  ...
  static get registryIs() { return "wpp-counter-v4-2-0"; }
  get host() { return this; }
  static get watchers() { return {
    "value": ["updateFormattedValue"]
  }; }
  static get style() { return wppCounterCss; }
}, [1, "wpp-counter", "wpp-counter-v4-2-0", {
    "name": [1],
    "value": [1026],
    "min": [2],
    "max": [2],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-counter-v4-2-0", "wpp-action-button-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-plus-v4-2-0", "wpp-icon-remove-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-counter-v4-2-0":
