...
}, [1, "wpp-counter", "wpp-counter-v2-22-0", {
    "name": [1],
    "value": [1026],
    "min": [2],
    "max": [2],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-counter-v2-22-0", "wpp-action-button-v2-22-0", "wpp-icon-cross-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-info-message-v2-22-0", "wpp-icon-plus-v2-22-0", "wpp-icon-remove-v2-22-0", "wpp-icon-success-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-inline-message-v2-22-0", "wpp-internal-label-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-label-v2-22-0", "wpp-spinner-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-counter-v2-22-0":
