...
const WppEmptyContent$1 = /*@__PURE__*/ proxyCustomElement(class WppEmptyContent extends HTMLElement {
  ...
  static get registryIs() { return "wpp-empty-content-v4-0-0"; }
  static get style() { return wppImageCss; }
}, [1, "wpp-empty-content", "wpp-empty-content-v4-0-0", {
    "width": [2],
    "height": [2]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-empty-content-v4-0-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-empty-content-v4-0-0":
