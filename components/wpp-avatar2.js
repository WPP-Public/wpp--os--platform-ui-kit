...
import { d as defineCustomElement$4 } from './wpp-icon-error2.js';
...
const WppAvatar = /*@__PURE__*/ proxyCustomElement(class WppAvatar extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return wppAvatarCss; }
}, [1, "wpp-avatar", "wpp-avatar-v2-22-0", {
    "name": [1],
    "size": [1],
    "variant": [1],
    "src": [1],
    "icon": [1],
    "color": [1],
    "amountOfHiddenAvatars": [2, "amount-of-hidden-avatars"],
    "withTooltip": [4, "with-tooltip"],
    "interactable": [4],
    "index": [2],
    "tooltipConfig": [1040],
    "isImageFailedToLoad": [32],
    "focusType": [32]
  }]);
function defineCustomElement() {
  ...
  const components = ["wpp-avatar-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-tooltip-v2-22-0"];
...
export { AVATAR_COLORS_VARIANTS as A, WppAvatar as W, defineCustomElement as d };
