...
}, [1, "wpp-avatar", "wpp-avatar-v4-2-0", {
    "name": [1],
    "size": [1],
    "variant": [1],
    "src": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-avatar-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-tooltip-v4-2-0"];
