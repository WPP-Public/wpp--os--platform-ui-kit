...
const WppIconChatMessageNew$1 = /*@__PURE__*/ proxyCustomElement(class WppIconChatMessageNew extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-chat-message-new-v4-0-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-chat-message-new", "wpp-icon-chat-message-new-v4-0-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-chat-message-new-v4-0-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-chat-message-new-v4-0-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconChatMessageNew$1);
      }
      break;
  } });
}

const WppIconChatMessageNew = WppIconChatMessageNew$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconChatMessageNew, defineCustomElement };
