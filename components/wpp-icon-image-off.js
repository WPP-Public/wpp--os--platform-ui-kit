...
const WppIconImageOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconImageOff extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-image-off-v3-6-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-image-off", "wpp-icon-image-off-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-image-off-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-image-off-v3-6-0":
