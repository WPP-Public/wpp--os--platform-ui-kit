...
const WppIconDataFunnel$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDataFunnel extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-data-funnel-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-data-funnel", "wpp-icon-data-funnel-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-data-funnel-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-data-funnel-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDataFunnel$1);
      }
      break;
  } });
}

const WppIconDataFunnel = WppIconDataFunnel$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDataFunnel, defineCustomElement };
