...
import { y as getAriaProps, n as autoFocusElement } from './utils.js';
...
}, [1, "wpp-textarea-input", "wpp-textarea-input-v4-1-0", {
    "name": [1],
    "value": [1025],
    "placeholder": [1],
    "required": [516],
