...
import { z as getAriaProps, n as autoFocusElement, y as mergeLocales } from './utils.js';
...
}, [1, "wpp-textarea-input", "wpp-textarea-input-v4-3-0", {
    "name": [1],
    "value": [1025],
    "placeholder": [1],
    "required": [516],
