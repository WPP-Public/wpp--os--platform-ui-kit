...
}, [1, "wpp-pagination-select", "wpp-pagination-select-v4-2-0", {
    "count": [2],
...
function defineCustomElement() {
  ...
  const components = ["wpp-pagination-select-v4-2-0", "wpp-divider-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-pagination-item-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-pagination-select-v4-2-0":
    ...
    case "wpp-icon-chevron-v4-2-0":
      ...
      break;
    case "wpp-pagination-item-v4-2-0":
      if (!customElements.get(tagName)) {
