...
}, [1, "wpp-pagination-select", "wpp-pagination-select-v3-3-1", {
    "count": [2],
...
function defineCustomElement() {
  ...
  const components = ["wpp-pagination-select-v3-3-1", "wpp-divider-v3-3-1", "wpp-icon-chevron-v3-3-1", "wpp-pagination-item-v3-3-1", "wpp-typography-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-pagination-select-v3-3-1":
    ...
    case "wpp-icon-chevron-v3-3-1":
      ...
      break;
    case "wpp-pagination-item-v3-3-1":
      if (!customElements.get(tagName)) {
