...
const WppIconPound$1 = /*@__PURE__*/ proxyCustomElement(class WppIconPound extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-pound-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-pound", "wpp-icon-pound-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-pound-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-pound-v3-5-0":
