...
const WppIconGrid$1 = /*@__PURE__*/ proxyCustomElement(class WppIconGrid extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-grid-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-grid-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconGrid$1);
      }
      break;
  } });
}

const WppIconGrid = WppIconGrid$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconGrid, defineCustomElement };
