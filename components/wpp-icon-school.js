...
const WppIconSchool$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSchool extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-school-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-school", "wpp-icon-school-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-school-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-school-v3-5-0":
