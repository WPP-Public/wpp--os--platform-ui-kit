...
function defineCustomElement() {
  ...
  const components = ["wpp-radio-v4-1-0", "wpp-icon-error-v4-1-0", "wpp-icon-warning-v4-1-0", "wpp-internal-label-v4-1-0", "wpp-internal-tooltip-v4-1-0", "wpp-label-v4-1-0", "wpp-tooltip-v4-1-0", "wpp-typography-v4-1-0"];
