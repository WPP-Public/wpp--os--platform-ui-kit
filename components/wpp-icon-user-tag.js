...
const WppIconUserTag$1 = /*@__PURE__*/ proxyCustomElement(class WppIconUserTag extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-user-tag", "wpp-icon-user-tag-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-user-tag-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-user-tag-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconUserTag$1);
      }
      break;
  } });
}

const WppIconUserTag = WppIconUserTag$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconUserTag, defineCustomElement };
