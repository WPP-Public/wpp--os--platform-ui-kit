...
const WppIconMailAllRead$1 = /*@__PURE__*/ proxyCustomElement(class WppIconMailAllRead extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-mail-all-read-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-mail-all-read", "wpp-icon-mail-all-read-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-mail-all-read-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-mail-all-read-v3-5-0":
