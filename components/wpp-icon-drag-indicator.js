...
const WppIconDragIndicator$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDragIndicator extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-drag-indicator", "wpp-icon-drag-indicator-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-drag-indicator-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-drag-indicator-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDragIndicator$1);
      }
      break;
  } });
}

const WppIconDragIndicator = WppIconDragIndicator$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDragIndicator, defineCustomElement };
