...
const WppIconColumnsOne$1 = /*@__PURE__*/ proxyCustomElement(class WppIconColumnsOne extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-columns-one-v3-4-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-columns-one", "wpp-icon-columns-one-v3-4-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-columns-one-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-columns-one-v3-4-0":
