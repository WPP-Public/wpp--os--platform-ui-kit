...
const WppIconDataViewCards$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDataViewCards extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-data-view-cards", "wpp-icon-data-view-cards-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-data-view-cards-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-data-view-cards-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDataViewCards$1);
      }
      break;
  } });
}

const WppIconDataViewCards = WppIconDataViewCards$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDataViewCards, defineCustomElement };
