...
const WppIconLike$1 = /*@__PURE__*/ proxyCustomElement(class WppIconLike extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-like-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-like-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconLike$1);
      }
      break;
  } });
}

const WppIconLike = WppIconLike$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconLike, defineCustomElement };
