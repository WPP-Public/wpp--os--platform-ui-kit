...
}, [1, "wpp-icon-table-sort-asc-pressed", "wpp-icon-table-sort-asc-pressed-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-table-sort-asc-pressed-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-table-sort-asc-pressed-v4-1-0":
