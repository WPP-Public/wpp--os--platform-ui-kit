...
const WppIconBtc$1 = /*@__PURE__*/ proxyCustomElement(class WppIconBtc extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-btc-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-btc-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconBtc$1);
      }
      break;
  } });
}

const WppIconBtc = WppIconBtc$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconBtc, defineCustomElement };
