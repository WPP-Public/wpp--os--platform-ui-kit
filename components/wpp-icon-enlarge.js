...
const WppIconEnlarge$1 = /*@__PURE__*/ proxyCustomElement(class WppIconEnlarge extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-enlarge-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-enlarge-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconEnlarge$1);
      }
      break;
  } });
}

const WppIconEnlarge = WppIconEnlarge$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconEnlarge, defineCustomElement };
