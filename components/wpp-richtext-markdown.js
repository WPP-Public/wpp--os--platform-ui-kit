...
}, [0, "wpp-richtext-markdown", "wpp-richtext-markdown-v3-6-0", {
    "value": [1537]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-richtext-markdown-v3-6-0", "wpp-quill-styles-v3-6-0", "wpp-richtext-common-styles-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-richtext-markdown-v3-6-0":
