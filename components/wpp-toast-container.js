...
}, [1, "wpp-toast-container", "wpp-toast-container-v3-5-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-toast-container-v3-5-0", "wpp-action-button-v3-5-0", "wpp-icon-cross-v3-5-0", "wpp-icon-error-v3-5-0", "wpp-icon-info-message-v3-5-0", "wpp-icon-success-v3-5-0", "wpp-icon-warning-v3-5-0", "wpp-spinner-v3-5-0", "wpp-toast-v3-5-0", "wpp-typography-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-toast-container-v3-5-0":
