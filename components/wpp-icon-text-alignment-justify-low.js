...
const WppIconTextAlignmentJustifyLow$1 = /*@__PURE__*/ proxyCustomElement(class WppIconTextAlignmentJustifyLow extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-justify-low-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-text-alignment-justify-low", "wpp-icon-text-alignment-justify-low-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-text-alignment-justify-low-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-text-alignment-justify-low-v4-2-0":
