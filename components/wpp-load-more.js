...
}, [1, "wpp-load-more", "wpp-load-more-v4-2-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-load-more-v4-2-0", "wpp-button-v4-2-0", "wpp-progress-indicator-v4-2-0", "wpp-spinner-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-load-more-v4-2-0":
