...
import { B as BUTTON_ROLE, a as MENU_ITEM, P as PRESENTATION_ROLE } from './constants.js';
...
const WppNavigationItem = /*@__PURE__*/ proxyCustomElement(class WppNavigationItem extends HTMLElement {
  constructor() {
    ...
    this.__registerHost();
    this.__attachShadow();
    this.wppActiveNavItemChanged = createEvent(this, "wppActiveNavItemChanged", 7);
    this.onClick = (event) => {
      if (this.nativeLink)
        return;
...
}, [1, "wpp-navigation-item", "wpp-navigation-item-v4-3-0", {
...
function defineCustomElement() {
  ...
  const components = ["wpp-navigation-item-v4-3-0", "wpp-icon-chevron-v4-3-0", "wpp-icon-more-v4-3-0", "wpp-typography-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-navigation-item-v4-3-0":
