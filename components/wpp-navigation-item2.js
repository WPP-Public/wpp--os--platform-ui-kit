...
const WppNavigationItem = /*@__PURE__*/ proxyCustomElement(class WppNavigationItem extends HTMLElement {
  constructor() {
    ...
    this.linkItem = () => (h("a", { href: this.path, class: "link", onClick: this.onClick, tabIndex: -1 }, h("div", { class: this.navItemCssClasses() }, h("wpp-typography-v3-3-0", { type: this.nestedItem ? 's-body' : 's-midi', class: { 'label-text': true, 'nested-text': this.nestedItem } }, this.label))));
    this.listItem = () => (h("li", { class: "list-item", part: "list-item" }, this.linkItem()));
    this.menuItem = () => (h("div", { class: this.navItemCssClasses() }, h("wpp-icon-more-v3-3-0", { direction: "horizontal", class: "menu-icon" })));
    this.extendedItem = () => (h("div", { class: this.navItemCssClasses() }, !this.chevronOnly && (h("wpp-typography-v3-3-0", { type: "s-midi", class: "label-text" }, this.label)), h("wpp-icon-chevron-v3-3-0", { direction: "down", color: "var(--wpp-grey-color-600)", class: "chevron-icon", part: "chevron-icon" })));
    this.renderItem = () => {
      if (this.menu) {
  ...
  static get registryIs() { return "wpp-navigation-item-v3-3-0"; }
  static get style() { return wppNavigationItemCss; }
}, [1, "wpp-navigation-item", "wpp-navigation-item-v3-3-0", {
...
function defineCustomElement() {
  ...
  const components = ["wpp-navigation-item-v3-3-0", "wpp-icon-chevron-v3-3-0", "wpp-icon-more-v3-3-0", "wpp-typography-v3-3-0"];
