...
const WppIconH2 = /*@__PURE__*/ proxyCustomElement(class WppIconH2 extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-h2-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-h2", "wpp-icon-h2-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-h2-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-h2-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconH2);
      }
      break;
  } });
}

export { WppIconH2 as W, defineCustomElement as d };
