...
const WppIconLogin$1 = /*@__PURE__*/ proxyCustomElement(class WppIconLogin extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-login", "wpp-icon-login-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-login-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-login-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconLogin$1);
      }
      break;
  } });
}

const WppIconLogin = WppIconLogin$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconLogin, defineCustomElement };
