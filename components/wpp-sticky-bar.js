...
}, [1, "wpp-sticky-bar", "wpp-sticky-bar-v3-3-1", {
    "variant": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-sticky-bar-v3-3-1", "wpp-action-button-v3-3-1", "wpp-button-v3-3-1", "wpp-icon-chevron-v3-3-1", "wpp-spinner-v3-3-1", "wpp-tab-v3-3-1", "wpp-tabs-v3-3-1", "wpp-typography-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-sticky-bar-v3-3-1":
