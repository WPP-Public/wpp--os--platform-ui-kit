...
}, [1, "wpp-sticky-bar", "wpp-sticky-bar-v3-5-0", {
    "variant": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-sticky-bar-v3-5-0", "wpp-action-button-v3-5-0", "wpp-button-v3-5-0", "wpp-icon-chevron-v3-5-0", "wpp-spinner-v3-5-0", "wpp-tab-v3-5-0", "wpp-tabs-v3-5-0", "wpp-typography-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-sticky-bar-v3-5-0":
