...
const WppIconCaptionOn = /*@__PURE__*/ proxyCustomElement(class WppIconCaptionOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-caption-on", "wpp-icon-caption-on-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-caption-on-v3-6-0"];
...
export { WppIconCaptionOn as W, defineCustomElement as d };
