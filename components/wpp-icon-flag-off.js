...
const WppIconFlagOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconFlagOff extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-flag-off-v3-4-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-flag-off", "wpp-icon-flag-off-v3-4-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-flag-off-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-flag-off-v3-4-0":
