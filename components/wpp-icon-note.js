...
const WppIconNote$1 = /*@__PURE__*/ proxyCustomElement(class WppIconNote extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-note-v3-3-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-note", "wpp-icon-note-v3-3-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-note-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-note-v3-3-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconNote$1);
      }
      break;
  } });
}

const WppIconNote = WppIconNote$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconNote, defineCustomElement };
