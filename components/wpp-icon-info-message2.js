...
const WppIconInfoMessage = /*@__PURE__*/ proxyCustomElement(class WppIconInfoMessage extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-info-message", "wpp-icon-info-message-v3-3-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-info-message-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-info-message-v3-3-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconInfoMessage);
      }
      break;
  } });
}

export { WppIconInfoMessage as W, defineCustomElement as d };
