...
const WppRichtextHtml$1 = /*@__PURE__*/ proxyCustomElement(class WppRichtextHtml extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, null, h("wpp-quill-styles-v3-4-0", null), h("wpp-richtext-common-styles-v3-4-0", null), h("div", { class: classes, "data-testid": "richtext-editor-container" }, h("div", { class: "ql-editor", innerHTML: this.value, "data-testid": "richtext-editor" }))));
  }
  static get registryIs() { return "wpp-richtext-html-v3-4-0"; }
}, [0, "wpp-richtext-html", "wpp-richtext-html-v3-4-0", {
    "value": [1025]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-richtext-html-v3-4-0", "wpp-quill-styles-v3-4-0", "wpp-richtext-common-styles-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-richtext-html-v3-4-0":
