...
const WppIconReply$1 = /*@__PURE__*/ proxyCustomElement(class WppIconReply extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-reply-v4-1-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-reply", "wpp-icon-reply-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-reply-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-reply-v4-1-0":
