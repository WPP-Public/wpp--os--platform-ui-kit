...
const WppChatAlert$1 = /*@__PURE__*/ proxyCustomElement(class WppChatAlert extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const WppChatAlert = WppChatAlert$1;
const defineCustomElement = defineCustomElement$1;

export { WppChatAlert, defineCustomElement };
