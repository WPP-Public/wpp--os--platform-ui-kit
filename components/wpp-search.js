  ...
  constructor() {
    ...
    this.renderInputPlaceholder = () => {
      if ((this.isFocused && !this.searchValue) || this.isDropdownShown || !this.value.length)
        return null;
      return (h("wpp-typography-v4-3-0", { type: "s-body", class: "input-placeholder", ref: placeholderEl => (this.placeholderEl = placeholderEl) }, this.getOptionLabel(this.value[0])));
    };
    ...
    this.renderDropdownContent = () => {
      ...
      if (this.value.length && !this.isFocused)
        return null;
      if (this.loading) {
        return (h("div", { class: "loading" }, h("wpp-spinner-v4-3-0", { slot: "left" }), h("wpp-typography-v4-3-0", { type: "s-body", slot: "label" }, this._locales.loading)));
      }
      ...
      return (h(Fragment, null, !!this._locales.dropdownHeader && (h("wpp-list-item-v4-3-0", { class: "dropdown-header", part: "dropdown-header" }, h("wpp-typography-v4-3-0", { type: "s-strong", slot: "label" }, this._locales.dropdownHeader))), h("slot", null), h("div", null, this.isInfiniteLoading && (h("div", { class: "infinite-loader" }, h("wpp-spinner-v4-3-0", null))))));
    };
    this.isFocused = false;
    this.searchValue = '';
...
}, [1, "wpp-search", "wpp-search-v4-3-0", {
    "name": [1],
    "loading": [516],
    "disabled": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-search-v4-3-0", "wpp-action-button-v4-3-0", "wpp-checkbox-v4-3-0", "wpp-icon-chevron-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-dash-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-search-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-tick-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-inline-message-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-label-v4-3-0", "wpp-list-item-v4-3-0", "wpp-spinner-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-search-v4-3-0":
