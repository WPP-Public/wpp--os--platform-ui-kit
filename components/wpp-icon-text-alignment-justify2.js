...
const WppIconTextAlignmentJustify = /*@__PURE__*/ proxyCustomElement(class WppIconTextAlignmentJustify extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-text-alignment-justify-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-text-alignment-justify", "wpp-icon-text-alignment-justify-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-text-alignment-justify-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-text-alignment-justify-v2-22-0":
