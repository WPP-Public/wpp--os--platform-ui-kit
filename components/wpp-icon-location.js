...
const WppIconLocation$1 = /*@__PURE__*/ proxyCustomElement(class WppIconLocation extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-location-v4-1-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-location", "wpp-icon-location-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-location-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-location-v4-1-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconLocation$1);
      }
      break;
  } });
}

const WppIconLocation = WppIconLocation$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconLocation, defineCustomElement };
