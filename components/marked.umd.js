...
import { W as WppIconAttach } from './wpp-icon-attach2.js';
import { W as WppIconBlockquote } from './wpp-icon-blockquote2.js';
import { W as WppIconBold } from './wpp-icon-bold2.js';
import { W as WppIconCodeView } from './wpp-icon-code-view2.js';
import { W as WppIconFloatCenter } from './wpp-icon-float-center2.js';
import { W as WppIconFloatLeft } from './wpp-icon-float-left2.js';
import { W as WppIconFloatRight } from './wpp-icon-float-right2.js';
import { W as WppIconH1 } from './wpp-icon-h12.js';
import { W as WppIconH2 } from './wpp-icon-h22.js';
import { W as WppIconImage } from './wpp-icon-image2.js';
import { W as WppIconIndentDecrease } from './wpp-icon-indent-decrease2.js';
import { W as WppIconIndentIncrease } from './wpp-icon-indent-increase2.js';
import { W as WppIconItalic } from './wpp-icon-italic2.js';
import { W as WppIconLink } from './wpp-icon-link2.js';
import { W as WppIconOrderedList } from './wpp-icon-ordered-list2.js';
import { W as WppIconRedo } from './wpp-icon-redo2.js';
import { W as WppIconStrikeThrough } from './wpp-icon-strike-through2.js';
import { W as WppIconTextAlignmentCenter } from './wpp-icon-text-alignment-center2.js';
import { W as WppIconTextAlignmentJustify } from './wpp-icon-text-alignment-justify2.js';
import { W as WppIconTextAlignmentLeft } from './wpp-icon-text-alignment-left2.js';
import { W as WppIconTextAlignmentRight } from './wpp-icon-text-alignment-right2.js';
import { W as WppIconUnderline } from './wpp-icon-underline2.js';
import { W as WppIconUndo } from './wpp-icon-undo2.js';
import { W as WppIconUnorderedList } from './wpp-icon-unordered-list2.js';
import { W as WppIconVideoClip } from './wpp-icon-video-clip2.js';
import { W as WppProgressIndicator } from './wpp-progress-indicator2.js';
import { W as WppIconChevron } from './wpp-icon-chevron2.js';
import { W as WppIconGallery } from './wpp-icon-gallery2.js';
import { l as lodash } from './lodash.js';
import { W as WppActionButton } from './wpp-action-button2.js';
import { W as WppInput } from './wpp-input2.js';
...
const Quill$2 = /*@__PURE__*/getDefaultExportFromCjs(quill);

const uploadTypes = ['image', 'video', 'attachment'];
const UPLOAD_REQUEST_EVENT = 'upload-request';

const Quill$1 = Quill$2;
const debugLevels = {
  error: 'error',
  warn: 'warn',
  log: 'log',
...
function extendBlotNames(blotNames) {
  blotNames.forEach(blotName => {
    Quill$2.register(blotName, extendBlot(Quill$2.import(blotName)), true);
  });
}
...
class BlotSpec {
  ...
  setSelection() {
    const blot = Quill$2.find(this.getTargetElement());
    if (blot) {
...
const QuillToolbar = Quill$2.import('modules/toolbar');
...
const BlockEmbed = Quill$2.import('blots/block/embed');
...
const BaseBlot$1 = Quill$2.import('blots/embed');
...
Quill$2.register('formats/attachment', AttachmentBlot);
Quill$2.register('formats/attachmentUploading', AttachmentUploadingBlot);
...
const BaseBlot = Quill$2.import('blots/embed');
...
Quill$2.register('formats/video', VideoBlot, true);
Quill$2.register('formats/videoUploading', VideoUploadingBlot);
...
Quill$2.register('formats/image', ImageBlot, true);
Quill$2.register('formats/imageUploading', ImageUploadingBlot);
...
const LinkBlot = Quill$2.import('formats/link');
...
const SizeAttributor = Quill$1.import('attributors/class/size');
SizeAttributor.whitelist = ['2xs', 'xs', 'm', 'l', 'xl', '2xl', '3xl', '4xl', '5xl'];
Quill$1.register(SizeAttributor, true);
Quill$1.register({ 'themes/wpp': WppTheme });
// media upload modules
Quill$1.register('modules/imageUpload', Image);
Quill$1.register('modules/videoUpload', Video);
Quill$1.register('modules/attachmentUpload', Attachment);
// image and video positioning modules (width, height, float, align)
ImageFormats.extendBlotNames = ['formats/image', 'formats/video'];
Quill$1.register('modules/imageFormats', ImageFormats);
Quill$1.register('modules/imageActions', ImageActions);
const keyboardModule = Quill$1.import('modules/keyboard');
...
Quill$1.register('modules/toolbar', WppQuillToolbar, true);
Quill$1.register('modules/imageLibrary', () => { });
Quill$1.DEFAULTS.formats = [...defaultFormats, ...quillImageFormats, ...quillUploadFormats];
Quill$1.DEFAULTS.modules = {
  history: {
    delay: 1000,
    maxStack: 100,
    userOnly: true,
...
export { KEYBOARD_FOCUS_CLASS as K, Quill$1 as Q, UPLOAD_REQUEST_EVENT as U, exportHtml as a, deepmerge_1 as b, createDragThumbnail as c, debugLevels as d, embedBlotInnerHtmlRegexp as e, formats as f, KEYBOARD_FOCUS_EVENT as g, marked_umd as m, quillMarkdownOptions as q, sources as s, turndownService as t, uploadTypes as u };
