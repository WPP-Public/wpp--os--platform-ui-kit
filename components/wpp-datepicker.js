...
import { g as getSlotEmptyStates, k as transformToVersionedTag, w as getHighestContainerInDOM, n as autoFocusElement, y as mergeLocales } from './utils.js';
...
}, [1, "wpp-datepicker", "wpp-datepicker-v4-2-0", {
    "range": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-datepicker-v4-2-0", "wpp-action-button-v4-2-0", "wpp-checkbox-v4-2-0", "wpp-icon-calendar-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-dash-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-tick-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-list-item-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-datepicker-v4-2-0":
