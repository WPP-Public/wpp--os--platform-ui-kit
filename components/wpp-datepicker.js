...
import { c as createCommonjsModule, a as commonjsGlobal, g as getDefaultExportFromCjs } from './_commonjsHelpers.js';
import { a as isObjectLike_1, _ as _baseGetTag, b as _baseUnary, c as _nodeUtil, i as isEqual_1, m as menuListConfig } from './menuListConfig.js';
import { F as FOCUS_TYPE } from './common.js';
import { j as transformToVersionedTag, v as getHighestContainerInDOM, m as autoFocusElement } from './utils.js';
...
import { d as defineCustomElement$i } from './wpp-icon-calendar2.js';
...
var airDatepicker = createCommonjsModule(function (module, exports) {
...
const defaultLocale = /*@__PURE__*/getDefaultExportFromCjs(en);
...
const WppDatepicker$1 = /*@__PURE__*/ proxyCustomElement(class WppDatepicker extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    ...
    this.setInitialDate = () => {
      if (this.value === '' || isEqual_1(this.value, [])) {
    ...
    this.onKeyUp = (event) => {
      ...
      if (!isEqual_1(inputDates, this.datePickerInstance.selectedDates)) {
        // @ts-ignore Due to outdated air-datepicker.d.ts
    ...
    this.handlePreviewPreset = (dateRange) => {
      ...
      if (isValidDate([formattedStartDate, formattedEndDate]) &&
        (!isEqual_1(currentSelectedStartDate, formattedStartDate) || !isEqual_1(currentSelectedEndDate, formattedEndDate))) {
  ...
  updateValue() {
    ...
    if (this.range) {
      ...
      if (isValidDate(formattedDate) && !isEqual_1(formattedDate, currentDatePickerValue)) {
        this.setInitialDate();
      }
    }
  }
  ...
  static get style() { return wppDatepickerCss; }
}, [1, "wpp-datepicker", "wpp-datepicker-v2-22-0", {
    "range": [4],
    ...
    "locale": [16],
    "labelConfig": [1040],
    "appendToListWrapper": [1028, "append-to-list-wrapper"],
    "dropdownConfig": [1040],
    "datePickerInstance": [32],
    "lastValidDate": [32],
    "lastAppliedDate": [32],
    "focusType": [32],
    "hidden": [32],
...
function defineCustomElement$1() {
  ...
  components.forEach(tagName => { switch (tagName) {
    ...
    case "wpp-checkbox-v2-22-0":
      ...
      break;
    case "wpp-icon-calendar-v2-22-0":
      if (!customElements.get(tagName)) {
...
const WppDatepicker = WppDatepicker$1;
const defineCustomElement = defineCustomElement$1;

export { WppDatepicker, defineCustomElement };
