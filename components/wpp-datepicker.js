...
import { g as getSlotEmptyStates, k as transformToVersionedTag, w as getHighestContainerInDOM, n as autoFocusElement } from './utils.js';
...
const WppDatepicker$1 = /*@__PURE__*/ proxyCustomElement(class WppDatepicker extends HTMLElement {
  ...
  static get style() { return wppDatepickerCss; }
}, [1, "wpp-datepicker", "wpp-datepicker-v3-4-0", {
    "range": [4],
    ...
    "dropdownConfig": [1040],
    "reverseLayout": [4, "reverse-layout"],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-datepicker-v3-4-0", "wpp-action-button-v3-4-0", "wpp-checkbox-v3-4-0", "wpp-icon-calendar-v3-4-0", "wpp-icon-chevron-v3-4-0", "wpp-icon-cross-v3-4-0", "wpp-icon-dash-v3-4-0", "wpp-icon-error-v3-4-0", "wpp-icon-info-message-v3-4-0", "wpp-icon-success-v3-4-0", "wpp-icon-tick-v3-4-0", "wpp-icon-warning-v3-4-0", "wpp-inline-message-v3-4-0", "wpp-internal-label-v3-4-0", "wpp-internal-tooltip-v3-4-0", "wpp-label-v3-4-0", "wpp-list-item-v3-4-0", "wpp-spinner-v3-4-0", "wpp-tooltip-v3-4-0", "wpp-typography-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-datepicker-v3-4-0":
