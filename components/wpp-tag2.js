...
function defineCustomElement() {
  ...
  const components = ["wpp-tag-v3-5-0", "wpp-icon-error-v3-5-0", "wpp-icon-warning-v3-5-0", "wpp-internal-tooltip-v3-5-0", "wpp-tooltip-v3-5-0", "wpp-typography-v3-5-0"];
