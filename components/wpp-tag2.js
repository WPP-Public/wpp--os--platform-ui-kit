...
function defineCustomElement() {
  ...
  const components = ["wpp-tag-v4-0-0", "wpp-icon-error-v4-0-0", "wpp-icon-warning-v4-0-0", "wpp-internal-tooltip-v4-0-0", "wpp-tooltip-v4-0-0", "wpp-typography-v4-0-0"];
