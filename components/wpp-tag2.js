...
import { g as getSlotEmptyStates, d as debounce, e as truncate } from './utils.js';
...
function defineCustomElement() {
  ...
  const components = ["wpp-tag-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
