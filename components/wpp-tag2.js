...
import { g as getSlotEmptyStates, c as truncate } from './utils.js';
...
function defineCustomElement() {
  ...
  const components = ["wpp-tag-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
