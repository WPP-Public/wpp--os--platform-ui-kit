...
const WppIconFullscreenMinimise = /*@__PURE__*/ proxyCustomElement(class WppIconFullscreenMinimise extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-fullscreen-minimise", "wpp-icon-fullscreen-minimise-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-fullscreen-minimise-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-fullscreen-minimise-v3-6-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconFullscreenMinimise);
      }
      break;
  } });
}

export { WppIconFullscreenMinimise as W, defineCustomElement as d };
