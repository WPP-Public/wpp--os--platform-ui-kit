...
const WppFloatingToolbar$1 = /*@__PURE__*/ proxyCustomElement(class WppFloatingToolbar extends HTMLElement {
  constructor() {
    ...
    this.renderActionButton = (data) => (h("wpp-action-button-v3-3-0", { key: `${data.icon}`, ...data }, h(transformToVersionedTag(data.icon), { slot: 'icon-start', part: 'icon' })));
  ...
  static get registryIs() { return "wpp-floating-toolbar-v3-3-0"; }
  get host() { return this; }
  static get watchers() { return {
    "actionButtonsConfig": ["onUpdateActionButtonsConfig"]
  }; }
  static get style() { return wppFloatingToolbarCss; }
}, [1, "wpp-floating-toolbar", "wpp-floating-toolbar-v3-3-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-floating-toolbar-v3-3-0", "wpp-action-button-v3-3-0", "wpp-spinner-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-floating-toolbar-v3-3-0":
