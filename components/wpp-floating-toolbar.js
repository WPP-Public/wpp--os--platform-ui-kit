...
}, [1, "wpp-floating-toolbar", "wpp-floating-toolbar-v3-5-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-floating-toolbar-v3-5-0", "wpp-action-button-v3-5-0", "wpp-spinner-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-floating-toolbar-v3-5-0":
