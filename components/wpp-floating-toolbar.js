...
}, [1, "wpp-floating-toolbar", "wpp-floating-toolbar-v4-1-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-floating-toolbar-v4-1-0", "wpp-action-button-v4-1-0", "wpp-spinner-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-floating-toolbar-v4-1-0":
