...
}, [1, "wpp-back-to-top-button", "wpp-back-to-top-button-v3-3-0", {
    "ariaProps": [16],
    "focusType": [32],
    "isPressed": [32],
    "validAriaProps": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-back-to-top-button-v3-3-0", "wpp-icon-arrow-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-back-to-top-button-v3-3-0":
