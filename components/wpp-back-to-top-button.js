...
const WppBackToTopButton$1 = /*@__PURE__*/ proxyCustomElement(class WppBackToTopButton extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), exportparts: "button, icon", onMouseDown: this.onMouseDown, onKeyDown: this.onKeyDown, onKeyUp: this.onKeyUp }, h("button", { ref: el => (this.buttonRef = el), onBlur: this.onBlur, class: this.buttonCssClasses(), type: "button", part: "button", "data-testid": "wppBackToTopButton", "aria-pressed": this.isPressed ? 'true' : 'false', ...this.validAriaProps }, h("wpp-icon-arrow-v3-4-0", { direction: "top", class: "icon", part: "icon" }))));
  }
...
}, [1, "wpp-back-to-top-button", "wpp-back-to-top-button-v3-4-0", {
    "ariaProps": [16],
    "focusType": [32],
    "isPressed": [32],
    "validAriaProps": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-back-to-top-button-v3-4-0", "wpp-icon-arrow-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-back-to-top-button-v3-4-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppBackToTopButton$1);
      }
      break;
    case "wpp-icon-arrow-v3-4-0":
      if (!customElements.get(tagName)) {
