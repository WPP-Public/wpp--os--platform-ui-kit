...
const WppBackToTopButton$1 = /*@__PURE__*/ proxyCustomElement(class WppBackToTopButton extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), exportparts: "button, icon", onMouseDown: this.onMouseDown, onKeyDown: this.onKeyDown, onKeyUp: this.onKeyUp }, h("button", { ref: el => (this.buttonRef = el), onBlur: this.onBlur, class: this.buttonCssClasses(), type: "button", part: "button", "data-testid": "wppBackToTopButton", "aria-pressed": this.isPressed ? 'true' : 'false', ...this.validAriaProps }, h("wpp-icon-arrow-v3-3-1", { direction: "top", class: "icon", part: "icon" }))));
  }
  static get registryIs() { return "wpp-back-to-top-button-v3-3-1"; }
  get host() { return this; }
  static get watchers() { return {
    "ariaProps": ["onUpdateAriaProps"]
  }; }
  static get style() { return wppBackToTopButtonCss; }
}, [1, "wpp-back-to-top-button", "wpp-back-to-top-button-v3-3-1", {
    "ariaProps": [16],
    "focusType": [32],
    "isPressed": [32],
    "validAriaProps": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-back-to-top-button-v3-3-1", "wpp-icon-arrow-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-back-to-top-button-v3-3-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppBackToTopButton$1);
      }
      break;
    case "wpp-icon-arrow-v3-3-1":
      if (!customElements.get(tagName)) {
