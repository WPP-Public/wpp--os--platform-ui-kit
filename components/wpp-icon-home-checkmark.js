...
const WppIconHomeCheckmark$1 = /*@__PURE__*/ proxyCustomElement(class WppIconHomeCheckmark extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-home-checkmark", "wpp-icon-home-checkmark-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-home-checkmark-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-home-checkmark-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconHomeCheckmark$1);
      }
      break;
  } });
}

const WppIconHomeCheckmark = WppIconHomeCheckmark$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconHomeCheckmark, defineCustomElement };
