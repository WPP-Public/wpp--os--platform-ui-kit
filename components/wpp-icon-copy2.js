...
const WppIconCopy = /*@__PURE__*/ proxyCustomElement(class WppIconCopy extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-copy", "wpp-icon-copy-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-copy-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-copy-v4-1-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCopy);
      }
      break;
  } });
}

export { WppIconCopy as W, defineCustomElement as d };
