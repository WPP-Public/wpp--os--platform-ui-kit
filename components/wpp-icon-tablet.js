...
const WppIconTablet$1 = /*@__PURE__*/ proxyCustomElement(class WppIconTablet extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-tablet", "wpp-icon-tablet-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-tablet-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-tablet-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconTablet$1);
      }
      break;
  } });
}

const WppIconTablet = WppIconTablet$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconTablet, defineCustomElement };
