...
const WppIconBlockquote = /*@__PURE__*/ proxyCustomElement(class WppIconBlockquote extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-blockquote-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-blockquote", "wpp-icon-blockquote-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-blockquote-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-blockquote-v2-22-0":
