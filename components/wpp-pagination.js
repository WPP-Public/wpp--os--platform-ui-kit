...
const WppPagination$1 = /*@__PURE__*/ proxyCustomElement(class WppPagination extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, { class: this.hostCssClasses(), exportparts: "body, per-page-label, pre-page-select, per-page-item, divider, range, page-select" }, h("div", { class: "control-pagination-wrapper", part: "body" }, h("wpp-typography-v3-3-1", { type: "s-body", part: "per-page-label" }, this._locales.itemsPerPage, ":"), h("wpp-select-v3-3-1", { type: "single", isTextSelect: true, onWppChange: this.handleItemsPerPageNumberChange, value: this.selectedItemPerPage, dropdownConfig: { ...this.dropdownConfig }, dropdownWidth: "100px", part: "pre-page-select", list: this.itemsPerPage.map(item => ({
        value: item,
        label: `${item}`,
        part: 'per-page-item',
      })) }), h("wpp-divider-v3-3-1", { part: "divider" }), h("wpp-typography-v3-3-1", { type: "s-body", part: "range" }, this.getPageRange())), countPagesToDisplay && (h("wpp-pagination-select-v3-3-1", { count: countPagesToDisplay, pageSelectThreshold: this.pageSelectThreshold, onWppChange: this.handleSelectedPageChange, activePageNumber: this.activePageNumber, part: "page-select" }))));
  }
  static get registryIs() { return "wpp-pagination-v3-3-1"; }
  static get watchers() { return {
    "locales": ["onUpdateLocales"]
  }; }
  static get style() { return wppPaginationCss; }
}, [1, "wpp-pagination", "wpp-pagination-v3-3-1", {
    "count": [2],
    "itemsPerPage": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-pagination-v3-3-1", "wpp-action-button-v3-3-1", "wpp-checkbox-v3-3-1", "wpp-divider-v3-3-1", "wpp-icon-chevron-v3-3-1", "wpp-icon-cross-v3-3-1", "wpp-icon-dash-v3-3-1", "wpp-icon-error-v3-3-1", "wpp-icon-info-message-v3-3-1", "wpp-icon-search-v3-3-1", "wpp-icon-success-v3-3-1", "wpp-icon-tick-v3-3-1", "wpp-icon-warning-v3-3-1", "wpp-inline-message-v3-3-1", "wpp-input-v3-3-1", "wpp-internal-label-v3-3-1", "wpp-internal-tooltip-v3-3-1", "wpp-label-v3-3-1", "wpp-list-item-v3-3-1", "wpp-pagination-item-v3-3-1", "wpp-pagination-select-v3-3-1", "wpp-select-v3-3-1", "wpp-spinner-v3-3-1", "wpp-tooltip-v3-3-1", "wpp-typography-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-pagination-v3-3-1":
