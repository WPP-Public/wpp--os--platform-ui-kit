...
const WppEmptyNothingFound$1 = /*@__PURE__*/ proxyCustomElement(class WppEmptyNothingFound extends HTMLElement {
  ...
  static get registryIs() { return "wpp-empty-nothing-found-v4-1-0"; }
  static get style() { return wppImageCss; }
}, [1, "wpp-empty-nothing-found", "wpp-empty-nothing-found-v4-1-0", {
    "width": [2],
    "height": [2]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-empty-nothing-found-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-empty-nothing-found-v4-1-0":
