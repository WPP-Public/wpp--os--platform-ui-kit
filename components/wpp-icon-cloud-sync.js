...
const WppIconCloudSync$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCloudSync extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-cloud-sync-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-cloud-sync", "wpp-icon-cloud-sync-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-cloud-sync-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-cloud-sync-v3-5-0":
