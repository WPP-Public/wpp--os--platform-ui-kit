...
const WppIconTableLink$1 = /*@__PURE__*/ proxyCustomElement(class WppIconTableLink extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-table-link-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-table-link-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconTableLink$1);
      }
      break;
  } });
}

const WppIconTableLink = WppIconTableLink$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconTableLink, defineCustomElement };
