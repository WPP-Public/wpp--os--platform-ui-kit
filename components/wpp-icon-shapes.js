...
const WppIconShapes$1 = /*@__PURE__*/ proxyCustomElement(class WppIconShapes extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-shapes-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-shapes", "wpp-icon-shapes-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-shapes-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-shapes-v3-5-0":
