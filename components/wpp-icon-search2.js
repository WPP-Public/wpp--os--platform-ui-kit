...
const WppIconSearch = /*@__PURE__*/ proxyCustomElement(class WppIconSearch extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-search-v3-3-1"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-search", "wpp-icon-search-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-search-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-search-v3-3-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSearch);
      }
      break;
  } });
}

export { WppIconSearch as W, defineCustomElement as d };
