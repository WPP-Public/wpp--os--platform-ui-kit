...
const WppIconCaptionOff = /*@__PURE__*/ proxyCustomElement(class WppIconCaptionOff extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-caption-off", "wpp-icon-caption-off-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-caption-off-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-caption-off-v3-5-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCaptionOff);
      }
      break;
  } });
}

export { WppIconCaptionOff as W, defineCustomElement as d };
