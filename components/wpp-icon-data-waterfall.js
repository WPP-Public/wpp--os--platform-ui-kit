...
const WppIconDataWaterfall$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDataWaterfall extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-data-waterfall", "wpp-icon-data-waterfall-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-data-waterfall-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-data-waterfall-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDataWaterfall$1);
      }
      break;
  } });
}

const WppIconDataWaterfall = WppIconDataWaterfall$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDataWaterfall, defineCustomElement };
