...
const WppSlider$1 = /*@__PURE__*/ proxyCustomElement(class WppSlider extends HTMLElement {
  constructor() {
    ...
    this.renderControl = () => {
      const label = this.labelConfig?.text && (h("wpp-label-v4-3-0", { htmlFor: this.name, optional: !this.required, disabled: this.disabled, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, part: "label" }));
      if (this.withValue && !this.withInput) {
        return (h("div", { class: this.controlCssClasses(), part: "control-wrapper" }, label || h("div", null), this.handleType({
          single: value => (h("wpp-typography-v4-3-0", { type: "s-midi", part: "value" }, value)),
          range: value => (h("div", { class: "range-value-wrapper", part: "value-wrapper" }, h("wpp-typography-v4-3-0", { type: "s-midi", part: "value" }, value[0]), h("wpp-divider-v4-3-0", { part: "value-divider", class: { divider: true, disabled: this.disabled } }), h("wpp-typography-v4-3-0", { type: "s-midi", part: "value" }, value[1]))),
          'middle-range': value => (h("div", { class: "range-value-wrapper", part: "value-wrapper" }, h("wpp-typography-v4-3-0", { type: "s-midi", part: "value" }, this.isMiddlePointHigher() ? value : this.middleValue), h("wpp-divider-v4-3-0", { part: "value-divider", class: { divider: true, disabled: this.disabled } }), h("wpp-typography-v4-3-0", { type: "s-midi", part: "value" }, this.isMiddlePointHigher() ? this.middleValue : value))),
        })));
      }
      return label;
    };
    this.renderSingleInput = () => (h("wpp-input-v4-3-0", { ref: inputRef => (this.inputRef = inputRef), type: "text", size: this.size, disabled: this.disabled, part: "input-number", onBlur: this.handleBlur, style: { width: this.inputWidth ? this.inputWidth : DEFAULT_INPUT_WIDTH }, class: { [`size-${this.size}`]: true }, maskOptions: {
    ...
    this.renderEditableInput = () => (h("div", { class: this.editableInputCssClasses(), part: "editable-input-wrapper" }, this.handleType({
      ...
      range: () => (h("div", { class: "range-input-wrapper", part: "input-wrapper" }, h("wpp-input-v4-3-0", { ref: inputRef => (this.inputRef = inputRef), type: "text", size: this.size, disabled: this.disabled, part: "input-min", onBlur: this.handleBlur, style: { width: this.inputWidth ? this.inputWidth : DEFAULT_INPUT_WIDTH }, class: { 'min-input': true, [`size-${this.size}`]: true }, maskOptions: {
          decimalPatternOptions: this.maskOptions && this.maskOptions[0]
            ...
            : getDefaultMaskOptions(this.step),
        } }), h("wpp-divider-v4-3-0", { class: { 'wpp-disabled': this.disabled }, part: "divider" }), h("wpp-input-v4-3-0", { ref: inputRef => (this.inputMaxRef = inputRef), type: "text", size: this.size, disabled: this.disabled, part: "input-max", onBlur: this.handleBlur, style: { width: this.inputWidth ? this.inputWidth : DEFAULT_INPUT_WIDTH }, class: { 'max-input': true, [`size-${this.size}`]: true }, maskOptions: {
    ...
    this.renderMarks = () => {
      if (this.displayMarks.length > 0) {
        ...
        return this.displayMarks.map((mark, index) => {
          ...
          const labelContent = (h("wpp-typography-v4-3-0", { id: `mark-label-${mark.value}`, class: this.labelCssClasses(), type: "xs-body", part: "label" }, labelText));
          return (h("div", { onClick: event => this.handleMarkClick(event, mark), class: this.markCssClasses(mark.value), style: style, part: "mark" }, !this.continuous && (h("div", { class: "circle", part: "mark-circle" }, h("div", { class: "mark", part: "mark-inner" }))), h("div", { class: "label-container" }, isTruncated ? (h("wpp-tooltip-v4-3-0", { config: { placement: tooltipPlacement }, text: this.tooltipTexts[mark.value] }, labelContent)) : (labelContent))));
        });
      }
    };
...
}, [1, "wpp-slider", "wpp-slider-v4-3-0", {
    "name": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-slider-v4-3-0", "wpp-action-button-v4-3-0", "wpp-divider-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-search-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-inline-message-v4-3-0", "wpp-input-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-label-v4-3-0", "wpp-spinner-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-slider-v4-3-0":
