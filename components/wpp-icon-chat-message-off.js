...
const WppIconChatMessageOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconChatMessageOff extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-chat-message-off-v3-3-1"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-chat-message-off", "wpp-icon-chat-message-off-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-chat-message-off-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-chat-message-off-v3-3-1":
