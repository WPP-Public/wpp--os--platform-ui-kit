...
const WppIconAutofitHeight$1 = /*@__PURE__*/ proxyCustomElement(class WppIconAutofitHeight extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-autofit-height-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-autofit-height-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconAutofitHeight$1);
      }
      break;
  } });
}

const WppIconAutofitHeight = WppIconAutofitHeight$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconAutofitHeight, defineCustomElement };
