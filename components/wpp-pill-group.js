...
}, [1, "wpp-pill-group", "wpp-pill-group-v4-2-0", {
    "name": [1],
    "size": [1],
    "value": [1032],
    "type": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-pill-group-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-pill-group-v4-2-0":
