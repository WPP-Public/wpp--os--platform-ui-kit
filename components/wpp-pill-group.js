...
const WppPillGroup$1 = /*@__PURE__*/ proxyCustomElement(class WppPillGroup extends HTMLElement {
  ...
  static get registryIs() { return "wpp-pill-group-v2-22-0"; }
...
}, [1, "wpp-pill-group", "wpp-pill-group-v2-22-0", {
    "name": [1],
    "size": [1],
    "value": [1032],
    "type": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-pill-group-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-label-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-label-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-pill-group-v2-22-0":
