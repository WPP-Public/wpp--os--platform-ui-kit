...
const WppIconCampaign$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCampaign extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-campaign", "wpp-icon-campaign-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-campaign-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-campaign-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCampaign$1);
      }
      break;
  } });
}

const WppIconCampaign = WppIconCampaign$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCampaign, defineCustomElement };
