...
const WppIconThumbsUp$1 = /*@__PURE__*/ proxyCustomElement(class WppIconThumbsUp extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-thumbs-up-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-thumbs-up-v3-6-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconThumbsUp$1);
      }
      break;
  } });
}

const WppIconThumbsUp = WppIconThumbsUp$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconThumbsUp, defineCustomElement };
