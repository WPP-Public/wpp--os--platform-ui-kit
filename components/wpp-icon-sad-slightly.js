...
const WppIconSadSlightly$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSadSlightly extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sad-slightly-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sad-slightly-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSadSlightly$1);
      }
      break;
  } });
}

const WppIconSadSlightly = WppIconSadSlightly$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSadSlightly, defineCustomElement };
