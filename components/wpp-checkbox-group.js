...
const WppCheckboxGroup$1 = /*@__PURE__*/ proxyCustomElement(class WppCheckboxGroup extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), onFocus: this.onFocus, onBlur: this.onBlur, exportparts: "inner" }, h("div", { class: "group-container", role: "group", "aria-labelledby": this.ariaProps.labelledby, ...(!!this.message && this.ariaProps.describedby ? { 'aria-describedby': this.ariaProps.describedby } : {}) }, this.labelConfig?.text && (h("wpp-label-v4-2-0", { class: "label", tag: "legend", optional: !this.required, config: this.labelConfig, tooltipConfig: this.labelTooltipConfig, id: this.ariaProps.labelledby })), h("div", { class: this.contentCssClasses(), style: this.gap ? { gap: `${this.gap}px` } : {} }, h("slot", { onSlotchange: this.getCheckboxElements, part: "inner" })), !!this.message && (h("wpp-inline-message-v4-2-0", { class: "inline-message", showTooltipFrom: this.maxMessageLength, message: this.message, type: this.messageType, id: this.ariaProps.describedby })))));
  }
  static get registryIs() { return "wpp-checkbox-group-v4-2-0"; }
  get host() { return this; }
  static get watchers() { return {
    "value": ["updateValue"]
  }; }
  static get style() { return wppCheckboxGroupCss; }
}, [1, "wpp-checkbox-group", "wpp-checkbox-group-v4-2-0", {
    "value": [1040],
    "required": [516],
    "message": [1],
