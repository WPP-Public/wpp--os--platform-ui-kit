...
const WppIconCellularDataOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCellularDataOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-cellular-data-on-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-cellular-data-on-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCellularDataOn$1);
      }
      break;
  } });
}

const WppIconCellularDataOn = WppIconCellularDataOn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCellularDataOn, defineCustomElement };
