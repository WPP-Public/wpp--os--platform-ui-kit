...
const WppIconRise$1 = /*@__PURE__*/ proxyCustomElement(class WppIconRise extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-rise-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-rise-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconRise$1);
      }
      break;
  } });
}

const WppIconRise = WppIconRise$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconRise, defineCustomElement };
