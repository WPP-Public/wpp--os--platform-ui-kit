...
const WppIconDownload = /*@__PURE__*/ proxyCustomElement(class WppIconDownload extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-download", "wpp-icon-download-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-download-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-download-v4-1-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDownload);
      }
      break;
  } });
}

export { WppIconDownload as W, defineCustomElement as d };
