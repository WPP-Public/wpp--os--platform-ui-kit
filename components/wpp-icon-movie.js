...
const WppIconMovie$1 = /*@__PURE__*/ proxyCustomElement(class WppIconMovie extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-movie-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-movie-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconMovie$1);
      }
      break;
  } });
}

const WppIconMovie = WppIconMovie$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconMovie, defineCustomElement };
