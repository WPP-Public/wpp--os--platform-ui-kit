...
const WppIconButton$1 = /*@__PURE__*/ proxyCustomElement(class WppIconButton extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), exportparts: "wrapper, inner" }, h("wpp-button-v3-3-1", { variant: "secondary", size: this.size, disabled: this.disabled, loading: this.loading, name: this.name, "data-testid": "wppIconButton", part: "wrapper" }, h("slot", { slot: "icon-start", part: "inner" }))));
  }
  static get registryIs() { return "wpp-icon-button-v3-3-1"; }
  static get style() { return wppIconButtonCss; }
}, [1, "wpp-icon-button", "wpp-icon-button-v3-3-1", {
    "size": [1],
    "disabled": [516],
    "loading": [516],
    "name": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-button-v3-3-1", "wpp-button-v3-3-1", "wpp-spinner-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-button-v3-3-1":
