...
const WppEmptyCards$1 = /*@__PURE__*/ proxyCustomElement(class WppEmptyCards extends HTMLElement {
  ...
  static get registryIs() { return "wpp-empty-cards-v4-3-0"; }
  static get style() { return wppImageCss; }
}, [1, "wpp-empty-cards", "wpp-empty-cards-v4-3-0", {
    "width": [2],
    "height": [2]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-empty-cards-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-empty-cards-v4-3-0":
