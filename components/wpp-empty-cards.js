...
const WppEmptyCards$1 = /*@__PURE__*/ proxyCustomElement(class WppEmptyCards extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-empty-cards-v2-22-0"; }
  static get style() { return wppImageCss; }
}, [1, "wpp-empty-cards", "wpp-empty-cards-v2-22-0", {
    "width": [2],
    "height": [2]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-empty-cards-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-empty-cards-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppEmptyCards$1);
      }
      break;
  } });
}

const WppEmptyCards = WppEmptyCards$1;
const defineCustomElement = defineCustomElement$1;

export { WppEmptyCards, defineCustomElement };
