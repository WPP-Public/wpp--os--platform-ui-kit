...
}, [1, "wpp-banner", "wpp-banner-v4-1-0", {
    "ariaProps": [16],
    "role": [1],
    "show": [1540],
    "closable": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-banner-v4-1-0", "wpp-action-button-v4-1-0", "wpp-icon-cross-v4-1-0", "wpp-icon-error-v4-1-0", "wpp-icon-info-message-v4-1-0", "wpp-icon-warning-v4-1-0", "wpp-internal-tooltip-v4-1-0", "wpp-spinner-v4-1-0", "wpp-tooltip-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-banner-v4-1-0":
