...
const WppBanner$1 = /*@__PURE__*/ proxyCustomElement(class WppBanner extends HTMLElement {
  constructor() {
    ...
    this.getMessageTypesIcons = () => {
      if (this.type === 'warning')
        return h("wpp-icon-warning-v3-6-0", { class: "left-icon", part: "left-icon" });
      if (this.type === 'information')
        return h("wpp-icon-info-message-v3-6-0", { class: "left-icon", part: "left-icon" });
      return null;
    };
  ...
  render() {
    ...
    return (h(Host, { style: style, class: this.hostCssClasses(), role: this.role, "aria-label": this.ariaProps.label || 'banner', exportparts: "left-icon, wrapper, body, content-wrapper, message, actions-wrapper, close-button, close-icon, actions, actions-wrapper" }, h("div", { class: this.hiddenBannerWrapperCssClasses(), part: "wrapper" }, h("div", { class: this.bannerWrapperCssClasses(), part: "body" }, h("div", { class: "content-wrapper", part: "content-wrapper" }, this.getMessageTypesIcons(), !this.isOverflowing ? (messageWrapper) : (h("wpp-tooltip-v3-6-0", { text: this.messageText, class: this.tooltipCSSClasses() }, messageWrapper))), h("div", { class: "actions-wrapper", part: "actions-wrapper" }, h(WrappedSlot, { wrapperClass: this.actionsCssClasses(), name: "actions", onSlotchange: this.updateSlotData, role: "presentation" }), this.closable && (h("wpp-action-button-v3-6-0", { variant: this.type === 'information' ? 'inverted' : 'secondary', onClick: this.handleCloseIconClick, class: "close-button", part: "close-button", ariaProps: { label: 'close banner' }, role: "presentation" }, h("wpp-icon-cross-v3-6-0", { slot: "icon-start", part: "close-icon", "aria-hidden": "true" }))))))));
  }
  static get registryIs() { return "wpp-banner-v3-6-0"; }
  get host() { return this; }
  static get style() { return wppBannerCss; }
}, [1, "wpp-banner", "wpp-banner-v3-6-0", {
    "ariaProps": [16],
    "role": [1],
    "show": [1540],
    "closable": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-banner-v3-6-0", "wpp-action-button-v3-6-0", "wpp-icon-cross-v3-6-0", "wpp-icon-error-v3-6-0", "wpp-icon-info-message-v3-6-0", "wpp-icon-warning-v3-6-0", "wpp-internal-tooltip-v3-6-0", "wpp-spinner-v3-6-0", "wpp-tooltip-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-banner-v3-6-0":
