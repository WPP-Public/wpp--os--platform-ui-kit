...
import { d as defineCustomElement$6 } from './wpp-icon-info2.js';
...
const WppBanner$1 = /*@__PURE__*/ proxyCustomElement(class WppBanner extends HTMLElement {
  constructor() {
    ...
    this.getMessageTypesIcons = () => {
      if (this.type === 'warning')
        return h("wpp-icon-warning-v2-22-0", { class: "left-icon", part: "left-icon" });
      if (this.type === 'information')
        return h("wpp-icon-info-v2-22-0", { class: "left-icon", part: "left-icon" });
      return null;
    };
  ...
  render() {
    ...
    return (h(Host, { style: style, class: this.hostCssClasses(), exportparts: "left-icon, wrapper, body, content-wrapper, message, actions-wrapper, close-button, close-icon, actions, actions-wrapper" }, h("div", { class: this.hiddenBannerWrapperCssClasses(), part: "wrapper" }, h("div", { class: this.bannerWrapperCssClasses(), part: "body" }, h("div", { class: "content-wrapper", part: "content-wrapper" }, this.getMessageTypesIcons(), !this.isOverflowing ? (messageWrapper) : (h("wpp-tooltip-v2-22-0", { text: this.messageText, class: this.tooltipCSSClasses() }, messageWrapper))), h("div", { class: "actions-wrapper", part: "actions-wrapper" }, h(WrappedSlot, { wrapperClass: this.actionsCssClasses(), name: "actions", onSlotchange: this.updateSlotData }), this.closable && (h("wpp-action-button-v2-22-0", { variant: this.type === 'information' ? 'inverted' : 'secondary', onClick: this.handleCloseIconClick, class: "close-button", part: "close-button" }, h("wpp-icon-cross-v2-22-0", { slot: "icon-start", part: "close-icon" }))))))));
  }
  static get registryIs() { return "wpp-banner-v2-22-0"; }
  get host() { return this; }
  static get style() { return wppBannerCss; }
}, [1, "wpp-banner", "wpp-banner-v2-22-0", {
    "show": [1540],
    "closable": [4],
    "type": [1],
    "hasActionsSlot": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-banner-v2-22-0", "wpp-action-button-v2-22-0", "wpp-icon-cross-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-info-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-spinner-v2-22-0", "wpp-tooltip-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-banner-v2-22-0":
