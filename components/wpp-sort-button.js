...
}, [1, "wpp-sort-button", "wpp-sort-button-v4-2-0", {
    "name": [1],
    "ariaProps": [16],
    "disabled": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-sort-button-v4-2-0", "wpp-icon-sort-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-sort-button-v4-2-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppSortButton$1);
      }
      break;
    case "wpp-icon-sort-v4-2-0":
      if (!customElements.get(tagName)) {
...
const WppSortButton = WppSortButton$1;
const defineCustomElement = defineCustomElement$1;

export { WppSortButton, defineCustomElement };
