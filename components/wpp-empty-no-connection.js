...
const WppEmptyNoConnection$1 = /*@__PURE__*/ proxyCustomElement(class WppEmptyNoConnection extends HTMLElement {
  ...
  static get registryIs() { return "wpp-empty-no-connection-v4-1-0"; }
  static get style() { return wppImageCss; }
}, [1, "wpp-empty-no-connection", "wpp-empty-no-connection-v4-1-0", {
    "width": [2],
    "height": [2]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-empty-no-connection-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-empty-no-connection-v4-1-0":
