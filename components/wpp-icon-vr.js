...
const WppIconVr$1 = /*@__PURE__*/ proxyCustomElement(class WppIconVr extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-vr", "wpp-icon-vr-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-vr-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-vr-v4-1-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconVr$1);
      }
      break;
  } });
}

const WppIconVr = WppIconVr$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconVr, defineCustomElement };
