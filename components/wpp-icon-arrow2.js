...
const WppIconArrow = /*@__PURE__*/ proxyCustomElement(class WppIconArrow extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-arrow-v3-4-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-arrow", "wpp-icon-arrow-v3-4-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-arrow-v3-4-0"];
...
export { WppIconArrow as W, defineCustomElement as d };
