...
const WppIconInstallUpdate$1 = /*@__PURE__*/ proxyCustomElement(class WppIconInstallUpdate extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-install-update-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-install-update", "wpp-icon-install-update-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-install-update-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-install-update-v3-5-0":
