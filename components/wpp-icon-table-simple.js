...
const WppIconTableSimple$1 = /*@__PURE__*/ proxyCustomElement(class WppIconTableSimple extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-table-simple", "wpp-icon-table-simple-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-table-simple-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-table-simple-v3-5-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconTableSimple$1);
      }
      break;
  } });
}

const WppIconTableSimple = WppIconTableSimple$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconTableSimple, defineCustomElement };
