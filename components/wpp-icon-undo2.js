...
const WppIconUndo = /*@__PURE__*/ proxyCustomElement(class WppIconUndo extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-undo-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-undo", "wpp-icon-undo-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-undo-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-undo-v2-22-0":
