...
const WppIconUserSearch$1 = /*@__PURE__*/ proxyCustomElement(class WppIconUserSearch extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-user-search-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-user-search", "wpp-icon-user-search-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-user-search-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-user-search-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconUserSearch$1);
      }
      break;
  } });
}

const WppIconUserSearch = WppIconUserSearch$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconUserSearch, defineCustomElement };
