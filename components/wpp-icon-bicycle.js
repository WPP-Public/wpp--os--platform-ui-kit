...
const WppIconBicycle$1 = /*@__PURE__*/ proxyCustomElement(class WppIconBicycle extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-bicycle-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-bicycle-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconBicycle$1);
      }
      break;
  } });
}

const WppIconBicycle = WppIconBicycle$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconBicycle, defineCustomElement };
