...
const WppMenuGroup$1 = /*@__PURE__*/ proxyCustomElement(class WppMenuGroup extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), exportparts: "header, divider" }, this.header && (h("wpp-typography-v4-1-0", { type: "2xs-strong", part: "header" }, this.header)), h("slot", null), this.withDivider && h("wpp-divider-v4-1-0", { class: "slot-divider", part: "divider" })));
  }
  static get registryIs() { return "wpp-menu-group-v4-1-0"; }
  static get style() { return wppMenuGroupCss; }
}, [1, "wpp-menu-group", "wpp-menu-group-v4-1-0", {
    "header": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-menu-group-v4-1-0", "wpp-divider-v4-1-0", "wpp-typography-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-menu-group-v4-1-0":
