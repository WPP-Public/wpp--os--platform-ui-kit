...
const WppIconEyedropper$1 = /*@__PURE__*/ proxyCustomElement(class WppIconEyedropper extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-eyedropper-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-eyedropper", "wpp-icon-eyedropper-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-eyedropper-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-eyedropper-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconEyedropper$1);
      }
      break;
  } });
}

const WppIconEyedropper = WppIconEyedropper$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconEyedropper, defineCustomElement };
