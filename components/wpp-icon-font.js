...
const WppIconFont$1 = /*@__PURE__*/ proxyCustomElement(class WppIconFont extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-font-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-font", "wpp-icon-font-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-font-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-font-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconFont$1);
      }
      break;
  } });
}

const WppIconFont = WppIconFont$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconFont, defineCustomElement };
