...
const WppIconShieldDismiss$1 = /*@__PURE__*/ proxyCustomElement(class WppIconShieldDismiss extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-shield-dismiss-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-shield-dismiss", "wpp-icon-shield-dismiss-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-shield-dismiss-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-shield-dismiss-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconShieldDismiss$1);
      }
      break;
  } });
}

const WppIconShieldDismiss = WppIconShieldDismiss$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconShieldDismiss, defineCustomElement };
