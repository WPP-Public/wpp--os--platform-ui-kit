...
const WppIconComment$1 = /*@__PURE__*/ proxyCustomElement(class WppIconComment extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-comment", "wpp-icon-comment-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-comment-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-comment-v3-5-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconComment$1);
      }
      break;
  } });
}

const WppIconComment = WppIconComment$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconComment, defineCustomElement };
