...
import { w as getHighestContainerInDOM, d as debounce, s as selectDropdownWidth, b as isEventTargetContained } from './utils.js';
import { Z as Z_INDEX } from './consts.js';
import { i as isSelected, r as renderSlotsInListItem, s as selectedOptionsByOrder } from './utils2.js';
...
}, [1, "wpp-autocomplete", "wpp-autocomplete-v4-1-0", {
    "labelConfig": [16],
    "name": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-autocomplete-v4-1-0", "wpp-action-button-v4-1-0", "wpp-checkbox-v4-1-0", "wpp-divider-v4-1-0", "wpp-icon-chevron-v4-1-0", "wpp-icon-cross-v4-1-0", "wpp-icon-dash-v4-1-0", "wpp-icon-drag-v4-1-0", "wpp-icon-error-v4-1-0", "wpp-icon-info-message-v4-1-0", "wpp-icon-search-v4-1-0", "wpp-icon-success-v4-1-0", "wpp-icon-tick-v4-1-0", "wpp-icon-warning-v4-1-0", "wpp-inline-message-v4-1-0", "wpp-input-v4-1-0", "wpp-internal-label-v4-1-0", "wpp-internal-tooltip-v4-1-0", "wpp-label-v4-1-0", "wpp-list-item-v4-1-0", "wpp-pill-v4-1-0", "wpp-spinner-v4-1-0", "wpp-tooltip-v4-1-0", "wpp-typography-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-autocomplete-v4-1-0":
