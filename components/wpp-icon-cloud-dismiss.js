...
const WppIconCloudDismiss$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCloudDismiss extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-cloud-dismiss-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-cloud-dismiss", "wpp-icon-cloud-dismiss-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-cloud-dismiss-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-cloud-dismiss-v4-2-0":
