...
const WppIconHandOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconHandOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-hand-on-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-hand-on-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconHandOn$1);
      }
      break;
  } });
}

const WppIconHandOn = WppIconHandOn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconHandOn, defineCustomElement };
