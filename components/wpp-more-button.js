...
function defineCustomElement$1() {
  ...
  const components = ["wpp-more-button-v4-2-0", "wpp-icon-more-v4-2-0", "wpp-spinner-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-more-button-v4-2-0":
