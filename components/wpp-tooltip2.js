...
import { w as getHighestContainerInDOM, A as isWppElement } from './utils.js';
...
}, [1, "wpp-tooltip", "wpp-tooltip-v4-3-0", {
    "disabled": [4],
    "header": [1],
    "text": [1],
    "value": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-tooltip-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-internal-tooltip-v4-3-0"];
