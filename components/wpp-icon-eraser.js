...
const WppIconEraser$1 = /*@__PURE__*/ proxyCustomElement(class WppIconEraser extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-eraser-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-eraser-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconEraser$1);
      }
      break;
  } });
}

const WppIconEraser = WppIconEraser$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconEraser, defineCustomElement };
