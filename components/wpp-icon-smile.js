...
const WppIconSmile$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSmile extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-smile", "wpp-icon-smile-v4-0-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-smile-v4-0-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-smile-v4-0-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSmile$1);
      }
      break;
  } });
}

const WppIconSmile = WppIconSmile$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSmile, defineCustomElement };
