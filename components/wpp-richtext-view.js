...
import { f as formats, n as normalizeEmptyParagraphs, c as normalizeListHtml, g as buildTiptapExtensions, E as Editor } from './tiptap-config.js';
...
}, [0, "wpp-richtext-view", "wpp-richtext-view-v4-1-0", {
    "value": [1537],
    "format": [1537],
    "formats": [16],
    "modules": [1025],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-richtext-view-v4-1-0", "wpp-richtext-common-styles-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-richtext-view-v4-1-0":
