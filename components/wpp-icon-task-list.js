...
const WppIconTaskList$1 = /*@__PURE__*/ proxyCustomElement(class WppIconTaskList extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-task-list-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-task-list-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconTaskList$1);
      }
      break;
  } });
}

const WppIconTaskList = WppIconTaskList$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconTaskList, defineCustomElement };
