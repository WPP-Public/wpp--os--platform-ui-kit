...
}, [1, "wpp-nav-sidebar-item", "wpp-nav-sidebar-item-v3-4-0", {
    "expanded": [1540],
    "extended": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-nav-sidebar-item-v3-4-0", "wpp-divider-v3-4-0", "wpp-icon-chevron-v3-4-0", "wpp-icon-error-v3-4-0", "wpp-icon-warning-v3-4-0", "wpp-internal-tooltip-v3-4-0", "wpp-tooltip-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-nav-sidebar-item-v3-4-0":
