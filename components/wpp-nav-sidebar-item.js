...
}, [1, "wpp-nav-sidebar-item", "wpp-nav-sidebar-item-v3-3-1", {
    "expanded": [1540],
    "extended": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-nav-sidebar-item-v3-3-1", "wpp-divider-v3-3-1", "wpp-icon-chevron-v3-3-1", "wpp-icon-error-v3-3-1", "wpp-icon-warning-v3-3-1", "wpp-internal-tooltip-v3-3-1", "wpp-tooltip-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-nav-sidebar-item-v3-3-1":
