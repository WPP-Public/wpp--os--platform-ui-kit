...
import { g as getSlotEmptyStates, e as truncate, k as transformToVersionedTag } from './utils.js';
...
const WppNavSidebarItem$1 = /*@__PURE__*/ proxyCustomElement(class WppNavSidebarItem extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.wppClickSidebarItem = createEvent(this, "wppClickSidebarItem", 1);
    this.wppClickExpandedItem = createEvent(this, "wppClickExpandedItem", 1);
    this.updateSlotData = () => {
...
}, [1, "wpp-nav-sidebar-item", "wpp-nav-sidebar-item-v4-3-0", {
    "expanded": [1540],
    "extended": [516],
    "maxTitleLengthWithSubItems": [2, "max-title-length-with-sub-items"],
    "maxTitleLengthWithoutSubItems": [2, "max-title-length-without-sub-items"],
    "label": [513],
    "path": [513],
    "groupTitle": [513, "group-title"],
    "nestedItem": [516, "nested-item"],
    "divide": [516],
    "active": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-nav-sidebar-item-v4-3-0", "wpp-divider-v4-3-0", "wpp-icon-chevron-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-tooltip-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-nav-sidebar-item-v4-3-0":
...
const WppNavSidebarItem = WppNavSidebarItem$1;
const defineCustomElement = defineCustomElement$1;

export { WppNavSidebarItem, defineCustomElement };
