...
}, [1, "wpp-nav-sidebar-item", "wpp-nav-sidebar-item-v4-2-0", {
    "expanded": [1540],
    "extended": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-nav-sidebar-item-v4-2-0", "wpp-divider-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-tooltip-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-nav-sidebar-item-v4-2-0":
