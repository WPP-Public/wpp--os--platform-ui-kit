...
const WppIconCart$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCart extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-cart-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-cart", "wpp-icon-cart-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-cart-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-cart-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCart$1);
      }
      break;
  } });
}

const WppIconCart = WppIconCart$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCart, defineCustomElement };
