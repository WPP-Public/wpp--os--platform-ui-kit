...
function defineCustomElement$1() {
  ...
  const components = ["wpp-expandable-card-v3-6-0", "wpp-accordion-v3-6-0", "wpp-divider-v3-6-0", "wpp-icon-chevron-v3-6-0", "wpp-icon-error-v3-6-0", "wpp-icon-warning-v3-6-0", "wpp-internal-tooltip-v3-6-0", "wpp-tooltip-v3-6-0", "wpp-typography-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-expandable-card-v3-6-0":
