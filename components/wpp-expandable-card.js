...
const WppExpandableCard$1 = /*@__PURE__*/ proxyCustomElement(class WppExpandableCard extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), onFocus: this.onFocus, onBlur: this.onBlur, "aria-expanded": this.expanded, exportparts: "expandable-card-body, accordion, section, title, icon, counter, divider, title-wrapper" }, h("div", { class: "body-container", part: "expandable-card-body" }, h("wpp-accordion-v2-22-0", { size: this.size, text: this.header, expanded: this.expanded, expandedByDefault: this.expandedByDefault, withDivider: false, onWppChange: this.onChange, part: "accordion" }, h("slot", null), h("slot", { name: "header", slot: "header", class: "header" }), h("slot", { name: "actions", slot: "actions", class: "actions" })))));
  }
  static get registryIs() { return "wpp-expandable-card-v2-22-0"; }
  get host() { return this; }
  static get style() { return wppExpandableCardCss; }
}, [1, "wpp-expandable-card", "wpp-expandable-card-v2-22-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-expandable-card-v2-22-0", "wpp-accordion-v2-22-0", "wpp-divider-v2-22-0", "wpp-icon-chevron-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-expandable-card-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppExpandableCard$1);
      }
      break;
    case "wpp-accordion-v2-22-0":
      if (!customElements.get(tagName)) {
