...
import { g as getSlotEmptyStates, k as transformToVersionedTag, e as truncate } from './utils.js';
...
function defineCustomElement() {
  ...
  const components = ["wpp-pill-v3-3-0", "wpp-icon-cross-v3-3-0", "wpp-icon-drag-v3-3-0", "wpp-icon-tick-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-pill-v3-3-0":
