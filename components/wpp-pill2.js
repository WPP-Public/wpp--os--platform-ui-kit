...
function defineCustomElement() {
  ...
  const components = ["wpp-pill-v4-0-0", "wpp-icon-cross-v4-0-0", "wpp-icon-drag-v4-0-0", "wpp-icon-error-v4-0-0", "wpp-icon-tick-v4-0-0", "wpp-icon-warning-v4-0-0", "wpp-internal-tooltip-v4-0-0", "wpp-tooltip-v4-0-0"];
