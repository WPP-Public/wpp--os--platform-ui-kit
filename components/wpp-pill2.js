...
import { g as getSlotEmptyStates, k as transformToVersionedTag, e as truncate, d as debounce } from './utils.js';
...
import { d as defineCustomElement$6 } from './wpp-icon-drag2.js';
import { d as defineCustomElement$5 } from './wpp-icon-error2.js';
import { d as defineCustomElement$4 } from './wpp-icon-tick2.js';
import { d as defineCustomElement$3 } from './wpp-icon-warning2.js';
import { d as defineCustomElement$2 } from './wpp-internal-tooltip2.js';
...
const WppPill = /*@__PURE__*/ proxyCustomElement(class WppPill extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    ...
    this.wppDragPress = createEvent(this, "wppDragPress", 1);
  ...
  static get style() { return wppPillCss; }
    ...
    "showTooltipOnTruncate": [4, "show-tooltip-on-truncate"],
    "hasIconStartSlot": [32],
    "hasSquareIcon": [32],
    "componentState": [32],
    "focusType": [32],
    "isOverflowTruncated": [32]
  }]);
...
export { WppPill as W, defineCustomElement as d };
