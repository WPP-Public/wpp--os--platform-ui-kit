...
import { g as getSlotEmptyStates, j as transformToVersionedTag, c as truncate } from './utils.js';
...
function defineCustomElement() {
  ...
  const components = ["wpp-pill-v2-22-0", "wpp-icon-cross-v2-22-0", "wpp-icon-drag-v2-22-0", "wpp-icon-tick-v2-22-0"];
