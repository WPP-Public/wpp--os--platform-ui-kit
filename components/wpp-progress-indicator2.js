...
const WppProgressIndicator = /*@__PURE__*/ proxyCustomElement(class WppProgressIndicator extends HTMLElement {
  ...
  static get registryIs() { return "wpp-progress-indicator-v4-2-0"; }
...
}, [1, "wpp-progress-indicator", "wpp-progress-indicator-v4-2-0", {
    "width": [2],
    "variant": [1],
    "value": [2],
...
function defineCustomElement() {
  ...
  const components = ["wpp-progress-indicator-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-progress-indicator-v4-2-0":
