...
const WppProgressIndicator = /*@__PURE__*/ proxyCustomElement(class WppProgressIndicator extends HTMLElement {
  ...
  static get registryIs() { return "wpp-progress-indicator-v3-3-1"; }
...
}, [1, "wpp-progress-indicator", "wpp-progress-indicator-v3-3-1", {
    "width": [2],
    "variant": [1],
    "value": [2],
...
function defineCustomElement() {
  ...
  const components = ["wpp-progress-indicator-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-progress-indicator-v3-3-1":
