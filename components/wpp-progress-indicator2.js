...
}, [1, "wpp-progress-indicator", "wpp-progress-indicator-v4-3-0", {
    "width": [2],
    "variant": [1],
    "value": [2],
...
function defineCustomElement() {
  ...
  const components = ["wpp-progress-indicator-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-progress-indicator-v4-3-0":
...
export { WppProgressIndicator as W, defineCustomElement as d };
