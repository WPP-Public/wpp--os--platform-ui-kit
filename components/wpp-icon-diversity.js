...
const WppIconDiversity$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDiversity extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-diversity-v3-4-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-diversity", "wpp-icon-diversity-v3-4-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-diversity-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-diversity-v3-4-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDiversity$1);
      }
      break;
  } });
}

const WppIconDiversity = WppIconDiversity$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDiversity, defineCustomElement };
