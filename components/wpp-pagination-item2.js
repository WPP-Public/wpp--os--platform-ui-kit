...
const WppPaginationItem = /*@__PURE__*/ proxyCustomElement(class WppPaginationItem extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), onClick: this.handleClick, onBlur: this.onBlur, onMouseDown: this.onMouseDown, onKeyUp: this.onKeyUp, tabIndex: 0, exportparts: "number" }, h("wpp-typography-v2-22-0", { type: "s-body", part: "number" }, this.number)));
  }
  static get registryIs() { return "wpp-pagination-item-v2-22-0"; }
  static get style() { return wppPaginationItemCss; }
}, [1, "wpp-pagination-item", "wpp-pagination-item-v2-22-0", {
    "number": [2],
    "selected": [4],
    "focusType": [32]
  }]);
function defineCustomElement() {
  ...
  const components = ["wpp-pagination-item-v2-22-0", "wpp-typography-v2-22-0"];
