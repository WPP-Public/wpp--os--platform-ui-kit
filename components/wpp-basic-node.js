...
import { y as mergeLocales, k as transformToVersionedTag } from './utils.js';
import { t as themeSubscriptionController } from './subscribe-to-theme.js';
import { d as defineCustomElement$s } from './wpp-action-button2.js';
import { d as defineCustomElement$r } from './wpp-button2.js';
...
}, [6, "wpp-basic-node", "wpp-basic-node-v4-2-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-basic-node-v4-2-0", "wpp-action-button-v4-2-0", "wpp-button-v4-2-0", "wpp-checkbox-v4-2-0", "wpp-divider-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-dash-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-file-v4-2-0", "wpp-icon-gear-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-play-v4-2-0", "wpp-icon-plus-v4-2-0", "wpp-icon-service-v4-2-0", "wpp-icon-stop-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-tick-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-list-item-v4-2-0", "wpp-menu-context-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-basic-node-v4-2-0":
