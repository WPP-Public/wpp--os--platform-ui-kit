...
const WppIconCalendarDate$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCalendarDate extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-calendar-date-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-calendar-date", "wpp-icon-calendar-date-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-calendar-date-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-calendar-date-v4-2-0":
