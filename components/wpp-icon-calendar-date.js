...
const WppIconCalendarDate$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCalendarDate extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-calendar-date-v3-6-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-calendar-date", "wpp-icon-calendar-date-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-calendar-date-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-calendar-date-v3-6-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCalendarDate$1);
      }
      break;
  } });
}

const WppIconCalendarDate = WppIconCalendarDate$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCalendarDate, defineCustomElement };
