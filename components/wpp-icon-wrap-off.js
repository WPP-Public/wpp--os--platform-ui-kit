...
const WppIconWrapOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconWrapOff extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-wrap-off", "wpp-icon-wrap-off-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-wrap-off-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-wrap-off-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconWrapOff$1);
      }
      break;
  } });
}

const WppIconWrapOff = WppIconWrapOff$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconWrapOff, defineCustomElement };
