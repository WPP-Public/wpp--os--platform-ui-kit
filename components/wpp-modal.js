...
function defineCustomElement$1() {
  ...
  const components = ["wpp-modal-v4-2-0", "wpp-button-v4-2-0", "wpp-divider-v4-2-0", "wpp-overlay-v4-2-0", "wpp-spinner-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-modal-v4-2-0":
