...
function defineCustomElement$1() {
  ...
  const components = ["wpp-modal-v4-3-0", "wpp-button-v4-3-0", "wpp-divider-v4-3-0", "wpp-overlay-v4-3-0", "wpp-spinner-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-modal-v4-3-0":
