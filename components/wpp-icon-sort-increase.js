...
const WppIconSortIncrease$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSortIncrease extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sort-increase-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sort-increase-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSortIncrease$1);
      }
      break;
  } });
}

const WppIconSortIncrease = WppIconSortIncrease$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSortIncrease, defineCustomElement };
