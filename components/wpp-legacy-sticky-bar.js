...
const WppLegacyStickyBar = WppLegacyStickyBar$1;
const defineCustomElement = defineCustomElement$1;

export { WppLegacyStickyBar, defineCustomElement };
