...
const WppIconRefresh = /*@__PURE__*/ proxyCustomElement(class WppIconRefresh extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-refresh-v4-3-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-refresh", "wpp-icon-refresh-v4-3-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-refresh-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-refresh-v4-3-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconRefresh);
      }
      break;
  } });
}

export { WppIconRefresh as W, defineCustomElement as d };
