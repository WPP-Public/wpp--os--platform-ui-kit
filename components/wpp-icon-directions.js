...
const WppIconDirections$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDirections extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-directions-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-directions", "wpp-icon-directions-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-directions-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-directions-v2-22-0":
...
const WppIconDirections = WppIconDirections$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDirections, defineCustomElement };
