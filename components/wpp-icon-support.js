...
const WppIconSupport$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSupport extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-support-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-support-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSupport$1);
      }
      break;
  } });
}

const WppIconSupport = WppIconSupport$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSupport, defineCustomElement };
