...
const WppIconSubItems$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSubItems extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-sub-items-v3-3-1"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-sub-items", "wpp-icon-sub-items-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sub-items-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sub-items-v3-3-1":
