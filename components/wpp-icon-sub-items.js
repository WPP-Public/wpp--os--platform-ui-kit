...
const WppIconSubItems$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSubItems extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-sub-items-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-sub-items", "wpp-icon-sub-items-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sub-items-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sub-items-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSubItems$1);
      }
      break;
  } });
}

const WppIconSubItems = WppIconSubItems$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSubItems, defineCustomElement };
