...
import { d as defineCustomElement$h } from './wpp-icon-clock2.js';
...
const WppTimePicker$1 = /*@__PURE__*/ proxyCustomElement(class WppTimePicker extends HTMLElement {
  constructor() {
    ...
    this.__registerHost();
    this.__attachShadow();
    this.wppFocus = createEvent(this, "wppFocus", 7);
    this.wppBlur = createEvent(this, "wppBlur", 7);
    this.wppChange = createEvent(this, "wppChange", 7);
    this.wppClear = createEvent(this, "wppClear", 7);
  ...
  render() {
    return (h(Host, { class: "wpp-time-picker", "aria-disabled": this.disabled, style: { width: !this.width ? DEFAULT_WIDTH_VALUE : this.width } }, this.labelConfig?.text && (h("wpp-label-v4-2-0", { typography: "s-strong", class: "label", htmlFor: this.name, optional: !this.required, config: this.labelConfig, disabled: this.disabled, tooltipConfig: this.labelTooltipConfig })), h("div", { ref: el => (this.anchorRef = el), id: "anchor", class: this.getAnchorCssClasses() }, h("div", { class: "anchor-time" }, h("wpp-icon-clock-v4-2-0", { class: "clock-icon" }), h("input", { ref: el => (this.inputRef = el), onFocus: this.onFocus, onBlur: this.onBlur, onKeyUp: this.onKeyUp, onKeyPress: this.onKeyPress, onPaste: this.onPaste, disabled: this.disabled, onInput: this.onUpdateInput, id: "time-picker", type: "text", placeholder: this.placeholder, value: this.value })), h("div", { class: "cross-icon-container" }, this.showDisplayCross && (h("wpp-icon-cross-v4-2-0", { class: "cross-icon", "aria-label": "Erase time", onClick: this.handleClickCrossIcon })))), h("div", { ref: el => (this.portalRef = el), class: "wpp-time-picker-portal" }, h("div", { ref: refEl => (this.hoursSectionRef = refEl), class: "hours section" }, HOURS.map((hour, hourIndex) => (h("wpp-list-item-v4-2-0", { id: `hour-${hour}`, key: hour, checked: this.checkedTimeValues.hoursIndex === hourIndex, onWppChangeListItem: () => this.handleClickListItem(hour, 'hour') }, h("span", { slot: "label" }, hour))))), h("wpp-divider-v4-2-0", { vertical: true }), h("div", { ref: refEl => (this.minutesSectionRef = refEl), class: "minutes section" }, this.generatedMinutes.map((minutes, minutesIndex) => (h("wpp-list-item-v4-2-0", { id: `minutes-${minutes}`, key: minutes, checked: this.checkedTimeValues.minutesIndex === minutesIndex, onWppChangeListItem: () => this.handleClickListItem(minutes, 'minutes') }, h("span", { slot: "label" }, minutes)))))), this.message && (h("wpp-inline-message-v4-2-0", { class: !this.messageType ? 'helper-text' : '', message: this.message, type: this.messageType, showTooltipFrom: this.maxMessageLength, tooltipConfig: this.tooltipConfig }))));
  }
  static get registryIs() { return "wpp-time-picker-v4-2-0"; }
  ...
  static get style() { return wppTimePickerCss; }
}, [1, "wpp-time-picker", "wpp-time-picker-v4-2-0", {
    "size": [1],
    "disabled": [516],
    "dropdownConfig": [1040],
    "placeholder": [1],
    "width": [1],
    "value": [1025],
    "minutesInterval": [514, "minutes-interval"],
    "labelConfig": [1040],
    "name": [1],
    "required": [516],
    "labelTooltipConfig": [16],
    "messageType": [1025, "message-type"],
    "message": [1025],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-time-picker-v4-2-0", "wpp-action-button-v4-2-0", "wpp-checkbox-v4-2-0", "wpp-divider-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-clock-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-dash-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-tick-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-list-item-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-time-picker-v4-2-0":
...
const WppTimePicker = WppTimePicker$1;
const defineCustomElement = defineCustomElement$1;

export { WppTimePicker, defineCustomElement };
