...
import { c as convertMBToBytes, b as getExtensionsList, g as getExtension, E as EXTENSION_TO_TYPE, m as modifyPropertiesOnFile, a as getBaseName, r as renameFile, d as defineCustomElement$o } from './wpp-file-upload-item2.js';
import { W as WrappedSlot } from './WrappedSlot.js';
import { c as hasParentWithId, g as getSlotEmptyStates, d as debounce } from './utils.js';
import { Z as Z_INDEX } from './consts.js';
import { d as defineCustomElement$p } from './wpp-action-button2.js';
import { d as defineCustomElement$n } from './wpp-icon-attach2.js';
...
import { d as defineCustomElement$e } from './wpp-icon-mic-on2.js';
import { d as defineCustomElement$d } from './wpp-icon-music2.js';
import { d as defineCustomElement$c } from './wpp-icon-pitch2.js';
import { d as defineCustomElement$b } from './wpp-icon-send2.js';
import { d as defineCustomElement$a } from './wpp-icon-spreadsheet2.js';
import { d as defineCustomElement$9 } from './wpp-icon-success2.js';
import { d as defineCustomElement$8 } from './wpp-icon-video-clip2.js';
import { d as defineCustomElement$7 } from './wpp-icon-warning2.js';
import { d as defineCustomElement$6 } from './wpp-inline-message2.js';
...
}, [1, "wpp-chat-input", "wpp-chat-input-v3-6-0", {
    "size": [1],
    "placeholder": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-chat-input-v3-6-0", "wpp-action-button-v3-6-0", "wpp-file-upload-item-v3-6-0", "wpp-icon-attach-v3-6-0", "wpp-icon-cross-v3-6-0", "wpp-icon-database-v3-6-0", "wpp-icon-document-v3-6-0", "wpp-icon-error-v3-6-0", "wpp-icon-file-v3-6-0", "wpp-icon-file-zip-v3-6-0", "wpp-icon-image-v3-6-0", "wpp-icon-info-message-v3-6-0", "wpp-icon-mic-on-v3-6-0", "wpp-icon-music-v3-6-0", "wpp-icon-pitch-v3-6-0", "wpp-icon-send-v3-6-0", "wpp-icon-spreadsheet-v3-6-0", "wpp-icon-success-v3-6-0", "wpp-icon-video-clip-v3-6-0", "wpp-icon-warning-v3-6-0", "wpp-inline-message-v3-6-0", "wpp-internal-tooltip-v3-6-0", "wpp-spinner-v3-6-0", "wpp-toast-v3-6-0", "wpp-tooltip-v3-6-0", "wpp-typography-v3-6-0"];
