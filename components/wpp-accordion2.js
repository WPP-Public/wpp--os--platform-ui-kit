...
}, [1, "wpp-accordion", "wpp-accordion-v4-1-0", {
...
function defineCustomElement() {
  ...
  const components = ["wpp-accordion-v4-1-0", "wpp-divider-v4-1-0", "wpp-icon-chevron-v4-1-0", "wpp-icon-error-v4-1-0", "wpp-icon-warning-v4-1-0", "wpp-internal-tooltip-v4-1-0", "wpp-tooltip-v4-1-0", "wpp-typography-v4-1-0"];
