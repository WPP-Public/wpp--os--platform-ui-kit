...
import { g as getSlotEmptyStates, j as transformToVersionedTag } from './utils.js';
...
}, [1, "wpp-accordion", "wpp-accordion-v2-22-0", {
...
function defineCustomElement() {
  ...
  const components = ["wpp-accordion-v2-22-0", "wpp-divider-v2-22-0", "wpp-icon-chevron-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
