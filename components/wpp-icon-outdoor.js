...
const WppIconOutdoor$1 = /*@__PURE__*/ proxyCustomElement(class WppIconOutdoor extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-outdoor-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-outdoor", "wpp-icon-outdoor-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-outdoor-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-outdoor-v4-2-0":
