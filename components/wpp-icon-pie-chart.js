...
const WppIconPieChart$1 = /*@__PURE__*/ proxyCustomElement(class WppIconPieChart extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-pie-chart-v3-6-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-pie-chart", "wpp-icon-pie-chart-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-pie-chart-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-pie-chart-v3-6-0":
