...
const WppIconEditText$1 = /*@__PURE__*/ proxyCustomElement(class WppIconEditText extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-edit-text-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-edit-text", "wpp-icon-edit-text-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-edit-text-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-edit-text-v2-22-0":
