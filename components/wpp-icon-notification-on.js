...
const WppIconNotificationOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconNotificationOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-notification-on", "wpp-icon-notification-on-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-notification-on-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-notification-on-v3-3-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconNotificationOn$1);
      }
      break;
  } });
}

const WppIconNotificationOn = WppIconNotificationOn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconNotificationOn, defineCustomElement };
