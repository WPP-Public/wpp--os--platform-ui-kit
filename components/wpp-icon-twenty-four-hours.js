...
const WppIconTwentyFourHours$1 = /*@__PURE__*/ proxyCustomElement(class WppIconTwentyFourHours extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-twenty-four-hours-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-twenty-four-hours", "wpp-icon-twenty-four-hours-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-twenty-four-hours-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-twenty-four-hours-v2-22-0":
...
const WppIconTwentyFourHours = WppIconTwentyFourHours$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconTwentyFourHours, defineCustomElement };
