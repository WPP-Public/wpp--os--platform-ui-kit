...
const WppIconAutofit$1 = /*@__PURE__*/ proxyCustomElement(class WppIconAutofit extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-autofit-v3-5-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-autofit", "wpp-icon-autofit-v3-5-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-autofit-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-autofit-v3-5-0":
