...
const WppLegacyAvatar$1 = /*@__PURE__*/ proxyCustomElement(class WppLegacyAvatar extends HTMLElement {
  ...
  static get registryIs() { return "wpp-legacy-avatar-v4-2-0"; }
...
}, [1, "wpp-legacy-avatar", "wpp-legacy-avatar-v4-2-0", {
    "name": [1],
    "size": [1],
    "variant": [1],
    "src": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-legacy-avatar-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-tooltip-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-legacy-avatar-v4-2-0":
...
const WppLegacyAvatar = WppLegacyAvatar$1;
const defineCustomElement = defineCustomElement$1;

export { WppLegacyAvatar, defineCustomElement };
