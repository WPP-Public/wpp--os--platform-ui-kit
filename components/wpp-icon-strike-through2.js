...
const WppIconStrikeThrough = /*@__PURE__*/ proxyCustomElement(class WppIconStrikeThrough extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-strike-through-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-strike-through", "wpp-icon-strike-through-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-strike-through-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-strike-through-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconStrikeThrough);
      }
      break;
  } });
}

export { WppIconStrikeThrough as W, defineCustomElement as d };
