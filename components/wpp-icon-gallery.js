...
const WppIconGallery$1 = /*@__PURE__*/ proxyCustomElement(class WppIconGallery extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-gallery", "wpp-icon-gallery-v4-3-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-gallery-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-gallery-v4-3-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconGallery$1);
      }
      break;
  } });
}

const WppIconGallery = WppIconGallery$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconGallery, defineCustomElement };
