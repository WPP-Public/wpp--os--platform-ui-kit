...
const WppIconTune = /*@__PURE__*/ proxyCustomElement(class WppIconTune extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-tune-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-tune-v4-1-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconTune);
      }
      break;
  } });
}

export { WppIconTune as W, defineCustomElement as d };
