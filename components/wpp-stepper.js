...
const WppStepper$1 = /*@__PURE__*/ proxyCustomElement(class WppStepper extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-stepper", "wpp-stepper-v4-3-0", {
    "activeStep": [514, "active-step"],
    "stepAmount": [2, "step-amount"],
    "completedSteps": [514, "completed-steps"],
    "stepperWidth": [1, "stepper-width"],
    "orientation": [513],
    "useResizeObserver": [4, "use-resize-observer"],
    "useDecimalSubSteps": [4, "use-decimal-sub-steps"],
    "stepIndicator": [32],
    "stepperPosition": [32],
    "lastActiveStep": [32],
    "lastCompletedStep": [32]
  }, [[2, "wppStepUpdate", "handleStepUpdate"], [2, "wppStepChange", "handleSelectStepClick"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["wpp-stepper-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-stepper-v4-3-0":
...
const WppStepper = WppStepper$1;
const defineCustomElement = defineCustomElement$1;

export { WppStepper, defineCustomElement };
