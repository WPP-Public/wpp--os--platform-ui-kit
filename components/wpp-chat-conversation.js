...
import { d as defineCustomElement$F } from './wpp-avatar2.js';
...
import { d as defineCustomElement$z } from './wpp-icon-attach2.js';
...
}, [1, "wpp-chat-conversation", "wpp-chat-conversation-v4-1-0", {
    "messages": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-chat-conversation-v4-1-0", "wpp-action-button-v4-1-0", "wpp-avatar-v4-1-0", "wpp-chat-conversation-message-v4-1-0", "wpp-chat-input-v4-1-0", "wpp-checkbox-v4-1-0", "wpp-divider-v4-1-0", "wpp-file-upload-item-v4-1-0", "wpp-icon-attach-v4-1-0", "wpp-icon-chevron-v4-1-0", "wpp-icon-copy-v4-1-0", "wpp-icon-cross-v4-1-0", "wpp-icon-dash-v4-1-0", "wpp-icon-database-v4-1-0", "wpp-icon-document-v4-1-0", "wpp-icon-download-v4-1-0", "wpp-icon-error-v4-1-0", "wpp-icon-file-v4-1-0", "wpp-icon-file-zip-v4-1-0", "wpp-icon-image-v4-1-0", "wpp-icon-info-message-v4-1-0", "wpp-icon-mic-on-v4-1-0", "wpp-icon-more-v4-1-0", "wpp-icon-music-v4-1-0", "wpp-icon-pitch-v4-1-0", "wpp-icon-plus-v4-1-0", "wpp-icon-send-v4-1-0", "wpp-icon-spreadsheet-v4-1-0", "wpp-icon-success-v4-1-0", "wpp-icon-tick-v4-1-0", "wpp-icon-video-clip-v4-1-0", "wpp-icon-warning-v4-1-0", "wpp-inline-message-v4-1-0", "wpp-internal-label-v4-1-0", "wpp-internal-tooltip-v4-1-0", "wpp-label-v4-1-0", "wpp-list-item-v4-1-0", "wpp-menu-context-v4-1-0", "wpp-spinner-v4-1-0", "wpp-toast-v4-1-0", "wpp-tooltip-v4-1-0", "wpp-typography-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-chat-conversation-v4-1-0":
