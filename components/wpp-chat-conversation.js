...
import { d as defineCustomElement$G } from './wpp-avatar2.js';
import { d as defineCustomElement$F } from './wpp-button2.js';
import { d as defineCustomElement$E } from './wpp-chat-conversation-message2.js';
import { d as defineCustomElement$D } from './wpp-chat-input2.js';
import { d as defineCustomElement$C } from './wpp-checkbox2.js';
import { d as defineCustomElement$B } from './wpp-divider2.js';
import { d as defineCustomElement$A } from './wpp-file-upload-item2.js';
import { d as defineCustomElement$z } from './wpp-icon-arrow2.js';
import { d as defineCustomElement$y } from './wpp-icon-chevron2.js';
import { d as defineCustomElement$x } from './wpp-icon-copy2.js';
import { d as defineCustomElement$w } from './wpp-icon-cross2.js';
import { d as defineCustomElement$v } from './wpp-icon-dash2.js';
import { d as defineCustomElement$u } from './wpp-icon-database2.js';
import { d as defineCustomElement$t } from './wpp-icon-document2.js';
import { d as defineCustomElement$s } from './wpp-icon-download2.js';
import { d as defineCustomElement$r } from './wpp-icon-error2.js';
import { d as defineCustomElement$q } from './wpp-icon-file2.js';
import { d as defineCustomElement$p } from './wpp-icon-file-zip2.js';
import { d as defineCustomElement$o } from './wpp-icon-image2.js';
import { d as defineCustomElement$n } from './wpp-icon-info-message2.js';
import { d as defineCustomElement$m } from './wpp-icon-mic-on2.js';
import { d as defineCustomElement$l } from './wpp-icon-more2.js';
import { d as defineCustomElement$k } from './wpp-icon-music2.js';
import { d as defineCustomElement$j } from './wpp-icon-pitch2.js';
import { d as defineCustomElement$i } from './wpp-icon-plus2.js';
import { d as defineCustomElement$h } from './wpp-icon-spreadsheet2.js';
import { d as defineCustomElement$g } from './wpp-icon-stop2.js';
...
}, [1, "wpp-chat-conversation", "wpp-chat-conversation-v4-3-0", {
    "messages": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-chat-conversation-v4-3-0", "wpp-action-button-v4-3-0", "wpp-avatar-v4-3-0", "wpp-button-v4-3-0", "wpp-chat-conversation-message-v4-3-0", "wpp-chat-input-v4-3-0", "wpp-checkbox-v4-3-0", "wpp-divider-v4-3-0", "wpp-file-upload-item-v4-3-0", "wpp-icon-arrow-v4-3-0", "wpp-icon-chevron-v4-3-0", "wpp-icon-copy-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-dash-v4-3-0", "wpp-icon-database-v4-3-0", "wpp-icon-document-v4-3-0", "wpp-icon-download-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-file-v4-3-0", "wpp-icon-file-zip-v4-3-0", "wpp-icon-image-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-mic-on-v4-3-0", "wpp-icon-more-v4-3-0", "wpp-icon-music-v4-3-0", "wpp-icon-pitch-v4-3-0", "wpp-icon-plus-v4-3-0", "wpp-icon-spreadsheet-v4-3-0", "wpp-icon-stop-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-tick-v4-3-0", "wpp-icon-video-clip-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-inline-message-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-label-v4-3-0", "wpp-list-item-v4-3-0", "wpp-menu-context-v4-3-0", "wpp-spinner-v4-3-0", "wpp-toast-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-chat-conversation-v4-3-0":
