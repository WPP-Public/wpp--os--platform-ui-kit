...
const WppEmptyNoAccess$1 = /*@__PURE__*/ proxyCustomElement(class WppEmptyNoAccess extends HTMLElement {
  ...
  static get registryIs() { return "wpp-empty-no-access-v2-22-0"; }
  static get style() { return wppImageCss; }
}, [1, "wpp-empty-no-access", "wpp-empty-no-access-v2-22-0", {
    "width": [2],
    "height": [2]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["wpp-empty-no-access-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-empty-no-access-v2-22-0":
