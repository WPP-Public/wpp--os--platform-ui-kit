...
import { d as defineCustomElement$6 } from './wpp-icon-done2.js';
import { d as defineCustomElement$5 } from './wpp-icon-edit2.js';
import { d as defineCustomElement$4 } from './wpp-popover2.js';
...
}, [1, "wpp-inline-edit", "wpp-inline-edit-v2-22-0", {
    "mode": [1],
    "value": [1],
    "placeholder": [1],
    "dropdownConfig": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-inline-edit-v2-22-0", "wpp-action-button-v2-22-0", "wpp-icon-cross-v2-22-0", "wpp-icon-done-v2-22-0", "wpp-icon-edit-v2-22-0", "wpp-popover-v2-22-0", "wpp-spinner-v2-22-0", "wpp-typography-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-inline-edit-v2-22-0":
    ...
    case "wpp-icon-cross-v2-22-0":
      ...
      break;
    case "wpp-icon-done-v2-22-0":
      if (!customElements.get(tagName)) {
        defineCustomElement$6();
      }
      break;
    case "wpp-icon-edit-v2-22-0":
      if (!customElements.get(tagName)) {
...
export { WppInlineEdit, defineCustomElement };
