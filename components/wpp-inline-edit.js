...
}, [1, "wpp-inline-edit", "wpp-inline-edit-v3-3-0", {
    "mode": [1],
    "value": [1],
    "placeholder": [1],
    "dropdownConfig": [16],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-inline-edit-v3-3-0", "wpp-action-button-v3-3-0", "wpp-icon-cross-v3-3-0", "wpp-icon-done-v3-3-0", "wpp-icon-edit-v3-3-0", "wpp-icon-error-v3-3-0", "wpp-icon-info-message-v3-3-0", "wpp-icon-search-v3-3-0", "wpp-icon-success-v3-3-0", "wpp-icon-warning-v3-3-0", "wpp-inline-message-v3-3-0", "wpp-input-v3-3-0", "wpp-internal-label-v3-3-0", "wpp-internal-tooltip-v3-3-0", "wpp-label-v3-3-0", "wpp-popover-v3-3-0", "wpp-spinner-v3-3-0", "wpp-tooltip-v3-3-0", "wpp-typography-v3-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-inline-edit-v3-3-0":
    ...
    case "wpp-icon-cross-v3-3-0":
      ...
      break;
    case "wpp-icon-done-v3-3-0":
      if (!customElements.get(tagName)) {
        defineCustomElement$h();
      }
      break;
    case "wpp-icon-edit-v3-3-0":
      if (!customElements.get(tagName)) {
