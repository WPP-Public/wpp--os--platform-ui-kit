...
const WppIconSmartwatch$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSmartwatch extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-smartwatch-v4-0-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-smartwatch-v4-0-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSmartwatch$1);
      }
      break;
  } });
}

const WppIconSmartwatch = WppIconSmartwatch$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSmartwatch, defineCustomElement };
