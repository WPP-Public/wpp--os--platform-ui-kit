...
const WppIconService = /*@__PURE__*/ proxyCustomElement(class WppIconService extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-service-v4-2-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-service", "wpp-icon-service-v4-2-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-service-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-service-v4-2-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconService);
      }
      break;
  } });
}

export { WppIconService as W, defineCustomElement as d };
