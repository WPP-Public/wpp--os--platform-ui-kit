...
const WppIconSortByIncrease$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSortByIncrease extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-sort-by-increase", "wpp-icon-sort-by-increase-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sort-by-increase-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sort-by-increase-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSortByIncrease$1);
      }
      break;
  } });
}

const WppIconSortByIncrease = WppIconSortByIncrease$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSortByIncrease, defineCustomElement };
