...
import { h as hasShadowDom, y as getAriaProps } from './utils.js';
...
}, [1, "wpp-floating-button", "wpp-floating-button-v4-1-0", {
    "disabled": [516],
    "loading": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-floating-button-v4-1-0", "wpp-icon-plus-v4-1-0", "wpp-spinner-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-floating-button-v4-1-0":
