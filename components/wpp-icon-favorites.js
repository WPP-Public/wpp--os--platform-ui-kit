...
const WppIconFavorites$1 = /*@__PURE__*/ proxyCustomElement(class WppIconFavorites extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-favorites-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-favorites-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconFavorites$1);
      }
      break;
  } });
}

const WppIconFavorites = WppIconFavorites$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconFavorites, defineCustomElement };
