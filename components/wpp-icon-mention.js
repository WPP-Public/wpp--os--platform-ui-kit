...
const WppIconMention$1 = /*@__PURE__*/ proxyCustomElement(class WppIconMention extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-mention-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-mention-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconMention$1);
      }
      break;
  } });
}

const WppIconMention = WppIconMention$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconMention, defineCustomElement };
