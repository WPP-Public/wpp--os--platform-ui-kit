...
const WppIconSortByDecrease$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSortByDecrease extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sort-by-decrease-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sort-by-decrease-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSortByDecrease$1);
      }
      break;
  } });
}

const WppIconSortByDecrease = WppIconSortByDecrease$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSortByDecrease, defineCustomElement };
