...
}, [1, "wpp-nav-sidebar", "wpp-nav-sidebar-v4-1-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-nav-sidebar-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-nav-sidebar-v4-1-0":
