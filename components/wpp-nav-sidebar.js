...
}, [1, "wpp-nav-sidebar", "wpp-nav-sidebar-v2-22-0", {
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-nav-sidebar-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-nav-sidebar-v2-22-0":
...
const WppNavSidebar = WppNavSidebar$1;
const defineCustomElement = defineCustomElement$1;

export { WppNavSidebar, defineCustomElement };
