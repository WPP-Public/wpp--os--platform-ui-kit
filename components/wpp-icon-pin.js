...
const WppIconPin$1 = /*@__PURE__*/ proxyCustomElement(class WppIconPin extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-pin", "wpp-icon-pin-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-pin-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-pin-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconPin$1);
      }
      break;
  } });
}

const WppIconPin = WppIconPin$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconPin, defineCustomElement };
