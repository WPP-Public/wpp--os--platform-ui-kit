...
const WppIconExternalLink$1 = /*@__PURE__*/ proxyCustomElement(class WppIconExternalLink extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-external-link-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-external-link", "wpp-icon-external-link-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-external-link-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-external-link-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconExternalLink$1);
      }
      break;
  } });
}

const WppIconExternalLink = WppIconExternalLink$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconExternalLink, defineCustomElement };
