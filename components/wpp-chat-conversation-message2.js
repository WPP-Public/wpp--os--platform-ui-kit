...
import { r as renderSlotsInListItem } from './utils2.js';
import { L as LIB_COMPONENTS_PREFIX } from './const.js';
import { d as defineCustomElement$y } from './wpp-action-button2.js';
import { d as defineCustomElement$x } from './wpp-avatar2.js';
import { d as defineCustomElement$w } from './wpp-checkbox2.js';
import { d as defineCustomElement$v } from './wpp-divider2.js';
import { d as defineCustomElement$u } from './wpp-file-upload-item2.js';
import { d as defineCustomElement$t } from './wpp-icon-chevron2.js';
import { d as defineCustomElement$s } from './wpp-icon-copy2.js';
import { d as defineCustomElement$r } from './wpp-icon-cross2.js';
import { d as defineCustomElement$q } from './wpp-icon-dash2.js';
import { d as defineCustomElement$p } from './wpp-icon-database2.js';
import { d as defineCustomElement$o } from './wpp-icon-document2.js';
import { d as defineCustomElement$n } from './wpp-icon-download2.js';
import { d as defineCustomElement$m } from './wpp-icon-error2.js';
import { d as defineCustomElement$l } from './wpp-icon-file2.js';
import { d as defineCustomElement$k } from './wpp-icon-file-zip2.js';
import { d as defineCustomElement$j } from './wpp-icon-image2.js';
import { d as defineCustomElement$i } from './wpp-icon-info-message2.js';
import { d as defineCustomElement$h } from './wpp-icon-more2.js';
import { d as defineCustomElement$g } from './wpp-icon-music2.js';
import { d as defineCustomElement$f } from './wpp-icon-pitch2.js';
import { d as defineCustomElement$e } from './wpp-icon-spreadsheet2.js';
import { d as defineCustomElement$d } from './wpp-icon-success2.js';
import { d as defineCustomElement$c } from './wpp-icon-tick2.js';
import { d as defineCustomElement$b } from './wpp-icon-video-clip2.js';
...
}, [1, "wpp-chat-conversation-message", "wpp-chat-conversation-message-v3-6-0", {
    "role": [1],
    "content": [1],
    "status": [1],
    "actionButtonsConfig": [16],
    "menuContextListItems": [16],
    "sourcesActionConfig": [16],
...
function defineCustomElement() {
  ...
  const components = ["wpp-chat-conversation-message-v3-6-0", "wpp-action-button-v3-6-0", "wpp-avatar-v3-6-0", "wpp-checkbox-v3-6-0", "wpp-divider-v3-6-0", "wpp-file-upload-item-v3-6-0", "wpp-icon-chevron-v3-6-0", "wpp-icon-copy-v3-6-0", "wpp-icon-cross-v3-6-0", "wpp-icon-dash-v3-6-0", "wpp-icon-database-v3-6-0", "wpp-icon-document-v3-6-0", "wpp-icon-download-v3-6-0", "wpp-icon-error-v3-6-0", "wpp-icon-file-v3-6-0", "wpp-icon-file-zip-v3-6-0", "wpp-icon-image-v3-6-0", "wpp-icon-info-message-v3-6-0", "wpp-icon-more-v3-6-0", "wpp-icon-music-v3-6-0", "wpp-icon-pitch-v3-6-0", "wpp-icon-spreadsheet-v3-6-0", "wpp-icon-success-v3-6-0", "wpp-icon-tick-v3-6-0", "wpp-icon-video-clip-v3-6-0", "wpp-icon-warning-v3-6-0", "wpp-inline-message-v3-6-0", "wpp-internal-label-v3-6-0", "wpp-internal-tooltip-v3-6-0", "wpp-label-v3-6-0", "wpp-list-item-v3-6-0", "wpp-menu-context-v3-6-0", "wpp-spinner-v3-6-0", "wpp-tooltip-v3-6-0", "wpp-typography-v3-6-0"];
...
export { WppChatConversationMessage as W, defineCustomElement as d };
