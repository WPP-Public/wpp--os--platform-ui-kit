...
const WppIconBarHorizontal$1 = /*@__PURE__*/ proxyCustomElement(class WppIconBarHorizontal extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-bar-horizontal", "wpp-icon-bar-horizontal-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-bar-horizontal-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-bar-horizontal-v2-22-0":
...
const WppIconBarHorizontal = WppIconBarHorizontal$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconBarHorizontal, defineCustomElement };
