...
import { c as convertMBToBytes, b as getExtensionsList, g as getExtension, m as modifyPropertiesOnFile, a as getBaseName, r as renameFile } from './utils2.js';
import { E as EXTENSION_TO_TYPE, d as defineCustomElement$p } from './wpp-file-upload-item2.js';
import { W as WrappedSlot } from './WrappedSlot.js';
import { g as getSlotEmptyStates } from './utils.js';
import { l as lodash } from './lodash.js';
import { d as defineCustomElement$q } from './wpp-action-button2.js';
import { d as defineCustomElement$o } from './wpp-icon-attach2.js';
import { d as defineCustomElement$n } from './wpp-icon-cross2.js';
import { d as defineCustomElement$m } from './wpp-icon-database2.js';
import { d as defineCustomElement$l } from './wpp-icon-document2.js';
import { d as defineCustomElement$k } from './wpp-icon-error2.js';
import { d as defineCustomElement$j } from './wpp-icon-file2.js';
import { d as defineCustomElement$i } from './wpp-icon-file-zip2.js';
...
import { d as defineCustomElement$f } from './wpp-icon-mic-on2.js';
import { d as defineCustomElement$e } from './wpp-icon-music2.js';
import { d as defineCustomElement$d } from './wpp-icon-pitch2.js';
import { d as defineCustomElement$c } from './wpp-icon-send2.js';
import { d as defineCustomElement$b } from './wpp-icon-spreadsheet2.js';
import { d as defineCustomElement$a } from './wpp-icon-success2.js';
import { d as defineCustomElement$9 } from './wpp-icon-video-clip2.js';
...
const WppChatInput$1 = /*@__PURE__*/ proxyCustomElement(class WppChatInput extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  componentDidLoad() {
    ...
    const debouncedResizeHandler = lodash.debounce(() => {
      if (this.textareaRef) {
  ...
  render() {
    ...
    return (h(Host, { class: this.hostCssClasses(), exportparts: "chat-input-container, toast, input-area, attachments, text-input, actions-bar, left-actions, right-actions, file-item", onClick: this.handleClick }, h("div", { class: this.chatInputContainerClasses(), part: "chat-input-container" }, this.showToast && (h("wpp-toast-v2-22-0", { message: this.toastMessage, type: this.toastType, duration: TOAST_DURATION, variant: "chat", part: "toast", class: this.chatToastClasses(), onClick: event => this.handleToastClick(event) })), h("div", { class: this.inputAreaClasses(), ref: el => (this.inputAreaRef = el), part: "input-area" }, allFiles?.length > 0 && (h("div", { class: this.attachmentsWrapperClasses(), part: "attachments" }, allFiles.map((file, index) => (h("wpp-file-upload-item-v2-22-0", { key: index, file: file, format: this.mergedFileUploadConfig.format, maxLabelLength: this.mergedFileUploadConfig.maxLabelLength, currentIndex: index, onWppDelete: this.handleDeleteItem, onWppClick: this.handleClickItem, locales: {
      ...
      }, part: "file-item", class: this.isFileWithError(file) ? 'error' : '' }))))), h("textarea", { class: this.textInputClasses(), placeholder: this.placeholder, value: this.message, ref: el => (this.textareaRef = el), onInput: event => this.handleInput(event), disabled: this.disabled, part: "text-input" })), h("div", { class: this.actionsBarClasses(), part: "actions-bar" }, h("div", { class: this.leftActionsClasses(), part: "left-actions" }, this.enableAttach && (h(Fragment, null, h("wpp-action-button-v2-22-0", { "data-testid": "attach-icon-only-button", disabled: this.disabled, variant: "secondary", onClick: () => this.handleFileSelection() }, h("wpp-icon-attach-v2-22-0", { slot: "icon-start" })), h("input", { class: "file-loader", type: "file", ref: inputRef => (this.inputRef = inputRef), style: { display: 'none' }, multiple: this.mergedFileUploadConfig.multiple, onChange: this.handleChange, accept: this.getAcceptExtensions().join(), title: "" }))), this.withSelect && (h(WrappedSlot, { wrapperClass: this.selectClasses(), name: "select", onSlotchange: this.updateSlotData })), this.enableMic && (h("wpp-action-button-v2-22-0", { "data-testid": "mic-icon-only-button", variant: "secondary", disabled: this.disabled }, h("wpp-icon-mic-on-v2-22-0", { slot: "icon-start" })))), h("div", { class: this.rightActionsClasses(), part: "right-actions" }, charExceeded && (h("wpp-typography-v2-22-0", { class: "char-counter", type: "xs-midi" }, this.message.length, "/", this.charactersLimit)), h("wpp-action-button-v2-22-0", { "data-testid": "send-icon-only-button", variant: "secondary", onClick: () => this.handleSend(), disabled: this.isSendDisabled }, h("wpp-icon-send-v2-22-0", { slot: "icon-start" })))))));
  }
...
}, [1, "wpp-chat-input", "wpp-chat-input-v2-22-0", {
    "placeholder": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-chat-input-v2-22-0", "wpp-action-button-v2-22-0", "wpp-file-upload-item-v2-22-0", "wpp-icon-attach-v2-22-0", "wpp-icon-cross-v2-22-0", "wpp-icon-database-v2-22-0", "wpp-icon-document-v2-22-0", "wpp-icon-error-v2-22-0", "wpp-icon-file-v2-22-0", "wpp-icon-file-zip-v2-22-0", "wpp-icon-image-v2-22-0", "wpp-icon-info-message-v2-22-0", "wpp-icon-mic-on-v2-22-0", "wpp-icon-music-v2-22-0", "wpp-icon-pitch-v2-22-0", "wpp-icon-send-v2-22-0", "wpp-icon-spreadsheet-v2-22-0", "wpp-icon-success-v2-22-0", "wpp-icon-video-clip-v2-22-0", "wpp-icon-warning-v2-22-0", "wpp-inline-message-v2-22-0", "wpp-internal-tooltip-v2-22-0", "wpp-spinner-v2-22-0", "wpp-toast-v2-22-0", "wpp-tooltip-v2-22-0", "wpp-typography-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-chat-input-v2-22-0":
...
const WppChatInput = WppChatInput$1;
const defineCustomElement = defineCustomElement$1;

export { WppChatInput, defineCustomElement };
