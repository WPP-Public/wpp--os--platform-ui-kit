...
function defineCustomElement() {
  ...
  const components = ["wpp-label-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-internal-label-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
