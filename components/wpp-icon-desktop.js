...
const WppIconDesktop$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDesktop extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-desktop-v4-1-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-desktop", "wpp-icon-desktop-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-desktop-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-desktop-v4-1-0":
