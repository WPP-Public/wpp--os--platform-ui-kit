...
const WppIconDesktop$1 = /*@__PURE__*/ proxyCustomElement(class WppIconDesktop extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-desktop-v3-3-1"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-desktop", "wpp-icon-desktop-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-desktop-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-desktop-v3-3-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconDesktop$1);
      }
      break;
  } });
}

const WppIconDesktop = WppIconDesktop$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconDesktop, defineCustomElement };
