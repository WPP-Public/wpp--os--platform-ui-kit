...
const WppIconSortDecrease$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSortDecrease extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-sort-decrease-v3-3-1"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-sort-decrease", "wpp-icon-sort-decrease-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sort-decrease-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sort-decrease-v3-3-1":
