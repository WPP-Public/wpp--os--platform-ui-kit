...
const WppIconSortDecrease$1 = /*@__PURE__*/ proxyCustomElement(class WppIconSortDecrease extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-sort-decrease-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-sort-decrease-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconSortDecrease$1);
      }
      break;
  } });
}

const WppIconSortDecrease = WppIconSortDecrease$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconSortDecrease, defineCustomElement };
