...
}, [1, "wpp-filter-button", "wpp-filter-button-v4-0-0", {
    "counter": [2],
    "name": [1],
    "ariaProps": [16],
    "disabled": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-filter-button-v4-0-0", "wpp-icon-tune-v4-0-0", "wpp-typography-v4-0-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-filter-button-v4-0-0":
