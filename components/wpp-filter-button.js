...
const WppFilterButton$1 = /*@__PURE__*/ proxyCustomElement(class WppFilterButton extends HTMLElement {
  ...
  render() {
    return (h(Host, { class: this.hostCssClasses(), exportparts: "button, icon, text, inner, counter", onBlur: this.onBlur, onMouseDown: this.onMouseDown, onKeyDown: this.onKeyDown, onKeyUp: this.onKeyUp }, h("button", { ref: el => (this.buttonRef = el), class: this.buttonCssClasses(), autoFocus: this.autoFocus, disabled: this.disabled, name: this.name, type: "button", "data-testid": "wppFilterButton", "aria-pressed": this.isPressed ? 'true' : 'false', ...this.validAriaProps, part: "button" }, h("wpp-icon-tune-v3-6-0", { class: "icon", part: "icon" }), h("span", { class: "text", part: "text" }, h("slot", { part: "inner" })), this.counter > 0 && (h("wpp-typography-v3-6-0", { class: "counter", type: "s-body", part: "counter" }, `(${this.counter})`)))));
  }
  static get registryIs() { return "wpp-filter-button-v3-6-0"; }
  get host() { return this; }
  static get watchers() { return {
    "ariaProps": ["onUpdateAriaProps"]
  }; }
  static get style() { return wppFilterButtonCss; }
}, [1, "wpp-filter-button", "wpp-filter-button-v3-6-0", {
    "counter": [2],
    "name": [1],
    "ariaProps": [16],
    "disabled": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-filter-button-v3-6-0", "wpp-icon-tune-v3-6-0", "wpp-typography-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-filter-button-v3-6-0":
