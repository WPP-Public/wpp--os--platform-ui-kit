...
}, [1, "wpp-filter-button", "wpp-filter-button-v3-5-0", {
    "counter": [2],
    "name": [1],
    "ariaProps": [16],
    "disabled": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-filter-button-v3-5-0", "wpp-icon-tune-v3-5-0", "wpp-typography-v3-5-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-filter-button-v3-5-0":
