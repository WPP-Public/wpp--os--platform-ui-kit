...
}, [1, "wpp-icon-table-sort-wrapper", "wpp-icon-table-sort-wrapper-v4-3-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "direction": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-table-sort-wrapper-v4-3-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-table-sort-wrapper-v4-3-0":
