...
import { y as mergeLocales, d as debounce } from './utils.js';
...
}, [1, "wpp-inline-message", "wpp-inline-message-v4-3-0", {
...
function defineCustomElement() {
  ...
  const components = ["wpp-inline-message-v4-3-0", "wpp-action-button-v4-3-0", "wpp-icon-cross-v4-3-0", "wpp-icon-error-v4-3-0", "wpp-icon-info-message-v4-3-0", "wpp-icon-success-v4-3-0", "wpp-icon-warning-v4-3-0", "wpp-internal-tooltip-v4-3-0", "wpp-spinner-v4-3-0", "wpp-tooltip-v4-3-0", "wpp-typography-v4-3-0"];
