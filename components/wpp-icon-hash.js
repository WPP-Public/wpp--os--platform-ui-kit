...
const WppIconHash$1 = /*@__PURE__*/ proxyCustomElement(class WppIconHash extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-hash", "wpp-icon-hash-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-hash-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-hash-v3-3-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconHash$1);
      }
      break;
  } });
}

const WppIconHash = WppIconHash$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconHash, defineCustomElement };
