...
const WppIconEyeOn$1 = /*@__PURE__*/ proxyCustomElement(class WppIconEyeOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-eye-on", "wpp-icon-eye-on-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-eye-on-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-eye-on-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconEyeOn$1);
      }
      break;
  } });
}

const WppIconEyeOn = WppIconEyeOn$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconEyeOn, defineCustomElement };
