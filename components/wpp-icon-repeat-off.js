...
const WppIconRepeatOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconRepeatOff extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-repeat-off-v3-6-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-repeat-off", "wpp-icon-repeat-off-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-repeat-off-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-repeat-off-v3-6-0":
