...
const WppIconRepeatOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconRepeatOff extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-repeat-off-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-repeat-off-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconRepeatOff$1);
      }
      break;
  } });
}

const WppIconRepeatOff = WppIconRepeatOff$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconRepeatOff, defineCustomElement };
