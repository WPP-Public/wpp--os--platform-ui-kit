...
const WppIconRedo = /*@__PURE__*/ proxyCustomElement(class WppIconRedo extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-redo-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-redo", "wpp-icon-redo-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-redo-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-redo-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconRedo);
      }
      break;
  } });
}

export { WppIconRedo as W, defineCustomElement as d };
