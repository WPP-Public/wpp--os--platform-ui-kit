...
const WppIconCommunication$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCommunication extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-communication-v4-1-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-communication", "wpp-icon-communication-v4-1-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-communication-v4-1-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-communication-v4-1-0":
