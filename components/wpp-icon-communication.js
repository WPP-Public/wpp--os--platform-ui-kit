...
const WppIconCommunication$1 = /*@__PURE__*/ proxyCustomElement(class WppIconCommunication extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-communication-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-communication-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconCommunication$1);
      }
      break;
  } });
}

const WppIconCommunication = WppIconCommunication$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconCommunication, defineCustomElement };
