...
const WppIconMicOn = /*@__PURE__*/ proxyCustomElement(class WppIconMicOn extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get registryIs() { return "wpp-icon-mic-on-v2-22-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-mic-on", "wpp-icon-mic-on-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement() {
  ...
  const components = ["wpp-icon-mic-on-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-mic-on-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconMicOn);
      }
      break;
  } });
}

export { WppIconMicOn as W, defineCustomElement as d };
