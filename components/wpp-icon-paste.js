...
const WppIconPaste$1 = /*@__PURE__*/ proxyCustomElement(class WppIconPaste extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-icon-paste", "wpp-icon-paste-v2-22-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-paste-v2-22-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-paste-v2-22-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WppIconPaste$1);
      }
      break;
  } });
}

const WppIconPaste = WppIconPaste$1;
const defineCustomElement = defineCustomElement$1;

export { WppIconPaste, defineCustomElement };
