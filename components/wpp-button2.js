...
import { g as getSlotEmptyStates, l as closestElement, z as getAriaProps } from './utils.js';
...
const WppButton = /*@__PURE__*/ proxyCustomElement(class WppButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
}, [1, "wpp-button", "wpp-button-v4-3-0", {
    "size": [1],
    "disabled": [516],
    "loading": [516],
    "variant": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-button-v4-3-0", "wpp-spinner-v4-3-0"];
...
export { WppButton as W, defineCustomElement as d };
