...
}, [1, "wpp-button", "wpp-button-v3-4-0", {
    "size": [1],
    "disabled": [516],
    "loading": [516],
    "variant": [1],
...
function defineCustomElement() {
  ...
  const components = ["wpp-button-v3-4-0", "wpp-spinner-v3-4-0"];
