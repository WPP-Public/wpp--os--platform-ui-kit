...
const WppIconEyeOff$1 = /*@__PURE__*/ proxyCustomElement(class WppIconEyeOff extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-eye-off-v3-6-0"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-eye-off", "wpp-icon-eye-off-v3-6-0", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-eye-off-v3-6-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-eye-off-v3-6-0":
