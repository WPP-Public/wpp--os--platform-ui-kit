...
}, [1, "wpp-side-modal", "wpp-side-modal-v3-4-0", {
    "actionsConfig": [16],
    "open": [1540],
    "size": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-side-modal-v3-4-0", "wpp-action-button-v3-4-0", "wpp-button-v3-4-0", "wpp-icon-chevron-v3-4-0", "wpp-icon-cross-v3-4-0", "wpp-overlay-v3-4-0", "wpp-spinner-v3-4-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-side-modal-v3-4-0":
