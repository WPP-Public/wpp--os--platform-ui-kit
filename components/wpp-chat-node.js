...
import { d as defineCustomElement$n } from './wpp-button2.js';
...
import { d as defineCustomElement$f } from './wpp-icon-plus2.js';
import { d as defineCustomElement$e } from './wpp-icon-service2.js';
...
const WppChatNode$1 = /*@__PURE__*/ proxyCustomElement(class WppChatNode extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return wppChatNodeCss; }
}, [6, "wpp-chat-node", "wpp-chat-node-v4-2-0", {
    ...
    "models": [16],
    "messageActions": [16],
    "selectedModelId": [1, "selected-model-id"],
    "locales": [16],
    "inputValue": [32],
    "messages": [32],
    "activeModelId": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-chat-node-v4-2-0", "wpp-action-button-v4-2-0", "wpp-avatar-v4-2-0", "wpp-button-v4-2-0", "wpp-checkbox-v4-2-0", "wpp-divider-v4-2-0", "wpp-icon-chevron-v4-2-0", "wpp-icon-cross-v4-2-0", "wpp-icon-dash-v4-2-0", "wpp-icon-error-v4-2-0", "wpp-icon-info-message-v4-2-0", "wpp-icon-plus-v4-2-0", "wpp-icon-service-v4-2-0", "wpp-icon-success-v4-2-0", "wpp-icon-tick-v4-2-0", "wpp-icon-warning-v4-2-0", "wpp-inline-message-v4-2-0", "wpp-internal-label-v4-2-0", "wpp-internal-tooltip-v4-2-0", "wpp-label-v4-2-0", "wpp-list-item-v4-2-0", "wpp-menu-context-v4-2-0", "wpp-spinner-v4-2-0", "wpp-tooltip-v4-2-0", "wpp-typography-v4-2-0"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-chat-node-v4-2-0":
...
const WppChatNode = WppChatNode$1;
const defineCustomElement = defineCustomElement$1;

export { WppChatNode, defineCustomElement };
