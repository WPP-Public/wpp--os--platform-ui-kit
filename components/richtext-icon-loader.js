...
const WppRichtextIconLoader = /*@__PURE__*/ proxyCustomElement(class WppRichtextIconLoader extends HTMLElement {
  ...
  render() {
    return (h(Host, null, h("div", { class: "icon-loader-container", "aria-hidden": "true", role: "presentation" }, h("wpp-icon-bold-v3-3-1", null), h("wpp-icon-italic-v3-3-1", null), h("wpp-icon-underline-v3-3-1", null), h("wpp-icon-strike-through-v3-3-1", null), h("wpp-icon-blockquote-v3-3-1", null), h("wpp-icon-code-view-v3-3-1", null), h("wpp-icon-h1-v3-3-1", null), h("wpp-icon-h2-v3-3-1", null), h("wpp-icon-ordered-list-v3-3-1", null), h("wpp-icon-unordered-list-v3-3-1", null), h("wpp-icon-text-alignment-left-v3-3-1", null), h("wpp-icon-text-alignment-center-v3-3-1", null), h("wpp-icon-text-alignment-right-v3-3-1", null), h("wpp-icon-text-alignment-justify-v3-3-1", null), h("wpp-icon-float-left-v3-3-1", null), h("wpp-icon-float-center-v3-3-1", null), h("wpp-icon-float-right-v3-3-1", null), h("wpp-icon-indent-increase-v3-3-1", null), h("wpp-icon-indent-decrease-v3-3-1", null), h("wpp-icon-link-v3-3-1", null), h("wpp-icon-undo-v3-3-1", null), h("wpp-icon-redo-v3-3-1", null), h("wpp-icon-attach-v3-3-1", null), h("wpp-icon-image-v3-3-1", null), h("wpp-icon-video-clip-v3-3-1", null), h("wpp-icon-info-v3-3-1", null))));
  }
  static get registryIs() { return "wpp-richtext-icon-loader-v3-3-1"; }
  get host() { return this; }
  static get style() { return richtextIconLoaderCss; }
}, [1, "wpp-richtext-icon-loader", "wpp-richtext-icon-loader-v3-3-1"]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["wpp-richtext-icon-loader-v3-3-1", "wpp-icon-attach-v3-3-1", "wpp-icon-blockquote-v3-3-1", "wpp-icon-bold-v3-3-1", "wpp-icon-code-view-v3-3-1", "wpp-icon-float-center-v3-3-1", "wpp-icon-float-left-v3-3-1", "wpp-icon-float-right-v3-3-1", "wpp-icon-h1-v3-3-1", "wpp-icon-h2-v3-3-1", "wpp-icon-image-v3-3-1", "wpp-icon-indent-decrease-v3-3-1", "wpp-icon-indent-increase-v3-3-1", "wpp-icon-info-v3-3-1", "wpp-icon-italic-v3-3-1", "wpp-icon-link-v3-3-1", "wpp-icon-ordered-list-v3-3-1", "wpp-icon-redo-v3-3-1", "wpp-icon-strike-through-v3-3-1", "wpp-icon-text-alignment-center-v3-3-1", "wpp-icon-text-alignment-justify-v3-3-1", "wpp-icon-text-alignment-left-v3-3-1", "wpp-icon-text-alignment-right-v3-3-1", "wpp-icon-underline-v3-3-1", "wpp-icon-undo-v3-3-1", "wpp-icon-unordered-list-v3-3-1", "wpp-icon-video-clip-v3-3-1"];
