...
const WppIconScale$1 = /*@__PURE__*/ proxyCustomElement(class WppIconScale extends HTMLElement {
  ...
  static get registryIs() { return "wpp-icon-scale-v3-3-1"; }
  static get style() { return wppIconCss; }
}, [1, "wpp-icon-scale", "wpp-icon-scale-v3-3-1", {
    "size": [1],
    "width": [2],
    "height": [2],
    "color": [1]
...
function defineCustomElement$1() {
  ...
  const components = ["wpp-icon-scale-v3-3-1"];
  components.forEach(tagName => { switch (tagName) {
    case "wpp-icon-scale-v3-3-1":
