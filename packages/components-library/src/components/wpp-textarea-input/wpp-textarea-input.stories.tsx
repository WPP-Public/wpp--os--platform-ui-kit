...
} as Meta<typeof WppTextareaInput>

export const WithinLimit: Story<Components.WppTextareaInput> = (
  args: Components.WppTextareaInput,
) => html` <wpp-textarea-input-v3-1-1
...
export const LimitExceeded: Story<Components.WppTextareaInput> = (
  args: Components.WppTextareaInput,
) => html` <wpp-textarea-input-v3-1-1
  @click="${() => console.log('textarea clicked')}"
  .name="${args.name}"
...
export const NoneLimit: Story<Components.WppTextareaInput & Components.WppInlineMessage> = (
