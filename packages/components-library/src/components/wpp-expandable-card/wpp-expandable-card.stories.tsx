...
} as Meta<typeof WppExpandableCard>
...
export const Expandable: Story<Components.WppExpandableCard> = (args: Components.WppExpandableCard) => html`
  <wpp-expandable-card-v3-1-1 .size="${args.size}" .variant="${args.variant}">
    ...
    <div slot="actions">
      <wpp-action-button-v3-1-1 variant="secondary">
        Action
        <wpp-icon-plus-v3-1-1 slot="icon-start"></wpp-icon-plus>
      </wpp-action-button-v3-1-1>
    </div>
  </wpp-expandable-card-v3-1-1>
`
