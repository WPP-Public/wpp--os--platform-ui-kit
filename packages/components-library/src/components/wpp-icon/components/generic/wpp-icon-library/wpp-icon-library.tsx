...
@Component({
  tag: 'wpp-icon-library-building',
  styleUrl: '../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconLibraryBuilding {
  /**
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-library-building"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
