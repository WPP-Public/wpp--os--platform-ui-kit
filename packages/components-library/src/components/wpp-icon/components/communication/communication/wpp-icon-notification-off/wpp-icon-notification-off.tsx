...
export class WppIconNotificationOff {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-notification-off component is deprecated. Please, use wpp-icon-notification instead',
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-notification-off"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
