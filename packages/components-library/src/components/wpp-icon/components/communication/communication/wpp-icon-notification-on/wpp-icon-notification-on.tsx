...
export class WppIconNotificationOn {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-notification-on component is deprecated. Please, use wpp-icon-notification-new instead',
