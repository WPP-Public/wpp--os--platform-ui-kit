...
| -------- | --------- | ------------------------------------------------------------------------------------------------------------------------- | --------------------- | -------------------------------- |
| `color`  | `color`   | Defines the icon color.                                                                                                   | `string`              | `'var(--wpp-danger-colour-400)'` |
...
### Used by
 ...
 - [wpp-sort-button](../../../../../wpp-sort-button)

### Graph
```mermaid
graph TD;
  wpp-sort-button --> wpp-icon-sort
  style wpp-icon-sort fill:#f9f,stroke:#333,stroke-width:4px
```
