...
export class WppIconRise {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-rise component is deprecated. Please, use wpp-icon-trend-ascend instead',
  ...
  render() {
    return (
      <WppIcon name="wpp-icon-rise" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
