...
@Component({
  tag: 'wpp-icon-descent',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconDescent {
  /**
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-descent component is deprecated. Please, use wpp-icon-trend-descent instead',
  ...
  render() {
    return (
      <WppIcon name="wpp-icon-descent" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
