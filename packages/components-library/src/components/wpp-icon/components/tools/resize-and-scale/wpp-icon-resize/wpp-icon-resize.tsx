...
export class WppIconResize {
  ...
  render() {
    return (
      <WppIcon name="wpp-icon-resize" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path fill-rule="evenodd" clip-rule="evenodd" d={ResizeDirectionIconPath[this.direction]} fill="currentColor" />
      </WppIcon>
    )
  }
}
