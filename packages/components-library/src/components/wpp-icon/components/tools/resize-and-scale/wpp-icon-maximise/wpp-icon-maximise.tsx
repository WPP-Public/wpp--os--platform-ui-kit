...
export class WppIconMaximise {
  ...
  render() {
    return (
      <WppIcon name="wpp-icon-maximise" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path d={MaximiseDirectionIconPath[this.direction]} fill="currentColor" />
      </WppIcon>
    )
  }
}
