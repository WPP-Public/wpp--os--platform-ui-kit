...
export class WppIconBank {
  ...
  render() {
    return (
      <WppIcon name="wpp-icon-bank" width={this.width} height={this.height} size={this.size} color={this.color}>
        <path
