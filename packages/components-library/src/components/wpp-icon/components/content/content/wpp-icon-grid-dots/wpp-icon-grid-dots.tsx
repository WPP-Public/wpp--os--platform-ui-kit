...
@Component({
  tag: 'wpp-icon-grid-dots',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconGridDots {
  /**
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-grid-dots component is deprecated. Please, use wpp-icon-grid instead',
