...
@Component({
  tag: 'wpp-icon-twenty-four-hours',
...
export class WppIconTwentyFourHours {
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-twenty-four-hours"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
