...
export class WppIconAvailable {
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-available-update"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
