...
@Component({
  tag: 'wpp-icon-favorites',
  styleUrl: '../../../../wpp-icon.scss',
  shadow: true,
})
export class WppIconFavorites {
  /**
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-favorites component is deprecated. Please, use wpp-icon-favourites instead',
