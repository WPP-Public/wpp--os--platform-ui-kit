...
export class WppIconSortByDecrease {
  ...
  componentWillLoad() {
    console.warn(
      '%cwpp-icon-sort-by-decrease component is deprecated. Please, use wpp-icon-sort-decrease instead',
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-sort-by-decrease"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
