...
export class WppIconBookInformation {
  ...
  render() {
    return (
      <WppIcon
        name="wpp-icon-book-information"
        width={this.width}
        height={this.height}
        size={this.size}
        color={this.color}
