...
| `locales`             | --                       | Indicates locales for search component                                                                                                                                                                         | `SearchLocales`                          | `{     nothingFound: 'Nothing found',     loading: 'Loading...',     dropdownHeader: '',   }` |
...
| ---------------------- | -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `wppBlur`              | Emitted when the search loses focus    | `CustomEvent<FocusEvent>`                                                                                                                                                                                                                                                                |
