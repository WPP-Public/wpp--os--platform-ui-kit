...
} as Meta<typeof WppTooltip>

export const TitleAndText: Story<Components.WppTooltip> = (args: Components.WppTooltip) => html`
  <wpp-tooltip-v3-1-1
    ...
    .error="${args.error}"
  >
    <wpp-button-v3-1-1 variant="${args.error ? 'destructive' : 'primary'}">
...
export const Value: Story<Components.WppTooltip> = (args: Components.WppTooltip) => html` <wpp-tooltip-v3-1-1
  .text="${args.text}"
  .value="${args.value}"
  .theme="${args.theme}"
  .config="${args.config}"
  ...
  .wordBreak="${args.wordBreak}"
>
  <wpp-button-v3-1-1 variant="primary">Button</wpp-button-v3-1-1>
</wpp-tooltip-v3-1-1>`
...
export const CustomContent: Story<Components.WppTooltip> = (args: Components.WppTooltip) => html`
  <wpp-tooltip-v3-1-1
    .dropdownWidth="${args.dropdownWidth}"
    .text="${args.text}"
    .config="${args.config}"
    ...
    .wordBreak="${args.wordBreak}"
  >
    <wpp-button-v3-1-1 data-testid="allow-html-tooltip-button">Tooltip with Custom Content</wpp-button-v3-1-1>
