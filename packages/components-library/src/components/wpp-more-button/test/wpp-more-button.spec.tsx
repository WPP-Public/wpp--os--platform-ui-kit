...
describe('wpp-more-button', () => {
  ...
  describe('Testing snapshots', () => {
    it('Testing default button with name', async () => {
      const page = await newSpecPage({
        components: [WppMoreButton],
        template: () => <wpp-more-button name="More items button" ariaProps={undefined}></wpp-more-button>,
      })
    ...
    it('Testing button with aria-label', async () => {
      const page = await newSpecPage({
        components: [WppMoreButton],
        template: () => <wpp-more-button ariaProps={{ label: 'More items menu' }}></wpp-more-button>,
      })
    ...
    it('Testing button with aria-desribedby', async () => {
      const page = await newSpecPage({
        components: [WppMoreButton],
        template: () => <wpp-more-button ariaProps={{ describedby: 'More items menu' }}></wpp-more-button>,
      })
