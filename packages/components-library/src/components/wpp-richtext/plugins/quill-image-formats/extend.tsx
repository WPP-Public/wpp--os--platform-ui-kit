...
type StyleMap = Partial<{ [key in keyof CSSStyleDeclaration]: string[] }>
 ...
 */
export function extendBlot(Blot: EmbedBlot): EmbedBlot {
...
export function extendBlotNames(blotNames: string[]) {
