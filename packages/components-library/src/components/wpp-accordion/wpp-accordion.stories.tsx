...
} as Meta<typeof WppAccordion>

type CardStoryArgs = Components.WppAccordion & { withActions: boolean; header: string; withTag: boolean }
...
export const Accordion: Story<CardStoryArgs> = (args: CardStoryArgs) => html`<div style="width: 600px">
  <wpp-accordion-v3-1-1 .size="${args.size}" .withTag="${args.withTag}" .disabled="${args.disabled}">
    <wpp-typography-v3-1-1
      slot="header"
      type=${handleTypographyType(args.size)}
      
      >Commitments & Responsibilities</wpp-typography-v3-1-1
    >
    <wpp-typography-v3-1-1
      ...
      by accident, sometimes on purpose (injected humour and the like). Lorem Ipsum is simply dummy text of the printing
      ...
      publishing software like Aldus PageMaker including versions of Lorem Ipsum. It is a long established fact that a
      ...
      humour and the like). Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
      been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
      scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into
      electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of
      Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus
      PageMaker including versions of Lorem Ipsum. It is a long established fact that a reader will be distracted by the
      ...
      readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model
    ...
    ${args.withTag ? html`<wpp-tag-v3-1-1 slot="tags" label="Neutral" variant="neutral"></wpp-tag-v3-1-1>` : null}
  </wpp-accordion-v3-1-1>
  <wpp-accordion-v3-1-1
  ...
  >
    ...
    >
    <wpp-typography-v3-1-1 type="s-body" ">
      ...
      args.withActions
        ? html`
            <div style="display: flex; align-items: center" slot="actions">
              <wpp-action-button-v3-1-1 .disabled="${args.disabled}" variant="secondary" style="margin-right: 4px">
                Actions 2
                <wpp-icon-premium-v3-1-1 slot="icon-start"></wpp-icon-premium-v3-1-1>
              </wpp-action-button-v3-1-1>
              <wpp-action-button-v3-1-1 .disabled="${args.disabled}" variant="secondary">
                Actions 1
                <wpp-icon-edit-v3-1-1 slot="icon-start"></wpp-icon-edit-v3-1-1>
              </wpp-action-button-v3-1-1>
            </div>
          `
        : null
  ...
  >
     <wpp-typography-v3-1-1
      slot="header"
      type=${handleTypographyType(args.size)}
      >Governance & Ethics</wpp-typography-v3-1-1
    >
    <wpp-typography-v3-1-1 type="s-body">
...
Accordion.args = {
  ...
  size: 'm',
  header:
    'Exploring the Convergence of Beauty, Science, and Technology to Shape the Future of Sustainable Innovations and Advanced Personal Care Solutions',
  withDivider: false,
  withActions: false,
  withTag: false,
}
