...
export const SingleSelectGroup: Story<CardSingleStoryArgsTypes> = (args: CardSingleStoryArgsTypes) => {
  const handleCardGroupChange = (event: CustomEvent) => {
    console.log('event.detail :>> ', event.detail)
  }

  return html`
    <wpp-card-group-v3-1-1
      .size="${args.size}"
    ...
    >
      <wpp-card-v3-1-1 name="item-a" value="item-a">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-1-1 type=${handleTypographyType(args.size)} slot="header">Item A</wpp-typography-v3-1-1>
      </wpp-card-v3-1-1>
      <wpp-card-v3-1-1 name="item-b" value="item-b">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-1-1 type=${handleTypographyType(args.size)} slot="header">Item B</wpp-typography-v3-1-1>
      </wpp-card-v3-1-1>
      <wpp-card-v3-1-1 value="item-c" .disabled="${args.disabled}">
        <div style="width: 238px; height: 200px"></div>
        <div slot="header" style="display: flex; align-items: center">
          <wpp-icon-user-v3-1-1 style="margin-right: 8px"></wpp-icon-user-v3-1-1>
...
export const MultipleSelectGroup: Story<CardStoryArgsTypes> = (args: CardStoryArgsTypes) => {
  ...
  return html`
    <wpp-card-group-v3-1-1
      ...
      style="width: 1000px; justify-content: space-between"
    >
      <wpp-card-v3-1-1 header="Item A" value="item-a">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-1-1 type=${handleTypographyType(args.size)} slot="header">Item A</wpp-typography-v3-1-1>
      </wpp-card-v3-1-1>
      <wpp-card-v3-1-1 header="Item B" value="item-b">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-1-1 type=${handleTypographyType(args.size)} slot="header">Item B</wpp-typography-v3-1-1>
      </wpp-card-v3-1-1>
      <wpp-card-v3-1-1 value="item-c" .disabled="${args.disabled}">
        <div style="width: 238px; height: 200px"></div>
        <wpp-typography-v3-1-1 type=${handleTypographyType(args.size)} slot="header"
          >${args.header}
        </wpp-typography-v3-1-1>
      </wpp-card-v3-1-1>
    </wpp-card-group-v3-1-1>
