...
export const Single: Story<DatepickerWithLimits> = (args: DatepickerWithLimits) => {
  if (!args.view) {
    args.view = 'days'
  }

  return html`<wpp-datepicker-v3-1-1
    .range=${args.range}
...
export const Range: Story<DatepickerWithLimits> = (args: DatepickerWithLimits) =>
  html`<wpp-datepicker-v3-1-1
    .range=${args.range}
    .messageType="${args.messageType}"
    .message="${args.message}"
    .static=${args.static}
...
export const RangeWithPresets: Story<DatepickerWithLimits> = (args: DatepickerWithLimits) =>
  html`<wpp-datepicker-v3-1-1
    .range=${args.range}
    .messageType="${args.messageType}"
    .message="${args.message}"
...
export const DependableDatepickers: Story<DatepickerWithLimits> = (args: DatepickerWithLimits) => {
  if (!args.view) {
    args.view = 'days'
  }
