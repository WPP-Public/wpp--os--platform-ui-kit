...
export type DateFormatType =
  | typeof DATE_FORMAT.DAY_MONTH_YEAR
  | typeof DATE_FORMAT.MONTH_DAY_YEAR
  | typeof DATE_FORMAT.YEAR_MONTH_DAY
...
// We need this export, because in other way we have error with AirDatepicker types in components.d.ts file
