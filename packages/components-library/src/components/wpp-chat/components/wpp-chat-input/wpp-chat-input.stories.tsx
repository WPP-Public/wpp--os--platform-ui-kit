...
} as Meta<typeof WppChatInput>

export const DefaultChatInput: Story<Components.WppChatInput> = (args: Components.WppChatInput) => {
        ...
        html`
          <div style=${'display: flex; flex-direction: column; height: 100vh; padding: 20px; box-sizing: border-box;'}>
            <div style=${'display: flex;'}>
              <wpp-typography-v3-1-1>Message History:</wpp-typography-v3-1-1>
              <ul>
                ${updatedMessages.map(msg => html`<li><wpp-typography-v3-1-1>${msg}</wpp-typography-v3-1-1></li>`)}
              </ul>
            </div>

            <div style=${'display: flex; align-items: flex-end; height: 100vh;'}>
              <wpp-chat-input-v3-1-1
