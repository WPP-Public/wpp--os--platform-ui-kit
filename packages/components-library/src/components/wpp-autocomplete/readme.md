...
| `locales`                 | --                            | Indicates locales for autocomplete component                                                                                                                                                                    | `AutocompleteLocales`                                  | `{     nothingFound: 'Nothing found',     beginTyping: 'Begin typing',     more: 'more',     showMore: 'more',     showLess: 'Show less',     selected: count => `${count} selected`,     loading: 'Loading...',     createNewElement: 'Create new element',   }` |
...
| ---------------------- | ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `wppBlur`              | Emitted when the autocomplete loses focus               | `CustomEvent<FocusEvent>`                                                                                                                                                                                                                                                                            |
