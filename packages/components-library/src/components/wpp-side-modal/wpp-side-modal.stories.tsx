...
export const SideModal: Story<SideModalStoryArgs> = (args: SideModalStoryArgs) => {
  const { handleOpenModal, handleCloseModal, handleActionModal } = getModalHandlers()

  return html`
    <div style="height: 1200px">
      <wpp-button-v3-1-1 @click=${handleOpenModal}>Open Side Modal</wpp-button-v3-1-1>
      <wpp-side-modal-v3-1-1
        @wppSideModalClose=${() => {
      ...
      >
        ...
        ${args.withActions
          ? html` <div slot="actions" style="display:flex; justify-content: flex-end;">
              ...
              <wpp-button-v3-1-1 variant="primary" .width=${'86px'} @click=${handleActionModal}>
                Action
              </wpp-button-v3-1-1>
            </div>`
          : null}
...
export const SideModalWithActionsConfig: Story<Components.WppSideModal> = (args: Components.WppSideModal) => {
  const { handleOpenModal, handleCloseModal } = getModalHandlers()

  return html`
    <div style="height: 1200px">
      <wpp-button-v3-1-1 @click=${handleOpenModal}>Open Side Modal with Actions Config</wpp-button-v3-1-1>
      <wpp-side-modal-v3-1-1
        @wppSideModalClose=${() => {
          console.log('Called wppSideModalClose')
          handleCloseModal()
