...
export enum SideModalCloseReason {
...
export type ActionConfig =
  ...
  | [SecondActionConfig]
  | [ThirdActionConfig]
  | [FirstActionConfig, SecondActionConfig]
  | [SecondActionConfig, FirstActionConfig]
  | [FirstActionConfig, ThirdActionConfig]
  | [ThirdActionConfig, FirstActionConfig]
  | [SecondActionConfig, ThirdActionConfig]
  | [ThirdActionConfig, SecondActionConfig]
  | [FirstActionConfig, SecondActionConfig, ThirdActionConfig]
  | [SecondActionConfig, FirstActionConfig, ThirdActionConfig]
  | [FirstActionConfig, ThirdActionConfig, SecondActionConfig]
  | [ThirdActionConfig, FirstActionConfig, SecondActionConfig]
  | [SecondActionConfig, ThirdActionConfig, FirstActionConfig]
  | [ThirdActionConfig, SecondActionConfig, FirstActionConfig]
