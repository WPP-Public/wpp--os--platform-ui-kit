import { Component, Prop, h, Event, EventEmitter, Watch, State, Element, Host, Listen } from '@stencil/core'
import {
...
export class WppTree {
   ...
   */
  @Prop() readonly locales: TreeLocaleType = {
