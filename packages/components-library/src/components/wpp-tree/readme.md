...
| `locales`                   | --                             | Defines the component locale types.                                                                                                       | `TreeLocaleType`       | `{     nothingFound: 'No result',   }`                                                                                                |
...
| `wppChange`      | Emitted when tree have changed it's state              | `CustomEvent<{ treeState: TreeType[]; currentItem?: TreeType \| undefined; selectedItems?: (TreeType \| null)[] \| undefined; selectedOriginalItems?: Partial<TreeType>[] \| undefined; reason: "search" \| "open" \| "select"; }>` |
