...
} as Meta<typeof WppFileUpload>

export const FileUpload: Story<Components.WppFileUpload> = (args: Components.WppFileUpload) =>
  html` <wpp-file-upload-v3-1-1
    ...
    @wppFileUploadItemDelete="${(e: CustomEvent) => console.log('wppFileUploadItemDelete', e.detail)}"
    @wppFileUploadItemClick="${(e: CustomEvent) => console.log('wppFileUploadItemClick', e.detail)}"
  />`
