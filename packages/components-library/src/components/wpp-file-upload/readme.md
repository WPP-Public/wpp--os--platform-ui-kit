...
| `locales`           | --                     | Indicates locales for file upload component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `FileUploadLocales`                           | `{     label: 'Choose a file',     text: 'to upload or drag it here',     info: (accept: string, size: number) => `Only ${accept} file at ${size} MB or less`,     sizeError: 'File exceeds size limit',     formatError: 'Wrong format',   }` |
...
| Slot | Description                                                                                        |
| ---- | -------------------------------------------------------------------------------------------------- |
|      | Should contain label and description of file upload. The default slot, without the name attribute. |
