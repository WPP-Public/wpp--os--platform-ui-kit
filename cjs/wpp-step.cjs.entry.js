...
const WppStep = class {
  constructor(hostRef) {
    ...
    this.renderStep = () => {
      if (!this.isSubStep() && this.completed) {
        return index.h("wpp-icon-tick-v3-3-0", { color: "var(--wpp-grey-color-000)" });
      }
      if (this.isSubStep()) {
        return null;
      }
    ...
    this.renderStepTypeData = () => {
      let icon;
      if (this.error)
        icon = index.h("wpp-icon-error-v3-3-0", null);
      if (this.warning)
        icon = index.h("wpp-icon-warning-v3-3-0", null);
      if (!icon)
        return null;
      if (this.iconDescription) {
        return (index.h("wpp-tooltip-v3-3-0", { config: { placement: 'bottom' }, text: this.iconDescription }, icon));
      }
  ...
  render() {
    return (index.h(index.Host, { class: this.hostCssClasses(), exportparts: "wrapper, step, step-bg, step-index, step-label, optional, icon, last-step, last-step-text, label, label-wrapper, ws-wrapper, ws-inner", onClick: this.handleStepClick }, index.h("div", { class: this.stepWrapperCssClasses(), part: "wrapper" }, this.orientation === 'vertical' && (index.h("div", { class: this.stepBgCssClasses(), part: "step-bg" }, index.h("div", { class: this.stepTextWrapperCssClasses(), part: "step-label" }, !this.labelTooltipText ? (index.h(WrappedSlot.WrappedSlot, { onSlotchange: this.handleSlotChange, name: "label" })) : (index.h("wpp-tooltip-v3-3-0", { class: "label-tooltip", config: { placement: 'right' }, text: this.labelTooltipText }, index.h(WrappedSlot.WrappedSlot, { onSlotchange: this.handleSlotChange, wrapperClass: 'label-wrapper', name: "label" }))), this.tooltipText ? (index.h("div", { class: "step-description" }, index.h("wpp-tooltip-v3-3-0", { class: "description-tooltip", config: { placement: 'right' }, text: this.tooltipText }, index.h(WrappedSlot.WrappedSlot, { onSlotchange: this.handleSlotChange, name: "description" })))) : (index.h("div", { class: "step-description" }, index.h("slot", { onSlotchange: this.handleSlotChange, name: "description" })))), this.renderStepTypeData())), index.h("div", { class: this.stepCssClasses(), part: "step" }, index.h("span", { class: this.stepIndexCssClasses(), part: "step-index" }, this.renderStep()), this.orientation === 'horizontal' && (index.h("div", { class: this.stepTextWrapperCssClasses(), part: "step-label" }, index.h(WrappedSlot.WrappedSlot, { name: "label" }), this.renderStepTypeData()))), !this.lastStep && (index.h("div", { class: this.stepConnectorCssClasses(), part: "last-step" }, index.h("span", { class: this.connectorLineCssClasses(), part: "last-step-text" })))), index.h(WrappedSlot.WrappedSlot, { wrapperClass: "steps-list-container" })));
  }
